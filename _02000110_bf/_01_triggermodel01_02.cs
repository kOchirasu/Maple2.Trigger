    ...
    public static class _01_triggermodel01_02 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000064}, arg2: 1);
                context.SetActor(arg1: 11, arg2: true, arg3: "Closed");
                context.SetEffect(arg1: new int[] {202}, arg2: true);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000064}, arg2: 0)) {
        ...
        private class State몬스터와전투 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(arg1: 11, arg2: true, arg3: "Opened");

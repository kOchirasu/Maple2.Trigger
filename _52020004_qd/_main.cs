    ...
    public static class _main {
        ...
        private class State퀘스트조건체크 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50001763},
                    arg3: new byte[] {2})) {
                    context.State = new State트럭으로가세요_대기(context);
                    return;
                }

                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50001763},
                    arg3: new byte[] {1})) {
                    context.State = new State세리하첫등장연출_대기(context);
                    return;
                }

                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50001762},
                    arg3: new byte[] {3})) {
                    context.State = new State제이든만_대기(context);
                    return;
                }
                ...
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50001761},
                    arg3: new byte[] {3})) {
                    context.State = new State제이든만_대기(context);
                    return;
                }
                ...
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50001761},
                    arg3: new byte[] {2})) {
                    context.State = new State제이든호출_대기(context);
                    return;
                }
                ...
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50001760},
                    arg3: new byte[] {3})) {
                    context.State = new State라딘에게돌아가_대기(context);
                    return;
                }
                ...
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50001760},
                    arg3: new byte[] {1})) {
                    context.State = new State공주님과기사연출_대기(context);
                    return;
                }
            }
        ...
        private class State라딘에게돌아가_대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50001760},
                    arg3: new byte[] {3})) {
                    context.State = new State라딘에게돌아가(context);
                    return;
                }
        ...
        private class State제이든호출_대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50001761},
                    arg3: new byte[] {2})) {
                    context.State = new State제이든호출_연출준비(context);
                    return;
                }
        ...
        private class State트럭으로가세요_대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50001763},
                    arg3: new byte[] {3})) {
                    context.State = new State트럭으로가세요(context);
                    return;
                }
        ...
        private class State빈방 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[]
                    {101, 102, 105, 106, 107, 108, 109, 110, 111, 121, 122, 131, 132, 133});
            }
        ...
        private class State공주님과기사연출_대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State공주님과기사연출_시작(context);
                    return;
                }
            }
        ...
        private class State공주님과기사연출_시작 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State공주와기사00(context);
                    return;
                }
            }
        ...
        private class State마무리 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State공주님과기사연출_종료(context);
                    return;
                }
            }
        ...
        private class State제이든호출_연출준비 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State제이든호출_연출시작(context);
                    return;
                }
            }
        ...
        private class State제이든호출_연출시작 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new StatePC진입_놀람(context);
                    return;
                }
            }
        ...
        private class StatePC진입_놀람 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State제이든짜증01(context);
                    return;
                }
            }
        ...
        private class State제이든짜증01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State제이든짜증02(context);
                    return;
                }
            }
        ...
        private class State제이든짜증02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State제이든짜증03(context);
                    return;
                }
            }
        ...
        private class State제이든짜증03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State제이든호출_연출종료(context);
                    return;
                }
            }
        ...
        private class State몬스터체크 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {105, 106, 107, 108, 109})) {
                    context.State = new State몬스터추가스폰01(context);
                    return;
                }

                if (context.MonsterDead(arg1: new int[] {105})) {
                    context.State = new State몬스터추가스폰105(context);
                    return;
                }

                if (context.MonsterDead(arg1: new int[] {106})) {
                    context.State = new State몬스터추가스폰106(context);
                    return;
                }

                if (context.MonsterDead(arg1: new int[] {107})) {
                    context.State = new State몬스터추가스폰107(context);
                    return;
                }

                if (context.MonsterDead(arg1: new int[] {108})) {
                    context.State = new State몬스터추가스폰108(context);
                    return;
                }

                if (context.MonsterDead(arg1: new int[] {109})) {
                    context.State = new State몬스터추가스폰109(context);
                    return;
                }
        ...
        private class State몬스터추가스폰01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {105, 106, 107, 108, 109}, arg2: true);
            }
        ...
        private class State세리하첫등장연출_대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State세리하첫등장연출_준비(context);
                    return;
                }
            }
        ...
        private class State세리하첫등장연출_준비 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State세리하첫등장연출_시작(context);
                    return;
                }
            }
        ...
        private class State세리하첫등장연출_시작 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State탐색실패01(context);
                    return;
                }
            }
        ...
        private class State탐색실패01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State탐색실패02(context);
                    return;
                }
            }
        ...
        private class State탐색실패02 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11003541, illustID: "Jaiden_normal",
                    msg: @"단서가 될 만한 게 없는 건지, 있는데도 모르겠는 건지.\n답답하네, 좀.", duration: 3000);
                context.MoveUserPath(arg1: "PC_walkinCenter");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State흑성회등장01(context);
                    return;
                }
            }
        ...
        private class State흑성회등장01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State흑성회등장02(context);
                    return;
                }
            }
        ...
        private class State흑성회등장02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State흑성회등장03(context);
                    return;
                }
            }
        ...
        private class State흑성회등장03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State흑성회등장04(context);
                    return;
                }
            }
        ...
        private class State흑성회등장04 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11003659, illustID: "WeiHong_normal",
                    msg: @"아마 이곳에 들어온 모두가 그들을 찾고 있을 거야.\n흑성회도 마찬가지다.", duration: 3000);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State흑성회등장05(context);
                    return;
                }
            }
        ...
        private class State흑성회등장05 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new StatePC독백01(context);
                    return;
                }
            }
        ...
        private class StatePC독백01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State레지스탕스등장01(context);
                    return;
                }
            }
        ...
        private class State레지스탕스등장01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State레지스탕스등장02(context);
                    return;
                }
            }
        ...
        private class State레지스탕스등장02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State레지스탕스등장03(context);
                    return;
                }
            }
        ...
        private class State레지스탕스등장03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State레지스탕스등장04(context);
                    return;
                }
            }
        ...
        private class State레지스탕스등장04 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11003662, msg: @"우리 등장이 좀 밋밋했죠?\n멋있게 등장하도록 연출 보강 예정이니 참고해 주세요.",
                    duration: 3000);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State세리하등장01(context);
                    return;
                }
            }
        ...
        private class State세리하등장01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State세리하등장02(context);
                    return;
                }
            }
        ...
        private class State세리하등장02 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11003659, illustID: "WeiHong_normal", msg: "$npc:11003660$, 정리해라.",
                    duration: 3000);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State세리하등장03(context);
                    return;
                }
            }
        ...
        private class State세리하등장03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.ShowCaption(type: "NameCaption", title: "$npc:11003660$", desc: "흑성회 특수부대장, $npc:11003659$의 측근",
                    align: "centerLeft", offsetRateX: 0.5f, offsetRateY: 0.15f, duration: 5000, scale: 2.0f);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State세리하등장04(context);
                    return;
                }
            }
        ...
        private class State세리하등장04 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State제이든경고01(context);
                    return;
                }
            }
        ...
        private class State제이든경고01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State제이든경고02(context);
                    return;
                }
            }
        ...
        private class State제이든경고02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003541, illustID: "Jaiden_normal",
                    msg: @"$npcName:11003660$$pp:가,이$ 나선 이상, 이제 여긴 불지옥이 될거야.\n시간 없어. 빨리.", duration: 3000);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new StatePC제이든과도망(context);
                    return;
                }
            }
        ...
        private class StatePC제이든과도망 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State세리하공격준비(context);
                    return;
                }
            }
        ...
        private class State세리하공격준비 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State자막구간_준비(context);
                    return;
                }
            }
        ...
        private class State자막구간_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 7000)) {
                    context.State = new State자막구간_02(context);
                    return;
                }
            }
        ...
        private class State자막구간_03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 7000)) {
                    context.State = new State세리하첫등장연출_종료(context);
                    return;
                }
            }

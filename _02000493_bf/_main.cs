    ...
    public static class _main {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {3060, 3061, 3062, 3063, 3064, 3065, 3066, 3067}, arg2: true, arg3: 0,
                    arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {3070, 3071}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                ...
                context.SetInteractObject(arg1: new int[] {10000978}, arg2: 2);
                context.SetInteractObject(arg1: new int[] {10000979}, arg2: 2);
                context.SetInteractObject(arg1: new int[] {10000980}, arg2: 2);
                context.SetInteractObject(arg1: new int[] {10000981}, arg2: 2);
                context.SetInteractObject(arg1: new int[] {10000982}, arg2: 2);
        ...
        private class State연출시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(
                    arg1: new int[]
                        {101, 102, 103, 111, 112, 113, 114, 115, 116, 119, 121, 122, 123, 124, 125, 126, 127},
                    arg2: false);
        ...
        private class State전투02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000978}, arg2: 1);
                context.SetInteractObject(arg1: new int[] {10000979}, arg2: 1);
                context.SetInteractObject(arg1: new int[] {10000980}, arg2: 1);
                context.CreateMonster(
                    arg1: new int[] {
        ...
        private class State전투03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000981}, arg2: 1);
                context.SetInteractObject(arg1: new int[] {10000982}, arg2: 1);
                context.CreateMonster(arg1: new int[] {301, 302, 303}, arg2: false);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {301, 302, 303})) {
                    context.SetMesh(arg1: new int[] {3060, 3061, 3062, 3063, 3064, 3065, 3066, 3067}, arg2: false,
        ...
        private class State전투04 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {411, 412, 413, 414, 421, 422, 423, 424}, arg2: false);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {411, 412, 413, 414, 421, 422, 423, 424})) {
        ...
        private class State포털개방 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {3070, 3071}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }

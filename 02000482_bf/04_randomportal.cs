    ...
    public static class _04_randomportal {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10002035, 10002036, 10002037}, arg2: 0);
        ...
        private class StateToWall02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, script: "$02000482_BF__04_RANDOMPORTAL__0$", arg3: 2000, arg4: "0");
            }
        ...
        private class StateToWallGuide01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 2, arg2: 11000006, script: "$02000482_BF__04_RANDOMPORTAL__1$", arg4: 5);
        ...
        private class StateToRoom01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10002036}, arg2: 1);
                context.SetUserValue(triggerId: 5, key: "ToWallFalse", value: 1);
                context.SetUserValue(triggerId: 7, key: "ToTowerFalse", value: 1);
            }

            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {10002036}, arg2: 0)) {
        ...
        private class StateToRoom02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "$02000482_BF__04_RANDOMPORTAL__2$", arg3: 2000, arg4: "0");
        ...
        private class StateToRoomGuide01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
                context.SetConversation(arg1: 2, arg2: 11000006, script: "$02000482_BF__04_RANDOMPORTAL__3$", arg4: 5);
        ...
        private class StateToTower01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(triggerId: 5, key: "ToWallFalse", value: 1);
                context.SetUserValue(triggerId: 6, key: "ToRoomFalse", value: 1);
                context.SetInteractObject(arg1: new[] {10002037}, arg2: 1);
            }

            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {10002037}, arg2: 0)) {
        ...
        private class StateToTower02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "$02000482_BF__04_RANDOMPORTAL__4$", arg3: 2000, arg4: "0");
        ...
        private class StateToTowerGuide01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
                context.SetConversation(arg1: 2, arg2: 11000006, script: "$02000482_BF__04_RANDOMPORTAL__5$", arg4: 5);

    ...
    public static class _12_ironplatetrap {
        public class StateSetting : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10002029}, state: 0, arg4: false);
        ...
        private class StateLeverOn : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10002029}, state: 1);
                context.SetEffect(triggerIds: new []{5300, 5301, 5302, 5303}, visible: true);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10002029}, arg2: 0)) {

    ...
    public static class _thema_03 {
        public class StateStart : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.UserDetected(boxIds: new []{1004})) {
        ...
        private class StateMonsterSpawn : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{161, 162, 163, 164, 165, 166});
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (context.MonsterDead(spawnIds: new []{161, 162, 163, 164, 165, 166})) {
        ...
        private class StateMonsterDestroy : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{161, 162, 163, 164, 165, 166});
            }

namespace Maple2.Trigger._80000007_bonus {
    public static class _trigger_01 {
        public class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(
                    ...
                    arg2: true);
                context.SetMesh(arg1: new[] {401, 402, 403, 404, 405, 406, 407, 408, 409}, arg2: true);
                context.SetMesh(arg1: new[] {410, 411, 412, 413, 414, 415, 416, 417, 418}, arg2: true);
                context.SetMesh(
                    arg1: new[] {
        ...
        private class State미로패턴01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {101, 102, 104, 105, 106, 110, 111, 112, 113, 115, 116}, arg2: false);
                context.SetMesh(
                    arg1: new[] {
                        2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016,
                        2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025, 2026, 2027, 2028, 2029, 2030, 2031, 2032,
        ...
        private class State미로패턴02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {102, 103, 104, 105, 106, 107, 108, 111, 112, 113, 115, 117},
                    arg2: false);
                context.SetMesh(
                    arg1: new[] {
                        2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016,

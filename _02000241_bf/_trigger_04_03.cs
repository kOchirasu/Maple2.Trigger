    ...
    public static class _trigger_04_03 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {306}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
            ...
            public override void Execute() {
                if (context.UserDetected(arg1: new int[] {406})) {
        ...
        private class State버튼눌림 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {306}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetActor(arg1: 509, arg2: true, arg3: "Opened");
                context.SetActor(arg1: 510, arg2: true, arg3: "Opened");
                context.CreateMonster(arg1: new int[] {609, 610}, arg2: false);

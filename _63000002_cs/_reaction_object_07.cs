...
namespace Maple2.Trigger._63000002_cs {
    public static class _reaction_object_07 {
        ...
        private class State채집가능 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {607}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {607}, arg2: 2)) {
                    context.CreateItem(arg1: new int[] {1007});
        ...
        private class State채집완료 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(arg1: "7", arg2: 30, arg3: false);
            }

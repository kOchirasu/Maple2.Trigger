    ...
    public static class _main {
        public class StateIdle : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10002054}, state: 1);
        ...
        private class StateQuestDungeonStart : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.QuestUserDetected(boxIds: new []{702}, questIds: new []{50100080}, questStates: new byte[]{1})) {
                    return new StateMermaid_01(context);
                }

                if (context.QuestUserDetected(boxIds: new []{702}, questIds: new []{50100080}, questStates: new byte[]{2})) {
        ...
        private class StateMoveuser_00 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveUser(mapId: 52100013, portalId: 2);
            }
        ...
        private class StateScene_02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 102, script: "$52100011_QD__MAIN__5$", arg4: 2, arg5: 1);
            }
        ...
        private class StateOpen_door_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 102, script: "$52100011_QD__MAIN__6$", arg4: 2, arg5: 0);
                context.SetConversation(type: 1, spawnId: 101, script: "$52100011_QD__MAIN__7$", arg4: 2, arg5: 1);
            }
        ...
        private class StateBattle_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetLocalCamera(cameraId: 8100, enable: true);
                context.SetConversation(type: 1, spawnId: 102, script: "$52100011_QD__MAIN__8$", arg4: 2, arg5: 0);
                context.SetConversation(type: 1, spawnId: 101, script: "$52100011_QD__MAIN__9$", arg4: 2, arg5: 1);
        ...
        private class StateOpen_door_03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 102, script: "$52100011_QD__MAIN__11$", arg4: 2, arg5: 1);
                context.SetConversation(type: 1, spawnId: 101, script: "$52100011_QD__MAIN__12$", arg4: 2, arg5: 0);
        ...
        private class StateBattle_03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 102, script: "$52100011_QD__MAIN__13$", arg4: 2, arg5: 0);
                context.SetConversation(type: 1, spawnId: 101, script: "$52100011_QD__MAIN__14$", arg4: 2, arg5: 2);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10002054}, arg2: 0)) {
        ...
        private class StateBattle_04 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 102, script: "$52100011_QD__MAIN__15$", arg4: 2, arg5: 0);
                context.SetConversation(type: 1, spawnId: 101, script: "$52100011_QD__MAIN__16$", arg4: 2, arg5: 2);
            }
        ...
        private class StateShip_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 102, script: "$52100011_QD__MAIN__17$", arg4: 2, arg5: 0);
                context.SetConversation(type: 1, spawnId: 101, script: "$52100011_QD__MAIN__18$", arg4: 2, arg5: 2);
            }
        ...
        private class StateShip_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "$52100011_QD__MAIN__19$", duration: 3000);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10002055}, arg2: 0)) {
        ...
        private class StateShip_03 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10002056}, arg2: 0)) {
        ...
        private class StateEnding_03 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveUser(mapId: 52100012, portalId: 0);
            }

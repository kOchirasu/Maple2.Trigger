    ...
    public static class _main {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {2001});
                ...
                context.SetInteractObject(arg1: new int[] {13000014}, arg2: 2);
        ...
        private class State레논구출 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {2002});
            }
        ...
        private class State진행07몬스터 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {1021});
            }
        ...
        private class State진행08 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 128, arg2: new int[] {2002})) {
                    ...
                    context.CreateMonster(arg1: new int[] {2003});
        ...
        private class State진행09몬스터 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {1022});
            }
        ...
        private class State진행10 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 130, arg2: new int[] {2003})) {
                    ...
                    context.CreateMonster(arg1: new int[] {2004});
        ...
        private class State진행11몬스터 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {1023});
            }
        ...
        private class State진행12 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 132, arg2: new int[] {2004})) {
                    ...
                    context.CreateMonster(arg1: new int[] {2005});
        ...
        private class State진행13몬스터 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {1024});
            }
        ...
        private class State진행14 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 134, arg2: new int[] {2005})) {
                    ...
                    context.CreateMonster(arg1: new int[] {2007});
        ...
        private class State던전종료연출딜레이 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {2008});
                context.DestroyMonster(arg1: new int[] {1025, 1026});
            }

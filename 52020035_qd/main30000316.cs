    ...
    public static class _main30000316 {
        public class StateIdle : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.QuestUserDetected(boxIds: new []{701}, questIds: new []{30000315, 30000316}, questStates: new byte[]{2})) {
        ...
        private class State흑성회입장 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
                context.CreateMonster(spawnIds: new []{116}, arg2: false, arg3: 0);
                context.CreateMonster(spawnIds: new []{109}, arg2: false, arg3: 0);
                context.CreateMonster(spawnIds: new []{104}, arg2: false, arg3: 0);
                context.CreateMonster(spawnIds: new []{103}, arg2: false, arg3: 0);
                context.CreateMonster(spawnIds: new []{122}, arg2: false, arg3: 0);
                context.CreateMonster(spawnIds: new []{123}, arg2: false, arg3: 0);
            }
        ...
        private class State손님맞이 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 109, patrolName: "MS2PatrolData_3001");
            }
        ...
        private class State손님맞이_01_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 116, patrolName: "MS2PatrolData_3002");
            }
        ...
        private class State손님맞이_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new []{4033}, returnView: false);
        ...
        private class State손님맞이_03_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetNpcRotation(spawnId: 109, rotation: 90);
                context.SetNpcEmotionSequence(spawnId: 109, sequenceName: "Bore_A");
        ...
        private class State흑성회와이야기시작01_1 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetNpcRotation(spawnId: 109, rotation: -360);
            }
        ...
        private class State흑성회와이야기시작02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetNpcEmotionSequence(spawnId: 109, sequenceName: "Bore_B");
        ...
        private class State흑성회와이야기시작02_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetNpcEmotionSequence(spawnId: 116, sequenceName: "Bore_A");
        ...
        private class State흑성회와이야기시작03_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new []{4023}, returnView: false);
        ...
        private class State흑성회와이야기시작04_라딘과웨이홍 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetNpcEmotionLoop(spawnId: 104, sequenceName: "Talk_A", duration: 5000f);
        ...
        private class State흑성회와이야기시작04_라딘과웨이홍_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new []{4020}, returnView: false);
                context.SetNpcEmotionLoop(spawnId: 103, sequenceName: "Talk_A", duration: 18000f);
        ...
        private class State흑성회와이야기시작04_라딘과웨이홍_03 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new []{4021}, returnView: false);
                context.SetNpcEmotionLoop(spawnId: 104, sequenceName: "Talk_A", duration: 10000f);
                context.AddBalloonTalk(spawnId: 123, msg: "건방진..", duration: 3000);
                context.AddBalloonTalk(spawnId: 122, msg: "감히!", duration: 3000);
        ...
        private class State흑성회와이야기시작04_라딘과웨이홍_05 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new []{4021}, returnView: false);
                context.SetNpcEmotionLoop(spawnId: 104, sequenceName: "Talk_A", duration: 7000f);
        ...
        private class State흑성회와이야기시작04_라딘과웨이홍_07 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new []{4021}, returnView: false);
                context.SetNpcEmotionLoop(spawnId: 104, sequenceName: "Talk_A", duration: 8000f);
        ...
        private class State흑성회와이야기시작04_라딘과웨이홍_08 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new []{4022}, returnView: false);
        ...
        private class State장면전환_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetAchievement(triggerId: 701, type: "trigger", code: "MeetRadin");
                context.DestroyMonster(spawnIds: new []{103, 104, 109, 122, 123, 116});
            }
        ...
        private class State마을로이동 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.MoveUser(mapId: 02020014, portalId: 4);
            }

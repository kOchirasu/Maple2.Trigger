    ...
    public static class _im_564 {
        ...
        private class State시작대기중 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000564}, arg2: 1);
            }
        ...
        private class State오브젝트반응 : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000564}, arg2: 0)) {
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 1103, arg3: "$02000197_BF__IM_564__0$", arg4: 3);
            }

            public override void Execute() {
                if (context.NpcDetected(arg1: 564, arg2: new int[] {1103})) {

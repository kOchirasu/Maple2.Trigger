    ...
    public static class _main {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {101, 102, 103, 104, 111, 115});
            }
        ...
        private class State퀘스트조건체크 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50001791},
                    arg3: new byte[] {3})) {
                ...
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50001790},
                    arg3: new byte[] {3})) {
                    context.State = new State기본_대기(context);
                    return;
                }
                ...
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50001784},
                    arg3: new byte[] {3})) {
                    context.State = new State기본_대기(context);
                    return;
                }
                ...
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50001783},
                    arg3: new byte[] {3})) {
                    context.State = new State기본_대기(context);
                    return;
                }
                ...
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50001782},
                    arg3: new byte[] {3})) {
                    context.State = new State기본_대기(context);
                    return;
                }
                ...
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50001781},
                    arg3: new byte[] {3})) {
                    context.State = new State기본_대기(context);
                    return;
                }
                ...
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50001780},
                    arg3: new byte[] {3})) {
                    context.State = new State기본_대기(context);
                    return;
                }
        ...
        private class State레지스탕스_대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {102, 103, 104}, arg2: false);
        ...
        private class State아르망_마무리 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {101, 111});
        ...
        private class State세리하_대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {111, 115}, arg2: false);
                context.SetProductionUI(arg1: 1);
                context.SetProductionUI(arg1: 3);
                context.SetOnetimeEffect(id: 1, enable: true, path: @"BG/Common/ScreenMask/Eff_fadein_1sec.xml");
            }
        ...
        private class State빈방 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {101, 102, 103, 104, 111, 115}, arg2: false);
            }

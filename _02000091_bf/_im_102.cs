    ...
    public static class _im_102 {
        ...
        private class State시작대기중 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000533}, arg2: 1);
        ...
        private class State오브젝트반응 : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000533}, arg2: 0)) {
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 1102, arg2: new int[] {102})) {
        ...
        private class StateNPC소멸 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetTimer(arg1: "102", arg2: 3);
            }

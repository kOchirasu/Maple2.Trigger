...
namespace Maple2.Trigger._52020016_qd {
    public static class _monster_spawn_4_5 {
        ...
        private class State전투페이즈 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {4000406}, arg2: false);
                context.SetConversation(arg1: 1, arg2: 4000406, arg3: "헤햇..제가 무서운가요?!", arg4: 3, arg5: 0);
            }

            public override void Execute() {
                if (context.CheckNpcHp(compare: "lowerEqual", value: 20, spawnPointId: 4000406, isRelative: "true")) {
        ...
        private class State몬스터소멸 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {4000406}, arg2: false);
            }

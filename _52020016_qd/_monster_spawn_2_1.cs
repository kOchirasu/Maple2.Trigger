...
namespace Maple2.Trigger._52020016_qd {
    public static class _monster_spawn_2_1 {
        ...
        private class State체력조건 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "respawn_phase_2", value: 1)) {
        ...
        private class State전투페이즈 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {4000101}, arg2: false);
                context.SetConversation(arg1: 1, arg2: 4000101, arg3: "그만 사라져 버려라!!", arg4: 3, arg5: 0);
            }

            public override void Execute() {
                if (context.CheckNpcHp(compare: "lowerEqual", value: 20, spawnPointId: 4000101, isRelative: "true")) {
        ...
        private class State몬스터소멸 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {4000101}, arg2: false);
            }

...
namespace Maple2.Trigger._61000011_me {
    public static class _main {
        ...
        private class State대기 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.WidgetCondition(arg1: "OxQuizUGC", arg2: "IsCanceled")) {
                    context.State = new State게임취소(context);
                    return;
                }
            }
        ...
        private class State시작 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.WidgetCondition(arg1: "OxQuizUGC", arg2: "IsFinished")) {
                    context.State = new State게임끝(context);
                    return;
                }
        ...
        private class State벽생성 : TriggerState {
            ...
            public override void Execute() {
                if (context.TimeExpired(arg1: "2")) {
                    context.State = new State정답대기(context);
                    return;
                }
            }
        ...
        private class State게임취소 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$61000011_ME__GAME_END_BY_CANCEL$", arg3: new int[] {3000},
                    arg4: "0");
            ...
            public override void OnExit() {
                ...
                context.EndMiniGame(winnerBoxId: 105, gameName: "oxquiz_ugc", isOnlyWinner: "1");
            }
        }
        ...
        private class State우승자카메라연출 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 3, arg2: "$61000011_ME__WINNER_IS$", arg3: new int[] {5000}, arg4: "105");
                context.SetEventUI(arg1: 3, arg2: "$61000011_ME__ENVY_IS$", arg3: new int[] {5000}, arg4: "!105");
        ...
        private class State완료보상 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State성공알림(context);
                    return;
                }
            }
        ...
        private class State종료 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 5, arg2: "$61000011_ME__GAME_END_BY_ALL_RETIRED$", arg3: new int[] {3000},
                    arg4: "0");
        ...
        private class State성공알림 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 7, arg2: "$61000011_ME__MAIN__SUCCESS_IS$", arg3: new int[] {3000}, arg4: "0");
        ...
        private class State마무리 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$61000011_ME__MAIN__GOODBYE$", arg3: new int[] {3000}, arg4: "0");

namespace Maple2.Trigger._63000089_cs {
    public static class _reaction_object_03 {
        ...
        private class State채집가능 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{603}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{603}, arg2: 2)) {
                    context.CreateItem(spawnIds: new []{1003});
        ...
        private class State채집완료 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "3", seconds: 30, clearAtZero: false);
            }

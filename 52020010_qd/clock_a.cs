namespace Maple2.Trigger._52020010_qd {
    public static class _clock_a {
        ...
        private class StateReady : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001271}, arg2: 0)) {
        ...
        private class StateEvent_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnId: 102, msg: "엄마! 나 이 빵 먹어도 돼요?", duration: 2500, delayTick: 0);
            }
        ...
        private class StateEvent_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnId: 103, msg: "안돼! 금방 밥먹을거야.", duration: 2500, delayTick: 0);
            }
        ...
        private class StateEvent_03 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnId: 102, msg: "힝... 아빠 나 이거 먹으면 안돼요?", duration: 2500, delayTick: 0);
            }
        ...
        private class StateEvent_04 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnId: 101, msg: "허허... 녀석 참. 그럼 한개만 먹는거다?", duration: 2500, delayTick: 0);
                context.AddBalloonTalk(spawnId: 103, msg: "여보!", duration: 2500, delayTick: 500);
            }
        ...
        private class StateEvent_05 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnId: 103, msg: "그보다 요즘 한다는 일은 잘 되가요?", duration: 2500, delayTick: 1500);
                context.AddBalloonTalk(spawnId: 102, msg: "와! 신난다!", duration: 2500, delayTick: 0);
            }
        ...
        private class StateEvent_06 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnId: 101, msg: "당연하지! 왕국 제일의 기술자인 내가 못할 일은 없어!", duration: 2800, delayTick: 1500);
            }
        ...
        private class StateEvent_07 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnId: 101, msg: "그런데 말이야. 일이 끝나갈 수록 기분이 영 찝찝해.", duration: 2800, delayTick: 1500);
            }
        ...
        private class StateEvent_08 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnId: 101, msg: "도대체 왕은 무슨 생각을 하고 있는건지...", duration: 3000, delayTick: 1500);
            }

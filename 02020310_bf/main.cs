    ...
    public static class _main {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.EnableSpawnPointPc(spawnId: 117, isEnable: false);
                context.SetInteractObject(interactIds: new []{12000301, 12000302, 12000303, 12000304, 12000305, 12000306, 12000307, 12000308, 12000309, 12000310, 12000311, 12000312, 12000313, 12000314, 12000315, 12000316, 12000317, 12000318, 12000319, 12000320, 12000321}, state: 0);
                context.SetInteractObject(interactIds: new []{12000404, 12000405}, state: 1);
                ...
                context.SetVisibleBreakableObject(triggerIds: new []{1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008, 1009, 1010, 1011, 1012, 1013, 1014, 1015, 1016, 1017, 1018, 1019, 1020, 1021, 1022}, arg2: true);
            }
        ...
        private class State마를레네대사 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11004582, script: "$02020310_BF__MAIN__0$", align: Align.Left, illustId: "Eone_serious", duration: 6000);
            }
        ...
        private class StateCamera종료 : TriggerState {
            ...
            public override TriggerState? Execute() {
                context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004582, illust: "Eone_normal", script: "$02020310_BF__MAIN__1$", duration: 6000);
                    context.SetSceneSkip();
        ...
        private class StateLineStart : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{1101, 1001, 1002, 1005, 1006, 1009, 1010, 1011, 1012, 1015, 1016, 1017, 1018, 1019, 1020})) {
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004582, illust: "Eone_normal", script: "$02020310_BF__MAIN__2$", duration: 8000);
        ...
        private class StateCableOn_01 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{12000301}, arg2: 0)) {
                    context.SetInteractObject(interactIds: new []{12000302, 12000303}, state: 0);
                ...
                if (context.ObjectInteracted(interactIds: new []{12000302}, arg2: 0)) {
                    context.SetInteractObject(interactIds: new []{12000301, 12000303}, state: 0);
                ...
                if (context.ObjectInteracted(interactIds: new []{12000303}, arg2: 0)) {
                    context.SetInteractObject(interactIds: new []{12000301, 12000302}, state: 0);
        ...
        private class StateCableDelay_01_1 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.SetEventUI(arg1: 1, script: "$02020310_BF__MAIN__3$", duration: 3000);
        ...
        private class StateCableDelay_01_2 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.SetEventUI(arg1: 1, script: "$02020310_BF__MAIN__4$", duration: 3000);
        ...
        private class StateCableDelay_01_3 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.SetEventUI(arg1: 1, script: "$02020310_BF__MAIN__5$", duration: 3000);
        ...
        private class StateCableDelay_02_1 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.SetEventUI(arg1: 1, script: "$02020310_BF__MAIN__6$", duration: 1000);
        ...
        private class StateCableDelay_02_2 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.SetEventUI(arg1: 1, script: "$02020310_BF__MAIN__7$", duration: 1000);
        ...
        private class StateCableDelay_02_3 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.SetEventUI(arg1: 1, script: "$02020310_BF__MAIN__8$", duration: 1000);
        ...
        private class StateCableDelay_03_1 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.SetEventUI(arg1: 1, script: "$02020310_BF__MAIN__9$", duration: 1000);
        ...
        private class StateCableDelay_03_2 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.SetEventUI(arg1: 1, script: "$02020310_BF__MAIN__10$", duration: 1000);
        ...
        private class StateCableDelay_03_3 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.SetEventUI(arg1: 1, script: "$02020310_BF__MAIN__11$", duration: 1000);
        ...
        private class StateCableDelay_04_1 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.SetEventUI(arg1: 1, script: "$02020310_BF__MAIN__12$", duration: 1000);
        ...
        private class StateCableDelay_04_2 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.SetEventUI(arg1: 1, script: "$02020310_BF__MAIN__13$", duration: 1000);
        ...
        private class StateCableDelay_04_3 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.SetEventUI(arg1: 1, script: "$02020310_BF__MAIN__14$", duration: 1000);
        ...
        private class StateCableDelay_05_1 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    ...
                    context.SetEventUI(arg1: 1, script: "$02020310_BF__MAIN__15$", duration: 5000);
        ...
        private class StateCableDelay_05_2 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    ...
                    context.SetEventUI(arg1: 1, script: "$02020310_BF__MAIN__16$", duration: 5000);
        ...
        private class StateCableDelay_05_3 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    ...
                    context.SetEventUI(arg1: 1, script: "$02020310_BF__MAIN__17$", duration: 5000);

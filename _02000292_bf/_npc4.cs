    ...
    public static class _npc4 {
        ...
        private class State시작대기중 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000623}, arg2: 1);
                context.DestroyMonster(arg1: new int[] {1104});
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000623}, arg2: 0)) {
        ...
        private class StateNPC대사 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000623}, arg2: 2);

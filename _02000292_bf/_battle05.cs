    ...
    public static class _battle05 {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {117, 118, 119, 120}, arg2: false, arg3: 0, arg4: 0, arg5: 2f);
                context.DestroyMonster(arg1: new int[] {1020});
                context.DestroyMonster(arg1: new int[] {1021});
                context.DestroyMonster(arg1: new int[] {1022});
                context.DestroyMonster(arg1: new int[] {1023});
                context.DestroyMonster(arg1: new int[] {1024});
                context.DestroyMonster(arg1: new int[] {2020});
                context.DestroyMonster(arg1: new int[] {2021});
                context.DestroyMonster(arg1: new int[] {2022});
                context.DestroyMonster(arg1: new int[] {2023});
                context.DestroyMonster(arg1: new int[] {2024});
        ...
        private class StateMobSpawn01 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterInCombat(arg1: new int[] {1020, 1021, 1022, 1023, 1024})) {
        ...
        private class StateMobBattle01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {117, 118, 119, 120}, arg2: true, arg3: 0, arg4: 0, arg5: 2f);
            }

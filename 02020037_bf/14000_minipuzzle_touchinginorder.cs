    ...
    public static class _14000_minipuzzle_touchinginorder {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000244, 12000077}, state: 2);
        ...
        private class StateTouchingInNumericalOrder_Success : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000244}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{12000244}, arg2: 0)) {

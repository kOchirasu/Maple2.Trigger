...
namespace Maple2.Trigger._52000163_qd {
    public static class _52000163 {
        ...
        private class State리엔원경_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowCaption(type: "VerticalCaption", title: "$52000163_QD__52000163__0$", align: "bottomLeft",
        ...
        private class State떠나기전준비 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {2001}, arg2: new int[] {40002753},
                    arg3: new byte[] {3})) {

    ...
    public static class _portal04 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10000889}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000889}, arg2: 0)) {
        ...
        private class State생성 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetPortal(arg1: 80, arg2: false, arg3: true, arg4: false);
        ...
        private class State재사용대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(arg1: "3", arg2: 7);
            }

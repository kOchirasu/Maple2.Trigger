...
namespace Maple2.Trigger._02100000_bf {
    public static class _timer {
        ...
        private class State몬스터등장_보스 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {82001}, arg2: true);
            }
        ...
        private class State성공 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 7, arg2: "$02100000_BF__TIMER__1$", arg3: new int[] {2000}, arg4: "0");
            }
        ...
        private class State실패 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 5, arg2: "$02100000_BF__TIMER__0$", arg3: new int[] {2000}, arg4: "0");
                context.DestroyMonster(arg1: new int[] {-1});
            }

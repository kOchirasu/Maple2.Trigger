namespace Maple2.Trigger._02020112_bf {
    public static class _room3 {
        ...
        private class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "$02020112_BF__ROOM3__0$", duration: 3000);
            }
        ...
        private class State격리 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetTimer(timerId: "1", seconds: 20, display: true, arg5: -40);
                ...
                context.SetEventUI(arg1: 1, script: "$02020112_BF__ROOM3__1$", duration: 5000, boxId: 932);

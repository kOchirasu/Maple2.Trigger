...
namespace Maple2.Trigger._52000030_qd {
    public static class _main_a {
        ...
        private class StateIshuraScript01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 2, arg2: 11001583, script: "$52000030_QD__MAIN_A__0$", arg4: 3, arg5: 0);
                context.SetConversation(arg1: 2, arg2: 11001584, script: "$52000030_QD__MAIN_A__1$", arg4: 2, arg5: 0);
        ...
        private class StateIshuraScript02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
                context.SetConversation(arg1: 2, arg2: 11001230, script: "$52000030_QD__MAIN_A__2$", arg4: 2, arg5: 0);
            }
        ...
        private class StateIshuraScript03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
                context.SetConversation(arg1: 2, arg2: 11001584, script: "$52000030_QD__MAIN_A__3$", arg4: 3, arg5: 0);
            }

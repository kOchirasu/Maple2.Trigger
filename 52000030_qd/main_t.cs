...
namespace Maple2.Trigger._52000030_qd {
    public static class _main_t {
        ...
        private class StateIshuraScript01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 2, spawnId: 11001244, script: "$52000030_QD__MAIN_T__0$", arg4: 2, arg5: 0);
                context.SetConversation(type: 2, spawnId: 11001586, script: "$52000030_QD__MAIN_T__1$", arg4: 3, arg5: 0);
        ...
        private class StateIshuraScript02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
                context.SetConversation(type: 2, spawnId: 11001586, script: "$52000030_QD__MAIN_T__2$", arg4: 2, arg5: 0);
            }
        ...
        private class StateIshuraScript03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
                context.SetConversation(type: 2, spawnId: 11001244, script: "$52000030_QD__MAIN_T__3$", arg4: 2, arg5: 0);
                context.SetConversation(type: 2, spawnId: 11001586, script: "$52000030_QD__MAIN_T__4$", arg4: 2, arg5: 0);
            }

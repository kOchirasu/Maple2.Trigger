    ...
    public static class _10_bridge {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {3700, 3701}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }

            public override void Execute() {
                if (context.UserDetected(arg1: new[] {9700}) && context.UserDetected(arg1: new[] {9701})) {
        ...
        private class StateBridgeOn : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {3700, 3701}, arg2: true, arg3: 300, arg4: 0, arg5: 2f);
            }
        ...
        private class StateBridgeOff : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {3700, 3701}, arg2: false, arg3: 0, arg4: 0, arg5: 2f);
            }

    ...
    public static class _06_bridge {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {3300, 3301, 3302}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }

            public override void Execute() {
                if (context.UserDetected(arg1: new int[] {9300}) && context.UserDetected(arg1: new int[] {9301})) {
        ...
        private class StateBridgeOn : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {3300, 3301, 3302}, arg2: true, arg3: 300, arg4: 0, arg5: 2f);
            }
        ...
        private class StateBridgeOff : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {3300, 3301, 3302}, arg2: false, arg3: 0, arg4: 0, arg5: 2f);
            }

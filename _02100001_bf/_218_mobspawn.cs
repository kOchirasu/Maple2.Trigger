...
namespace Maple2.Trigger._02100001_bf {
    public static class _218_mobspawn {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(arg1: new int[] {218});
            }
        ...
        private class StateMobSpawn : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {218}, arg2: false);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {218})) {

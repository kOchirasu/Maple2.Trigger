...
namespace Maple2.Trigger._02100001_bf {
    public static class _310_mobspawn {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(arg1: new int[] {310});
            }
        ...
        private class StateMobSpawn : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {310}, arg2: false);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {310})) {

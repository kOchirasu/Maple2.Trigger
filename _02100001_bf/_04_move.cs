    ...
    public static class _04_move {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10001244}, arg2: 1);
                context.SetBreakable(arg1: new int[] {4502}, arg2: false);
                context.SetVisibleBreakableObject(arg1: new int[] {4502}, arg2: true);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10001244}, arg2: 0)) {
        ...
        private class StateMoveStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetBreakable(arg1: new int[] {4502}, arg2: true);
            }
        ...
        private class StateMoveStop : TriggerState {
            ...
            public override void OnEnter() {
                context.SetBreakable(arg1: new int[] {4502}, arg2: false);
                context.SetVisibleBreakableObject(arg1: new int[] {4502}, arg2: false);
            }

    ...
    public static class _triggerbox_104 {
        public class State블록 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {3038, 3039, 3040, 3041, 3042, 3043, 3044, 3045, 3046}, arg2: false,
        ...
        private class State블록생성 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetRandomMesh(arg1: new[] {3038, 3039, 3040, 3041, 3042, 3043, 3044, 3045, 3046},

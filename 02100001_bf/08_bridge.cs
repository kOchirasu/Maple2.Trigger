    ...
    public static class _08_bridge {
        public class StateWait : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.UserDetected(boxIds: new []{9500}) && context.UserDetected(boxIds: new []{9501})) {
        ...
        private class StateBridgeOn : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{3500, 3501}, visible: true, arg3: 300, arg4: 0, arg5: 2f);
            }
        ...
        private class StateBridgeOff : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{3500, 3501}, visible: false, arg3: 0, arg4: 0, arg5: 2f);
            }

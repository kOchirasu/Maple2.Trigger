    ...
    public static class _10_bridge {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{3700, 3701}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }

            public override TriggerState? Execute() {
                if (context.UserDetected(boxIds: new []{9700}) && context.UserDetected(boxIds: new []{9701})) {
        ...
        private class StateBridgeOn : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{3700, 3701}, visible: true, arg3: 300, arg4: 0, arg5: 2f);
            }
        ...
        private class StateBridgeOff : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{3700, 3701}, visible: false, arg3: 0, arg4: 0, arg5: 2f);
            }

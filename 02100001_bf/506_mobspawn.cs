namespace Maple2.Trigger._02100001_bf {
    public static class _506_mobspawn {
        public class StateWait : TriggerState {
            internal StateWait(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetUserValue(key: "RemoveAll", value: 0);
                context.DestroyMonster(spawnIds: new []{506});
            }
        ...
        private class StateMobSpawn : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{506}, arg2: false);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{506})) {

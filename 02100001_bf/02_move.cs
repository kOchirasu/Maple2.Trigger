    ...
    public static class _02_move {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10001241}, arg2: 1);
                context.SetBreakable(arg1: new[] {4500}, arg2: false);
                context.SetVisibleBreakableObject(arg1: new[] {4500}, arg2: true);
            }

            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {10001241}, arg2: 0)) {
        ...
        private class StateMoveStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetBreakable(arg1: new[] {4500}, arg2: true);
            }

    ...
    public static class _01_abovewall {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10001150}, arg2: 0);
                context.SetInteractObject(arg1: new int[] {10001151}, arg2: 0);
                context.SetInteractObject(arg1: new int[] {10001152}, arg2: 0);
        ...
        private class StateMobActorSpawn : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 901, arg3: "$02000399_BF__01_ABOVEWALL__0$", arg4: 2, arg5: 1);
                context.SetConversation(arg1: 1, arg2: 902, arg3: "$02000399_BF__01_ABOVEWALL__1$", arg4: 2, arg5: 1);
                context.SetConversation(arg1: 1, arg2: 903, arg3: "$02000399_BF__01_ABOVEWALL__2$", arg4: 2, arg5: 1);
            }
        ...
        private class StateBattle01Start : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10001150}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10001150}, arg2: 0)) {
        ...
        private class StateBattle03Start : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10001151}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10001151}, arg2: 0)) {
        ...
        private class StateBattle04Start : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10001152}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10001152}, arg2: 0)) {

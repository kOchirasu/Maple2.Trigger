    ...
    public static class _main {
        ...
        private class State전투02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{12101, 12102, 12201, 12202, 12203, 12204, 12205, 12206}, arg2: false);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{12101, 12102, 12201, 12202, 12203, 12204, 12205, 12206})) {
        ...
        private class State전투03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{13101, 13102, 13103, 13104, 13105, 13106, 13107, 13108, 13201, 13202, 13203, 13204}, arg2: false);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{13101, 13102, 13103, 13104, 13105, 13106, 13107, 13108, 13201, 13202, 13203, 13204})) {

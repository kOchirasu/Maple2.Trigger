    ...
    public static class _main {
        ...
        private class State시작 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new int[] {900001}, arg2: false);
                context.SetEffect(arg1: new int[] {900002}, arg2: false);
                context.SetEffect(arg1: new int[] {900003}, arg2: false);
                context.SetEffect(arg1: new int[] {900004}, arg2: false);
                context.SetEffect(arg1: new int[] {900005}, arg2: false);
                context.SetInteractObject(arg1: new int[] {10000822}, arg2: 0);
            }
        ...
        private class State관문_01_개방 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000822}, arg2: 1);
            }
        ...
        private class State관문_02_시작 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {21, 22, 23, 24, 25, 26, 27, 28, 29})) {
        ...
        private class State관문_02_개방 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10000823}, arg2: 1);
                context.SetInteractObject(arg1: new int[] {10000824}, arg2: 1);
            }
        ...
        private class State관문_03_개방 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {6004}, arg2: false, arg4: 0, arg5: 10f);

    ...
    public static class _qeagle_07 {
        public class StateWaitStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000487}, state: 1);
                context.SetActor(triggerId: 913, visible: false, initialSequence: "Attack_Idle_A");
                context.SetEffect(triggerIds: new []{914}, visible: false);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000487}, arg2: 0)) {
        ...
        private class StateInteractObject : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(triggerId: 913, visible: true, initialSequence: "Attack_Idle_A");
                context.SetEffect(triggerIds: new []{914}, visible: true);

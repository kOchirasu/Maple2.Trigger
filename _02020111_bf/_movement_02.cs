    ...
    public static class _movement_02 {
        ...
        private class State시작 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserDetected(arg1: "1001")) {
                    context.State = new State환경변화_2(context);
                    return;
                }
            }
        ...
        private class State환경변화_2 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.UserValue(key: "dark", value: 3)) {
        ...
        private class State페이드아웃_2 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State조명변경_2(context);
                    return;
                }
            }
        ...
        private class State조명변경_2 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 12000)) {
                    context.State = new State페이드인_2(context);
                    return;
                }
        ...
        private class State페이드인_2 : TriggerState {
            internal State페이드인_2(ITriggerContext context) : base(context) { }
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State유저이동_2(context);
                    return;
                }
            }
        ...
        private class State유저이동_2 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State조명리셋_2(context);
                    return;
                }
            }
        ...
        private class State조명리셋_2 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.MoveNpcToPos(spawnPointID: 101, pos: new Vector3(-28f, 4030f, 2551f),
                ...
                context.SetEffect(arg1: new int[] {200001, 200002, 200003, 200004, 200005}, arg2: true);
            ...
            public override void Execute() {
                ...
                if (context.UserValue(key: "dark", value: 4)) {
                    context.State = new State중앙지역이동_2(context);
                    return;
                }
            }
        ...
        private class State중앙지역이동_2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {200001, 200002, 200003, 200004, 200005}, arg2: false);
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 100)) {
                    context.State = new State중앙지역이동_2_페이드인(context);
                    return;
                }
            }
        ...
        private class State중앙지역이동_2_페이드인 : TriggerState {
            internal State중앙지역이동_2_페이드인(ITriggerContext context) : base(context) { }

            public override void OnEnter() { }

            public override void Execute() {
                if (context.WaitTick(waitTick: 100)) {
                    context.State = new State포탈설정_2(context);
                    return;
                }
            }
        ...
        private class State포탈설정_2 : TriggerState {
            internal State포탈설정_2(ITriggerContext context) : base(context) { }

    ...
    public static class _movement_01 {
        ...
        private class State시작 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserDetected(arg1: new int[] {1001})) {
                    context.State = new State환경변화(context);
                    return;
                }
            }
        ...
        private class State환경변화 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.UserValue(key: "dark", value: 1)) {
        ...
        private class State조명변경 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$02020111_BF__MOVEMENT_01__0$", arg3: new int[] {3000});
        ...
        private class State유저이동 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$02020111_BF__MOVEMENT_01__2$", arg3: new int[] {4000});
            }
        ...
        private class State조명리셋 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.MoveNpcToPos(spawnPointID: 101, pos: new Vector3(-3743f, 294f, 1651f),
                ...
                context.SetEffect(arg1: new int[] {200031, 200032, 200033, 200034, 200035}, arg2: true);
            ...
            public override void Execute() {
                ...
                if (context.UserValue(key: "dark", value: 2)) {
                    context.State = new State중앙지역이동_1(context);
                    return;
                }
            }
        ...
        private class State중앙지역이동_1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {200031, 200032, 200033, 200034, 200035}, arg2: false);
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 100)) {
                    context.State = new State중앙지역이동_1_페이드인(context);
                    return;
                }
            }
        ...
        private class State중앙지역이동_1_페이드인 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 100)) {
                    context.State = new State포탈설정_1(context);
                    return;
                }
            }

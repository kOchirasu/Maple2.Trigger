...
namespace Maple2.Trigger._02020111_bf {
    public static class _thema_01 {
        ...
        private class State몬스터등장 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {141, 142, 143, 144, 145, 146});
            }
            ...
            public override void Execute() {
                ...
                if (context.MonsterDead(arg1: new int[] {141, 142, 143, 144, 145, 146})) {
        ...
        private class State몬스터소멸 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {141, 142, 143, 144, 145, 146});
            }

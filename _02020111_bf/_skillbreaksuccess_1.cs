    ...
    public static class _skillbreaksuccess_1 {
        ...
        private class State시작 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "SkillBreakSuccess_1", value: 1)
                    && context.UserValue(key: "SkillBreakSuccess_2", value: 1)
                    && context.UserValue(key: "SkillBreakSuccess_3", value: 1)
                    && context.UserValue(key: "SkillBreakSuccess_4", value: 1)) {
        ...
        private class State버프발동 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "SkillBreakSuccess_1", value: 0)
                    && context.UserValue(key: "SkillBreakSuccess_2", value: 0)
                    && context.UserValue(key: "SkillBreakSuccess_3", value: 0)
                    && context.UserValue(key: "SkillBreakSuccess_4", value: 0)

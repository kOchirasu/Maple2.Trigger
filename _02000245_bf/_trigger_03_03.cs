    ...
    public static class _trigger_03_03 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {613, 614, 615});
            }
        ...
        private class State몹생성 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {613, 614, 615}, arg2: false);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {613, 614, 615})) {

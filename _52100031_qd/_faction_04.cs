    ...
    public static class _faction_04 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10002066}, arg2: 2);
                context.SetInteractObject(arg1: new int[] {10002070}, arg2: 2);
            }
        ...
        private class State인원수체크 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 1301, arg3: "$52100031_QD__FACTION_04__0$", arg4: 5, arg5: 0);
            }
        ...
        private class State퀘스트 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10002070}, arg2: 1);
        ...
        private class State보스소환 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "DungeonClear", value: 1)) {
                    ...
                    context.SetInteractObject(arg1: new int[] {10002066}, arg2: 0);
                    context.SetInteractObject(arg1: new int[] {10002070}, arg2: 0);
                    context.RemoveBuff(arg1: 199, arg2: 99910160);

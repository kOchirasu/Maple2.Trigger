    ...
    public static class _hack_03 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000371}, state: 0);
            }
        ...
        private class State스폰 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{1031}, arg2: false);
                context.SetInteractObject(interactIds: new []{10000371}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000371}, arg2: 0)) {
        ...
        private class State코드_1279 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__0$", duration: 2000);
            }
        ...
        private class State코드_1238 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "5", seconds: 5);
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__1$", duration: 2000);
            }
        ...
        private class State코드_1358 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__2$", duration: 2000);
            }
        ...
        private class State코드_1489 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "5", seconds: 5);
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__3$", duration: 2000);
            }
        ...
        private class State코드_1567 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "5", seconds: 5);
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__4$", duration: 2000);
            }
        ...
        private class State코드_1679 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "5", seconds: 5);
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__5$", duration: 2000);
            }
        ...
        private class State코드_2389 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "5", seconds: 5);
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__6$", duration: 2000);
            }
        ...
        private class State코드_2347 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "5", seconds: 5);
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__7$", duration: 2000);
            }
        ...
        private class State코드_2478 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "5", seconds: 5);
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__8$", duration: 2000);
            }
        ...
        private class State코드_2456 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "5", seconds: 5);
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__9$", duration: 2000);
            }
        ...
        private class State코드_2569 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "5", seconds: 5);
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__10$", duration: 2000);
            }
        ...
        private class State코드_2678 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "5", seconds: 5);
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__11$", duration: 2000);
            }
        ...
        private class State코드_3458 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "5", seconds: 5);
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__12$", duration: 2000);
            }
        ...
        private class State코드_3589 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "5", seconds: 5);
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__13$", duration: 2000);
            }
        ...
        private class State코드_3679 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "5", seconds: 5);
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__14$", duration: 2000);
            }
        ...
        private class State코드_3789 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "5", seconds: 5);
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__15$", duration: 2000);
            }
        ...
        private class State코드_4567 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "5", seconds: 5);
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__16$", duration: 2000);
            }
        ...
        private class State코드_4578 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "5", seconds: 5);
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__17$", duration: 2000);
            }
        ...
        private class State코드_4689 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "5", seconds: 5);
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__18$", duration: 2000);
            }
        ...
        private class State코드_4789 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "5", seconds: 5);
                context.SetEventUI(arg1: 1, script: "$02000298_BF__HACK_03__19$", duration: 2000);
            }

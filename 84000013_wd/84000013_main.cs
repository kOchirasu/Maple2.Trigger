...
namespace Maple2.Trigger._84000013_wd {
    public static class _84000013_main {
        ...
        private class StateStartCinematic : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.WeddingMoveUser(type: WeddingEntryType.Guest, arg1: 84000013, arg2: new byte[] {22, 23}, arg3: 701);
                context.WeddingMoveUser(type: WeddingEntryType.Guest, arg1: 84000013, arg2: new byte[] {22, 23}, arg3: 703);
                context.WeddingMoveUser(type: WeddingEntryType.Groom, arg1: 84000013, arg2: new byte[] {11}, arg3: 702);
                context.WeddingMoveUser(type: WeddingEntryType.Bride, arg1: 84000013, arg2: new byte[] {12}, arg3: 702);
                context.SetPortal(portalId: 99, visible: true, enabled: true, minimapVisible: true);
            }
        ...
        private class State주례줌인02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcId: 11004724, script: "$84000013_WD__84000013_MAIN__0$", duration: 3500);
            }
        ...
        private class State주례사 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetCinematicUI(type: 3);
                context.AddCinematicTalk(npcId: 11004724, script: "$84000013_WD__84000013_MAIN__1$", duration: 4000);
            }
        ...
        private class State탈주로중단 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11004724, script: "$84000013_WD__84000013_MAIN__2$", duration: 3000);
            }
        ...
        private class State탈주로중단선언 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11004724, script: "$84000013_WD__84000013_MAIN__3$", duration: 3000);
            }
        ...
        private class State미입력으로중단01 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11004724, script: "$84000013_WD__84000013_MAIN__4$", duration: 3000);
            }
        ...
        private class State미입력으로중단선언 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11004724, script: "$84000013_WD__84000013_MAIN__5$", duration: 3000);
            }
        ...
        private class State성혼발표 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11004724, script: "$84000013_WD__84000013_MAIN__6$", duration: 2500);

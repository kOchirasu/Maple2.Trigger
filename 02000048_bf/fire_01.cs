    ...
    public static class _fire_01 {
        public class StateWaitStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000306}, state: 1);
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000306}, arg2: 0)) {
        ...
        private class StateInteractObject : TriggerState {
            ...
            public override void OnExit() {
                context.SetMesh(triggerIds: new []{201}, visible: true, arg3: 0, arg4: 0, arg5: 1f);
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 401, script: "$02000048_BF__FIRE_01__0$", arg4: 2);
        ...
        private class StateMonsterCombat : TriggerState {
            ...
            public override TriggerState? Execute() {
                ...
                if (!context.MonsterInCombat(spawnIds: new []{401})) {

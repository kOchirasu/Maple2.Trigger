namespace Maple2.Trigger._02000048_bf {
    public static class _fire_01 {
        ...
        private class StateInteractObject : TriggerState {
            ...
            public override void OnExit() {
                context.SetMesh(arg1: new[] {201}, arg2: true, arg3: 0, arg4: 0, arg5: 1f);
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 401, script: "$02000048_BF__FIRE_01__0$", arg4: 2);
        ...
        private class StateMonsterCombat : TriggerState {
            ...
            public override TriggerState Execute() {
                ...
                if (!context.MonsterInCombat(arg1: new[] {401})) {

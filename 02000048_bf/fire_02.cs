namespace Maple2.Trigger._02000048_bf {
    public static class _fire_02 {
        public class StateWaitStart : TriggerState {
            internal StateWaitStart(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000307}, state: 1);
                context.SetMesh(triggerIds: new []{202}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(triggerIds: new []{302}, visible: false);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000307}, arg2: 0)) {
        ...
        private class StateInteractObject : TriggerState {
            ...
            public override void OnExit() {
                context.SetMesh(triggerIds: new []{202}, visible: true, arg3: 0, arg4: 0, arg5: 1f);
                context.SetEffect(triggerIds: new []{302}, visible: true);
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 402, script: "$02000048_BF__FIRE_02__0$", arg4: 2);
        ...
        private class StateMonsterCombat : TriggerState {
            ...
            public override TriggerState? Execute() {
                ...
                if (!context.MonsterInCombat(spawnIds: new []{402})) {

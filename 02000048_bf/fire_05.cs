    ...
    public static class _fire_05 {
        public class StateWaitStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000310}, state: 1);
                context.SetMesh(triggerIds: new []{205}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(triggerIds: new []{305}, visible: false);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000310}, arg2: 0)) {
        ...
        private class StateInteractObject : TriggerState {
            ...
            public override void OnExit() {
                context.SetMesh(triggerIds: new []{205}, visible: true, arg3: 0, arg4: 0, arg5: 1f);
                context.SetEffect(triggerIds: new []{305}, visible: true);
                context.CreateMonster(spawnIds: new []{405}, arg2: false);
            }
        }
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 405, script: "$02000048_BF__FIRE_05__0$", arg4: 2);
        ...
        private class StateMonsterCombat : TriggerState {
            ...
            public override TriggerState? Execute() {
                ...
                if (!context.MonsterInCombat(spawnIds: new []{405})) {

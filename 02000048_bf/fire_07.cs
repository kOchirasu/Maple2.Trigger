    ...
    public static class _fire_07 {
        public class StateWaitStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10000312}, arg2: 1);
                context.SetMesh(arg1: new[] {207}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(arg1: new[] {307}, arg2: false);
            }

            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {10000312}, arg2: 0)) {
        ...
        private class StateInteractObject : TriggerState {
            ...
            public override void OnExit() {
                context.SetMesh(arg1: new[] {207}, arg2: true, arg3: 0, arg4: 0, arg5: 1f);
                context.SetEffect(arg1: new[] {307}, arg2: true);
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 407, script: "$02000048_BF__FIRE_07__0$", arg4: 2);
        ...
        private class StateMonsterCombat : TriggerState {
            ...
            public override TriggerState Execute() {
                ...
                if (!context.MonsterInCombat(arg1: new[] {407})) {

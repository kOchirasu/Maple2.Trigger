    ...
    public static class _g04p00_400 {
        ...
        private class StateWait : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P01Set", value: 1)) {
                    context.State = new StateNumberOnP01(context);
                    return;
                }

                if (context.UserValue(key: "G04P02Set", value: 1)) {
                    context.State = new StateNumberOnP02(context);
                    return;
                }

                if (context.UserValue(key: "G04P03Set", value: 1)) {
                    context.State = new StateNumberOnP03(context);
                    return;
                }

                if (context.UserValue(key: "G04P04Set", value: 1)) {
                    context.State = new StateNumberOnP04(context);
                    return;
                }

                if (context.UserValue(key: "G04P05Set", value: 1)) {
                    context.State = new StateNumberOnP05(context);
                    return;
                }

                if (context.UserValue(key: "G04P06Set", value: 1)) {
                    context.State = new StateNumberOnP06(context);
                    return;
                }

                if (context.UserValue(key: "G04P07Set", value: 1)) {
                    context.State = new StateNumberOnP07(context);
                    return;
                }

                if (context.UserValue(key: "G04P08Set", value: 1)) {
                    context.State = new StateNumberOnP08(context);
                    return;
                }

                if (context.UserValue(key: "G04P09Set", value: 1)) {
                    context.State = new StateNumberOnP09(context);
                    return;
                }

                if (context.UserValue(key: "G04P10Set", value: 1)) {
                    context.State = new StateNumberOnP10(context);
                    return;
                }

                if (context.UserValue(key: "G04P11Set", value: 1)) {
                    context.State = new StateNumberOnP11(context);
                    return;
                }

                if (context.UserValue(key: "G04P12Set", value: 1)) {
                    context.State = new StateNumberOnP12(context);
                    return;
                }

                if (context.UserValue(key: "G04P13Set", value: 1)) {
                    context.State = new StateNumberOnP13(context);
                    return;
                }

                if (context.UserValue(key: "G04P14Set", value: 1)) {
                    context.State = new StateNumberOnP14(context);
                    return;
                }

                if (context.UserValue(key: "G04P15Set", value: 1)) {
                    context.State = new StateNumberOnP15(context);
                    return;
                }

                if (context.UserValue(key: "G04P16Set", value: 1)) {
                    context.State = new StateNumberOnP16(context);
                    return;
                }

                if (context.UserValue(key: "G04P17Set", value: 1)) {
                    context.State = new StateNumberOnP17(context);
                    return;
                }

                if (context.UserValue(key: "G04P18Set", value: 1)) {
                    context.State = new StateNumberOnP18(context);
                    return;
                }

                if (context.UserValue(key: "G04P19Set", value: 1)) {
                    context.State = new StateNumberOnP19(context);
                    return;
                }

                if (context.UserValue(key: "G04P20Set", value: 1)) {
                    context.State = new StateNumberOnP20(context);
                    return;
                }

                if (context.UserValue(key: "G04P21Set", value: 1)) {
                    context.State = new StateNumberOnP21(context);
                    return;
                }

                if (context.UserValue(key: "G04P22Set", value: 1)) {
                    context.State = new StateNumberOnP22(context);
                    return;
                }

                if (context.UserValue(key: "G04P23Set", value: 1)) {
                    context.State = new StateNumberOnP23(context);
                    return;
                }

                if (context.UserValue(key: "G04P24Set", value: 1)) {
                    context.State = new StateNumberOnP24(context);
                    return;
                }

                if (context.UserValue(key: "G04P25Set", value: 1)) {
                    context.State = new StateNumberOnP25(context);
                    return;
                }

                if (context.UserValue(key: "G04P26Set", value: 1)) {
                    context.State = new StateNumberOnP26(context);
                    return;
                }

                if (context.UserValue(key: "G04P27Set", value: 1)) {
                    context.State = new StateNumberOnP27(context);
                    return;
                }

                if (context.UserValue(key: "G04P28Set", value: 1)) {
                    context.State = new StateNumberOnP28(context);
                    return;
                }

                if (context.UserValue(key: "G04P29Set", value: 1)) {
                    context.State = new StateNumberOnP29(context);
                    return;
                }

                if (context.UserValue(key: "G04P30Set", value: 1)) {
                    context.State = new StateNumberOnP30(context);
                    return;
                }

                if (context.UserValue(key: "G04P31Set", value: 1)) {
                    context.State = new StateNumberOnP31(context);
                    return;
                }

                if (context.UserValue(key: "G04P32Set", value: 1)) {
                    context.State = new StateNumberOnP32(context);
                    return;
                }

                if (context.UserValue(key: "G04P33Set", value: 1)) {
                    context.State = new StateNumberOnP33(context);
                    return;
                }

                if (context.UserValue(key: "G04P34Set", value: 1)) {
                    context.State = new StateNumberOnP34(context);
                    return;
                }

                if (context.UserValue(key: "G04P35Set", value: 1)) {
                    context.State = new StateNumberOnP35(context);
                    return;
                }

                if (context.UserValue(key: "G04P36Set", value: 1)) {
                    context.State = new StateNumberOnP36(context);
                    return;
                }

                if (context.UserValue(key: "G04P37Set", value: 1)) {
                    context.State = new StateNumberOnP37(context);
                    return;
                }

                if (context.UserValue(key: "G04P38Set", value: 1)) {
                    context.State = new StateNumberOnP38(context);
                    return;
                }

                if (context.UserValue(key: "G04P39Set", value: 1)) {
                    context.State = new StateNumberOnP39(context);
                    return;
                }

                if (context.UserValue(key: "G04P40Set", value: 1)) {
        ...
        private class StateNumberOnP01 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P01TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP02 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P02TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP03 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P03TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP04 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P04TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP05 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P05TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP06 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P06TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP07 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P07TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP08 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P08TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP09 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P09TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP10 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P10TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP11 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P11TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP12 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P12TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP13 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P13TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP14 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P14TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP15 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P15TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP16 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P16TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP17 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P17TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP18 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P18TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP19 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P19TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP20 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P20TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP21 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P21TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP22 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P22TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP23 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P23TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP24 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P24TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP25 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P25TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP26 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P26TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP27 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P27TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP28 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P28TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP29 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P29TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP30 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P30TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP31 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P31TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP32 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P32TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP33 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P33TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP34 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P34TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP35 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P35TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP36 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P36TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP37 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P37TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP38 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P38TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP39 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P39TimeLimit", value: 1)) {
        ...
        private class StateNumberOnP40 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "G04P40TimeLimit", value: 1)) {

    ...
    public static class _barrier_8210 {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {8211, 8212, 8213, 8214, 8215, 8216}, arg2: false, arg3: 0, arg4: 0,
                    arg5: 0f);
                context.SetEffect(arg1: new int[] {8210}, arg2: false);
                context.SetInteractObject(arg1: new int[] {10001189}, arg2: 2);
                context.SetInteractObject(arg1: new int[] {10001205}, arg2: 2);
            }

            public override void Execute() {
                if (context.UserValue(key: "Barrier21", value: 1)) {
                    context.State = new StateSensor7211(context);
                    return;
                }

                if (context.UserValue(key: "Barrier21", value: 2)) {
                    context.State = new StateSensor7212(context);
                    return;
                }

                if (context.UserValue(key: "Barrier21", value: 3)) {
                    context.State = new StateSensor7213(context);
                    return;
                }

                if (context.UserValue(key: "Barrier21", value: 4)) {
                    context.State = new StateSensor7214(context);
                    return;
                }

                if (context.UserValue(key: "Barrier21", value: 5)) {
        ...
        private class StateSensor7211 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9210, arg2: 1, arg3: "Equal")) {
                    context.State = new StateActivate7211(context);
                    return;
                }

                if (context.UserValue(key: "Barrier21", value: 10)) {
        ...
        private class StateSensor7212 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {8211, 8212, 8213, 8214, 8215, 8216}, arg2: false, arg3: 0, arg4: 0,
                    arg5: 0f);
                context.SetEffect(arg1: new int[] {8210}, arg2: false);
                context.SetInteractObject(arg1: new int[] {10001189}, arg2: 0);
                context.SetInteractObject(arg1: new int[] {10001205}, arg2: 0);
            }

            public override void Execute() {
                if (context.CountUsers(arg1: 9210, arg2: 2, arg3: "Equal")) {
        ...
        private class StateSafeGreen7212 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9210, arg2: 2, arg3: "Equal")) {
                    context.State = new StateCheckSameUserTag7212(context);
                    return;
                }
        ...
        private class StateCheckSameUserTag7212 : TriggerState {
            internal StateCheckSameUserTag7212(ITriggerContext context) : base(context) { }

            public override void OnEnter() { }

            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxID: 9210)
                    && context.CountUsers(arg1: 9210, arg2: 2, arg3: "Equal")) {
        ...
        private class StateEnable7212 : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(arg1: new int[] {9210}, arg2: "DDStop_Stage_Shiled_01");
                context.SetInteractObject(arg1: new int[] {10001189}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10001189}, arg2: 0)) {
        ...
        private class StateActivate7212 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {8211, 8212, 8213, 8214, 8215, 8216}, arg2: true, arg3: 0, arg4: 0,
                    arg5: 0f);
                context.SetInteractObject(arg1: new int[] {10001189}, arg2: 2);
            }
        ...
        private class StateDelay7212 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10001205}, arg2: 1);
            }
            ...
            public override void Execute() {
                ...
                if (context.ObjectInteracted(arg1: new int[] {10001205}, arg2: 0)) {
        ...
        private class StateSensor7213 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9210, arg2: 3, arg3: "Equal")) {
        ...
        private class StateSafeGreen7213 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9210, arg2: 3, arg3: "Equal")) {
                    context.State = new StateCheckSameUserTag7213(context);
                    return;
                }
        ...
        private class StateCheckSameUserTag7213 : TriggerState {
            internal StateCheckSameUserTag7213(ITriggerContext context) : base(context) { }

            public override void OnEnter() { }

            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxID: 9210)
                    && context.CountUsers(arg1: 9210, arg2: 3, arg3: "Equal")) {
        ...
        private class StateSensor7214 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9210, arg2: 4, arg3: "Equal")) {
        ...
        private class StateSafeGreen7214 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9210, arg2: 4, arg3: "Equal")) {
                    context.State = new StateCheckSameUserTag7214(context);
                    return;
                }
        ...
        private class StateCheckSameUserTag7214 : TriggerState {
            internal StateCheckSameUserTag7214(ITriggerContext context) : base(context) { }

            public override void OnEnter() { }

            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxID: 9210)
                    && context.CountUsers(arg1: 9210, arg2: 4, arg3: "Equal")) {
        ...
        private class StateSensor7215 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9210, arg2: 5, arg3: "Equal")) {
        ...
        private class StateSafeGreen7215 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9210, arg2: 5, arg3: "Equal")) {
                    context.State = new StateCheckSameUserTag7215(context);
                    return;
                }
        ...
        private class StateCheckSameUserTag7215 : TriggerState {
            internal StateCheckSameUserTag7215(ITriggerContext context) : base(context) { }

            public override void OnEnter() { }

            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxID: 9210)
                    && context.CountUsers(arg1: 9210, arg2: 5, arg3: "Equal")) {

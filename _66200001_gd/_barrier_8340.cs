    ...
    public static class _barrier_8340 {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10001196}, arg2: 2);
                context.SetInteractObject(arg1: new int[] {10001212}, arg2: 2);
            }
        ...
        private class StateSensor7342 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {8341, 8342, 8343, 8344, 8345, 8346}, arg2: false, arg3: 0, arg4: 0,
                    arg5: 0f);
                context.SetEffect(arg1: new int[] {8340}, arg2: false);
                context.SetInteractObject(arg1: new int[] {10001196}, arg2: 0);
                context.SetInteractObject(arg1: new int[] {10001212}, arg2: 0);
            }
        ...
        private class StateCheckSameUserTag7342 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxID: 9340)
                    && context.CountUsers(arg1: 9340, arg2: 2, arg3: "Equal")) {
        ...
        private class StateEnable7342 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10001196}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10001196}, arg2: 0)) {
        ...
        private class StateDelay7342 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10001212}, arg2: 1);
            }
            ...
            public override void Execute() {
                ...
                if (context.ObjectInteracted(arg1: new int[] {10001212}, arg2: 0)) {
        ...
        private class StateCheckSameUserTag7343 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxID: 9340)
                    && context.CountUsers(arg1: 9340, arg2: 3, arg3: "Equal")) {
        ...
        private class StateCheckSameUserTag7344 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxID: 9340)
                    && context.CountUsers(arg1: 9340, arg2: 4, arg3: "Equal")) {
        ...
        private class StateCheckSameUserTag7345 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxID: 9340)
                    && context.CountUsers(arg1: 9340, arg2: 5, arg3: "Equal")) {

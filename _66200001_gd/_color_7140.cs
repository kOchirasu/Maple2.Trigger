    ...
    public static class _color_7140 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new[] {814}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new[] {914, 1014}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateYellowBefore : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {814}, arg2: true, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(arg1: new[] {914, 1014}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateRedBefore : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {1014}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new[] {914, 814}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateGreenAfter : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {914}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateYellowAfter : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {814}, arg2: true, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(arg1: new[] {914}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new[] {1014}, arg2: false, arg3: 100, arg4: 0, arg5: 0f);
            }
        ...
        private class StateRedAfter : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {1014}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new[] {914}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new[] {814}, arg2: false, arg3: 100, arg4: 0, arg5: 0f);
            }
        ...
        private class StateClear : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {914}, arg2: false, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(arg1: new[] {814}, arg2: false, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(arg1: new[] {1014}, arg2: false, arg3: 0, arg4: 0, arg5: 2f);
            }
        ...
        private class StateRegen : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new[] {814}, arg2: true, arg3: 400, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new[] {914, 1014}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }

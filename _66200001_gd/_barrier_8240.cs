    ...
    public static class _barrier_8240 {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10001192}, arg2: 2);
                context.SetInteractObject(arg1: new int[] {10001208}, arg2: 2);
            }
        ...
        private class StateSensor7242 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {8241, 8242, 8243, 8244, 8245, 8246}, arg2: false, arg3: 0, arg4: 0,
                    arg5: 0f);
                context.SetEffect(arg1: new int[] {8240}, arg2: false);
                context.SetInteractObject(arg1: new int[] {10001192}, arg2: 0);
                context.SetInteractObject(arg1: new int[] {10001208}, arg2: 0);
            }
        ...
        private class StateSafeGreen7242 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9240, arg2: 2, arg3: "Equal")) {
                    context.State = new StateCheckSameUserTag7242(context);
                    return;
                }
        ...
        private class StateCheckSameUserTag7242 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxID: 9240)
                    && context.CountUsers(arg1: 9240, arg2: 2, arg3: "Equal")) {
        ...
        private class StateEnable7242 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10001192}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10001192}, arg2: 0)) {
        ...
        private class StateDelay7242 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10001208}, arg2: 1);
            }
            ...
            public override void Execute() {
                ...
                if (context.ObjectInteracted(arg1: new int[] {10001208}, arg2: 0)) {
        ...
        private class StateSafeGreen7243 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9240, arg2: 3, arg3: "Equal")) {
                    context.State = new StateCheckSameUserTag7243(context);
                    return;
                }
        ...
        private class StateCheckSameUserTag7243 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxID: 9240)
                    && context.CountUsers(arg1: 9240, arg2: 3, arg3: "Equal")) {
        ...
        private class StateSafeGreen7244 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9240, arg2: 4, arg3: "Equal")) {
                    context.State = new StateCheckSameUserTag7244(context);
                    return;
                }
        ...
        private class StateCheckSameUserTag7244 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxID: 9240)
                    && context.CountUsers(arg1: 9240, arg2: 4, arg3: "Equal")) {
        ...
        private class StateSafeGreen7245 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9240, arg2: 5, arg3: "Equal")) {
                    context.State = new StateCheckSameUserTag7245(context);
                    return;
                }
        ...
        private class StateCheckSameUserTag7245 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxID: 9240)
                    && context.CountUsers(arg1: 9240, arg2: 5, arg3: "Equal")) {

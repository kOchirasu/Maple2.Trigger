    ...
    public static class _barrier_8140 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {10001204}, arg2: 2);
            }
        ...
        private class StateSensor7142 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new[] {8141, 8142, 8143, 8144}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(arg1: new[] {8140}, arg2: false);
                context.SetInteractObject(arg1: new[] {10001188}, arg2: 0);
                context.SetInteractObject(arg1: new[] {10001204}, arg2: 0);
            }
        ...
        private class StateCheckSameUserTag7142 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxId: 9140)
                    && context.GetUserCount(boxId: 9140) == 2) {
        ...
        private class StateCheckSameUserTag7143 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxId: 9140)
                    && context.GetUserCount(boxId: 9140) == 3) {
        ...
        private class StateCheckSameUserTag7144 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxId: 9140)
                    && context.GetUserCount(boxId: 9140) == 4) {
        ...
        private class StateCheckSameUserTag7145 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxId: 9140)
                    && context.GetUserCount(boxId: 9140) == 5) {

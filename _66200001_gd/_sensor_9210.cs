    ...
    public static class _sensor_9210 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new[] {521}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new[] {5210}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
            }

            public override void Execute() {
                if (context.GetUserValue(key: "Box21Check") == 0) {
                    context.State = new StateSensor0(context);
                    return;
                }

                if (context.GetUserValue(key: "Box21Check") == 1) {
                    context.State = new StateSensor1(context);
                    return;
                }

                if (context.GetUserValue(key: "Box21Check") == 2) {
                    context.State = new StateSensor2(context);
                    return;
                }

                if (context.GetUserValue(key: "Box21Check") == 3) {
                    context.State = new StateSensor3(context);
                    return;
                }

                if (context.GetUserValue(key: "Box21Check") == 4) {
                    context.State = new StateSensor4(context);
                    return;
                }

                if (context.GetUserValue(key: "Box21Check") == 5) {
        ...
        private class StatePass : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(arg1: new[] {9210}, arg2: "DDStop_Stage_Pass_01");
                context.SetMesh(arg1: new[] {521}, arg2: false, arg3: 0, arg4: 0, arg5: 2f);
        ...
        private class StateFail : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(arg1: new[] {9210}, arg2: "DDStop_Stage_Fail_01");
                context.SetMesh(arg1: new[] {521}, arg2: false, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(arg1: new[] {5210}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);

    ...
    public static class _barrier_8440 {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10001200}, arg2: 2);
                context.SetInteractObject(arg1: new int[] {10001216}, arg2: 2);
            }
        ...
        private class StateSensor7442 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {8441, 8442, 8443, 8444}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(arg1: new int[] {8440}, arg2: false);
                context.SetInteractObject(arg1: new int[] {10001200}, arg2: 0);
                context.SetInteractObject(arg1: new int[] {10001216}, arg2: 0);
            }
        ...
        private class StateCheckSameUserTag7442 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxID: 9440)
                    && context.CountUsers(arg1: 9440, arg2: 2, arg3: "Equal")) {
        ...
        private class StateEnable7442 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10001200}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10001200}, arg2: 0)) {
        ...
        private class StateDelay7442 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10001216}, arg2: 1);
            }
            ...
            public override void Execute() {
                ...
                if (context.ObjectInteracted(arg1: new int[] {10001216}, arg2: 0)) {
        ...
        private class StateCheckSameUserTag7443 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxID: 9440)
                    && context.CountUsers(arg1: 9440, arg2: 3, arg3: "Equal")) {
        ...
        private class StateCheckSameUserTag7444 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxID: 9440)
                    && context.CountUsers(arg1: 9440, arg2: 4, arg3: "Equal")) {
        ...
        private class StateCheckSameUserTag7445 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckSameUserTag(triggerBoxID: 9440)
                    && context.CountUsers(arg1: 9440, arg2: 5, arg3: "Equal")) {

    ...
    public static class _blackbuff {
        public class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{12000406}, state: 0);
                context.SetInteractObject(interactIds: new []{12000406}, state: 1);
            }
        ...
        private class StateCheckObject : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{12000406}, arg2: 0)) {

...
namespace Maple2.Trigger._02020141_bf {
    public static class _mobspawn09 {
        ...
        private class State트리거영역체크시작 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.UserDetected(arg1: new int[] {10900})) {
        ...
        private class State졸몬스터등장하기 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {10901, 10902, 10903, 10904}, arg2: false);
            }
        ...
        private class State졸몬스터제거작업 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {10901, 10902, 10903, 10904});
            }

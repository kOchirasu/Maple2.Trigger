    ...
    public static class _interactmesh10014112 {
        ...
        private class State최초시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10003148}, arg2: 2);
            }
        ...
        private class State탈것_등장연출 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {914112}, arg2: false);
            }
        ...
        private class State탈것_등장 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10003148}, arg2: 1);
                context.DestroyMonster(arg1: new int[] {914112});
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10003148}, arg2: 0)) {

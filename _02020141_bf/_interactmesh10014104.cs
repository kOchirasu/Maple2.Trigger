    ...
    public static class _interactmesh10014104 {
        ...
        private class State최초시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10003150}, arg2: 2);
            }
        ...
        private class State탈것_등장연출 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {14104}, arg2: false);
            }
        ...
        private class State탈것_등장 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10003150}, arg2: 1);
                context.DestroyMonster(arg1: new int[] {14104});
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10003150}, arg2: 0)) {

...
namespace Maple2.Trigger._02000383_bf {
    public static class _1122330_dooropen {
        ...
        private class StateStageEnter : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "StageClear01", value: 1)) {
        ...
        private class StateStageClear01 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "StageClear02", value: 1)) {
        ...
        private class StateStageClear02 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "StageClear03", value: 1)) {
        ...
        private class StateStageClear03 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "StageClear04", value: 1)) {
        ...
        private class StateStageClear04 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "StageClear05", value: 1)) {

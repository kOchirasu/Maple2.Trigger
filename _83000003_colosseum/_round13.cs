namespace Maple2.Trigger._83000003_colosseum {
    public static class _round13 {
        ...
        private class State스폰대사 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.TimeExpired(arg1: "LimitTimer")) {
                    context.SideNpcTalk(type: "talk", npcId: 11004288, illust: "nagi_switchon", script: "$83000003_COLOSSEUM__ROUND13__5$", duration: 3000);
                ...
                if (context.UserDetected(arg1: new[] {902})) {
                    context.SideNpcTalk(type: "talk", npcId: 11004288, illust: "nagi_switchon", script: "$83000003_COLOSSEUM__ROUND13__6$", duration: 3000);
                    context.DestroyMonster(arg1: new[] {113});
                    context.SetNpcDuelHpBar(isOpen: false, spawnPointId: 113);
                    context.DestroyMonster(arg1: new[] {10000, 10001});
                    context.State = new StateFailRoundDelay(context);
                ...
                if (!context.UserDetected(arg1: new[] {904})) {
                    context.SideNpcTalk(type: "talk", npcId: 11004288, illust: "nagi_switchon", script: "$83000003_COLOSSEUM__ROUND13__7$", duration: 3000);
                    context.DestroyMonster(arg1: new[] {113});
                    context.SetNpcDuelHpBar(isOpen: false, spawnPointId: 113);
                    context.DestroyMonster(arg1: new[] {10000, 10001});
                    context.State = new StateFailRoundDelay(context);
        ...
        private class StateClearRoundDelay : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    ...
                    context.SetEventUI(arg1: 3, arg2: "$83000003_COLOSSEUM__ROUND13__8$", arg3: 3000);
        ...
        private class StateFailRoundDelay : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.SetEventUI(arg1: 5, arg2: "$83000003_COLOSSEUM__ROUND13__9$", arg3: 3000);
                    context.State = new StateFailRound(context);
                    return;
                }
            }

    ...
    public static class _round12 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "StartRound12", value: 1)) {
        ...
        private class State라운드조건체크 : TriggerState {
            ...
            public override void Execute() {
                if (context.DungeonRoundRequire(round: 12)) {
                    context.SideNpcTalk(type: "talk", npcID: 11004288, illust: "nagi_normal",
                        script: "$83000003_COLOSSEUM__ROUND12__0$", duration: 5000);
                ...
                if (true) {
                    context.SideNpcTalk(type: "talk", npcID: 11004288, illust: "nagi_switchon",
                        script: "$83000003_COLOSSEUM__ROUND12__1$", duration: 3000);
        ...
        private class State몬스터스폰 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddBuff(arg1: new int[] {112}, arg2: 69000501, arg3: 1, arg4: true);
            }
        ...
        private class State스폰대사 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {112})) {
                ...
                if (context.TimeExpired(arg1: "LimitTimer")) {
                    context.SideNpcTalk(type: "talk", npcID: 11004288, illust: "nagi_switchon",
                        script: "$83000003_COLOSSEUM__ROUND12__5$", duration: 3000);
        ...
        private class StateClearRoundDelay : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    ...
                    context.SetEventUI(arg1: 3, arg2: "$83000003_COLOSSEUM__ROUND12__8$", arg3: new int[] {3000});
        ...
        private class StateFailRoundDelay : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.SetEventUI(arg1: 5, arg2: "$83000003_COLOSSEUM__ROUND12__9$", arg3: new int[] {3000});
                    context.State = new StateFailRound(context);
                    return;
                }
            }
        ...
        private class StateClearRound : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    ...
                    context.SideNpcTalk(type: "talk", npcID: 11004288, illust: "nagi_normal",
                        script: "$83000003_COLOSSEUM__ROUND12__10$", duration: 3000);

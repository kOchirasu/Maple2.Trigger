    ...
    public static class _round7 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "StartRound7", value: 1)) {
        ...
        private class State라운드조건체크 : TriggerState {
            ...
            public override void Execute() {
                if (context.DungeonRoundRequire(round: 7)) {
                    context.SideNpcTalk(type: "talk", npcID: 11004288, illust: "nagi_switchon",
                        script: "$83000002_COLOSSEUM__ROUND7__0$", duration: 5000);
                ...
                if (true) {
                    context.SideNpcTalk(type: "talk", npcID: 11004288, illust: "nagi_switchon",
                        script: "$83000002_COLOSSEUM__ROUND7__1$", duration: 3000);
        ...
        private class State몬스터스폰 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddBuff(arg1: new int[] {107}, arg2: 69000501, arg3: 1, arg4: true);
            }
        ...
        private class State스폰대사 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.TimeExpired(arg1: "LimitTimer")) {
                    context.SideNpcTalk(type: "talk", npcID: 11004288, illust: "nagi_switchon",
                        script: "$83000002_COLOSSEUM__ROUND7__5$", duration: 3000);
                ...
                if (context.UserDetected(arg1: "902")) {
                    context.SideNpcTalk(type: "talk", npcID: 11004288, illust: "nagi_switchon",
                        script: "$83000002_COLOSSEUM__ROUND7__6$", duration: 3000);
                    context.DestroyMonster(arg1: new int[] {107});
                    context.SetNpcDuelHpBar(isOpen: "false", spawnPointID: 107);
                    context.State = new StateFailRoundDelay(context);
                    return;
                ...
                if (!context.UserDetected(arg1: "904")) {
                    context.SideNpcTalk(type: "talk", npcID: 11004288, illust: "nagi_switchon",
                        script: "$83000002_COLOSSEUM__ROUND7__7$", duration: 3000);
                    context.DestroyMonster(arg1: new int[] {107});
                    context.SetNpcDuelHpBar(isOpen: "false", spawnPointID: 107);
                    context.State = new StateFailRoundDelay(context);
                    return;
        ...
        private class StateClearRoundDelay : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    ...
                    context.SetEventUI(arg1: 3, arg2: "$83000002_COLOSSEUM__ROUND7__8$", arg3: new int[] {3000});
        ...
        private class StateFailRoundDelay : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.SetEventUI(arg1: 5, arg2: "$83000002_COLOSSEUM__ROUND7__9$", arg3: new int[] {3000});
                    context.State = new StateFailRound(context);
                    return;
                }
            }
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    ...
                    context.SideNpcTalk(type: "talk", npcID: 11004285, illust: "Queencbean_Normal",
                        script: "$83000002_COLOSSEUM__ROUND7__10$", duration: 3000);

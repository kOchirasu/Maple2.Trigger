    ...
    public static class _01_abovewall {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10002101, 10002102, 10002103}, state: 0);
        ...
        private class StateMobActorSpawn : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 901, script: "$52100055_QD__01_ABOVEWALL__0$", arg4: 2, arg5: 1);
                context.SetConversation(type: 1, spawnId: 902, script: "$52100055_QD__01_ABOVEWALL__0$", arg4: 2, arg5: 1);
                context.SetConversation(type: 1, spawnId: 903, script: "$52100055_QD__01_ABOVEWALL__0$", arg4: 2, arg5: 1);
            }
        ...
        private class StateBattle01Start : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10002101}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10002101}, arg2: 0)) {
        ...
        private class StateBattle03Start : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10002102}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10002102}, arg2: 0)) {
        ...
        private class StateBattle04Start : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10002103}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10002103}, arg2: 0)) {

    ...
    public static class _barrier_8320 {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10000947}, arg2: 2);
                context.SetInteractObject(arg1: new int[] {10000963}, arg2: 2);
            }
            ...
            public override void Execute() {
                ...
                if (context.UserValue(key: "Barrier32", value: 7)) {
                    context.State = new StateSensor7327(context);
                    return;
                }

                if (context.UserValue(key: "Barrier32", value: 8)) {
                    context.State = new StateSensor7328(context);
                    return;
                }

                if (context.UserValue(key: "Barrier32", value: 9)) {
                    context.State = new StateSensor7329(context);
                    return;
                }

                if (context.UserValue(key: "Barrier32", value: 6)) {
                    context.State = new StateSensor7326(context);
                    return;
                }

                if (context.UserValue(key: "Barrier32", value: 15)) {
                    context.State = new StateSensor73215(context);
                    return;
                }

                if (context.UserValue(key: "Barrier32", value: 20)) {
                    context.State = new StateSensor73220(context);
                    return;
                }

                if (context.UserValue(key: "Barrier32", value: 25)) {
                    context.State = new StateSensor73225(context);
                    return;
                }

                if (context.UserValue(key: "Barrier32", value: 30)) {
        ...
        private class StateSensor7321 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {8321, 8322, 8323, 8324, 8325, 8326, 8327, 8328}, arg2: false, arg3: 0,
                    arg4: 0, arg5: 0f);
                context.SetEffect(arg1: new int[] {8320}, arg2: false);
                context.SetInteractObject(arg1: new int[] {10000947}, arg2: 0);
                context.SetInteractObject(arg1: new int[] {10000963}, arg2: 0);
            }
        ...
        private class StateEnable7322 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10000947}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000947}, arg2: 0)) {
        ...
        private class StateDelay7322 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000963}, arg2: 1);
            }
            ...
            public override void Execute() {
                ...
                if (context.ObjectInteracted(arg1: new int[] {10000963}, arg2: 0)) {

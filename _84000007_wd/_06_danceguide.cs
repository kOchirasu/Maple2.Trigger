...
namespace Maple2.Trigger._84000007_wd {
    public static class _06_danceguide {
        ...
        private class StateDanceGuideP11_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityID: 26100801, textID: 26100801, durationTime: 4000);
            }
        ...
        private class StateDanceGuideP11_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityID: 26100802, textID: 26100802, durationTime: 4000);
            }
        ...
        private class StateDanceGuideP12_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityID: 28400703, textID: 28400703, durationTime: 4000);
            }
        ...
        private class StateDanceGuideP21_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityID: 26100801, textID: 26100801, durationTime: 5000);
            }
        ...
        private class StateDanceGuideP21_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityID: 26100802, textID: 26100802, durationTime: 5000);
            }
        ...
        private class StateDanceGuideP22_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityID: 28400703, textID: 28400703, durationTime: 5000);
            }
        ...
        private class StateDanceGuideP41_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityID: 26100801, textID: 26100801, durationTime: 6000);
            }
        ...
        private class StateDanceGuideP52_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityID: 26100802, textID: 26100802, durationTime: 6000);
            }
        ...
        private class StateDanceGuideP62_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityID: 28400703, textID: 28400703, durationTime: 6000);
            }

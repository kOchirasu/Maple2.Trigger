    ...
    public static class _act03 {
        ...
        private class StateQ3_미카Cinematic01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {2001, 2002}, arg2: false);
            }
        ...
        private class StateQ3_미카Cinematic03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {2002, 2001}, arg2: true);
            }
        ...
        private class StateQ3_시네마틱Cinematic01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
                context.SetConversation(arg1: 2, arg2: 11001285, script: "$52010005_QD__ACT03__0$", arg4: 4);
        ...
        private class StateQ3_시네마틱Cinematic03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 2, arg2: 11001316, script: "$52010005_QD__ACT03__1$", arg4: 3);
        ...
        private class StateQ3_미카Exit02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 2, arg2: 11001285, script: "$52010005_QD__ACT03__2$", arg4: 3);
        ...
        private class StateQ3_UserExit02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(id: "42", arg2: 4);
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
                context.SetConversation(arg1: 2, arg2: 11001316, script: "$52010005_QD__ACT03__3$", arg4: 4);

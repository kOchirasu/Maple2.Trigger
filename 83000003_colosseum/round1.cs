    ...
    public static class _round1 {
        ...
        private class State라운드ConditionCheck : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetDungeonRoundsRequired() == 1) {
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_normal", script: "$83000002_COLOSSEUM__ROUND1__0$", duration: 5000);
        ...
        private class State라운드Wait : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.SideNpcTalk(type: SideNpcTalkType.CutIn, illust: "Robe_normal", duration: 3000);
        ...
        private class StateMonsterSpawn : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddBuff(boxIds: new []{101}, skillId: 69000501, level: 1, arg4: true);
            }
        ...
        private class State스폰대사 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnId: 101, msg: "$83000002_COLOSSEUM__ROUND1__2$", duration: 3000);
                context.SetUserValue(triggerId: 900002, key: "Timer", value: 1);
                context.SetTimer(timerId: "LimitTimer", seconds: 60, autoRemove: true);
                context.SetNpcDuelHpBar(isOpen: true, spawnId: 101, durationTick: 60000, npcHpStep: 10);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{101})) {
                    context.AddBalloonTalk(spawnId: 101, msg: "$83000002_COLOSSEUM__ROUND1__3$", duration: 3000);
                    context.SetNpcDuelHpBar(isOpen: false, spawnId: 101);
                    return new StateClearRoundDelay(context);
                }

                if (context.TimeExpired(timerId: "LimitTimer")) {
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND1__4$", duration: 3000);
                ...
                if (context.UserDetected(boxIds: new []{902})) {
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND1__5$", duration: 3000);
                    context.DestroyMonster(spawnIds: new []{101});
                    context.SetNpcDuelHpBar(isOpen: false, spawnId: 101);
                    return new StateFailRoundDelay(context);
                }
                ...
                if (!context.UserDetected(boxIds: new []{904})) {
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND1__6$", duration: 3000);
                    context.DestroyMonster(spawnIds: new []{101});
                    context.SetNpcDuelHpBar(isOpen: false, spawnId: 101);
                    return new StateFailRoundDelay(context);
                }
        ...
        private class StateClearRoundDelay : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    ...
                    context.SetEventUI(arg1: 3, script: "$83000002_COLOSSEUM__ROUND1__7$", duration: 3000);
        ...
        private class StateFailRoundDelay : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.SetEventUI(arg1: 5, script: "$83000002_COLOSSEUM__ROUND1__8$", duration: 3000);
                    return new StateFailRound(context);
                }
        ...
        private class StateClearRound : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.MoveUserToPos(position: new Vector3(300f, -225f, 1500f), rotation: new Vector3(0f, 0f, 270f));
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_normal", script: "$83000002_COLOSSEUM__ROUND1__9$", duration: 3000);

    ...
    public static class _round6 {
        public class StateWait : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetUserValue(key: "StartRound6") == 1) {
        ...
        private class State라운드ConditionCheck : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetDungeonRoundsRequired() == 6) {
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_normal", script: "$83000002_COLOSSEUM__ROUND6__0$", duration: 5000);
                    return new State라운드Wait(context);
                }

                context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND6__1$", duration: 3000);
        ...
        private class State라운드Wait : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.SideNpcTalk(type: SideNpcTalkType.CutIn, illust: "Ophelia_normal", duration: 3000);
                    context.ShowRoundUI(round: 6, duration: 3000);
        ...
        private class StateMonsterSpawn : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddBuff(boxIds: new []{106}, skillId: 69000501, level: 1, arg4: true);
            }
        ...
        private class StateCount : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowCountUI(text: "$83000002_COLOSSEUM__ROUND6__2$", count: 3, soundType: 2);
            }
        ...
        private class State스폰대사 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnId: 106, msg: "$83000002_COLOSSEUM__ROUND6__3$", duration: 3000);
                context.SetTimer(timerId: "LimitTimer", seconds: 120, clearAtZero: true);
                context.SetNpcDuelHpBar(isOpen: true, spawnId: 106, durationTick: 120000, npcHpStep: 10);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{106})) {
                    context.AddBalloonTalk(spawnId: 106, msg: "$83000002_COLOSSEUM__ROUND6__4$", duration: 3000);
                    context.SetNpcDuelHpBar(isOpen: false, spawnId: 106);
                    return new StateClearRoundDelay(context);
                }

                if (context.TimeExpired(timerId: "LimitTimer")) {
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND6__5$", duration: 3000);
                ...
                if (context.UserDetected(boxIds: new []{902})) {
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND6__6$", duration: 3000);
                    context.DestroyMonster(spawnIds: new []{106});
                    context.SetNpcDuelHpBar(isOpen: false, spawnId: 106);
                    return new StateFailRoundDelay(context);
                }
                ...
                if (!context.UserDetected(boxIds: new []{904})) {
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND6__7$", duration: 3000);
                    context.DestroyMonster(spawnIds: new []{106});
                    context.SetNpcDuelHpBar(isOpen: false, spawnId: 106);
                    return new StateFailRoundDelay(context);
                }
        ...
        private class StateClearRoundDelay : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    ...
                    context.SetEventUI(arg1: 3, script: "$83000002_COLOSSEUM__ROUND6__8$", duration: 3000);
        ...
        private class StateFailRoundDelay : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.SetEventUI(arg1: 5, script: "$83000002_COLOSSEUM__ROUND6__9$", duration: 3000);
                    return new StateFailRound(context);
                }
        ...
        private class StateClearRound : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    ...
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_normal", script: "$83000002_COLOSSEUM__ROUND6__10$", duration: 3000);
                    context.SetUserValue(triggerId: 900001, key: "StartRound6", value: 2);
        ...
        private class StateFailRound : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.SetUserValue(triggerId: 900001, key: "StartRound6", value: 3);
                    return new StateWait(context);
                }

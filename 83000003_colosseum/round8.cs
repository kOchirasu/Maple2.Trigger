    ...
    public static class _round8 {
        ...
        private class State라운드ConditionCheck : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetDungeonRoundsRequired() == 8) {
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND8__0$", duration: 5000);
                    return new State라운드Wait(context);
                }

                context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND8__1$", duration: 3000);
        ...
        private class State라운드Wait : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.SideNpcTalk(type: SideNpcTalkType.CutIn, illust: "Cutin_Patos_01", duration: 3000);
        ...
        private class StateMonsterSpawn : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddBuff(boxIds: new []{108}, skillId: 69000501, level: 1, arg4: true);
            }
        ...
        private class State기믹더미소환 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.RandomCondition(rate: 50)) {
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004285, illust: "Queencbean_Normal", script: "$83000002_COLOSSEUM__ROUND8__3$", duration: 6000);
        ...
        private class State스폰대사 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnId: 108, msg: "$83000002_COLOSSEUM__ROUND8__5$", duration: 3000);
                context.SetTimer(timerId: "LimitTimer", seconds: 180, autoRemove: true);
                context.SetNpcDuelHpBar(isOpen: true, spawnId: 108, durationTick: 180000, npcHpStep: 10);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{108})) {
                    context.AddBalloonTalk(spawnId: 108, msg: "$83000002_COLOSSEUM__ROUND8__6$", duration: 3000);
                    context.SetNpcDuelHpBar(isOpen: false, spawnId: 108);
                ...
                if (context.TimeExpired(timerId: "LimitTimer")) {
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND8__7$", duration: 3000);
                ...
                if (context.UserDetected(boxIds: new []{902})) {
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND8__8$", duration: 3000);
                    context.DestroyMonster(spawnIds: new []{108});
                    context.SetNpcDuelHpBar(isOpen: false, spawnId: 108);
                    context.DestroyMonster(spawnIds: new []{10000, 10001});
                    return new StateFailRoundDelay(context);
                ...
                if (!context.UserDetected(boxIds: new []{904})) {
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND8__9$", duration: 3000);
                    context.DestroyMonster(spawnIds: new []{108});
                    context.SetNpcDuelHpBar(isOpen: false, spawnId: 108);
                    context.DestroyMonster(spawnIds: new []{10000, 10001});
                    return new StateFailRoundDelay(context);
        ...
        private class StateClearRoundDelay : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    ...
                    context.SetEventUI(arg1: 3, script: "$83000002_COLOSSEUM__ROUND8__10$", duration: 3000);
        ...
        private class StateFailRoundDelay : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.SetEventUI(arg1: 5, script: "$83000002_COLOSSEUM__ROUND8__11$", duration: 3000);
                    return new StateFailRound(context);
                }
        ...
        private class StateClearRound : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    ...
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_normal", script: "$83000002_COLOSSEUM__ROUND8__12$", duration: 3000);

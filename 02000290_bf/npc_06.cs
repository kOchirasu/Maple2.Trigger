    ...
    public static class _npc_06 {
        public class StateWaitStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000463}, state: 1);
                context.CreateMonster(spawnIds: new []{906});
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000463}, arg2: 0)) {
        ...
        private class StateNPCScript : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 906, script: "$02000290_BF__NPC_06__0$", arg4: 2);
            }
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 906, script: "$02000290_BF__NPC_06__1$", arg4: 2);
            }

    ...
    public static class _15_relicmob_grey {
        public class StateSetting : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{1500, 1501, 1502, 1503, 1504, 1505, 1506, 1507, 1508, 1509});
        ...
        private class StateMobSpawn01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{1500}, arg2: false);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{1500})) {
        ...
        private class StateMobSpawn03 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{1502})) {
                    return new StateNotice(context);
                }
        ...
        private class StateMobSpawn04 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{1503})) {
                    return new StateNotice(context);
                }
        ...
        private class StateMobSpawn05 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{1504})) {
                    return new StateNotice(context);
                }
        ...
        private class StateMobSpawn06 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{1505})) {
                    return new StateNotice(context);
                }
        ...
        private class StateMobSpawn07 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{1506})) {
                    return new StateNotice(context);
                }
        ...
        private class StateMobSpawn08 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{1507})) {
                    return new StateNotice(context);
                }
        ...
        private class StateMobSpawn09 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{1508})) {
                    return new StateNotice(context);
                }
        ...
        private class StateMobSpawn10 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{1509}, arg2: false);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{1509})) {
                    return new StateNotice(context);
                }

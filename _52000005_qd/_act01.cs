namespace Maple2.Trigger._52000005_qd {
    public static class _act01 {
        ...
        private class State딜레이01 : TriggerState {
            ...
            public override void Execute() {
                if (context.TimeExpired(arg1: "1")) {
                    context.State = new State영감대화준비(context);
                    return;
                }
            }
        ...
        private class State영감대화준비 : TriggerState {
            ...
            public override void Execute() {
                if (true) {
                    context.State = new State영감대화01(context);
                    return;
                }
            }
        ...
        private class State영감대화01 : TriggerState {
            ...
            public override void Execute() {
                if (context.TimeExpired(arg1: "2")) {
                    context.State = new State영감대화02대기(context);
                    return;
                }
            }
        ...
        private class State영감대화02대기 : TriggerState {
            ...
            public override void Execute() {
                if (true) {
                    context.State = new State영감대화02(context);
                    return;
                }
            }
        ...
        private class State영감대화02 : TriggerState {
            ...
            public override void Execute() {
                if (context.TimeExpired(arg1: "3")) {
                    context.State = new State여제입장01(context);
                    return;
                }
            }
        ...
        private class State딜레이03 : TriggerState {
            ...
            public override void Execute() {
                if (context.TimeExpired(arg1: "12")) {
                    context.State = new State여제대화01(context);
                    return;
                }
            }
        ...
        private class State영상재생 : TriggerState {
            ...
            public override void Execute() {
                if (context.WidgetCondition(arg1: "SceneMovie", arg2: "IsStop", arg3: "1")) {
                    context.State = new State영상종료(context);
                    return;
                }
            }

    ...
    public static class _main {
        public class StateQuest체크 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.QuestUserDetected(boxIds: new []{199}, questIds: new []{50100060}, questStates: new byte[]{1})) {
                    return new StateWait(context);
                }

                if (context.QuestUserDetected(boxIds: new []{199}, questIds: new []{50100060}, questStates: new byte[]{2})) {
                    return new StateQuest완료가능이거나완료1(context);
                }

                if (context.QuestUserDetected(boxIds: new []{199}, questIds: new []{50100060}, questStates: new byte[]{3})) {
                    return new StateQuest완료가능이거나완료1(context);
                }
        ...
        private class State부선장Script03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 2, spawnId: 24003011, script: "$02000391_BF__MAIN__2$", arg4: 4, align: Align.Left);
            }
        ...
        private class State세이렌Script01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcId: 11003888, illustId: "Celine_normal", script: "$02000391_BF__MAIN__3$", align: Align.Left, duration: 4000);
            }
        ...
        private class StateCamera310 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcId: 11003888, illustId: "Celine_normal", script: "$02000391_BF__MAIN__4$", align: Align.Left, duration: 3000);
        ...
        private class State세이렌연주02 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11003888, illustId: "Celine_normal", script: "$02000391_BF__MAIN__6$", align: Align.Left, duration: 5000);
                context.PlaySystemSoundInBox(sound: "Dungeon_Siren_Harp01");
                context.SetNpcEmotionSequence(spawnId: 1098, sequenceName: "Attack_01_D");
            }
        ...
        private class State세이렌이동 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11003888, illustId: "Celine_normal", script: "$02000391_BF__MAIN__7$", align: Align.Left, duration: 3500);
        ...
        private class StateQuest완료가능이거나완료1 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    return new StateQuest완료가능이거나완료2(context);
                }
        ...
        private class StateQuest완료가능이거나완료2 : TriggerState {
            internal StateQuest완료가능이거나완료2(ITriggerContext context) : base(context) { }

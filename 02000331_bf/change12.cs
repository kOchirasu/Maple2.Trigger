    ...
    public static class _change12 {
        public class StateWait : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 9023, spawnIds: new []{603})) {
        ...
        private class State교체쓰러짐 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{613});
            }
        ...
        private class State교체일어남 : TriggerState {
            ...
            public override void OnEnter() {
                context.ChangeMonster(removeSpawnId: 613, addSpawnId: 310);
            }

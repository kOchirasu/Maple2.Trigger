    ...
    public static class _708_darknesstotem_08round {
        ...
        private class StateTotemApp01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {2308}, arg2: false);
                context.SetMesh(
                    arg1: new int[]
                        {3700, 3701, 3702, 3703, 3704, 3705, 3706, 3707, 3708, 3709, 3710, 3711, 3712, 3713},
        ...
        private class StateJuntaReady01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 2308, arg3: "$02000378_BF__708_DARKNESSTOTEM_08ROUND__0$",
                    arg4: 3, arg5: 0);
            }
        ...
        private class StateDestoryTotem01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {2108}, arg2: false);
            }
        ...
        private class StateJuntaReturn01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(arg1: new int[] {2308});
                context.DestroyMonster(arg1: new int[] {2108});
            }
        ...
        private class StateJuntaReturn02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {2208}, arg2: false);
            }

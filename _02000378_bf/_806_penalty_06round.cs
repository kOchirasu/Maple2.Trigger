...
namespace Maple2.Trigger._02000378_bf {
    public static class _806_penalty_06round {
        ...
        private class State1stWaveStart01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90680, 90682, 90684, 90686, 90688}, arg2: false);
            }
        ...
        private class State1stWaveStart02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90681, 90683, 90685, 90687, 90689}, arg2: false);
            }
        ...
        private class State2ndWaveStart02 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {
                    90680, 90681, 90682, 90683, 90684, 90685, 90686, 90687, 90688, 90689, 90690, 90691, 90692, 90693,
                    90694, 90695, 90696, 90697, 90698, 90699
                })) {

    ...
    public static class _707_darknesstotem_07round {
        ...
        private class StateTotemApp01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {2307}, arg2: false);
                context.SetMesh(
                    arg1: new int[]
                        {3600, 3601, 3602, 3603, 3604, 3605, 3606, 3607, 3608, 3609, 3610, 3611, 3612, 3613},
        ...
        private class StateJuntaReady01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 2307, arg3: "$02000378_BF__707_DARKNESSTOTEM_07ROUND__0$",
                    arg4: 3, arg5: 0);
            }
        ...
        private class StateDestoryTotem01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {2107}, arg2: false);
            }
        ...
        private class StateJuntaReturn01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(arg1: new int[] {2307});
                context.DestroyMonster(arg1: new int[] {2107});
            }
        ...
        private class StateJuntaReturn02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {2207}, arg2: false);
            }

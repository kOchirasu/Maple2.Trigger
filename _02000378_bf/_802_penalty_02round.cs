namespace Maple2.Trigger._02000378_bf {
    public static class _802_penalty_02round {
        ...
        private class State1stWaveStart01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new[] {90280, 90282, 90284, 90286, 90288}, arg2: false);
            }
        ...
        private class State1stWaveStart02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new[] {90281, 90283, 90285, 90287, 90289}, arg2: false);
            }
        ...
        private class State2ndWaveStart01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new[] {90290, 90292, 90294, 90296, 90298}, arg2: false);
            }
        ...
        private class State2ndWaveStart02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new[] {90291, 90293, 90295, 90297, 90299}, arg2: false);
            }

            public override TriggerState Execute() {
                if (context.MonsterDead(arg1: new[] {90280, 90281, 90282, 90283, 90284, 90285, 90286, 90287, 90288, 90289, 90290, 90291, 90292, 90293, 90294, 90295, 90296, 90297, 90298, 90299})) {
        ...
        private class StatePenaltyFinished01 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new[] {90280, 90281, 90282, 90283, 90284, 90285, 90286, 90287, 90288, 90289, 90290, 90291, 90292, 90293, 90294, 90295, 90296, 90297, 90298, 90299});

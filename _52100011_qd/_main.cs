    ...
    public static class _main {
        ...
        private class Stateidle : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10002054}, arg2: 1);
        ...
        private class StateQuestDungeonStart : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {702}, arg2: new int[] {50100080},
                    arg3: new byte[] {1})) {
                    context.State = new Statemermaid_01(context);
                    return;
                }
        ...
        private class Statescene_02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 102, arg3: "$52100011_QD__MAIN__5$", arg4: 2, arg5: 1);
            }
        ...
        private class Stateopen_door_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 102, arg3: "$52100011_QD__MAIN__6$", arg4: 2, arg5: 0);
                context.SetConversation(arg1: 1, arg2: 101, arg3: "$52100011_QD__MAIN__7$", arg4: 2, arg5: 1);
            }
        ...
        private class Statebattle_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetLocalCamera(cameraId: 8100, enable: true);
                context.SetConversation(arg1: 1, arg2: 102, arg3: "$52100011_QD__MAIN__8$", arg4: 2, arg5: 0);
                context.SetConversation(arg1: 1, arg2: 101, arg3: "$52100011_QD__MAIN__9$", arg4: 2, arg5: 1);
        ...
        private class Statebattle_03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 102, arg3: "$52100011_QD__MAIN__13$", arg4: 2, arg5: 0);
                context.SetConversation(arg1: 1, arg2: 101, arg3: "$52100011_QD__MAIN__14$", arg4: 2, arg5: 2);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10002054}, arg2: 0)) {
        ...
        private class Stateship_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 102, arg3: "$52100011_QD__MAIN__17$", arg4: 2, arg5: 0);
                context.SetConversation(arg1: 1, arg2: 101, arg3: "$52100011_QD__MAIN__18$", arg4: 2, arg5: 2);
            }
        ...
        private class Stateship_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$52100011_QD__MAIN__19$", arg3: new int[] {3000});
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10002055}, arg2: 0)) {
        ...
        private class Stateship_03 : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10002056}, arg2: 0)) {
        ...
        private class Stateending : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetOnetimeEffect(id: 1, enable: false, path: @"BG/Common/ScreenMask/Eff_fadein_1sec.xml");
                context.CameraSelectPath(arg1: new int[] {8003, 8004, 8005, 8006}, arg2: false);
            }

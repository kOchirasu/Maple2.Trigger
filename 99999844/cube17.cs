namespace Maple2.Trigger._99999844 {
    public static class _cube17 {
        ...
        private class State큐브17 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4029, 4030, 4031, 4032, 5029, 5030, 5031, 5032}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State큐브Remove : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4029, 4030, 4031, 4032, 5029, 5030, 5031, 5032}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }

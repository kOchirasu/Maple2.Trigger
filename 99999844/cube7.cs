namespace Maple2.Trigger._99999844 {
    public static class _cube7 {
        ...
        private class State큐브7 : TriggerState {
            internal State큐브7(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4010, 5010}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }

            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.SetUserValue(triggerId: 920007, key: "CubeOff", value: 1);
        ...
        private class State큐브Remove : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4010, 5010}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (context.UserDetected(boxIds: new []{9004})) {
                    context.SetUserValue(triggerId: 910007, key: "Cube", value: 0);

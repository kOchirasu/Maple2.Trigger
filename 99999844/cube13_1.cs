namespace Maple2.Trigger._99999844 {
    public static class _cube13_1 {
        ...
        private class StateOff_1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{5022, 5023, 5024}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateOn_1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{5022, 5023, 5024}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateOff_7 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 200)) {
                    context.SetUserValue(triggerId: 920013, key: "CubeOff", value: 0);
                    context.SetUserValue(triggerId: 910013, key: "Cube", value: 2);

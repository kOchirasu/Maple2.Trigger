namespace Maple2.Trigger._99999844 {
    public static class _cube6 {
        ...
        private class State큐브6 : TriggerState {
            internal State큐브6(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4009}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State큐브Remove : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4009}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (context.UserDetected(boxIds: new []{9004})) {
                    context.SetUserValue(triggerId: 910006, key: "Cube", value: 0);

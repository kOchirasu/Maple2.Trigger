namespace Maple2.Trigger._99999844 {
    public static class _cube2 {
        ...
        private class State큐브2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4003, 5003}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State큐브Remove : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4003, 5003}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }

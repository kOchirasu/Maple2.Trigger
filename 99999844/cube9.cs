namespace Maple2.Trigger._99999844 {
    public static class _cube9 {
        ...
        private class State큐브9 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4014, 4015, 4016, 4017, 5014, 5015, 5016, 5017}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State큐브Remove : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4014, 4015, 4016, 4017, 5014, 5015, 5016, 5017}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }

namespace Maple2.Trigger._99999844 {
    public static class _cube18 {
        ...
        private class State큐브18 : TriggerState {
            internal State큐브18(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4033, 4034}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State큐브Remove : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4033, 4034}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }

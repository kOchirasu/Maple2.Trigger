namespace Maple2.Trigger._99999844 {
    public static class _cube4 {
        ...
        private class State큐브4 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4006, 4007, 5006, 5007}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State큐브Remove : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4006, 4007, 5006, 5007}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }

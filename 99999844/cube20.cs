namespace Maple2.Trigger._99999844 {
    public static class _cube20 {
        ...
        private class State큐브20 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4038, 4039, 4040, 5038, 5039, 5040}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State큐브Remove : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4038, 4039, 4040, 5038, 5039, 5040}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }

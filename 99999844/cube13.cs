namespace Maple2.Trigger._99999844 {
    public static class _cube13 {
        ...
        private class State큐브13 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4022, 4023, 4024, 5022, 5023, 5024}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State큐브Remove : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4022, 4023, 4024, 5022, 5023, 5024}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }

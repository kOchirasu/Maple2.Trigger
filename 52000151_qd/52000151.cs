    ...
    public static class _52000151 {
        ...
        private class State파토스SpawnCinematic04 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {7002, 7003}, arg2: false);
            }
        ...
        private class State파토스SpawnCinematic08 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {7008, 7009}, arg2: false);
            }
        ...
        private class State파토스SpawnCinematic09 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {7010, 7011}, arg2: false);
            }
        ...
        private class State파토스SpawnCinematic12 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {7012, 7013, 7014, 7015}, arg2: false);
            }
        ...
        private class State파토스SpawnCinematic13 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {7016, 7017}, arg2: false);
            }
        ...
        private class State파토스SpawnCinematic15 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {7018, 7019}, arg2: false);
            }
        ...
        private class State파토스SpawnCinematic18 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {7020, 7021}, arg2: false);
        ...
        private class State파토스SpawnCinematic19 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {7022, 7023}, arg2: false);
        ...
        private class State파토스SpawnCinematic20 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {7024, 7025}, arg2: false);

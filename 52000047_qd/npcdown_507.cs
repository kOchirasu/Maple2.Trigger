    ...
    public static class _npcdown_507 {
        public class StateWait : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 9900, spawnIds: new []{907})) {
        ...
        private class StateNpcFight : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{907})) {
        ...
        private class StateNpcDown : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{517}, arg2: false);
            }
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{517});

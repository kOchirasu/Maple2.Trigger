namespace Maple2.Trigger._52000047_qd {
    public static class _npcdown_504 {
        public class StateWait : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 9900, spawnIds: new []{904})) {
        ...
        private class StateNpcDown : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{514}, arg2: false);
            }
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{514});

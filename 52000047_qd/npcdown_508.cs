namespace Maple2.Trigger._52000047_qd {
    public static class _npcdown_508 {
        public class StateWait : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 9900, spawnIds: new []{908})) {
        ...
        private class StateNpcDown : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{518}, arg2: false);
            }
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{518});

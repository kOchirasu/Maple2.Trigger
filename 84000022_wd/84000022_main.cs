    ...
    public static class _84000022_main {
        ...
        private class StateStartCinematic : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.WeddingMoveUser(entryType: "Guest", arg1: 84000022, arg2: new byte[] {22, 23}, arg3: 701);
                context.WeddingMoveUser(entryType: "Guest", arg1: 84000022, arg2: new byte[] {22, 23}, arg3: 703);
                context.WeddingMoveUser(entryType: "Groom", arg1: 84000022, arg2: new byte[] {11}, arg3: 702);
                context.WeddingMoveUser(entryType: "Bride", arg1: 84000022, arg2: new byte[] {12}, arg3: 702);
                context.SetPortal(arg1: 99, arg2: true, arg3: true, arg4: true);
            }
        ...
        private class State주례줌인02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcId: 11004723, msg: "$84000022_WD__84000022_MAIN__0$", duration: 3500);
            }
        ...
        private class State주례사 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetCinematicUI(arg1: 3);
                context.AddCinematicTalk(npcId: 11004723, msg: "$84000022_WD__84000022_MAIN__1$", duration: 4000);
            }
        ...
        private class State탈주로중단 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11004723, msg: "$84000022_WD__84000022_MAIN__2$", duration: 3000);
            }
        ...
        private class State탈주로중단선언 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11004723, msg: "$84000022_WD__84000022_MAIN__3$", duration: 3000);
            }
        ...
        private class State미입력으로중단01 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11004723, msg: "$84000022_WD__84000022_MAIN__4$", duration: 3000);
            }
        ...
        private class State미입력으로중단선언 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11004723, msg: "$84000022_WD__84000022_MAIN__5$", duration: 3000);
            }
        ...
        private class State성혼발표 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11004723, msg: "$84000022_WD__84000022_MAIN__6$", duration: 2500);

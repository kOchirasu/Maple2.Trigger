    ...
    public static class _wave_03_warning {
        ...
        private class State돌격 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 190, script: "$02000334_BF__WAVE__6$", arg4: 3);
                context.CreateMonster(spawnIds: new []{991, 996}, arg2: true);
        ...
        private class StateCamera_복구 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 199, script: "$02000334_BF__WAVE__7$", arg4: 3);
                context.SetTimer(timerId: "10", seconds: 10);
        ...
        private class State돌격2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{98001}, visible: true);
                context.MoveNpc(spawnId: 190, patrolName: "MS2PatrolData_3501");
                context.SetConversation(type: 1, spawnId: 190, script: "$02000334_BF__WAVE__8$", arg4: 3);
                context.CreateMonster(spawnIds: new []{992, 995, 997}, arg2: true);
                context.SetTimer(timerId: "3", seconds: 3);
            }
        ...
        private class StateCamera_복구2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{98006}, visible: true);
                context.MoveNpc(spawnId: 199, patrolName: "MS2PatrolData_3502");
                context.SetConversation(type: 1, spawnId: 199, script: "$02000334_BF__WAVE__9$", arg4: 3);
                context.AddBuff(boxIds: new []{90001}, skillId: 70000068, level: 1);
                context.SetTimer(timerId: "10", seconds: 10);
                context.CameraSelectPath(pathIds: new []{8017}, returnView: false);
            }
        ...
        private class State돌격3 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{98001}, visible: true);
                context.MoveNpc(spawnId: 190, patrolName: "MS2PatrolData_3501");
                context.SetConversation(type: 1, spawnId: 190, script: "$02000334_BF__WAVE__10$", arg4: 3);
                context.CreateMonster(spawnIds: new []{993, 994, 996}, arg2: true);
                context.SetTimer(timerId: "3", seconds: 3);
            }
        ...
        private class StateCamera_복구3 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddBuff(boxIds: new []{90001}, skillId: 70000068, level: 1);
                context.MoveNpc(spawnId: 199, patrolName: "MS2PatrolData_3502");
                context.SetConversation(type: 1, spawnId: 199, script: "$02000334_BF__WAVE__11$", arg4: 3);
                context.CameraSelectPath(pathIds: new []{8017}, returnView: false);
            }

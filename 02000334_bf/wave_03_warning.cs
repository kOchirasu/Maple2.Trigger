    ...
    public static class _wave_03_warning {
        ...
        private class State돌격 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 190, script: "$02000334_BF__WAVE__6$", arg4: 3);
        ...
        private class StateCamera_복구 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 199, script: "$02000334_BF__WAVE__7$", arg4: 3);
                context.SetTimer(id: "10", arg2: 10);
        ...
        private class State돌격2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {98001}, arg2: true);
                context.MoveNpc(arg1: 190, arg2: "MS2PatrolData_3501");
                context.SetConversation(arg1: 1, arg2: 190, script: "$02000334_BF__WAVE__8$", arg4: 3);
        ...
        private class StateCamera_복구2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {98006}, arg2: true);
                context.MoveNpc(arg1: 199, arg2: "MS2PatrolData_3502");
                context.SetConversation(arg1: 1, arg2: 199, script: "$02000334_BF__WAVE__9$", arg4: 3);
                context.AddBuff(arg1: new[] {90001}, arg2: 70000068, arg3: 1);
                context.SetTimer(id: "10", arg2: 10);
                context.CameraSelectPath(pathIds: new[] {8017}, arg2: false);
            }
        ...
        private class State돌격3 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {98001}, arg2: true);
                context.MoveNpc(arg1: 190, arg2: "MS2PatrolData_3501");
                context.SetConversation(arg1: 1, arg2: 190, script: "$02000334_BF__WAVE__10$", arg4: 3);
        ...
        private class StateCamera_복구3 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddBuff(arg1: new[] {90001}, arg2: 70000068, arg3: 1);
                context.MoveNpc(arg1: 199, arg2: "MS2PatrolData_3502");
                context.SetConversation(arg1: 1, arg2: 199, script: "$02000334_BF__WAVE__11$", arg4: 3);
                context.CameraSelectPath(pathIds: new[] {8017}, arg2: false);
            }

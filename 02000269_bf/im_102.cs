    ...
    public static class _im_102 {
        public class StateWaitStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10000677}, arg2: 1);
            }
        ...
        private class StateInteractObject : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {10000677}, arg2: 0)) {
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 1102, script: "$02000269_BF__IM_102__0$", arg4: 2);
            }

            public override TriggerState Execute() {
                if (context.NpcDetected(arg1: 1102, arg2: new[] {1102})) {
        ...
        private class StateNPCDestroy : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetTimer(id: "1102", arg2: 60);
            }

    ...
    public static class _im_103 {
        public class StateWaitStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000678}, state: 1);
            }
        ...
        private class StateInteractObject : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000678}, arg2: 0)) {
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 1103, script: "$02000269_BF__IM_103__0$", arg4: 2);
            }

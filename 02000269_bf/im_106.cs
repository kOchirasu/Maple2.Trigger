    ...
    public static class _im_106 {
        public class StateWaitStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10000681}, arg2: 1);
            }
        ...
        private class StateInteractObject : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {10000681}, arg2: 0)) {
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 1106, script: "$02000269_BF__IM_106__0$", arg4: 2);
            }
        ...
        private class StateNPCDestroy : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetTimer(id: "1106", arg2: 60);
            }

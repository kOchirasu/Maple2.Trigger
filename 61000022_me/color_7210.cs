    ...
    public static class _color_7210 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{821}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(triggerIds: new []{921, 1021}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateYellowBefore : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{821}, visible: true, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(triggerIds: new []{921, 1021}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateRedBefore : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{1021}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(triggerIds: new []{921, 821}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateGreenAfter : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{921}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateYellowAfter : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{821}, visible: true, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(triggerIds: new []{921}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(triggerIds: new []{1021}, visible: false, arg3: 100, arg4: 0, arg5: 0f);
            }
        ...
        private class StateRedAfter : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{1021}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(triggerIds: new []{921}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(triggerIds: new []{821}, visible: false, arg3: 100, arg4: 0, arg5: 0f);
            }
        ...
        private class StateClear : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{921}, visible: false, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(triggerIds: new []{821}, visible: false, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(triggerIds: new []{1021}, visible: false, arg3: 0, arg4: 0, arg5: 2f);
            }
        ...
        private class StateRegen : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{821}, visible: true, arg3: 400, arg4: 0, arg5: 0f);
                context.SetMesh(triggerIds: new []{921, 1021}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }

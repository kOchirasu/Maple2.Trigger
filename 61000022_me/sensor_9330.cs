    ...
    public static class _sensor_9330 {
        ...
        private class StateGamblePass : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{533}, visible: false, arg3: 0, arg4: 0, arg5: 2f);
                context.WriteLog(logName: "dancedancestop", triggerId: 9330, @event: "char_event", arg4: 4, arg5: "gamble");
            }
        ...
        private class StateJackpotPass : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{533}, visible: false, arg3: 0, arg4: 0, arg5: 2f);
                context.WriteLog(logName: "dancedancestop", triggerId: 9330, @event: "char_event", arg4: 4, arg5: "jackpot");
            }
        ...
        private class StateGambleReset : TriggerState {
            ...
            public override void OnEnter() {
                context.SetAchievement(triggerId: 9330, type: "trigger", code: "ddstop_gamble");

    ...
    public static class _01_massivemain {
        ...
        private class StateGameGuide01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetAchievement(triggerId: 9001, type: "trigger", code: "christmasddstop_start");
                context.GiveGuildExp(boxId: 0, type: 2);
                context.SetMiniGameAreaForHack(boxId: 9001);
                context.StartMiniGame(boxId: 9001, round: 5, type: MiniGame.ChristmasDanceDanceStop);
            }
        ...
        private class StateR01End : TriggerState {
            ...
            public override void OnEnter() {
                context.WriteLog(logName: "christmasdancedancestop", triggerId: 9001, @event: "round_clear", arg4: 1);
        ...
        private class StateR02End : TriggerState {
            ...
            public override void OnEnter() {
                context.WriteLog(logName: "christmasdancedancestop", triggerId: 9001, @event: "round_clear", arg4: 2);
                context.SetCinematicUI(type: 0);
                context.SetCinematicUI(type: 2);
                context.CameraSelect(triggerId: 901, enable: false);
            }
        ...
        private class StateR03End : TriggerState {
            ...
            public override void OnEnter() {
                context.WriteLog(logName: "christmasdancedancestop", triggerId: 9001, @event: "round_clear", arg4: 3);
                context.SetCinematicUI(type: 0);
                context.SetCinematicUI(type: 2);
                context.CameraSelect(triggerId: 901, enable: false);
            }
        ...
        private class StateR04_GambleGuide01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.WriteLog(logName: "christmasdancedancestop", triggerId: 9001, @event: "system_event", arg4: 4, arg5: "gamble");
            }
        ...
        private class StateR04_JackpotGuide01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.PlaySystemSoundInBox(boxIds: new []{9000}, sound: "DJDD_Round_06");
                context.WriteLog(logName: "christmasdancedancestop", triggerId: 9001, @event: "system_event", arg4: 4, arg5: "jackpot");
            }
        ...
        private class StateR04GambleEnd : TriggerState {
            ...
            public override void OnEnter() {
                context.WriteLog(logName: "christmasdancedancestop", triggerId: 9001, @event: "round_clear", arg4: 4);
                context.SetCinematicUI(type: 0);
                context.SetCinematicUI(type: 2);
                context.CameraSelect(triggerId: 901, enable: false);
            }
        ...
        private class StateR05End : TriggerState {
            ...
            public override void OnEnter() {
                context.WriteLog(logName: "christmasdancedancestop", triggerId: 9001, @event: "round_clear", arg4: 5);
                context.SetCinematicUI(type: 0);
                context.SetCinematicUI(type: 2);
                context.CameraSelect(triggerId: 901, enable: false);
            }
        ...
        private class StateGameOver : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveUser(mapId: 61000022, portalId: 3, boxId: 9002);
                ...
                context.SetAchievement(triggerId: 9001, type: "trigger", code: "christmasddstop_win");
            }
        ...
        private class StateGiveReward : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.EndMiniGame(winnerBoxId: 9001, type: MiniGame.ChristmasDanceDanceStop);

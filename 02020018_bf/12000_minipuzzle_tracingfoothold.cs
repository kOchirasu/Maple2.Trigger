    ...
    public static class _12000_minipuzzle_tracingfoothold {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000082, 12000083, 12000223, 12000075}, state: 2);
        ...
        private class StateTracingFootHold_Success : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{12000223}, arg2: 0)) {
                    return new StateTracingFootHold_SuccessDelay(context);
                }

                if (context.TimeExpired(timerId: "2")) {
                    context.SetInteractObject(interactIds: new []{12000223}, state: 2);

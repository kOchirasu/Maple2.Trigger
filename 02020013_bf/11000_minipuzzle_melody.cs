    ...
    public static class _11000_minipuzzle_melody {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000201, 12000074, 12000058, 12000059, 12000060, 12000061, 12000062, 12000063, 12000064, 12000065}, state: 2);
        ...
        private class StateEndMelodyQuiz_Success : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000201}, state: 1);
                context.SetTimer(timerId: "2", seconds: 60, autoRemove: true, display: false, vOffset: 0);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{12000201}, arg2: 0)) {

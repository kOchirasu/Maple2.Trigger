namespace Maple2.Trigger._02020013_bf {
    public static class _102_melodypattern {
        ...
        private class StateMelodyPlay01_Start : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{11201}, visible: true);
        ...
        private class StateMelodyPlay05_Start : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{11202}, visible: true);
                context.SetActor(triggerId: 11002, visible: true, initialSequence: "ks_quest_musical_B01_yellow");
            }
        ...
        private class StateCheckAnswer01_Delay : TriggerState {
            ...
            public override void OnExit() {
                context.SetInteractObject(interactIds: new []{12000058}, state: 1);
            }
        }

...
namespace Maple2.Trigger._02000230_bf {
    public static class _save_03 {
        ...
        private class State주민구출 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000355}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000355}, arg2: 0)) {
        ...
        private class State문열림 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {30311}, arg2: true);
                context.SetActor(arg1: 30302, arg2: false, arg3: "Attack_02_A");
                context.CreateMonster(arg1: new int[] {30312}, arg2: true);
                context.SetActor(arg1: 30303, arg2: false, arg3: "Attack_02_A");
                context.CreateMonster(arg1: new int[] {30313}, arg2: true);
                context.SetActor(arg1: 30304, arg2: false, arg3: "Attack_Idle_A");
                context.CreateMonster(arg1: new int[] {30314}, arg2: true);
                context.SetActor(arg1: 30305, arg2: false, arg3: "Attack_02_A");
                context.CreateMonster(arg1: new int[] {30315}, arg2: true);
        ...
        private class State도망과공격 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 90311, arg2: new int[] {311})) {
        ...
        private class State도망완료 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {30311, 30312, 30313, 30314, 30315})) {
                    context.State = new State트리거초기화(context);
                    return;
                }

                if (!context.MonsterInCombat(arg1: new int[] {30311, 30312, 30313, 30314, 30315})) {
                    context.State = new State트리거초기화(context);
                    return;
                }
            }
        ...
        private class State트리거초기화 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(arg1: new int[] {30311, 30312, 30313, 30314, 30315});
            }

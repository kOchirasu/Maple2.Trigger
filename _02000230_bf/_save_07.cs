...
namespace Maple2.Trigger._02000230_bf {
    public static class _save_07 {
        ...
        private class State주민구출 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000359}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000359}, arg2: 0)) {
        ...
        private class State문열림 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {70711}, arg2: true);
                context.SetActor(arg1: 70702, arg2: false, arg3: "Attack_02_A");
                context.CreateMonster(arg1: new int[] {70712}, arg2: true);
                context.SetActor(arg1: 70703, arg2: false, arg3: "Attack_02_A");
                context.CreateMonster(arg1: new int[] {70713}, arg2: true);
                context.SetActor(arg1: 70704, arg2: false, arg3: "Attack_Idle_A");
                context.CreateMonster(arg1: new int[] {70714}, arg2: true);
                context.SetActor(arg1: 70705, arg2: false, arg3: "Attack_02_A");
                context.CreateMonster(arg1: new int[] {70715}, arg2: true);
        ...
        private class State도망과공격 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {711}, arg2: false);
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 90711, arg2: new int[] {711})) {
        ...
        private class State도망완료 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {70711, 70712, 70713, 70714, 70715})) {
                    context.State = new State트리거초기화(context);
                    return;
                }

                if (!context.MonsterInCombat(arg1: new int[] {70711, 70712, 70713, 70714, 70715})) {
                    context.State = new State트리거초기화(context);
                    return;
                }
            }
        ...
        private class State트리거초기화 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(arg1: new int[] {70711, 70712, 70713, 70714, 70715});
            }

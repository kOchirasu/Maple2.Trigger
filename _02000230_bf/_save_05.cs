...
namespace Maple2.Trigger._02000230_bf {
    public static class _save_05 {
        ...
        private class State주민구출 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000357}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000357}, arg2: 0)) {
        ...
        private class State문열림 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {50511}, arg2: true);
                context.SetActor(arg1: 50502, arg2: false, arg3: "Attack_02_A");
                context.CreateMonster(arg1: new int[] {50512}, arg2: true);
                context.SetActor(arg1: 50503, arg2: false, arg3: "Attack_02_A");
                context.CreateMonster(arg1: new int[] {50513}, arg2: true);
                context.SetActor(arg1: 50504, arg2: false, arg3: "Attack_Idle_A");
                context.CreateMonster(arg1: new int[] {50514}, arg2: true);
                context.SetActor(arg1: 50505, arg2: false, arg3: "Attack_02_A");
                context.CreateMonster(arg1: new int[] {50515}, arg2: true);
        ...
        private class State도망과공격 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 90511, arg2: new int[] {511})) {
        ...
        private class State도망완료 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {50511, 50512, 50513, 50514, 50515})) {
                    context.State = new State트리거초기화(context);
                    return;
                }

                if (!context.MonsterInCombat(arg1: new int[] {50511, 50512, 50513, 50514, 50515})) {
                    context.State = new State트리거초기화(context);
                    return;
                }
            }
        ...
        private class State트리거초기화 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(arg1: new int[] {50511, 50512, 50513, 50514, 50515});
            }

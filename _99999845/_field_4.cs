...
namespace Maple2.Trigger._99999845 {
    public static class _field_4 {
        ...
        private class StateBlock_1 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new[] {1114})) {
                    context.SetVisibleBreakableObject(arg1: new[] {1019}, arg2: true);
        ...
        private class StateBlock_2 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new[] {1115})) {
                    context.SetVisibleBreakableObject(arg1: new[] {1020}, arg2: true);
        ...
        private class StateBlock_3 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new[] {1116})) {
                    context.SetVisibleBreakableObject(arg1: new[] {1021}, arg2: true);

namespace Maple2.Trigger._02020065_bf {
    public static class _battle_1 {
        ...
        private class State스폰_1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetOnetimeEffect(id: 1, enable: false, path: @"BG/Common/Sound/Eff_System_Dark_Intro_Chord_01.xml");
                context.SideNpcTalk(type: "talk", npcId: 11001813, illust: "Turka_normal", duration: 5000, script: "$02020065_BF__BATTLE_1__0$");
            }
        ...
        private class State스폰_1_추가대사1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SideNpcTalk(type: "talk", npcId: 11001813, illust: "Turka_normal", duration: 5000, script: "$02020065_BF__BATTLE_1__1$");
            }
        ...
        private class State스폰_1_추가대사2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SideNpcTalk(type: "talk", npcId: 11003536, illust: "Neirin_surprise", duration: 5000, script: "$02020065_BF__BATTLE_1__2$");
            }

    ...
    public static class _3300_findkeyfromfabricbox {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10001142}, state: 0);
        ...
        private class StateTrue : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10001142}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001142}, arg2: 0)) {

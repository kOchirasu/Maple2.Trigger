...
namespace Maple2.Trigger._52100201_qd {
    public static class _cube11 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "Cube", value: 1)) {
                    context.State = new State큐브11(context);
                    return;
                }
            }
        ...
        private class State큐브11 : TriggerState {
            internal State큐브11(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {4019}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {5019}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.SetUserValue(triggerID: 920011, key: "CubeOff", value: 1);
        ...
        private class State큐브제거 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {4019}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {5019}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }
            ...
            public override void Execute() {
                ...
                if (context.UserDetected(arg1: new int[] {9004})) {
                    context.SetUserValue(triggerID: 910011, key: "Cube", value: 0);

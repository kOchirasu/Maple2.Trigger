namespace Maple2.Trigger._52100201_qd {
    public static class _cube8 {
        ...
        private class State큐브8 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {4011, 4012, 4013}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new[] {5011, 5012, 5013}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State큐브제거 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {4011, 4012, 4013}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new[] {5011, 5012, 5013}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }

namespace Maple2.Trigger._52100201_qd {
    public static class _cube10 {
        public class State대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.GetUserValue(key: "Cube") == 1) {
                    context.State = new State큐브10(context);
                    return;
                }
            }
        ...
        private class State큐브10 : TriggerState {
            internal State큐브10(ITriggerContext context) : base(context) { }
        ...
        private class State큐브제거 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2800)) {
                    context.State = new State큐브10(context);
                    return;
                }

                if (context.UserDetected(arg1: new[] {9004})) {
                    context.SetUserValue(triggerId: 910010, key: "Cube", value: 0);

namespace Maple2.Trigger._52100201_qd {
    public static class _cube7 {
        public class State대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.GetUserValue(key: "Cube") == 1) {
                    context.State = new State큐브7(context);
                    return;
                }
            }
        ...
        private class State큐브7 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {4010, 5010}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State큐브제거 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {4010, 5010}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }

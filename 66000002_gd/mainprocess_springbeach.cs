    ...
    public static class _mainprocess_springbeach {
        ...
        private class StateStartMassiveEvent2 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, script: "$61000007_ME__MAINPROCESS_SPRINGBEACH__3$", arg3: 4000);
            }
        ...
        private class StateStartMassiveEvent3 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, script: "$61000007_ME__MAINPROCESS_SPRINGBEACH__4$", arg3: 4000);
            }

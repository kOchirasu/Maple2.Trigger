namespace Maple2.Trigger._66000002_gd {
    public static class _mainprocess_springbeach {
        ...
        private class State경기장입장 : TriggerState {
            ...
            public override TriggerState? Execute() {
                context.MoveUser(mapId: 66000002, portalId: 902, boxId: 302);
        ...
        private class StateStartMassiveEvent2 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, script: "$61000007_ME__MAINPROCESS_SPRINGBEACH__3$", duration: 4000);
            }
        ...
        private class StateStartMassiveEvent3 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, script: "$61000007_ME__MAINPROCESS_SPRINGBEACH__4$", duration: 4000);
            }
        ...
        private class State보상단계 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "37", seconds: 7);
        ...
        private class StateBuff걸기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "38", seconds: 6);
            }

...
namespace Maple2.Trigger._83000002_colosseum {
    public static class _round5 {
        ...
        private class State라운드조건체크 : TriggerState {
            ...
            public override void Execute() {
                if (context.GetDungeonRoundsRequired() == 5) {
                    context.SideNpcTalk(type: "talk", npcId: 11004288, illust: "nagi_normal", script: "$83000002_COLOSSEUM__ROUND5__0$", duration: 5000);
                    context.State = new State라운드대기(context);
                    return;
                }

                if (true) {
                    context.SideNpcTalk(type: "talk", npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND5__1$", duration: 3000);
        ...
        private class State라운드대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.SideNpcTalk(type: "cutin", illust: "Orde_normal", duration: 3000);
        ...
        private class State스폰대사 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.TimeExpired(arg1: "LimitTimer")) {
                    context.SideNpcTalk(type: "talk", npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND5__5$", duration: 3000);
                ...
                if (context.UserDetected(arg1: new[] {902})) {
                    context.SideNpcTalk(type: "talk", npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND5__6$", duration: 3000);
                    context.DestroyMonster(arg1: new[] {105});
                    context.SetNpcDuelHpBar(isOpen: false, spawnPointId: 105);
                    context.State = new StateFailRoundDelay(context);
                    return;
                ...
                if (!context.UserDetected(arg1: new[] {904})) {
                    context.SideNpcTalk(type: "talk", npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND5__7$", duration: 3000);
                    context.DestroyMonster(arg1: new[] {105});
                    context.SetNpcDuelHpBar(isOpen: false, spawnPointId: 105);
                    context.State = new StateFailRoundDelay(context);
                    return;
        ...
        private class StateClearRoundDelay : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    ...
                    context.SetEventUI(arg1: 3, arg2: "$83000002_COLOSSEUM__ROUND5__8$", arg3: 3000);
        ...
        private class StateFailRoundDelay : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.SetEventUI(arg1: 5, arg2: "$83000002_COLOSSEUM__ROUND5__9$", arg3: 3000);
                    context.State = new StateFailRound(context);
                    return;
                }
            }
        ...
        private class StateClearRound : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    ...
                    context.SideNpcTalk(type: "talk", npcId: 11004288, illust: "nagi_normal", script: "$83000002_COLOSSEUM__ROUND5__10$", duration: 3000);

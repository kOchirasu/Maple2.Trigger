    ...
    public static class _round2 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "StartRound2", value: 1)) {
        ...
        private class State라운드조건체크 : TriggerState {
            ...
            public override void Execute() {
                if (context.DungeonRoundRequire(round: 2)) {
                    context.SideNpcTalk(type: "talk", npcID: 11004288, illust: "nagi_normal",
                        script: "$83000002_COLOSSEUM__ROUND2__0$", duration: 5000);
                ...
                if (true) {
                    context.SideNpcTalk(type: "talk", npcID: 11004288, illust: "nagi_switchon",
                        script: "$83000002_COLOSSEUM__ROUND2__1$", duration: 3000);
        ...
        private class State몬스터스폰 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddBuff(arg1: new int[] {102}, arg2: 69000501, arg3: 1, arg4: true);
            }
        ...
        private class State스폰대사 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.TimeExpired(arg1: "LimitTimer")) {
                    context.SideNpcTalk(type: "talk", npcID: 11004288, illust: "nagi_switchon",
                        script: "$83000002_COLOSSEUM__ROUND2__5$", duration: 3000);
                ...
                if (context.UserDetected(arg1: "902")) {
                    context.SideNpcTalk(type: "talk", npcID: 11004288, illust: "nagi_switchon",
                        script: "$83000002_COLOSSEUM__ROUND2__6$", duration: 3000);
                    context.DestroyMonster(arg1: new int[] {102});
                    context.SetNpcDuelHpBar(isOpen: "false", spawnPointID: 102);
                    context.State = new StateFailRoundDelay(context);
                    return;
                ...
                if (!context.UserDetected(arg1: "904")) {
                    context.SideNpcTalk(type: "talk", npcID: 11004288, illust: "nagi_switchon",
                        script: "$83000002_COLOSSEUM__ROUND2__7$", duration: 3000);
                    context.DestroyMonster(arg1: new int[] {102});
                    context.SetNpcDuelHpBar(isOpen: "false", spawnPointID: 102);
                    context.State = new StateFailRoundDelay(context);
                    return;
        ...
        private class StateClearRoundDelay : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    ...
                    context.SetEventUI(arg1: 3, arg2: "$83000002_COLOSSEUM__ROUND2__8$", arg3: new int[] {3000});
        ...
        private class StateFailRoundDelay : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.SetEventUI(arg1: 5, arg2: "$83000002_COLOSSEUM__ROUND2__9$", arg3: new int[] {3000});
                    context.State = new StateFailRound(context);
                    return;
                }
            }
        ...
        private class StateClearRound : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    ...
                    context.SideNpcTalk(type: "talk", npcID: 11004288, illust: "nagi_normal",
                        script: "$83000002_COLOSSEUM__ROUND2__10$", duration: 3000);

namespace Maple2.Trigger._02000390_bf {
    public static class _summon {
        ...
        private class StateSummon_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 102, script: "$02000390_BF__SUMMON__0$", arg4: 2, arg5: 0);
                context.SetConversation(type: 1, spawnId: 101, script: "$02000390_BF__SUMMON__1$", arg4: 2, arg5: 2);

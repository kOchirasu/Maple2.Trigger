    ...
    public static class _02_npcbackup03 {
        ...
        private class StateReinforcementsCreation : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.MoveNpc(spawnId: 203, patrolName: "MS2PatrolData_23");
            }

            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 4003, spawnIds: new []{203})) {
        ...
        private class StateMoveReinforcements : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 2001, spawnIds: new []{203})) {

    ...
    public static class _02_npcbackup01 {
        ...
        private class StateReinforcementsCreation : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.MoveNpc(spawnId: 201, patrolName: "MS2PatrolData_21");
                context.SetConversation(type: 1, spawnId: 201, script: "$02000076_TW_HenesysVillage__02_NPCBACKUP01__0$", arg4: 1);
            }

            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 4001, spawnIds: new []{201})) {
        ...
        private class StateMoveReinforcements : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 2001, spawnIds: new []{201})) {

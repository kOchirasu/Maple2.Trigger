    ...
    public static class _01_npcbackup03 {
        ...
        private class StateReinforcementsCreation : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.MoveNpc(spawnId: 103, patrolName: "MS2PatrolData_13");
            }

            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 3003, spawnIds: new []{103})) {
        ...
        private class StateMoveReinforcements : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 2001, spawnIds: new []{103})) {

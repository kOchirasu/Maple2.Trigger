...
namespace Maple2.Trigger._61000022_me {
    public static class _06_danceguide {
        ...
        private class StateDanceGuideP12_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityID: 26100803, textID: 26100803, durationTime: 4000);
            }
        ...
        private class StateDanceGuideP22_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityID: 26100803, textID: 26100803, durationTime: 5000);
            }
        ...
        private class StateDanceGuideP62_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityID: 26100803, textID: 26100803, durationTime: 6000);
            }

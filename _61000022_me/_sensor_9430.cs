    ...
    public static class _sensor_9430 {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {543}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {5430}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
            }

            public override void Execute() {
                if (context.UserValue(key: "Box43Check", value: 0)) {
                    context.State = new StateSensor0(context);
                    return;
                }

                if (context.UserValue(key: "Box43Check", value: 1)) {
                    context.State = new StateSensor1(context);
                    return;
                }

                if (context.UserValue(key: "Box43Check", value: 2)) {
                    context.State = new StateSensor2(context);
                    return;
                }

                if (context.UserValue(key: "Box43Check", value: 3)) {
                    context.State = new StateSensor3(context);
                    return;
                }

                if (context.UserValue(key: "Box43Check", value: 4)) {
                    context.State = new StateSensor4(context);
                    return;
                }

                if (context.UserValue(key: "Box43Check", value: 5)) {
        ...
        private class StatePass : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(arg1: new int[] {9430}, arg2: "DDStop_Stage_Pass_01");
                context.SetUserValue(triggerID: 7430, key: "Color43", value: 0);
                context.SetMesh(arg1: new int[] {543}, arg2: false, arg3: 0, arg4: 0, arg5: 2f);
            }
        ...
        private class StateFail : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(arg1: new int[] {9430}, arg2: "DDStop_Stage_Fail_01");
                context.SetMesh(arg1: new int[] {543}, arg2: false, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(arg1: new int[] {5430}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetUserValue(triggerID: 7430, key: "Color43", value: 4);
            }

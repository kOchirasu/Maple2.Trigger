    ...
    public static class _lookinto_thief_09 {
        public class StateWait : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.QuestUserDetected(boxIds: new []{9000}, questIds: new []{60100070}, questStates: new byte[]{3}, jobCode: 70)) {
                    return new StateQuit(context);
                }

                if (context.QuestUserDetected(boxIds: new []{9900}, questIds: new []{60100070}, questStates: new byte[]{2}, jobCode: 70)) {
                    return new StateQuit(context);
                }

                if (context.QuestUserDetected(boxIds: new []{9900}, questIds: new []{60100070}, questStates: new byte[]{1}, jobCode: 70)) {
                    return new StateLoadingDelay02(context);
                }

                if (context.QuestUserDetected(boxIds: new []{9000}, questIds: new []{60100065}, questStates: new byte[]{3}, jobCode: 70)) {
                    return new StateDefaultSetting02(context);
                }

                if (context.QuestUserDetected(boxIds: new []{9000}, questIds: new []{60100065}, questStates: new byte[]{2}, jobCode: 70)) {
        ...
        private class StateQuit02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, script: "$52000037_QD__LOOKINTO_THIEF_09__0$", duration: 3000, boxId: 0);
            }

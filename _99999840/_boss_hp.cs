...
namespace Maple2.Trigger._99999840 {
    public static class _boss_hp {
        ...
        private class State시작 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckNpcHp(compare: "lowerEqual", value: 70, spawnPointId: 901, isRelative: "true")) {
        ...
        private class State70프로 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckNpcHp(compare: "lowerEqual", value: 50, spawnPointId: 901, isRelative: "true")) {
        ...
        private class State50프로 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckNpcHp(compare: "lowerEqual", value: 30, spawnPointId: 901, isRelative: "true")) {
        ...
        private class State30프로 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckNpcHp(compare: "lowerEqual", value: 10, spawnPointId: 901, isRelative: "true")) {

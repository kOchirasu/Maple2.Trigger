    ...
    public static class _im_543 {
        public class StateWaitStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000543}, state: 1);
            }
        ...
        private class StateInteractObject : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000543}, arg2: 0)) {
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 1102, patrolName: "MS2PatrolData_543");
                context.SetConversation(type: 1, spawnId: 1102, script: "$02000013_BF__IM_543__0$", arg4: 2, arg5: 0);
            }

            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 543, spawnIds: new []{1102})) {

    ...
    public static class _im_544 {
        public class StateWaitStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000544}, state: 1);
            }
        ...
        private class StateInteractObject : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000544}, arg2: 0)) {
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 1103, patrolName: "MS2PatrolData_544");
                context.SetConversation(type: 1, spawnId: 1103, script: "$02000013_BF__IM_544__0$", arg4: 2, arg5: 0);
            }

            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 544, spawnIds: new []{1103})) {

    ...
    public static class _im_547 {
        public class StateWaitStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000547}, state: 1);
            }
        ...
        private class StateInteractObject : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000547}, arg2: 0)) {
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 1106, patrolName: "MS2PatrolData_547");
                context.SetConversation(type: 1, spawnId: 1106, script: "$02000013_BF__IM_547__0$", arg4: 2, arg5: 0);
            }

            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 547, spawnIds: new []{1106})) {

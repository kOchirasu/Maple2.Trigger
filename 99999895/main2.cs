namespace Maple2.Trigger._99999895 {
    public static class _main2 {
        ...
        private class State스폰Script1 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnId: 201, msg: "네 마음가짐과 기량을 한 번 볼까?", duration: 3000);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{201})) {
                    context.AddBalloonTalk(spawnId: 201, msg: "너 따위 애송이에게 지다니...", duration: 3000);
        ...
        private class State스폰Script2 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnId: 202, msg: "와라!! 얼마나 성장했는지 보겠다!", duration: 3000);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{202})) {
                    context.AddBalloonTalk(spawnId: 202, msg: "꽤 하는군. 즐거운 싸움이었다.", duration: 3000);
        ...
        private class State스폰Script3 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnId: 203, msg: "그동안 어떤 성과를 이루셨는지 보여주세요.", duration: 3000);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{203})) {
                    context.AddBalloonTalk(spawnId: 203, msg: "좋은 실력입니다. 엘리넬 학생들에게 귀감이 될 분이시군요.", duration: 3000);

namespace Maple2.Trigger._52100022_qd {
    public static class _01_bossbattle {
        ...
        private class StateBoss01Talk01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 2, spawnId: 11003068, script: "$02000382_BF__01_BOSSBATTLE__0$", arg4: 4);
        ...
        private class StateBoss01Talk02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 2, spawnId: 11003069, script: "$02000382_BF__01_BOSSBATTLE__1$", arg4: 5);
        ...
        private class StateBoss02Talk01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 2, spawnId: 11003068, script: "$02000382_BF__01_BOSSBATTLE__2$", arg4: 3);
        ...
        private class StateBoss02Talk02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 2, spawnId: 11003069, script: "$02000382_BF__01_BOSSBATTLE__3$", arg4: 4);
        ...
        private class StateBoss03Talk01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 2, spawnId: 11003068, script: "$02000382_BF__01_BOSSBATTLE__4$", arg4: 4);
        ...
        private class StateBoss03Talk02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 2, spawnId: 11003069, script: "$02000382_BF__01_BOSSBATTLE__5$", arg4: 5);

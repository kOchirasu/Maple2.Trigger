    ...
    public static class _event4 {
        ...
        private class State진행3 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new[] {307, 308, 309, 310, 311, 312}, arg2: true, arg3: 300, arg4: 50,
                    arg5: 2f);
                context.SetMesh(arg1: new[] {313, 314, 315, 316, 317, 318, 319, 320}, arg2: true, arg3: 400,
                    arg4: 50, arg5: 2f);
                context.SetMesh(arg1: new[] {321, 322, 323, 324, 325, 326, 327, 328, 329, 330}, arg2: true,
                    arg3: 500, arg4: 50, arg5: 2f);
                context.SetMesh(arg1: new[] {331, 332, 333, 334, 335, 336, 337, 338, 339, 340, 341, 342},
                    arg2: true, arg3: 600, arg4: 50, arg5: 2f);
                context.SetMesh(arg1: new[] {343, 344, 345, 346, 347, 348, 349, 350, 351, 352, 353, 354},
                    arg2: true, arg3: 700, arg4: 50, arg5: 2f);
                context.SetMesh(arg1: new[] {355, 356, 357, 358, 359, 360, 361, 362, 363, 364}, arg2: true,
                    arg3: 800, arg4: 50, arg5: 2f);
                context.SetMesh(arg1: new[] {365, 366, 367, 368, 369, 370, 371, 372}, arg2: true, arg3: 900,
                    arg4: 50, arg5: 2f);

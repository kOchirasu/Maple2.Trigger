    ...
    public static class _barrier_8240 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000945, 10000961}, state: 2);
            }
        ...
        private class StateSensor7242 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{8241, 8242, 8243, 8244, 8245, 8246}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(triggerIds: new []{8240}, visible: false);
                context.SetInteractObject(interactIds: new []{10000945, 10000961}, state: 0);
            }
        ...
        private class StateEnable7242 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000945}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000945}, arg2: 0)) {
        ...
        private class StateActivate7242 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000945}, state: 2);
            }
        ...
        private class StateDelay7242 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000961}, state: 1);
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (context.ObjectInteracted(interactIds: new []{10000961}, arg2: 0)) {

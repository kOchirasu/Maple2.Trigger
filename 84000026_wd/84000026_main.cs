    ...
    public static class _84000026_main {
        ...
        private class StateStartCinematic : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.WeddingMoveUser(type: WeddingEntryType.Guest, mapId: 84000026, portalIds: new []{22, 23}, boxId: 701);
                context.WeddingMoveUser(type: WeddingEntryType.Guest, mapId: 84000026, portalIds: new []{22, 23}, boxId: 703);
                context.WeddingMoveUser(type: WeddingEntryType.Groom, mapId: 84000026, portalIds: new []{11}, boxId: 702);
                context.WeddingMoveUser(type: WeddingEntryType.Bride, mapId: 84000026, portalIds: new []{12}, boxId: 702);
                context.SetPortal(portalId: 99, visible: true, enabled: true, minimapVisible: true);
            }
        ...
        private class State주례사 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetCinematicUI(type: 3);
                context.WeddingSetUserRotation(type: WeddingEntryType.Groom, immediate: true);
                context.WeddingSetUserRotation(type: WeddingEntryType.Bride, immediate: true);

    ...
    public static class _main30000336 {
        public class State체크 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.QuestUserDetected(boxIds: new []{2003}, questIds: new []{30000336}, questStates: new byte[]{2})) {
        ...
        private class State체크2 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{107, 108}, arg2: false);
        ...
        private class State세번째Cinematic대화진행02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetNpcEmotionSequence(spawnId: 108, sequenceName: "Bore_A");
        ...
        private class State세번째Cinematic대화진행03_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new []{4040}, returnView: false);
        ...
        private class State세번째Cinematic대화진행04 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new []{4022}, returnView: false);
                context.SetNpcEmotionSequence(spawnId: 108, sequenceName: "Talk_A");

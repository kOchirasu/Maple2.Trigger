namespace Maple2.Trigger._63000002_cs {
    public static class _reaction_object_07 {
        ...
        private class State채집가능 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{607}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{607}, arg2: 2)) {
                    context.CreateItem(spawnIds: new []{1007});
        ...
        private class State채집완료 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "7", seconds: 30, clearAtZero: false);
            }

namespace Maple2.Trigger._63000002_cs {
    public static class _reaction_object_08 {
        ...
        private class State채집가능 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{608}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{608}, arg2: 2)) {
                    context.CreateItem(spawnIds: new []{1008});
        ...
        private class State채집완료 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "8", seconds: 30, clearAtZero: false);
            }

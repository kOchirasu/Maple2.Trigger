...
namespace Maple2.Trigger._02000493_bf {
    public static class _main {
        ...
        private class StateStartCinematic : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{101, 102, 103, 111, 112, 113, 114, 115, 116, 119, 121, 122, 123, 124, 125, 126, 127}, arg2: false);
        ...
        private class State전투01 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{101, 102, 103, 111, 112, 113, 114, 115, 116, 119, 121, 122, 123, 124, 125, 126, 127})) {

...
namespace Maple2.Trigger._02100004_bf {
    public static class _npc01 {
        ...
        private class State소환대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(triggerID: 999992, key: "NpcSpawned01", value: 0);
            }

            public override void Execute() {
                if (context.UserValue(key: "NpcSpawn01", value: 1)) {
        ...
        private class State소환 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(triggerID: 999992, key: "NpcSpawned01", value: 1);

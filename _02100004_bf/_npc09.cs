...
namespace Maple2.Trigger._02100004_bf {
    public static class _npc09 {
        ...
        private class State소환대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(triggerID: 999992, key: "NpcSpawned09", value: 0);
            }

            public override void Execute() {
                if (context.UserValue(key: "NpcSpawn09", value: 1)) {
        ...
        private class State소환 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(triggerID: 999992, key: "NpcSpawned09", value: 1);
                context.CreateMonster(arg1: new int[] {2009}, arg2: true);
            }

...
namespace Maple2.Trigger._02100004_bf {
    public static class _npc13 {
        ...
        private class State소환대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(triggerID: 999992, key: "NpcSpawned13", value: 0);
            }

            public override void Execute() {
                if (context.UserValue(key: "NpcSpawn13", value: 1)) {
        ...
        private class State소환 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(triggerID: 999992, key: "NpcSpawned13", value: 1);
                context.CreateMonster(arg1: new int[] {2013}, arg2: true);
            }

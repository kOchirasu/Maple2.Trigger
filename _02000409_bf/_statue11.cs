    ...
    public static class _statue11 {
        ...
        private class State세팅 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {11}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State수신대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "StatueHuman02Death", value: 1)) {
                    context.SetMesh(arg1: new int[] {11}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);

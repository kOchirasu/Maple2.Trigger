            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {1104, 1150, 1151, 1152, 1157, 1158, 1159, 1160, 1161})) {
                    ...
                    context.CreateMonster(arg1: new int[] {1211, 1212, 1213, 1214, 1215, 1216, 1217, 1218, 1219, 1220},
                        arg2: false);
                    context.CreateMonster(arg1: new int[] {1221, 1222, 1223, 1224}, arg2: false);
        ...
        private class StateCableOn_04 : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {12000304}, arg2: 0)) {
                    ...
                    context.DestroyMonster(arg1: new int[] {30003, 30004}, arg2: false);
                    context.SetMesh(
                        arg1: new int[]
        ...
        private class StateCableOn_05 : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {12000305}, arg2: 0)) {
                    ...
                    context.DestroyMonster(arg1: new int[] {30001, 30002, 30004}, arg2: false);
                    context.SetMesh(
                        arg1: new int[]
        ...
        private class StateCableOn_06 : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {12000306}, arg2: 0)) {
                    ...
                    context.DestroyMonster(arg1: new int[] {30001, 30002, 30003}, arg2: false);
                    context.SetMesh(
                        arg1: new int[]

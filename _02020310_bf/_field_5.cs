    ...
    public static class _field_5 {
        public class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {12000400}, arg2: 0);
                context.SetInteractObject(arg1: new[] {12000401}, arg2: 0);
                context.SetInteractObject(arg1: new[] {12000402}, arg2: 0);
                context.SetInteractObject(arg1: new[] {12000403}, arg2: 0);
            }
        ...
        private class StateArcheon_Ready : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new[]
                    ...
                    context.SetInteractObject(arg1: new[] {12000400}, arg2: 1);
                    context.SetInteractObject(arg1: new[] {12000401}, arg2: 1);
                    context.SetInteractObject(arg1: new[] {12000402}, arg2: 1);
                    context.SetInteractObject(arg1: new[] {12000403}, arg2: 1);
        ...
        private class StateArcheon_Move1_0 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    ...
                    context.CreateMonster(
                        arg1: new[] {11001, 11002, 11003, 11004, 11005, 11006, 11007, 11008, 11009, 11010},
                        arg2: false);
                    context.CreateMonster(
                        arg1: new[] {11011, 11012, 11013, 11014, 11015, 11016, 11017, 11018, 11019, 11020},
                        arg2: false);
                    context.CreateMonster(
                        arg1: new[] {11021, 11022, 11023, 11024, 11025, 11026, 11027, 11028, 11029}, arg2: false);

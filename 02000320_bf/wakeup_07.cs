    ...
    public static class _wakeup_07 {
        ...
        private class State깨어남1 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 70004, script: "$02000320_BF__WAKEUP_07__0$", arg4: 2, arg5: 0);
                context.CreateMonster(arg1: new[] {70005}, arg2: true);
                context.SetConversation(arg1: 1, arg2: 70005, script: "$02000320_BF__WAKEUP_07__1$", arg4: 2, arg5: 1);
                context.CreateMonster(arg1: new[] {70006}, arg2: true);
                context.SetConversation(arg1: 1, arg2: 70006, script: "$02000320_BF__WAKEUP_07__2$", arg4: 2, arg5: 2);
                context.CreateMonster(arg1: new[] {70001});
                context.CreateMonster(arg1: new[] {70002});
                context.CreateMonster(arg1: new[] {70003});
                context.SetConversation(arg1: 1, arg2: 70003, script: "$02000320_BF__WAKEUP_07__3$", arg4: 2, arg5: 3);
                context.SetConversation(arg1: 1, arg2: 70001, script: "$02000320_BF__WAKEUP_07__4$", arg4: 2, arg5: 4);
            }
        ...
        private class State깨어남2 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 70002, script: "$02000320_BF__WAKEUP_07__5$", arg4: 2, arg5: 0);
                context.SetConversation(arg1: 1, arg2: 70001, script: "$02000320_BF__WAKEUP_07__6$", arg4: 2, arg5: 1);
                context.SetConversation(arg1: 1, arg2: 70003, script: "$02000320_BF__WAKEUP_07__7$", arg4: 2, arg5: 2);
            }
        ...
        private class State다시자러감 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 70004, script: "$02000320_BF__WAKEUP_07__8$", arg4: 2, arg5: 0);
                context.SetConversation(arg1: 1, arg2: 70005, script: "$02000320_BF__WAKEUP_07__9$", arg4: 2, arg5: 1);
                context.SetConversation(arg1: 1, arg2: 70006, script: "$02000320_BF__WAKEUP_07__10$", arg4: 2, arg5: 2);
            }

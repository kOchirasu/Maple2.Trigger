    ...
    public static class _save_06 {
        public class StateTriggerReset : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{6001}, visible: false, arg5: 1f);
            }
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000472}, state: 1);
                context.CreateMonster(spawnIds: new []{601, 602}, arg2: false);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000472}, arg2: 0)) {
        ...
        private class State문열림 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{6001}, visible: true, arg5: 1f);
        ...
        private class State도망갈Prepare1 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 611, script: "$03000145_BF__SAVE_06__0$", arg4: 2, arg5: 0);
            }
        ...
        private class State도망갈Prepare2 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 612, script: "$03000145_BF__SAVE_06__1$", arg4: 2, arg5: 0);
            }
        ...
        private class State도망중 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 611, script: "$03000145_BF__SAVE_06__2$", arg4: 2, arg5: 0);
                context.SetConversation(type: 1, spawnId: 612, script: "$03000145_BF__SAVE_06__3$", arg4: 2, arg5: 1);
            }
        ...
        private class State도망끝 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(spawnIds: new []{611, 612});
            }

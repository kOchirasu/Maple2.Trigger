    ...
    public static class _save_06 {
        ...
        private class State도망갈Prepare1 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 611, script: "$03000145_BF__SAVE_06__0$", arg4: 2, arg5: 0);
            }
        ...
        private class State도망갈Prepare2 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 612, script: "$03000145_BF__SAVE_06__1$", arg4: 2, arg5: 0);
            }
        ...
        private class State도망중 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 611, script: "$03000145_BF__SAVE_06__2$", arg4: 2, arg5: 0);
                context.SetConversation(arg1: 1, arg2: 612, script: "$03000145_BF__SAVE_06__3$", arg4: 2, arg5: 1);
            }

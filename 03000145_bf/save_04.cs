    ...
    public static class _save_04 {
        public class StateTriggerReset : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{4001}, visible: false, arg5: 1f);
            }
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000470}, state: 1);
                context.CreateMonster(spawnIds: new []{401, 402}, arg2: false);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000470}, arg2: 0)) {
        ...
        private class State문열림 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{4001}, visible: true, arg5: 1f);
                context.DestroyMonster(spawnIds: new []{401, 402});
                context.CreateMonster(spawnIds: new []{411, 412}, arg2: false);
            }
        ...
        private class State도망갈Prepare1 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 411, script: "$03000145_BF__SAVE_04__0$", arg4: 2, arg5: 0);
            }
        ...
        private class State도망갈Prepare2 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 412, script: "$03000145_BF__SAVE_04__1$", arg4: 2, arg5: 0);
            }
        ...
        private class State도망시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 411, patrolName: "MS2PatrolData_411");
                context.MoveNpc(spawnId: 412, patrolName: "MS2PatrolData_412");
            }
        ...
        private class State도망중 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 411, script: "$03000145_BF__SAVE_04__2$", arg4: 2, arg5: 0);
                context.SetConversation(type: 1, spawnId: 412, script: "$03000145_BF__SAVE_04__3$", arg4: 2, arg5: 1);
            }
        ...
        private class State도망끝 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(spawnIds: new []{411, 412});
            }

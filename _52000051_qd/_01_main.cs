    ...
    public static class _01_main {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {3014}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
        ...
        private class StateLodingDelay01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new StateSetDarkness01(context);
                    return;
                }
            }
        ...
        private class StateSetDarkness01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(
                    arg1: new int[] {
                        950, 951, 952, 953, 955, 956, 957, 958, 959, 962, 963, 964, 967, 970, 974, 975, 976, 977, 978,
                        980, 981, 982
                    }, arg2: false);
            }
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new StateSetDarkness02(context);
                    return;
                }
            }
        ...
        private class StateSetDarkness02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new StateNpcCinematic01(context);
                    return;
                }
            }
        ...
        private class StateNpcCinematic01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new StateNpcCinematic01Skip(context);
                    return;
                }
            }
        ...
        private class StateNpcCinematic01Skip : TriggerState {
            ...
            public override void Execute() {
                if (true) {
                    context.State = new StateNpcCinematic02(context);
                    return;
                }
            }
        ...
        private class StateNpcCinematic02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new StateNpcCinematic02Skip(context);
                    return;
                }
            }
        ...
        private class StateNpcCinematic02Skip : TriggerState {
            ...
            public override void Execute() {
                if (true) {
                    context.State = new StateNpcCinematic03(context);
                    return;
                }
            }
        ...
        private class StateNpcCinematic03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new StateNpcCinematic04(context);
                    return;
                }
            }
        ...
        private class StateNpcCinematic04 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new StateNpcCinematic05(context);
                    return;
                }
            }
        ...
        private class StateNpcCinematic05 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new StateNpcCinematic05Skip(context);
                    return;
                }
            }
        ...
        private class StateNpcPatrol01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {3014}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
        ...
        private class StateNpcPatrol02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$52000051_QD__01_MAIN__5$", arg3: new int[] {5000}, arg4: "0");
            }
        ...
        private class StateShadowApp01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {901, 903, 905}, arg2: false);
            }
        ...
        private class StateShadowApp02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$52000051_QD__01_MAIN__13$", arg3: new int[] {3000}, arg4: "0");
                context.CreateMonster(arg1: new int[] {914, 916, 918}, arg2: false);
            }
        ...
        private class StateShadowApp03 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {921, 926, 928}, arg2: false);
            }
        ...
        private class StateStartPuzzle02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {5000}, arg2: true);
                context.SetEventUI(arg1: 1, arg2: "$52000051_QD__01_MAIN__15$", arg3: new int[] {5000}, arg4: "0");
            }

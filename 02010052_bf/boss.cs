    ...
    public static class _boss {
        ...
        private class StateBurn_state_04 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetTimer(timerId: "6", seconds: 6, clearAtZero: true, display: false);
        ...
        private class StateClear_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
                context.CameraSelect(triggerId: 80006, enable: true);
                ...
                context.SetTimer(timerId: "5", seconds: 5, clearAtZero: true, display: false);
            }
            ...
            public override void OnExit() {
                ...
                context.CameraSelect(triggerId: 80006, enable: false);
            }
        }

    ...
    public static class _boss {
        ...
        private class StateBoss_01c : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 995, script: "$02010052_BF__BOSS__0$", arg4: 3, arg5: 0);
        ...
        private class StateBurn_state_01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, script: "$02010052_BF__BOSS__1$", arg3: 3000);
        ...
        private class StateBoss_02c : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityId: 200, textId: 20105201);
                context.SetConversation(arg1: 1, arg2: 996, script: "$02010052_BF__BOSS__2$", arg4: 3, arg5: 0);
        ...
        private class StateBurn_state_02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, script: "$02010052_BF__BOSS__3$", arg3: 3000);
        ...
        private class StateBoss_03c : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityId: 200, textId: 20105201);
                context.SetConversation(arg1: 1, arg2: 997, script: "$02010052_BF__BOSS__4$", arg4: 3, arg5: 0);
        ...
        private class StateBurn_state_03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, script: "$02010052_BF__BOSS__5$", arg3: 3000);
        ...
        private class StateBurn_state_04 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 2, arg2: 21800073, script: "$02010052_BF__BOSS__6$", arg4: 5);
                ...
                context.CameraSelectPath(pathIds: new[] {80004, 80005}, arg2: true);
                context.SetTimer(id: "6", arg2: 6, arg3: true, arg4: false);
        ...
        private class StateBoss_battle_01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, script: "$02010052_BF__BOSS__7$", arg3: 3000);
            }
        ...
        private class StateClear_01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 2, arg2: 21800073, script: "$02010052_BF__BOSS__8$", arg4: 4);
                context.SetTimer(id: "5", arg2: 5, arg3: true, arg4: false);
            }

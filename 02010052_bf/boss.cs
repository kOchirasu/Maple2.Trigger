namespace Maple2.Trigger._02010052_bf {
    public static class _boss {
        ...
        private class StateBoss_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{7531}, visible: true);
                context.SetMesh(triggerIds: new []{6801, 6802, 6803, 6804, 6805, 6806, 6807, 6808, 6809, 6810}, visible: true, arg3: 80, arg4: 70, arg5: 8f);
                context.SetTimer(timerId: "1", seconds: 1);
            }
        ...
        private class StateBoss_01b : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{7910}, visible: true);
                context.CreateMonster(spawnIds: new []{995}, arg2: false);
                context.SetTimer(timerId: "1", seconds: 1);
            }
        ...
        private class StateBoss_01c : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 995, script: "$02010052_BF__BOSS__0$", arg4: 3, arg5: 0);
                context.CreateMonster(spawnIds: new []{120}, arg2: false);
                context.CreateMonster(spawnIds: new []{621, 622, 623, 624, 625}, arg2: true);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{120})) {
        ...
        private class StateBurn_state_01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(triggerIds: new []{7507}, visible: true);
                context.SetMesh(triggerIds: new []{6801, 6802, 6803, 6804, 6805, 6806, 6807, 6808, 6809, 6810}, visible: false, arg3: 800, arg4: 100, arg5: 0f);
                context.SetMesh(triggerIds: new []{600003}, visible: false, arg3: 800, arg4: 100, arg5: 0f);
                context.SetEffect(triggerIds: new []{7910}, visible: true);
                context.DestroyMonster(spawnIds: new []{995});
                context.SetEventUI(arg1: 1, script: "$02010052_BF__BOSS__1$", duration: 3000);
                context.SetEffect(triggerIds: new []{7031}, visible: true);
        ...
        private class StateBoss_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{7532}, visible: true);
                context.SetMesh(triggerIds: new []{6821, 6822, 6823, 6824, 6825, 6826, 6827, 6828, 6829, 6830}, visible: true, arg3: 80, arg4: 70, arg5: 8f);
                context.SetTimer(timerId: "1", seconds: 1);
            }
        ...
        private class StateBoss_02b : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{7911}, visible: true);
                context.CreateMonster(spawnIds: new []{996}, arg2: false);
                context.SetTimer(timerId: "1", seconds: 1);
            }
        ...
        private class StateBoss_02c : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityId: 200, textId: 20105201);
                context.SetConversation(type: 1, spawnId: 996, script: "$02010052_BF__BOSS__2$", arg4: 3, arg5: 0);
                context.CreateMonster(spawnIds: new []{121}, arg2: false);
                context.CreateMonster(spawnIds: new []{631, 632, 633, 634, 635}, arg2: true);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{121})) {
        ...
        private class StateBurn_state_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.HideGuideSummary(entityId: 200);
                context.SetEffect(triggerIds: new []{7508}, visible: true);
                context.SetMesh(triggerIds: new []{6821, 6822, 6823, 6824, 6825, 6826, 6827, 6828, 6829, 6830}, visible: false, arg3: 800, arg4: 100, arg5: 0f);
                context.SetMesh(triggerIds: new []{600004}, visible: false, arg3: 800, arg4: 100, arg5: 0f);
                context.SetEffect(triggerIds: new []{7911}, visible: true);
                context.DestroyMonster(spawnIds: new []{996});
                context.SetEventUI(arg1: 1, script: "$02010052_BF__BOSS__3$", duration: 3000);
                context.SetEffect(triggerIds: new []{7032}, visible: true);
                context.SetTimer(timerId: "1", seconds: 1, display: false);
            }
        ...
        private class StateBoss_03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{7533}, visible: true);
                context.SetMesh(triggerIds: new []{6830, 6831, 6832, 6833, 6834, 6835, 6836, 6837, 6838, 6839, 6840}, visible: true, arg3: 80, arg4: 70, arg5: 8f);
                context.SetTimer(timerId: "1", seconds: 1);
            }
        ...
        private class StateBoss_03b : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{7912}, visible: true);
        ...
        private class StateBoss_03c : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityId: 200, textId: 20105201);
                context.SetConversation(type: 1, spawnId: 997, script: "$02010052_BF__BOSS__4$", arg4: 3, arg5: 0);
                context.CreateMonster(spawnIds: new []{641, 642, 643, 644, 645}, arg2: true);
                context.CreateMonster(spawnIds: new []{122}, arg2: false);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{122})) {
        ...
        private class StateBurn_state_03 : TriggerState {
            ...
            public override void OnEnter() {
                context.HideGuideSummary(entityId: 200);
                context.SetEffect(triggerIds: new []{7509}, visible: true);
                context.SetMesh(triggerIds: new []{6830, 6831, 6832, 6833, 6834, 6835, 6836, 6837, 6838, 6839, 6840}, visible: false, arg3: 800, arg4: 100, arg5: 0f);
                context.SetMesh(triggerIds: new []{600005}, visible: false, arg3: 800, arg4: 100, arg5: 0f);
                context.SetEffect(triggerIds: new []{7912}, visible: true);
                context.DestroyMonster(spawnIds: new []{997});
                context.SetEventUI(arg1: 1, script: "$02010052_BF__BOSS__5$", duration: 3000);
                context.SetEffect(triggerIds: new []{7033}, visible: true);
                context.SetTimer(timerId: "1", seconds: 1, display: false);
            }
            ...
            public override void OnExit() {
                context.CreateMonster(spawnIds: new []{123, 124}, arg2: false);
            }
        }
        ...
        private class StateBoss_04_idle : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{123})) {
                    return new StateBoss_04_idle_A(context);
                }

                if (context.MonsterDead(spawnIds: new []{124})) {
        ...
        private class StateBoss_04_idle_A : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{7034}, visible: true);
            }
            ...
            public override void OnExit() {
                context.SetEffect(triggerIds: new []{7035}, visible: true);
            }
        }
        ...
        private class StateBurn_state_04 : TriggerState {
            ...
            public override void OnExit() {
                context.SetMesh(triggerIds: new []{6890, 6891, 6892, 6893, 6894, 6895}, visible: true, arg3: 50, arg4: 70, arg5: 0f);
        ...
        private class StateBoss_battle_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{6701, 6702, 6703, 6704, 6705, 6706, 6707, 6708, 6709, 6710, 6711, 6712, 6713, 6714, 6715, 6716, 6717, 6718, 6719, 6720, 6721, 6722, 6723, 6724, 6725, 6726, 6727, 6728, 6729, 6730, 6731, 6732, 6733, 6734, 6735, 6736, 6737, 6738, 6739, 6740, 6741, 6742, 6743, 6744, 6745, 6746, 6747, 6748, 6749, 6750, 6751, 6752, 6753, 6754, 6755, 6756, 6757, 6758, 6759, 6760, 6761, 6762, 6763, 6764, 6765, 6766, 6767, 6768, 6769, 6770, 6771, 6772, 6773, 6774, 6775, 6776, 6777, 6778, 6779, 6780, 6781, 6782, 6783, 6784, 6785, 6786, 6787, 6788, 6789, 6790, 6791, 6792, 6793, 6794, 6795, 6796, 6797, 6798, 6799}, visible: false, arg3: 80, arg4: 50, arg5: 0f);
                context.SetEventUI(arg1: 1, script: "$02010052_BF__BOSS__7$", duration: 3000);
            }
        ...
        private class StateClear_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
                context.CameraSelect(triggerId: 80006, enabled: true);
                context.CreateMonster(spawnIds: new []{9998}, arg2: false);
                context.SetEffect(triggerIds: new []{7998}, visible: true);
                context.MoveNpc(spawnId: 9998, patrolName: "MS2PatrolData_1009");
                context.SetConversation(type: 2, spawnId: 21800073, script: "$02010052_BF__BOSS__8$", arg4: 4);
                context.SetTimer(timerId: "5", seconds: 5, autoRemove: true, display: false);
            }
            ...
            public override void OnExit() {
                ...
                context.SetCinematicUI(type: 7);
                context.SetEffect(triggerIds: new []{7998}, visible: true);
                context.DestroyMonster(spawnIds: new []{9998});
                context.CameraSelect(triggerId: 80006, enabled: false);
            }
        }
        ...
        private class StateEnd : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{6890, 6891, 6892, 6893, 6894, 6895}, visible: false, arg3: 80, arg4: 10, arg5: 0f);

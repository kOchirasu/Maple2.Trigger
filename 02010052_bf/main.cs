    ...
    public static class _main {
        ...
        private class StateStart_03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {80010, 80011}, arg2: true);
        ...
        private class StateStart_04 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "$02010052_BF__MAIN__6$", arg3: 3000);
            }
        ...
        private class StateEvent_01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 2, arg2: 21800073, script: "$02010052_BF__MAIN__1$", arg4: 3);
        ...
        private class StateEvent_01_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 2, arg2: 21800073, script: "$02010052_BF__MAIN__2$", arg4: 3);
        ...
        private class StateEvent_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 992, script: "$02010052_BF__MAIN__3$", arg4: 3);
                context.SetTimer(id: "3", arg2: 3);
            }
        ...
        private class StateEvent_02_02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.ShowGuideSummary(entityId: 200, textId: 20105201);
                context.SetConversation(arg1: 1, arg2: 992, script: "$02010052_BF__MAIN__4$", arg4: 3, arg5: 0);
        ...
        private class StateEvent_03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 2, arg2: 21800073, script: "$02010052_BF__MAIN__5$", arg4: 3);

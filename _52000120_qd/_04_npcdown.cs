...
namespace Maple2.Trigger._52000120_qd {
    public static class _04_npcdown {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10001170}, arg2: 2);
                context.DestroyMonster(arg1: new int[] {230});
        ...
        private class StateNpcDown : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {220});
                context.SetInteractObject(arg1: new int[] {10001170}, arg2: 1);
            }
            ...
            public override void Execute() {
                ...
                if (context.ObjectInteracted(arg1: new int[] {10001170}, arg2: 0)) {
        ...
        private class StateNpcWakeUp : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10001170}, arg2: 2);
                context.CreateMonster(arg1: new int[] {230}, arg2: false);
            }
            ...
            public override void Execute() {
                ...
                if (context.NpcDetected(arg1: 9900, arg2: new int[] {220})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {220, 230});
                context.SetInteractObject(arg1: new int[] {10001170}, arg2: 0);
            }

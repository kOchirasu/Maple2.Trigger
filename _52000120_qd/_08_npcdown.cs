    ...
    public static class _08_npcdown {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10001167}, arg2: 2);
                context.DestroyMonster(arg1: new int[] {234});
        ...
        private class StateNpcDown : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10001167}, arg2: 1);
            }
            ...
            public override void Execute() {
                ...
                if (context.ObjectInteracted(arg1: new int[] {10001167}, arg2: 0)) {
        ...
        private class StateNpcWakeUp : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10001167}, arg2: 2);
                context.CreateMonster(arg1: new int[] {234}, arg2: false);
            }
            ...
            public override void Execute() {
                ...
                if (context.NpcDetected(arg1: 9900, arg2: new int[] {224})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {224, 234});
                context.SetInteractObject(arg1: new int[] {10001167}, arg2: 0);
            }

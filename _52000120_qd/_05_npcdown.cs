    ...
    public static class _05_npcdown {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10001169}, arg2: 2);
                context.DestroyMonster(arg1: new int[] {231});
        ...
        private class StateNpcDown : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {221});
                context.SetInteractObject(arg1: new int[] {10001169}, arg2: 1);
            }
            ...
            public override void Execute() {
                ...
                if (context.ObjectInteracted(arg1: new int[] {10001169}, arg2: 0)) {
        ...
        private class StateNpcWakeUp : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10001169}, arg2: 2);
                context.CreateMonster(arg1: new int[] {231}, arg2: false);
            }
            ...
            public override void Execute() {
                ...
                if (context.NpcDetected(arg1: 9900, arg2: new int[] {221})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {221, 231});
                context.SetInteractObject(arg1: new int[] {10001169}, arg2: 0);
            }

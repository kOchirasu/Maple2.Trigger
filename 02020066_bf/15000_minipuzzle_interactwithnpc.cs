    ...
    public static class _15000_minipuzzle_interactwithnpc {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000253, 12000078, 12000093}, state: 2);
        ...
        private class StateInteractWithNpc_Success : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000253}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{12000253}, arg2: 0)) {

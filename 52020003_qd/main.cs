    ...
    public static class _main {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{101, 102, 111, 112, 113, 121, 122, 123, 124, 125, 126});
            }
        ...
        private class StateQuestConditionCheck : TriggerState {
            ...
            public override TriggerState? Execute() {
                ...
                if (context.QuestUserDetected(boxIds: new []{9000}, questIds: new []{50001759}, questStates: new byte[]{3})) {
                    return new State제이든Spawn_완료(context);
                }

                if (context.QuestUserDetected(boxIds: new []{9000}, questIds: new []{50001759}, questStates: new byte[]{2})) {
                    return new State제이든Spawn_완료(context);
                }

                if (context.QuestUserDetected(boxIds: new []{9000}, questIds: new []{50001759}, questStates: new byte[]{1})) {
                    return new State흑성회전투_Wait(context);
                }

                if (context.QuestUserDetected(boxIds: new []{9000}, questIds: new []{50001758}, questStates: new byte[]{3})) {
                    return new StateDefault(context);
                }
        ...
        private class StatePCSpawn : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.MoveUserPath(patrolName: "MS2PatrolData_PC_Walkin_01");
                context.AddBalloonTalk(spawnId: 0, msg: "꽤 넓네, 생각보다…", duration: 2000, delayTick: 0);
        ...
        private class State누군가있다 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.MoveUserPath(patrolName: "MS2PatrolData_PC_Walkin_02");
            }
        ...
        private class State누군가있다_발견 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new []{8001}, returnView: false);
                context.AddBalloonTalk(spawnId: 0, msg: "잠깐… 누가 있나?", duration: 3000, delayTick: 0);
                context.MoveUserPath(patrolName: "MS2PatrolData_PC_Walkin_03");
            }
        ...
        private class State요원Spawn_Prepare : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddBalloonTalk(spawnId: 113, msg: "하하하!", duration: 2000, delayTick: 0);
            }
        ...
        private class StatePC반응02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetPcEmotionLoop(sequenceName: "Emotion_Cinematic_ShakeHead_A", duration: 3000f);
            }
        ...
        private class State요원소환01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.MoveNpc(spawnId: 111, patrolName: "111_blackstars_patrol_00");
                context.AddBalloonTalk(spawnId: 111, msg: "각오해라!", duration: 2000, delayTick: 0);
            }
        ...
        private class State요원소환02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.MoveNpc(spawnId: 112, patrolName: "112_blackstars_patrol_01");
                context.AddBalloonTalk(spawnId: 112, msg: "혼내주마!", duration: 2000, delayTick: 0);
            }
        ...
        private class StateBattleStart01 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{121, 122})) {
        ...
        private class StateBattleStart02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{123, 124}, arg2: true);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{123, 124})) {
        ...
        private class StateBattleStart03 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{125, 126}, arg2: true);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{125, 126})) {
        ...
        private class State제이든_Spawn_Wait : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{111, 112, 113, 121, 122, 123, 124, 125, 126});
        ...
        private class State제이든Script02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new []{8021, 8022}, returnView: false);
                context.AddCinematicTalk(npcId: 11003541, script: "무슨 일 있었어?", duration: 3000, align: Align.Left);
                context.MoveNpc(spawnId: 101, patrolName: "101_MS2PatrolData_Jaiden_Walkin");
                context.SetSceneSkip();
            }
        ...
        private class StateStopCinematic : TriggerState {
            ...
            public override void OnEnter() {
                context.SetAchievement(triggerId: 9000, type: "trigger", code: "BlackStarAttack01");
                context.CameraReset(interpolationTime: 2.0f);
                context.SetCinematicUI(type: 0);
                context.SetCinematicUI(type: 2);
            }
        ...
        private class State제이든Spawn_완료 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{101, 111, 112, 113, 121, 122, 123, 124, 125, 126});
                context.CreateMonster(spawnIds: new []{102}, arg2: false);
            }

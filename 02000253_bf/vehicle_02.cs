    ...
    public static class _vehicle_02 {
        public class StateIdle : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{8052}, visible: false);
            }
        ...
        private class StateMonster_spawn : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{8052}, visible: true);
                context.CreateMonster(spawnIds: new []{3004}, arg2: true);
            }
        ...
        private class StateEnd : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001053}, state: 2);
            }

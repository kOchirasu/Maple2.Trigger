    ...
    public static class _cannon_02 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {692}, arg2: false);
                context.SetEffect(arg1: new int[] {792}, arg2: false);
                context.SetMesh(arg1: new int[] {3903}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
            }

            public override void Execute() {
                if (context.UserValue(key: "cannon02", value: 1)) {
        ...
        private class State생성 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {2902}, arg2: true);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {2902})) {
                    context.SetEffect(arg1: new int[] {692}, arg2: true);
                    context.SetMesh(arg1: new int[] {3902}, arg2: false, arg3: 0, arg4: 0, arg5: 5f);
        ...
        private class State보스전_대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "Bosscannon02", value: 1)) {
        ...
        private class State보스전용_생성 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {692}, arg2: false);
                context.SetEffect(arg1: new int[] {792}, arg2: true);
                context.SetMesh(arg1: new int[] {3902}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.CreateMonster(arg1: new int[] {2902}, arg2: true);
                context.AddBuff(arg1: new int[] {2099}, arg2: 70002071, arg3: 1, arg4: true, arg5: false);
                context.AddBuff(arg1: new int[] {2902}, arg2: 40444001, arg3: 1, arg4: true, arg5: false);
            }
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {2902})) {
                    ...
                    context.SetEffect(arg1: new int[] {792}, arg2: false);
                    context.SetMesh(arg1: new int[] {3902}, arg2: false, arg3: 0, arg4: 0, arg5: 5f);
                    context.AddBuff(arg1: new int[] {2099}, arg2: 70002072, arg3: 1, arg4: true, arg5: false);

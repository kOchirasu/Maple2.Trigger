    ...
    public static class _cannon_04 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new int[] {794}, arg2: false);
        ...
        private class State보스전_대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "Bosscannon04", value: 1)) {
        ...
        private class State보스전용_생성 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {694}, arg2: false);
                context.SetEffect(arg1: new int[] {794}, arg2: true);
                context.SetMesh(arg1: new int[] {3904}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.CreateMonster(arg1: new int[] {2904}, arg2: true);
                context.AddBuff(arg1: new int[] {2099}, arg2: 70002091, arg3: 1, arg4: true, arg5: false);
            }
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {2904})) {
                    ...
                    context.SetEffect(arg1: new int[] {794}, arg2: false);
                    context.SetMesh(arg1: new int[] {3904}, arg2: false, arg3: 0, arg4: 0, arg5: 5f);
                    context.AddBuff(arg1: new int[] {2099}, arg2: 70002092, arg3: 1, arg4: true, arg5: false);
                    context.AddBuff(arg1: new int[] {2904}, arg2: 40444001, arg3: 1, arg4: true, arg5: false);
        ...
        private class State종료 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new int[] {794}, arg2: false);
                context.SetMesh(arg1: new int[] {3904}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.DestroyMonster(arg1: new int[] {2904});
            }

    ...
    public static class _bush_04 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 1001004, arg2: 1, arg3: "Equal")) {
        ...
        private class State버프발동 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBuff(arg1: new int[] {1001004}, arg2: 70000075, arg3: 1, arg4: false, arg5: false);
            }
            ...
            public override void Execute() {
                ...
                if (context.CountUsers(arg1: 1001004, arg2: 1, arg3: "Greater")) {
                    context.State = new State대기(context);
                    return;
                }

                if (!context.UserDetected(arg1: new int[] {1001004})) {
                    context.State = new State대기(context);
                    return;
                }
            }

    ...
    public static class _invasion_portal {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10002184}, arg2: 2, arg3: false);
            }
        ...
        private class State포탈열림 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10002184}, arg2: 1, arg3: false);
            }
            ...
            public override void Execute() {
                ...
                if (context.ObjectInteracted(arg1: new int[] {10002184}, arg2: 2)) {
        ...
        private class State유저이동 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.DungeonVariable(varID: 1000, value: true)) {

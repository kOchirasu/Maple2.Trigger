    ...
    public static class _52010055 {
        public class State준비 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new[] {502}, arg2: false);
        ...
        private class State시작 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new[] {30000}, arg2: true);
                context.SetMesh(arg1: new[] {30001}, arg2: true);
                context.SetMesh(arg1: new[] {30002}, arg2: true);
                context.SetProductionUI(arg1: 1);
                context.SetProductionUI(arg1: 3);
                context.CreateMonster(arg1: new[] {1}, arg2: false);
                context.CreateMonster(arg1: new[] {2}, arg2: false);
                context.CreateMonster(arg1: new[] {3}, arg2: false);
                context.CreateMonster(arg1: new[] {4}, arg2: false);
                context.CreateMonster(arg1: new[] {5}, arg2: false);
        ...
        private class State3차크림슨스폰 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new[] {212}, arg2: false);
            }
        ...
        private class State4차크림슨스폰 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new[] {215}, arg2: false);
                context.CreateMonster(arg1: new[] {216}, arg2: false);
            }
        ...
        private class State보스전끝크림슨발록대사1 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new[] {1}, arg2: false);
                context.CreateMonster(arg1: new[] {2}, arg2: false);
                context.CreateMonster(arg1: new[] {13}, arg2: false);
                context.CreateMonster(arg1: new[] {14}, arg2: false);
                context.CreateMonster(arg1: new[] {15}, arg2: false);
        ...
        private class State엔딩연출콘대르2 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new[] {5000}, arg2: true);
                context.SetEffect(arg1: new[] {502}, arg2: true);
        ...
        private class State엔딩연출준비1 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(arg1: new[] {13});
                context.DestroyMonster(arg1: new[] {14});
                context.DestroyMonster(arg1: new[] {15});
                context.MoveUser(arg1: 52010055, arg2: 5);
            }
        ...
        private class State크림슨대사준비1 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new[] {705}, arg2: false);
                context.CreateMonster(arg1: new[] {706}, arg2: false);
                context.CreateMonster(arg1: new[] {707}, arg2: false);
                context.VisibleMyPc(isVisible: false);
        ...
        private class State엔딩대사메이슨1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {10000}, arg2: false);
                context.SetMesh(arg1: new[] {10001}, arg2: false);
                context.SetMesh(arg1: new[] {10002}, arg2: false);
                context.SetMesh(arg1: new[] {10003}, arg2: false);
                context.SetMesh(arg1: new[] {10004}, arg2: false);

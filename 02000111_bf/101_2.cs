    ...
    public static class _101_2 {
        public class StateWaitStart1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000165}, state: 1);
                context.SetMesh(triggerIds: new []{302}, visible: false);
                context.SetEffect(triggerIds: new []{402}, visible: false);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000165}, arg2: 0)) {
        ...
        private class State열기1 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 202, spawnIds: new []{103})) {
                    return new State아이템1(context);
                }

                if (context.NpcDetected(boxId: 202, spawnIds: new []{104})) {
                    return new State아이템2(context);
                }

                if (context.NpcDetected(boxId: 202, spawnIds: new []{105})) {
        ...
        private class State아이템1 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateItem(spawnIds: new []{502}, triggerId: 0, itemId: 10000165);
                context.SetMesh(triggerIds: new []{302}, visible: false);
                context.SetInteractObject(interactIds: new []{10000165}, state: 1);
                context.SetEffect(triggerIds: new []{402}, visible: true);

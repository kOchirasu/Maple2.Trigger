    ...
    public static class _brick_06 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{34006}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetSkill(triggerIds: new []{7006}, enabled: false);
            }
        ...
        private class StateSetup : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 200)) {
                    context.SetMesh(triggerIds: new []{34006}, visible: false, arg3: 0, arg4: 0, arg5: 0f);

namespace Maple2.Trigger._02010054_bf {
    public static class _brick_03 {
        public class StateWait : TriggerState {
            internal StateWait(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{34003}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
        ...
        private class StateSetup : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 200)) {
                    context.SetMesh(triggerIds: new []{34003}, visible: false, arg3: 0, arg4: 0, arg5: 0f);

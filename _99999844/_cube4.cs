namespace Maple2.Trigger._99999844 {
    public static class _cube4 {
        public class State대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.GetUserValue(key: "Cube") == 1) {
                    context.State = new State큐브4(context);
                    return;
                }
            }
        ...
        private class State큐브4 : TriggerState {
            internal State큐브4(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetMesh(arg1: new[] {4006, 4007}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new[] {5006, 5007}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.SetUserValue(triggerId: 920004, key: "CubeOff", value: 1);
        ...
        private class State큐브제거 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {4006, 4007}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new[] {5006, 5007}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }
            ...
            public override void Execute() {
                ...
                if (context.UserDetected(arg1: new[] {9004})) {
                    context.SetUserValue(triggerId: 910004, key: "Cube", value: 0);

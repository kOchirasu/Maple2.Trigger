...
namespace Maple2.Trigger._99999844 {
    public static class _cube20 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "Cube", value: 1)) {
                    context.State = new State큐브20(context);
                    return;
                }
            }
        ...
        private class State큐브20 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {4038, 4039, 4040}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {5038, 5039, 5040}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State큐브제거 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {4038, 4039, 4040}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {5038, 5039, 5040}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }

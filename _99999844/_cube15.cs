...
namespace Maple2.Trigger._99999844 {
    public static class _cube15 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "Cube", value: 1)) {
                    context.State = new State큐브15(context);
                    return;
                }
            }
        ...
        private class State큐브15 : TriggerState {
            internal State큐브15(ITriggerContext context) : base(context) { }
        ...
        private class State큐브제거 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.UserDetected(arg1: new int[] {9004})) {
                    context.SetUserValue(triggerID: 910015, key: "Cube", value: 0);

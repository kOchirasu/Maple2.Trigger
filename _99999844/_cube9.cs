...
namespace Maple2.Trigger._99999844 {
    public static class _cube9 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "Cube", value: 1)) {
                    context.State = new State큐브9(context);
                    return;
                }
            }
        ...
        private class State큐브9 : TriggerState {
            internal State큐브9(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {4014, 4015, 4016, 4017}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {5014, 5015, 5016, 5017}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.SetUserValue(triggerID: 920009, key: "CubeOff", value: 1);
        ...
        private class State큐브제거 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {4014, 4015, 4016, 4017}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {5014, 5015, 5016, 5017}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }
            ...
            public override void Execute() {
                ...
                if (context.UserDetected(arg1: "9004")) {
                    context.SetUserValue(triggerID: 910009, key: "Cube", value: 0);

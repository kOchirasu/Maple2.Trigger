namespace Maple2.Trigger._02020027_bf {
    public static class _stun_3 {
        ...
        private class StateBattleStart : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetUserValue(key: "summon_3_3") == 1) {
        ...
        private class StateBuff_2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 401, script: "$02020027_BF__stun_1__0$", arg4: 3, arg5: 0);
                context.SetConversation(type: 1, spawnId: 402, script: "$02020027_BF__stun_1__1$", arg4: 3, arg5: 0);
            }
        ...
        private class StateBuff_4 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 403, script: "$02020027_BF__stun_1__2$", arg4: 3, arg5: 0);
                context.SetConversation(type: 1, spawnId: 404, script: "$02020027_BF__stun_1__3$", arg4: 3, arg5: 0);
            }
        ...
        private class StateBuff_5 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 405, script: "$02020027_BF__stun_1__4$", arg4: 3, arg5: 0);
                context.SetConversation(type: 1, spawnId: 406, script: "$02020027_BF__stun_1__5$", arg4: 3, arg5: 0);
            }

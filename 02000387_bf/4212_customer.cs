namespace Maple2.Trigger._02000387_bf {
    public static class _4212_customer {
        ...
        private class StatePatrol01 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 4212, arg2: "MS2PatrolData_401");
            }
        ...
        private class StatePatrol02 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 4212, arg2: "MS2PatrolData_402");
            }
        ...
        private class StatePatrol03 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 4212, arg2: "MS2PatrolData_403");
            }
        ...
        private class StatePickItem_30000675 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointId: 4212, nifPath: @"Map/Royalcity/Indoor/ry_in_prop_sewingmachine_A01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateRightItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 4212, script: "$02000387_BF__4212_CUSTOMER__0$", arg4: 3, arg5: 0);
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 4212, arg2: "MS2PatrolData_444");
            }
        ...
        private class StateWrongItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnPointId: 4212);
                context.SetConversation(arg1: 1, arg2: 4212, script: "$02000387_BF__4212_CUSTOMER__1$", arg4: 3, arg5: 0);
            }

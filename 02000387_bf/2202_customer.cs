namespace Maple2.Trigger._02000387_bf {
    public static class _2202_customer {
        ...
        private class StatePatrol01 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 2202, arg2: "MS2PatrolData_201");
            }
        ...
        private class StatePatrol02 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 2202, arg2: "MS2PatrolData_202");
            }
        ...
        private class StatePatrol03 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 2202, arg2: "MS2PatrolData_203");
            }
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.NpcDetected(arg1: 9123, arg2: new[] {2202})) {
        ...
        private class StatePickItem_30000694 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointId: 2202, nifPath: @"Map/Kerningcity/Indoor/ke_in_prop_catower_A01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateDetectItem_30000694 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.DetectLiftableObject(triggerBoxIds: new[] {9202}, itemId: 30000694)) {
        ...
        private class StateRightItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnPointId: 2202);
                context.SetConversation(arg1: 1, arg2: 2202, script: "$02000387_BF__2202_CUSTOMER__0$", arg4: 3, arg5: 0);
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 2202, arg2: "MS2PatrolData_222");
            }

            public override TriggerState Execute() {
                if (context.NpcDetected(arg1: 9302, arg2: new[] {2202})) {
        ...
        private class StateWrongItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnPointId: 2202);
                context.SetConversation(arg1: 1, arg2: 2202, script: "$02000387_BF__2202_CUSTOMER__1$", arg4: 3, arg5: 0);
            }

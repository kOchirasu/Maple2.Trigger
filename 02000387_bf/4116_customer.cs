namespace Maple2.Trigger._02000387_bf {
    public static class _4116_customer {
        ...
        private class StateCustomerEnter : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new[] {4116}, arg2: false);
            }
        ...
        private class StatePatrol01 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 4116, arg2: "MS2PatrolData_401");
            }
        ...
        private class StatePatrol02 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 4116, arg2: "MS2PatrolData_402");
            }
        ...
        private class StatePatrol03 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 4116, arg2: "MS2PatrolData_403");
            }
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.NpcDetected(arg1: 9143, arg2: new[] {4116})) {
        ...
        private class StateDetectItem_30000639 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.DetectLiftableObject(triggerBoxIds: new[] {9204}, itemId: 30000639)) {
        ...
        private class StateDetectItem_30000640 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.DetectLiftableObject(triggerBoxIds: new[] {9204}, itemId: 30000640)) {
                    return new StateRightItem(context);
                }
        ...
        private class StateDetectItem_30000703 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.DetectLiftableObject(triggerBoxIds: new[] {9204}, itemId: 30000703)) {
                    return new StateRightItem(context);
                }
        ...
        private class StateDetectItem_30000704 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.DetectLiftableObject(triggerBoxIds: new[] {9204}, itemId: 30000704)) {
                    return new StateRightItem(context);
                }
        ...
        private class StateDetectItem_30000705 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.DetectLiftableObject(triggerBoxIds: new[] {9204}, itemId: 30000705)) {
                    return new StateRightItem(context);
                }
        ...
        private class StateDetectItem_30000715 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.DetectLiftableObject(triggerBoxIds: new[] {9204}, itemId: 30000715)) {
                    return new StateRightItem(context);
                }
        ...
        private class StateRightItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnPointId: 4116);
                context.SetConversation(arg1: 1, arg2: 4116, script: "$02000387_BF__4116_CUSTOMER__0$", arg4: 3, arg5: 0);
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 4116, arg2: "MS2PatrolData_444");
            }

            public override TriggerState Execute() {
                if (context.NpcDetected(arg1: 9304, arg2: new[] {4116})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new[] {4116});
            }
        ...
        private class StateWrongItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnPointId: 4116);
                context.SetConversation(arg1: 1, arg2: 4116, script: "$02000387_BF__4116_CUSTOMER__1$", arg4: 3, arg5: 0);
            }

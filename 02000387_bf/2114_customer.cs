namespace Maple2.Trigger._02000387_bf {
    public static class _2114_customer {
        ...
        private class StateCustomerEnter : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{2114}, arg2: false);
            }
        ...
        private class StatePatrol01 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 2114, patrolName: "MS2PatrolData_201");
            }
        ...
        private class StatePatrol02 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 2114, patrolName: "MS2PatrolData_202");
            }
        ...
        private class StatePatrol03 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 2114, patrolName: "MS2PatrolData_203");
            }
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 9123, spawnIds: new []{2114})) {
        ...
        private class StatePickItem_30000655 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnId: 2114, nifPath: @"Map/Royalcity/Indoor/ry_in_prop_amp_A01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateDetectItem_30000655 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.DetectLiftableObject(boxIds: new []{9202}, itemId: 30000655)) {
        ...
        private class StatePickItem_30000708 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnId: 2114, nifPath: @"Effect/BG/Liftup/co_liftup_piano_B01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateDetectItem_30000708 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.DetectLiftableObject(boxIds: new []{9202}, itemId: 30000708)) {
                    return new StateRightItem(context);
                }
        ...
        private class StatePickItem_30000709 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnId: 2114, nifPath: @"Effect/BG/Liftup/co_liftup_vibraphone_A01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateDetectItem_30000709 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.DetectLiftableObject(boxIds: new []{9202}, itemId: 30000709)) {
                    return new StateRightItem(context);
                }
        ...
        private class StateRightItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnId: 2114);
                context.SetConversation(type: 1, spawnId: 2114, script: "$02000387_BF__2114_CUSTOMER__0$", arg4: 3, arg5: 0);
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 2114, patrolName: "MS2PatrolData_222");
            }

            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 9302, spawnIds: new []{2114})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{2114});
            }
        ...
        private class StateWrongItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnId: 2114);
                context.SetConversation(type: 1, spawnId: 2114, script: "$02000387_BF__2114_CUSTOMER__1$", arg4: 3, arg5: 0);
            }

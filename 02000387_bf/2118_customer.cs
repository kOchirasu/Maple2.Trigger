namespace Maple2.Trigger._02000387_bf {
    public static class _2118_customer {
        ...
        private class StateCustomerEnter : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{2118}, arg2: false);
            }
        ...
        private class StatePatrol01 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 2118, patrolName: "MS2PatrolData_201");
            }
        ...
        private class StatePatrol02 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 2118, patrolName: "MS2PatrolData_202");
            }
        ...
        private class StatePatrol03 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 2118, patrolName: "MS2PatrolData_203");
            }
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 9123, spawnIds: new []{2118})) {
        ...
        private class StatePickItem_30000647 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnId: 2118, nifPath: @"Map/UGC/Indoor/ugc_in_funct_alchemy_B01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateDetectItem_30000647 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.DetectLiftableObject(boxIds: new []{9202}, itemId: 30000647)) {
        ...
        private class StatePickItem_30000648 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnId: 2118, nifPath: @"Map/UGC/Indoor/ugc_in_funct_alchemy_A01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateDetectItem_30000648 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.DetectLiftableObject(boxIds: new []{9202}, itemId: 30000648)) {
                    return new StateRightItem(context);
                }
        ...
        private class StatePickItem_30000657 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnId: 2118, nifPath: @"Map/Iceland/Indoor/ic_in_prop_bed_B01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateDetectItem_30000657 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.DetectLiftableObject(boxIds: new []{9202}, itemId: 30000657)) {
                    return new StateRightItem(context);
                }
        ...
        private class StatePickItem_30000661 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnId: 2118, nifPath: @"Map/Royalcity/Indoor/ry_in_cubric_fishtank_A01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateDetectItem_30000661 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.DetectLiftableObject(boxIds: new []{9202}, itemId: 30000661)) {
                    return new StateRightItem(context);
                }
        ...
        private class StatePickItem_30000690 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnId: 2118, nifPath: @"Map/Tria/Indoor/tr_in_prop_sofa_D01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateDetectItem_30000690 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.DetectLiftableObject(boxIds: new []{9202}, itemId: 30000690)) {
                    return new StateRightItem(context);
                }
        ...
        private class StatePickItem_30000713 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnId: 2118, nifPath: @"Map/Steampunk/Indoor/sp_in_prop_desk_A01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateDetectItem_30000713 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.DetectLiftableObject(boxIds: new []{9202}, itemId: 30000713)) {
                    return new StateRightItem(context);
                }
        ...
        private class StatePickItem_30000714 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnId: 2118, nifPath: @"Map/SF/Field/sf_fi_prop_incubator_D01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateDetectItem_30000714 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.DetectLiftableObject(boxIds: new []{9202}, itemId: 30000714)) {
                    return new StateRightItem(context);
                }
        ...
        private class StateRightItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnId: 2118);
                context.SetConversation(type: 1, spawnId: 2118, script: "$02000387_BF__2118_CUSTOMER__0$", arg4: 3, arg5: 0);
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 2118, patrolName: "MS2PatrolData_222");
            }

            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 9302, spawnIds: new []{2118})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{2118});
            }
        ...
        private class StateWrongItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnId: 2118);
                context.SetConversation(type: 1, spawnId: 2118, script: "$02000387_BF__2118_CUSTOMER__1$", arg4: 3, arg5: 0);
            }

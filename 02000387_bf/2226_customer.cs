namespace Maple2.Trigger._02000387_bf {
    public static class _2226_customer {
        ...
        private class StateCustomerEnter : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new[] {2226}, arg2: false);
            }
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.NpcDetected(arg1: 9123, arg2: new[] {2226})) {
        ...
        private class StatePickItem_30000687 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointId: 2226, nifPath: @"Map/Kerningcity/Indoor/ke_in_prop_beanbag_A02.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateDetectItem_30000687 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.DetectLiftableObject(triggerBoxIds: new[] {9202}, itemId: 30000687)) {
        ...
        private class StateRightItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 2226, script: "$02000387_BF__2226_CUSTOMER__0$", arg4: 3, arg5: 0);
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.NpcDetected(arg1: 9302, arg2: new[] {2226})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new[] {2226});
            }
        ...
        private class StateWrongItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnPointId: 2226);
                context.SetConversation(arg1: 1, arg2: 2226, script: "$02000387_BF__2226_CUSTOMER__1$", arg4: 3, arg5: 0);
            }

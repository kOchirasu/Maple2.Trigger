namespace Maple2.Trigger._02000387_bf {
    public static class _4120_customer {
        ...
        private class StateCustomerEnter : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new[] {4120}, arg2: false);
            }
        ...
        private class StatePatrol01 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 4120, arg2: "MS2PatrolData_401");
            }
        ...
        private class StatePatrol02 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 4120, arg2: "MS2PatrolData_402");
            }
        ...
        private class StatePatrol03 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 4120, arg2: "MS2PatrolData_403");
            }
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.NpcDetected(arg1: 9143, arg2: new[] {4120})) {
        ...
        private class StatePickItem_30000635 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointId: 4120, nifPath: @"Map/Kerningcity/Indoor/ke_in_prop_tv_C01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StatePickItem_30000649 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointId: 4120, nifPath: @"Map/Tria/Indoor/tr_in_prop_mirror_A01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StatePickItem_30000655 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointId: 4120, nifPath: @"Map/Royalcity/Indoor/ry_in_prop_amp_A01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateDetectItem_30000655 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.DetectLiftableObject(triggerBoxIds: new[] {9204}, itemId: 30000655)) {
                    return new StateRightItem(context);
                }
        ...
        private class StatePickItem_30000701 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointId: 4120, nifPath: @"Map/Common/Indoor/co_in_prop_security_A01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StatePickItem_30000708 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointId: 4120, nifPath: @"Effect/BG/Liftup/co_liftup_piano_B01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateDetectItem_30000708 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.DetectLiftableObject(triggerBoxIds: new[] {9204}, itemId: 30000708)) {
                    return new StateRightItem(context);
                }
        ...
        private class StateRightItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnPointId: 4120);
                context.SetConversation(arg1: 1, arg2: 4120, script: "$02000387_BF__4120_CUSTOMER__0$", arg4: 3, arg5: 0);
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 4120, arg2: "MS2PatrolData_444");
            }

            public override TriggerState Execute() {
                if (context.NpcDetected(arg1: 9304, arg2: new[] {4120})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new[] {4120});
            }
        ...
        private class StateWrongItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnPointId: 4120);
                context.SetConversation(arg1: 1, arg2: 4120, script: "$02000387_BF__4120_CUSTOMER__1$", arg4: 3, arg5: 0);
            }

namespace Maple2.Trigger._02000387_bf {
    public static class _4112_customer {
        ...
        private class StateCustomerEnter : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{4112}, arg2: false);
            }
        ...
        private class StatePatrol01 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 4112, patrolName: "MS2PatrolData_401");
            }
        ...
        private class StatePatrol02 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 4112, patrolName: "MS2PatrolData_402");
            }
        ...
        private class StatePatrol03 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 4112, patrolName: "MS2PatrolData_403");
            }
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 9143, spawnIds: new []{4112})) {
        ...
        private class StatePickItem_30000649 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnId: 4112, nifPath: @"Map/Tria/Indoor/tr_in_prop_mirror_A01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StatePickItem_30000657 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnId: 4112, nifPath: @"Map/Iceland/Indoor/ic_in_prop_bed_B01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateDetectItem_30000657 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.DetectLiftableObject(boxIds: new []{9204}, itemId: 30000657)) {
                    return new StateRightItem(context);
                }
        ...
        private class StatePickItem_30000697 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnId: 4112, nifPath: @"Npc/Etc/UGC_Poclain/UGC_Poclain_01.nif", isOutline: true, scale: 1.2f, rotateZ: 315);
            }
        ...
        private class StateDetectItem_30000697 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.DetectLiftableObject(boxIds: new []{9204}, itemId: 30000697)) {
                    return new StateRightItem(context);
                }
        ...
        private class StatePickItem_30000698 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnId: 4112, nifPath: @"Npc/Etc/UGC_FlameBike_Npc/UGC_FlameBike_03.nif", isOutline: true, scale: 1.2f, rotateZ: 315);
            }
        ...
        private class StateDetectItem_30000698 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.DetectLiftableObject(boxIds: new []{9204}, itemId: 30000698)) {
                    return new StateRightItem(context);
                }
        ...
        private class StatePickItem_30000701 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnId: 4112, nifPath: @"Map/Common/Indoor/co_in_prop_security_A01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StatePickItem_30000716 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnId: 4112, nifPath: @"Map/Kerningcity/Field/ke_fi_prop_tire_A02.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateDetectItem_30000716 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.DetectLiftableObject(boxIds: new []{9204}, itemId: 30000716)) {
                    return new StateRightItem(context);
                }
        ...
        private class StateRightItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnId: 4112);
                context.SetConversation(type: 1, spawnId: 4112, script: "$02000387_BF__4112_CUSTOMER__0$", arg4: 3, arg5: 0);
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 4112, patrolName: "MS2PatrolData_444");
            }

            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 9304, spawnIds: new []{4112})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{4112});
            }
        ...
        private class StateWrongItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnId: 4112);
                context.SetConversation(type: 1, spawnId: 4112, script: "$02000387_BF__4112_CUSTOMER__1$", arg4: 3, arg5: 0);
            }

namespace Maple2.Trigger._02000387_bf {
    public static class _3219_customer {
        ...
        private class StateCustomerEnter : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new[] {3219}, arg2: false);
            }
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.NpcDetected(arg1: 9133, arg2: new[] {3219})) {
        ...
        private class StatePickItem_30000673 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointId: 3219, nifPath: @"Map/Royalcity/Indoor/ry_in_prop_pooltable_A01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateRightItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 3219, script: "$02000387_BF__3219_CUSTOMER__0$", arg4: 3, arg5: 0);
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.NpcDetected(arg1: 9303, arg2: new[] {3219})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new[] {3219});
            }
        ...
        private class StateWrongItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnPointId: 3219);
                context.SetConversation(arg1: 1, arg2: 3219, script: "$02000387_BF__3219_CUSTOMER__1$", arg4: 3, arg5: 0);
            }

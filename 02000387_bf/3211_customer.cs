namespace Maple2.Trigger._02000387_bf {
    public static class _3211_customer {
        ...
        private class StateCustomerEnter : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{3211}, arg2: false);
            }
        ...
        private class StatePatrol01 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 3211, patrolName: "MS2PatrolData_301");
            }
        ...
        private class StatePatrol02 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 3211, patrolName: "MS2PatrolData_302");
            }
        ...
        private class StatePatrol03 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 3211, patrolName: "MS2PatrolData_303");
            }
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 9133, spawnIds: new []{3211})) {
        ...
        private class StatePickItem_30000620 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnId: 3211, nifPath: @"Map/Henesys/Indoor/he_in_prop_fireplace_A01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateDetectItem_30000620 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.DetectLiftableObject(boxIds: new []{9203}, itemId: 30000620)) {
        ...
        private class StateRightItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnId: 3211);
                context.SetConversation(type: 1, spawnId: 3211, script: "$02000387_BF__3211_CUSTOMER__0$", arg4: 3, arg5: 0);
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 3211, patrolName: "MS2PatrolData_333");
            }

            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 9303, spawnIds: new []{3211})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{3211});
            }
        ...
        private class StateWrongItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnId: 3211);
                context.SetConversation(type: 1, spawnId: 3211, script: "$02000387_BF__3211_CUSTOMER__1$", arg4: 3, arg5: 0);
            }

namespace Maple2.Trigger._02000387_bf {
    public static class _1221_customer {
        public class StateWait : TriggerState {
            internal StateWait(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001088}, state: 0);
        ...
        private class StateCustomerEnter : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{1221}, arg2: false);
            }
        ...
        private class StatePatrol01 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 1221, patrolName: "MS2PatrolData_101");
            }
        ...
        private class StatePatrol02 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 1221, patrolName: "MS2PatrolData_102");
            }
        ...
        private class StatePatrol03 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 1221, patrolName: "MS2PatrolData_103");
            }
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 9113, spawnIds: new []{1221})) {
        ...
        private class StateWaitGreeting : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001088}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001088}, arg2: 0)) {
            ...
            public override void OnExit() {
                context.SetInteractObject(interactIds: new []{10001088}, state: 2);
            }
        }
        ...
        private class StatePickItem_30000621 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnId: 1221, nifPath: @"Map/Royalcity/Indoor/ry_in_prop_sandbag_A01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateDetectItem_30000621 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.DetectLiftableObject(boxIds: new []{9201}, itemId: 30000621)) {
        ...
        private class StateRightItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnId: 1221);
                context.SetConversation(type: 1, spawnId: 1221, script: "$02000387_BF__1221_CUSTOMER__0$", arg4: 3, arg5: 0);
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 1221, patrolName: "MS2PatrolData_111");
            }

            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 9301, spawnIds: new []{1221})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{1221});
            }
        ...
        private class StateWrongItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnId: 1221);
                context.SetConversation(type: 1, spawnId: 1221, script: "$02000387_BF__1221_CUSTOMER__1$", arg4: 3, arg5: 0);
            }

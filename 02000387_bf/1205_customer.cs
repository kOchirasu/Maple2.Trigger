namespace Maple2.Trigger._02000387_bf {
    public static class _1205_customer {
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.NpcDetected(arg1: 9113, arg2: new[] {1205})) {
        ...
        private class StatePickItem_30000655 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointId: 1205, nifPath: @"Map/Royalcity/Indoor/ry_in_prop_amp_A01.nif", isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateDetectItem_30000655 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.DetectLiftableObject(triggerBoxIds: new[] {9201}, itemId: 30000655)) {
        ...
        private class StateRightItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 1205, script: "$02000387_BF__1205_CUSTOMER__0$", arg4: 3, arg5: 0);
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.NpcDetected(arg1: 9301, arg2: new[] {1205})) {
        ...
        private class StateWrongItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnPointId: 1205);
                context.SetConversation(arg1: 1, arg2: 1205, script: "$02000387_BF__1205_CUSTOMER__1$", arg4: 3, arg5: 0);
            }

namespace Maple2.Trigger._52000045_qd {
    public static class _main_03 {
        ...
        private class State자베스Script01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 2, spawnId: 11001546, script: "$52000045_QD__MAIN_03__0$", arg4: 3);
        ...
        private class State브라보Script01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 2, spawnId: 11001545, script: "$52000045_QD__MAIN_03__1$", arg4: 3);
        ...
        private class State제이시Script01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 2, spawnId: 11000515, script: "$52000045_QD__MAIN_03__2$", arg4: 5);

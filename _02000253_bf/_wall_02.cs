    ...
    public static class _wall_02 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {503, 504}, arg2: true);
                context.SetMesh(arg1: new int[] {604, 605, 606}, arg2: true);
                context.SetInteractObject(arg1: new int[] {10000438}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000438}, arg2: 0)) {
        ...
        private class State열기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {503, 504}, arg2: false);
                context.SetMesh(arg1: new int[] {604, 605, 606}, arg2: false);
            }

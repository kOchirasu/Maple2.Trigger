    ...
    public static class _move {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new int[] {8041}, arg2: false);
                context.SetEffect(arg1: new int[] {8042}, arg2: false);
                context.SetEffect(arg1: new int[] {8043}, arg2: false);
                context.SetEffect(arg1: new int[] {8044}, arg2: false);
                ...
                context.SetInteractObject(arg1: new int[] {10001053}, arg2: 2);
            }
        ...
        private class State1번 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new int[] {8041}, arg2: true);
                context.SetBreakable(
                    arg1: new int[]
        ...
        private class State11번 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {3001});
            }
        ...
        private class State2번 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {8042}, arg2: true);
                context.PlaySystemSoundInBox(arg2: "System_ShowGuideSummary_01");
                context.ShowGuideSummary(entityID: 20002523, textID: 20002523);
                context.SetTimer(arg1: "1", arg2: 10);
                context.SetBreakable(
        ...
        private class State21번 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {8042}, arg2: false);
                context.SetTimer(arg1: "1", arg2: 30, arg3: false);
                context.CreateMonster(arg1: new int[] {3002});
            }
        ...
        private class State3번 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {8044}, arg2: true);
                context.PlaySystemSoundInBox(arg2: "System_ShowGuideSummary_01");
                context.ShowGuideSummary(entityID: 20002523, textID: 20002523);
                context.SetTimer(arg1: "1", arg2: 10);
                context.SetBreakable(
        ...
        private class State31번 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {8044}, arg2: false);
                context.SetTimer(arg1: "1", arg2: 30, arg3: false);
                context.CreateMonster(arg1: new int[] {3003});
            }
        ...
        private class State4번 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {8043}, arg2: true);
                context.PlaySystemSoundInBox(arg2: "System_ShowGuideSummary_01");
                context.ShowGuideSummary(entityID: 20002523, textID: 20002523);
                context.SetTimer(arg1: "1", arg2: 10);
                context.SetBreakable(
        ...
        private class State41번 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {8043}, arg2: false);
                context.SetTimer(arg1: "1", arg2: 30, arg3: false);
                context.CreateMonster(arg1: new int[] {3004});
            }
        ...
        private class State42번 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(arg1: "1", arg2: 30, arg3: false);
                context.SetInteractObject(arg1: new int[] {10001053}, arg2: 1);
            }

    ...
    public static class _52000177 {
        ...
        private class State영상재생_end : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetCinematicUI(arg1: 9, arg2: "$52000177_QD__52000177__0$", arg3: false);
                context.SetOnetimeEffect(id: 1, enable: true, path: @"BG/Common/ScreenMask/Eff_CameraMasking_FastFadeIn.xml");
            }
        ...
        private class StateQuit02 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.QuestUserDetected(arg1: new[] {9001}, arg2: new[] {20002364}, arg3: new byte[] {3})) {
        ...
        private class State전원Exit03 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.QuestUserDetected(arg1: new[] {9001}, arg2: new[] {20002368}, arg3: new byte[] {3})) {

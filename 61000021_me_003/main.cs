...
namespace Maple2.Trigger._61000021_me_003 {
    public static class _main {
        ...
        private class State문제표시 : TriggerState {
            ...
            public override void OnEnter() {
                context.StartMiniGame(boxId: 105, round: 10, type: MiniGame.OXQuizUgc);
                context.WidgetAction(type: WidgetType.OxQuizUGC, name: "PeekQuiz");
        ...
        private class State문제정리 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.WidgetAction(type: WidgetType.OxQuizUGC, name: "CleanUpQuiz");
            }
        ...
        private class StateEnd : TriggerState {
            ...
            public override void OnEnter() {
                context.EndMiniGame(winnerBoxId: 105, type: MiniGame.OXQuizUgc);

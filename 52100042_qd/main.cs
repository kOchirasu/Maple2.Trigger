namespace Maple2.Trigger._52100042_qd {
    public static class _main {
        ...
        private class StateQuest_end : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 510, script: "$52100042_QD__MAIN__0$", arg4: 2, arg5: 0);
                context.SetConversation(type: 1, spawnId: 510, script: "$52100042_QD__MAIN__1$", arg4: 2, arg5: 2);
                context.SetAchievement(triggerId: 90000, type: "trigger", code: "Madracan_Q03");
            }
        ...
        private class StateQuestEnd_warp : TriggerState {
            ...
            public override void OnExit() {
                context.MoveUser(mapId: 52100043, portalId: 0);
            }
        }

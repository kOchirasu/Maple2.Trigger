...
namespace Maple2.Trigger._02000545_bf {
    public static class _egg {
        ...
        private class State아르키아체력 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckNpcHp(compare: "lowerEqual", value: 55, spawnPointId: 102, isRelative: "true")) {
        ...
        private class State알메쉬생성 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {2133, 2134}, arg2: true);
            ...
            public override void Execute() {
                ...
                if (context.MonsterDead(arg1: new int[] {502})) {
                    context.State = new State알파괴2(context);
                    return;
                }

                if (context.MonsterDead(arg1: new int[] {501, 502})) {
        ...
        private class State알파괴1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {2133}, arg2: false);
        ...
        private class State알파괴2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {2134}, arg2: false);
                context.SetAiExtraData(key: "phase", value: 1);
            }

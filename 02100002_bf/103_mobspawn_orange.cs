    ...
    public static class _103_mobspawn_orange {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(spawnIds: new []{30100, 30075, 30050, 30025, 30001, 31001, 31002, 31003});
                context.SetEffect(triggerIds: new []{5103, 5203}, visible: false);
            }
        ...
        private class StateGauge100_Normal : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{30100}, arg2: false);
            }
        ...
        private class StateGauge75_Normal : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{5103}, visible: true);
                context.CreateMonster(spawnIds: new []{30075}, arg2: false);
            }
        ...
        private class StateGauge50_Normal : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{5103}, visible: true);
                context.CreateMonster(spawnIds: new []{30050}, arg2: false);
            }
        ...
        private class StateGauge25_Normal : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{5103}, visible: true);
                context.CreateMonster(spawnIds: new []{30025}, arg2: false);
            }
        ...
        private class StateGauge1_Normal : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{5103}, visible: true);
                context.CreateMonster(spawnIds: new []{30001}, arg2: false);
            }
        ...
        private class StateSpawn_Eater : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{31001}, arg2: false);
            }
        ...
        private class StateSpawn_Runner : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{5203}, visible: true);
                context.CreateMonster(spawnIds: new []{31002}, arg2: false);
            }

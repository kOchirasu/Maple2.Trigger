namespace Maple2.Trigger._02100002_bf {
    public static class _104_mobspawn_purple {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(spawnIds: new []{40100, 40075, 40050, 40025, 40001, 41001, 41002, 41003});
                context.SetEffect(triggerIds: new []{5104, 5204}, visible: false);
            }
        ...
        private class StateGauge100_Normal : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{40100}, arg2: false);
            }
        ...
        private class StateGauge75_Normal : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{5104}, visible: true);
                context.CreateMonster(spawnIds: new []{40075}, arg2: false);
            }
        ...
        private class StateGauge50_Normal : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{5104}, visible: true);
                context.CreateMonster(spawnIds: new []{40050}, arg2: false);
            }
        ...
        private class StateGauge25_Normal : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{5104}, visible: true);
                context.CreateMonster(spawnIds: new []{40025}, arg2: false);
            }
        ...
        private class StateGauge1_Normal : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{5104}, visible: true);
                context.CreateMonster(spawnIds: new []{40001}, arg2: false);
            }
        ...
        private class StateSpawn_Eater : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{41001}, arg2: false);
            }
        ...
        private class StateSpawn_Runner : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{5204}, visible: true);
                context.CreateMonster(spawnIds: new []{41002}, arg2: false);
            }

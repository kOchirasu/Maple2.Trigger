    ...
    public static class _11_tankrefil_yellowgreen {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetActor(arg1: 4001, arg2: true, arg3: "Interaction_tankyellowgreen_A01_100");
                context.SetActor(arg1: 4101, arg2: true, arg3: "Interaction_tankyellowgreen_A01_100");
                context.SetEffect(arg1: new[] {5301, 5401, 5501}, arg2: false);
            }
        ...
        private class StateGauge100 : TriggerState {
            ...
            public override TriggerState Execute() {
                ...
                if (context.DetectLiftableObject(triggerBoxIds: new[] {2001}, itemId: 30000883)) {
        ...
        private class StateGauge100_Refil : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {5301, 5401, 5501}, arg2: true);
        ...
        private class StateGauge75 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetActor(arg1: 4001, arg2: true, arg3: "Interaction_tankyellowgreen_A01_75");
                context.SetActor(arg1: 4101, arg2: true, arg3: "Interaction_tankyellowgreen_A01_75");
            }
        ...
        private class StateGauge50 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetActor(arg1: 4001, arg2: true, arg3: "Interaction_tankyellowgreen_A01_50");
                context.SetActor(arg1: 4101, arg2: true, arg3: "Interaction_tankyellowgreen_A01_50");
            }
        ...
        private class StateGauge25 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetActor(arg1: 4001, arg2: true, arg3: "Interaction_tankyellowgreen_A01_25");
                context.SetActor(arg1: 4101, arg2: true, arg3: "Interaction_tankyellowgreen_A01_25");
            }
        ...
        private class StateGauge1 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetActor(arg1: 4001, arg2: true, arg3: "Interaction_tankyellowgreen_A01_1");
                context.SetActor(arg1: 4101, arg2: true, arg3: "Interaction_tankyellowgreen_A01_1");
            }

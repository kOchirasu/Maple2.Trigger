    ...
    public static class _25_spawnholder_pink {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10001256}, state: 2);
                context.SetInteractObject(interactIds: new []{10001257}, state: 0);
            }
        ...
        private class StateSpawnStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001257}, state: 1);
                context.SetInteractObject(interactIds: new []{10001256}, state: 2);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001257}, arg2: 0)) {
        ...
        private class StateSpawnStop : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001257}, state: 2);
                context.SetInteractObject(interactIds: new []{10001256}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001256}, arg2: 0)) {

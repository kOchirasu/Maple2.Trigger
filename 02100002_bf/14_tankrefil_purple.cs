namespace Maple2.Trigger._02100002_bf {
    public static class _14_tankrefil_purple {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetActor(triggerId: 4004, visible: true, initialSequence: "Interaction_tankpurple_A01_100");
                context.SetActor(triggerId: 4104, visible: true, initialSequence: "Interaction_tankpurple_A01_100");
                context.SetEffect(triggerIds: new []{5304, 5404, 5504}, visible: false);
            }
        ...
        private class StateGauge100 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(triggerId: 104, key: "Gauge", value: 100);
            ...
            public override TriggerState? Execute() {
                ...
                if (context.DetectLiftableObject(boxIds: new []{2004}, itemId: 30000886)) {
        ...
        private class StateGauge100_Refil : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{5304, 5404, 5504}, visible: true);
        ...
        private class StateGauge75 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(triggerId: 104, key: "Gauge", value: 75);
                context.ResetTimer(timerId: "100100");
                context.SetTimer(timerId: "10075", seconds: 15, autoRemove: true);
                context.SetActor(triggerId: 4004, visible: true, initialSequence: "Interaction_tankpurple_A01_75");
                context.SetActor(triggerId: 4104, visible: true, initialSequence: "Interaction_tankpurple_A01_75");
            }
        ...
        private class StateGauge50 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(triggerId: 104, key: "Gauge", value: 50);
                context.ResetTimer(timerId: "10075");
                context.SetTimer(timerId: "10050", seconds: 15, autoRemove: true);
                context.SetActor(triggerId: 4004, visible: true, initialSequence: "Interaction_tankpurple_A01_50");
                context.SetActor(triggerId: 4104, visible: true, initialSequence: "Interaction_tankpurple_A01_50");
            }
        ...
        private class StateGauge25 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(triggerId: 104, key: "Gauge", value: 25);
                context.ResetTimer(timerId: "10050");
                context.SetTimer(timerId: "10025", seconds: 15, autoRemove: true);
                context.SetActor(triggerId: 4004, visible: true, initialSequence: "Interaction_tankpurple_A01_25");
                context.SetActor(triggerId: 4104, visible: true, initialSequence: "Interaction_tankpurple_A01_25");
            }
        ...
        private class StateGauge1 : TriggerState {
            ...
            public override void OnEnter() {
                context.ResetTimer(timerId: "10025");
                context.SetUserValue(triggerId: 104, key: "Gauge", value: 1);
                context.SetActor(triggerId: 4004, visible: true, initialSequence: "Interaction_tankpurple_A01_1");
                context.SetActor(triggerId: 4104, visible: true, initialSequence: "Interaction_tankpurple_A01_1");
            }
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(triggerId: 104, key: "StopSpawn", value: 1);
            }

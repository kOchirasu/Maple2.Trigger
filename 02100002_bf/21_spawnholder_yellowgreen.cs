    ...
    public static class _21_spawnholder_yellowgreen {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {10001248}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10001249}, arg2: 0);
            }
        ...
        private class StateSpawnStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10001249}, arg2: 1);
                context.SetInteractObject(arg1: new[] {10001248}, arg2: 2);
            }

            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {10001249}, arg2: 0)) {
        ...
        private class StateSpawnStop : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10001249}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10001248}, arg2: 1);
            }

            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {10001248}, arg2: 0)) {

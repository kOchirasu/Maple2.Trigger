namespace Maple2.Trigger._02100002_bf {
    public static class _21_spawnholder_yellowgreen {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10001248}, state: 2);
                context.SetInteractObject(interactIds: new []{10001249}, state: 0);
            }
        ...
        private class StateSpawnStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001249}, state: 1);
                context.SetInteractObject(interactIds: new []{10001248}, state: 2);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001249}, arg2: 0)) {
        ...
        private class StateStopDelay : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(triggerId: 101, key: "SpawnHold", value: 1);
            }
        ...
        private class StateSpawnStop : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001249}, state: 2);
                context.SetInteractObject(interactIds: new []{10001248}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001248}, arg2: 0)) {
        ...
        private class StateStartDelay : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(triggerId: 101, key: "SpawnHold", value: 0);
            }

    ...
    public static class _12_tankrefil_skyblue {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetActor(triggerId: 4002, visible: true, initialSequence: "Interaction_tankskyblue_A01_100");
                context.SetActor(triggerId: 4102, visible: true, initialSequence: "Interaction_tankskyblue_A01_100");
                context.SetEffect(triggerIds: new []{5302, 5402, 5502}, visible: false);
            }
        ...
        private class StateGauge100 : TriggerState {
            ...
            public override TriggerState? Execute() {
                ...
                if (context.DetectLiftableObject(boxIds: new []{2002}, itemId: 30000885)) {
        ...
        private class StateGauge100_Refil : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{5302, 5402, 5502}, visible: true);
        ...
        private class StateGauge75 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetActor(triggerId: 4002, visible: true, initialSequence: "Interaction_tankskyblue_A01_75");
                context.SetActor(triggerId: 4102, visible: true, initialSequence: "Interaction_tankskyblue_A01_75");
            }
        ...
        private class StateGauge50 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetActor(triggerId: 4002, visible: true, initialSequence: "Interaction_tankskyblue_A01_50");
                context.SetActor(triggerId: 4102, visible: true, initialSequence: "Interaction_tankskyblue_A01_50");
            }
        ...
        private class StateGauge25 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetActor(triggerId: 4002, visible: true, initialSequence: "Interaction_tankskyblue_A01_25");
                context.SetActor(triggerId: 4102, visible: true, initialSequence: "Interaction_tankskyblue_A01_25");
            }
        ...
        private class StateGauge1 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetActor(triggerId: 4002, visible: true, initialSequence: "Interaction_tankskyblue_A01_1");
                context.SetActor(triggerId: 4102, visible: true, initialSequence: "Interaction_tankskyblue_A01_1");
            }

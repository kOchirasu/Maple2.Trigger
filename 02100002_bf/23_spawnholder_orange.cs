namespace Maple2.Trigger._02100002_bf {
    public static class _23_spawnholder_orange {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10001252}, state: 2);
                context.SetInteractObject(interactIds: new []{10001253}, state: 0);
            }
        ...
        private class StateSpawnStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001253}, state: 1);
                context.SetInteractObject(interactIds: new []{10001252}, state: 2);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001253}, arg2: 0)) {
        ...
        private class StateSpawnStop : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001253}, state: 2);
                context.SetInteractObject(interactIds: new []{10001252}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001252}, arg2: 0)) {

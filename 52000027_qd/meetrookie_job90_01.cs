    ...
    public static class _meetrookie_job90_01 {
        public class StateWait : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.QuestUserDetected(boxIds: new []{9000}, questIds: new []{20002243}, questStates: new byte[]{1}, jobCode: 90)) {
        ...
        private class State미션완료01 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.QuestUserDetected(boxIds: new []{9900}, questIds: new []{20002243}, questStates: new byte[]{2})) {

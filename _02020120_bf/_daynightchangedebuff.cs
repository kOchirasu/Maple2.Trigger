    ...
    public static class _daynightchangedebuff {
        ...
        private class StateReady : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(arg1: new int[] {2222}, arg2: true);
                context.SetSkill(arg1: new int[] {1212}, arg2: false);
            }

            public override void Execute() {
                if (context.CountUsers(arg1: 199, arg2: 1)) {
        ...
        private class State낮밤변환신호대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "DayNightChange", value: 1)) {
                    context.State = new State낮시간으로변화대기단계(context);
                    return;
                }

                if (context.UserValue(key: "DayNightChange", value: 2)) {
                    context.State = new State밤시간으로변화대기단계(context);
                    return;
                }

                if (context.UserValue(key: "DayNightChange", value: 3)) {
        ...
        private class State낮시간으로변화하기_맵초기화 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBuff(arg1: new int[] {299}, arg2: 50004547, arg3: 2, arg4: false);
        ...
        private class State밤시간으로변화하기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetSkill(arg1: new int[] {1212}, arg2: true);
                context.SetUserValue(key: "DayNightChange", value: 0);
            }
        ...
        private class State디버프모조리제거 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBuff(arg1: new int[] {299}, arg2: 50005315, arg3: 1, arg4: false);
                context.SetUserValue(key: "DayNightChange", value: 0);
            }

    ...
    public static class _12_findway {
        ...
        private class StateReadyToWalkIn01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 212, script: "$02000378_BF__12_FINDWAY__0$", arg4: 3, arg5: 1);
            }
        ...
        private class StateReadyToWalkIn02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 112, script: "$02000378_BF__12_FINDWAY__1$", arg4: 3, arg5: 1);
            }
        ...
        private class StateRound12_Start : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 1012, script: "$02000378_BF__12_FINDWAY__2$", arg4: 3, arg5: 2);
        ...
        private class StateRound12_RouteSelect : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 113, script: "$02000378_BF__12_FINDWAY__3$", arg4: 3, arg5: 0);

namespace Maple2.Trigger._02000378_bf {
    public static class _808_penalty_08round {
        ...
        private class State1stWaveStart01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{90880, 90882, 90884, 90886, 90888}, arg2: false);
            }
        ...
        private class State1stWaveStart02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{90881, 90883, 90885, 90887, 90889}, arg2: false);
            }

    ...
    public static class _901_mobwave_01round {
        ...
        private class State1stWaveStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, script: "$02000378_BF__901_MOBWAVE_01ROUND__0$", duration: 6000, boxId: 0);
                context.SetUserValue(key: "WaveTime", value: 1);
                context.SetEffect(triggerIds: new []{5101}, visible: true);
                context.CreateMonster(spawnIds: new []{90100, 90102, 90104}, arg2: false);
            }
        ...
        private class State1stWaveDelayRandom : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{90101, 90103, 90105}, arg2: false);
            }
        ...
        private class State2ndWaveStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{90110, 90112, 90114}, arg2: false);
            }
        ...
        private class State2ndWaveDelayRandom : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{90111, 90113, 90115}, arg2: false);
            }
        ...
        private class State3rdWaveStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{90120, 90122, 90124}, arg2: false);
            }
        ...
        private class State3rdWaveDelay : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{90131, 90133, 90135}, arg2: false);
            }
        ...
        private class State5thWaveStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{90190, 90192, 90194}, arg2: false);
            }
        ...
        private class State5thWaveDelay : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{90191, 90193, 90195}, arg2: false);
            }
        ...
        private class StateNpcDownPenaltyStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(triggerIds: new []{5000}, visible: true);
                context.SetEventUI(arg1: 1, script: "$02000378_BF__901_MOBWAVE_01ROUND__1$", duration: 4000, boxId: 0);
                context.SetConversation(type: 1, spawnId: 1101, script: "$02000378_BF__901_MOBWAVE_01ROUND__2$", arg4: 4, arg5: 4);
            }
        ...
        private class StateReturnToWave : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(key: "PenaltyFinish", value: 0);
                context.SetEffect(triggerIds: new []{5000}, visible: true);
                context.SetEventUI(arg1: 1, script: "$02000378_BF__901_MOBWAVE_01ROUND__3$", duration: 4000, boxId: 0);

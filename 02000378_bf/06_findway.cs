namespace Maple2.Trigger._02000378_bf {
    public static class _06_findway {
        ...
        private class StateReadyToWalkIn_FromPortal : TriggerState {
            ...
            public override void OnExit() {
                context.CreateMonster(arg1: new[] {106, 2006}, arg2: false);
            }
        }
        ...
        private class StateReadyToWalkIn_FromPortal02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 106, script: "$02000378_BF__06_FINDWAY__1$", arg4: 3, arg5: 0);
            }
        ...
        private class StateRound06_Start : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 1006, script: "$02000378_BF__06_FINDWAY__2$", arg4: 3, arg5: 2);
        ...
        private class StateRound06_Sucess : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 106, script: "$02000378_BF__06_FINDWAY__3$", arg4: 2, arg5: 1);
            }

    ...
    public static class _03_findway {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new[] {4023, 3003}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
        ...
        private class StateReadyToWalkIn01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 201, script: "$02000378_BF__03_FINDWAY__0$", arg4: 2, arg5: 0);
            }
        ...
        private class StateReadyToWalkIn02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 201, script: "$02000378_BF__03_FINDWAY__1$", arg4: 2, arg5: 1);
            }
        ...
        private class StateReadyToWalkIn03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 101, script: "$02000378_BF__03_FINDWAY__2$", arg4: 2, arg5: 2);
            }
        ...
        private class StateRound03_Start : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 1003, script: "$02000378_BF__03_FINDWAY__3$", arg4: 3, arg5: 2);
        ...
        private class StateRound03_Sucess02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 103, script: "$02000378_BF__03_FINDWAY__4$", arg4: 2, arg5: 1);
            }
        ...
        private class StateQuit02 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new[] {203, 904, 905, 906});
            }

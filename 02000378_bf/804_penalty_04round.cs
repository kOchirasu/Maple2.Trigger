namespace Maple2.Trigger._02000378_bf {
    public static class _804_penalty_04round {
        ...
        private class State1stWaveStart01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{90480, 90482, 90484, 90486, 90488}, arg2: false);
            }
        ...
        private class State1stWaveStart02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{90481, 90483, 90485, 90487, 90489}, arg2: false);
            }
        ...
        private class State2ndWaveStart02 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{90480, 90481, 90482, 90483, 90484, 90485, 90486, 90487, 90488, 90489, 90490, 90491, 90492, 90493, 90494, 90495, 90496, 90497, 90498, 90499})) {
        ...
        private class StatePenaltyFinished01 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{90480, 90481, 90482, 90483, 90484, 90485, 90486, 90487, 90488, 90489, 90490, 90491, 90492, 90493, 90494, 90495, 90496, 90497, 90498, 90499});

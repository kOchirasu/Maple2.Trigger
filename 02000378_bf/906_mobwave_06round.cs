    ...
    public static class _906_mobwave_06round {
        ...
        private class State1stWaveStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, script: "$02000378_BF__906_MOBWAVE_06ROUND__0$", duration: 6000, boxId: 0);
        ...
        private class State1stWaveDirection10 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{90600, 90602, 90604}, arg2: false);
            }
        ...
        private class State1stWaveDirection11 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{90601, 90603, 90605}, arg2: false);
            }
        ...
        private class State1stWaveDirection20 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{90610, 90612, 90614}, arg2: false);
            }
        ...
        private class State1stWaveDirection21 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{90611, 90613, 90615}, arg2: false);
            }
        ...
        private class State1stWaveDirection30 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{90620, 90622, 90624}, arg2: false);
            }
        ...
        private class State1stWaveDirection31 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{90621, 90623, 90625}, arg2: false);
            }
        ...
        private class State1stWaveDirection40 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{90630, 90632, 90634}, arg2: false);
            }
        ...
        private class State1stWaveDirection41 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{90631, 90633, 90635}, arg2: false);
            }
        ...
        private class State1stWaveDirection50 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{90640, 90642, 90644}, arg2: false);
            }
        ...
        private class State1stWaveDirection51 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{90641, 90643, 90645}, arg2: false);
            }
        ...
        private class State5thWaveStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{90690, 90692, 90694}, arg2: false);
            }
        ...
        private class State5thWaveDelay : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{90691, 90693, 90695}, arg2: false);
            }
        ...
        private class StateNpcDownPenaltyStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(triggerIds: new []{5000}, visible: true);
                context.SetEventUI(arg1: 1, script: "$02000378_BF__906_MOBWAVE_06ROUND__1$", duration: 4000, boxId: 0);
                context.SetConversation(type: 1, spawnId: 1106, script: "$02000378_BF__906_MOBWAVE_06ROUND__2$", arg4: 4, arg5: 4);
            }
        ...
        private class StateReturnToWave : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(key: "PenaltyFinish", value: 0);
                context.SetEffect(triggerIds: new []{5000}, visible: true);
                context.SetEventUI(arg1: 1, script: "$02000378_BF__906_MOBWAVE_06ROUND__3$", duration: 4000, boxId: 0);

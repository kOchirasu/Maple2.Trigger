    ...
    public static class _vip_dungeon_round {
        ...
        private class State시작대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "round1start", value: 1)) {
                    context.State = new State1라운드01(context);
                    return;
                }
            }
        ...
        private class State1라운드01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SpawnNpcRange(
                    ...
                    }, isAutoTargeting: true, randomPickCount: 3, score: 100);
            }
        ...
        private class State1라운드02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 10000)) {
                    context.State = new State1라운드03(context);
                    return;
                }
            }
        ...
        private class State2라운드대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "round2start", value: 1)) {
                    context.State = new State2라운드01(context);
                    return;
                }
            }
        ...
        private class State2라운드01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SpawnNpcRange(
                    ...
                    }, isAutoTargeting: true, randomPickCount: 4, score: 100);
            }
        ...
        private class State2라운드02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 10000)) {
                    context.State = new State2라운드03(context);
                    return;
                }
            }
        ...
        private class State3라운드대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "round3start", value: 1)) {
                    context.State = new State3라운드01(context);
                    return;
                }
            }
        ...
        private class State3라운드02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 6000)) {
                    context.State = new State3라운드03(context);
                    return;
                }
            }
        ...
        private class State3라운드03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 6000)) {
                    context.State = new State3라운드04(context);
                    return;
                }
            }
        ...
        private class State3라운드04 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 6000)) {
                    context.State = new State3라운드05(context);
                    return;
                }
            }
        ...
        private class State4라운드대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "round4start", value: 1)) {
                    context.State = new State4라운드01(context);
                    return;
                }
            }
        ...
        private class State4라운드03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State4라운드04(context);
                    return;
                }
            }
        ...
        private class State4라운드04 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State4라운드05(context);
                    return;
                }
            }
        ...
        private class State4라운드05 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State4라운드06(context);
                    return;
                }
            }
        ...
        private class State5라운드대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "round5start", value: 1)) {
                    context.State = new State5라운드01(context);
                    return;
                }
            }
        ...
        private class State5라운드01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State5라운드02(context);
                    return;
                }
            }
        ...
        private class State5라운드02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State5라운드03(context);
                    return;
                }
            }
        ...
        private class State5라운드03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State5라운드04(context);
                    return;
                }
            }
        ...
        private class State5라운드04 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State5라운드05(context);
                    return;
                }
            }
        ...
        private class State5라운드05 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State5라운드06(context);
                    return;
                }
            }
        ...
        private class State5라운드06 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State5라운드07(context);
                    return;
                }
            }
        ...
        private class State5라운드07 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State5라운드08(context);
                    return;
                }
            }
        ...
        private class State5라운드08 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State5라운드09(context);
                    return;
                }
            }
        ...
        private class State5라운드09 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State5라운드10(context);
                    return;
                }
            }

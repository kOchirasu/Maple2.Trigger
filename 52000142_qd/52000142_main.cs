...
namespace Maple2.Trigger._52000142_qd {
    public static class _52000142_main {
        ...
        private class State동료의비웃음_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 102, script: "$52000142_QD__52000142_MAIN__11$", arg4: 3, arg5: 0);
            }
        ...
        private class State동료의비웃음_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 103, script: "$52000142_QD__52000142_MAIN__12$", arg4: 3, arg5: 0);
            }
        ...
        private class State동료의비웃음_03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 104, script: "$52000142_QD__52000142_MAIN__13$", arg4: 3, arg5: 0);
            }
        ...
        private class State란스구하기_08 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 0, script: "$52000142_QD__52000142_MAIN__34$", arg4: 3, arg5: 0);
            }
        ...
        private class State란스구하기_09 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 108, script: "$52000142_QD__52000142_MAIN__35$", arg4: 3, arg5: 0);
            }

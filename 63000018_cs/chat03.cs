namespace Maple2.Trigger._63000018_cs {
    public static class _chat03 {
        ...
        private class StateChat01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 301, script: "$63000018_CS__CHAT03__0$", arg4: 4, arg5: 0);
                context.SetConversation(type: 1, spawnId: 302, script: "$63000018_CS__CHAT03__1$", arg4: 4, arg5: 4);
                context.SetConversation(type: 1, spawnId: 301, script: "$63000018_CS__CHAT03__2$", arg4: 4, arg5: 8);
                context.SetConversation(type: 1, spawnId: 302, script: "$63000018_CS__CHAT03__3$", arg4: 4, arg5: 12);
            }

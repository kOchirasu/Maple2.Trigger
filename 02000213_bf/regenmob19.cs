namespace Maple2.Trigger._02000213_bf {
    public static class _regenmob19 {
        ...
        private class State소환몹Spawn : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000260}, arg2: 1)) {
                    context.CreateMonster(spawnIds: new []{1019}, arg2: false);
        ...
        private class StateDeadCheck : TriggerState {
            ...
            public override TriggerState? Execute() {
                ...
                if (context.MonsterDead(spawnIds: new []{1019})) {
        ...
        private class State소멸 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{1019});

namespace Maple2.Trigger._02000213_bf {
    public static class _regenmob10 {
        ...
        private class State소환몹Spawn : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000259}, arg2: 1)) {
        ...
        private class StateDeadCheck : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000259}, arg2: 0)) {
                    return new State소멸(context);
                }

                if (context.ObjectInteracted(interactIds: new []{10000259}, arg2: 2)) {
                    return new State소멸(context);
                }

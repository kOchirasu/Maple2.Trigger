...
namespace Maple2.Trigger._02000555_bf {
    public static class _gamelogic_9002 {
        ...
        private class State라운드1시작전UI : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$02000535_BF__GAMELOGIC_9002__0$", arg3: new int[] {3000});
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.LockMyPc(isLock: true);
                    context.SetEventUI(arg1: 1, arg2: "$02000535_BF__GAMELOGIC_9002__1$", arg3: new int[] {6000});
        ...
        private class State라운드1진행 : TriggerState {
            ...
            public override void Execute() {
                if (context.WidgetCondition(arg1: "TypingGame", arg2: "Result", arg3: "1")) {
                    ...
                    context.SetEventUI(arg1: 1, arg2: "$02000535_BF__GAMELOGIC_9002__2$", arg3: new int[] {3000});
                ...
                if (context.WidgetCondition(arg1: "TypingGame", arg2: "Result", arg3: "0")) {
                    ...
                    context.SetEventUI(arg1: 1, arg2: "$02000535_BF__GAMELOGIC_9002__3$", arg3: new int[] {3000});
                    context.State = new State라운드종료(context);
                    return;
                }
            }
        ...
        private class State라운드2시작전UI : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$02000535_BF__GAMELOGIC_9002__4$", arg3: new int[] {3000});
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.LockMyPc(isLock: true);
                    context.SetEventUI(arg1: 1, arg2: "$02000535_BF__GAMELOGIC_9002__5$", arg3: new int[] {4000});
        ...
        private class State라운드2진행 : TriggerState {
            ...
            public override void Execute() {
                if (context.WidgetCondition(arg1: "TypingGame", arg2: "Result", arg3: "1")) {
                    context.SetEventUI(arg1: 1, arg2: "$02000535_BF__GAMELOGIC_9002__6$", arg3: new int[] {3000});
                    context.WidgetAction(arg1: "Round", arg2: "RoundResult", arg3: "1");
                    context.State = new State라운드종료(context);
                    return;
                }
                ...
                if (context.WidgetCondition(arg1: "TypingGame", arg2: "Result", arg3: "0")) {
                    context.SetEventUI(arg1: 1, arg2: "$02000535_BF__GAMELOGIC_9002__7$", arg3: new int[] {3000});
                    context.WidgetAction(arg1: "Round", arg2: "RoundResult", arg3: "0");
                    context.State = new State라운드종료(context);
                    return;
                }
        ...
        private class State라운드3시작전UI : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$02000535_BF__GAMELOGIC_9002__8$", arg3: new int[] {3000});
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.LockMyPc(isLock: true);
                    context.SetEventUI(arg1: 1, arg2: "$02000535_BF__GAMELOGIC_9002__9$", arg3: new int[] {3000});
        ...
        private class State라운드3진행 : TriggerState {
            ...
            public override void Execute() {
                if (context.WidgetCondition(arg1: "TypingGame", arg2: "Result", arg3: "1")) {
                    context.LockMyPc(isLock: true);
                    context.SetEventUI(arg1: 1, arg2: "$02000535_BF__GAMELOGIC_9002__10$", arg3: new int[] {3000});
                    context.WidgetAction(arg1: "Round", arg2: "RoundResult", arg3: "1");
                    context.State = new State라운드종료(context);
                    return;
                }
                ...
                if (context.WidgetCondition(arg1: "TypingGame", arg2: "Result", arg3: "0")) {
                    context.SetEventUI(arg1: 1, arg2: "$02000535_BF__GAMELOGIC_9002__11$", arg3: new int[] {3000});
                    context.WidgetAction(arg1: "Round", arg2: "RoundResult", arg3: "0");
                    context.State = new State라운드종료(context);
                    return;
                }
        ...
        private class State게임성공종료 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(triggerID: 1001, key: "GameLogicEnd", value: 1);
        ...
        private class State게임실패종료 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(triggerID: 1001, key: "GameLogicEnd", value: 2);
                context.SetUserValue(key: "GameLogicStart", value: 999);
            }

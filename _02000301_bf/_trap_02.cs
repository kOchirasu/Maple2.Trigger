    ...
    public static class _trap_02 {
        ...
        private class State시작 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {3021, 3022, 3023, 3024, 3025, 3026}, arg2: true, arg3: 0, arg4: 0,
                    arg5: 0f);
                context.SetMesh(
                    arg1: new int[] {4201, 4202, 4203, 4204, 4205, 4206, 4207, 4208, 4209, 4210, 4211, 4212},
                    arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {3027, 3028}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
            }
            ...
            public override void Execute() {
                ...
                if (context.UserDetected(arg1: new int[] {10201})) {
                    context.State = new State경보(context);
                    return;
                }

                if (context.UserDetected(arg1: new int[] {10202})) {
                    context.State = new State경보(context);
                    return;
                }
        ...
        private class State경보 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {3027, 3028}, arg2: false, arg3: 0, arg4: 0, arg5: 5f);
            }
        ...
        private class State해제 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {2003})) {
                    context.SetMesh(arg1: new int[] {3021, 3022, 3023, 3024, 3025, 3026}, arg2: false, arg3: 0, arg4: 0,
                        arg5: 5f);
                    context.SetMesh(
                        arg1: new int[] {4201, 4202, 4203, 4204, 4205, 4206, 4207, 4208, 4209, 4210, 4211, 4212},
                        arg2: false, arg3: 0, arg4: 0, arg5: 5f);

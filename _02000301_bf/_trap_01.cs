    ...
    public static class _trap_01 {
        public class State시작 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {10000511}, arg2: 1);
                context.SetEffect(arg1: new[] {603, 604, 605, 610}, arg2: false);
                context.SetMesh(arg1: new[] {3011, 3012, 3013, 3014, 3015, 3016}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
        ...
        private class State경보 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {10000511}, arg2: 0);
                context.CreateMonster(arg1: new[] {2002}, arg2: false);
                context.SetEffect(arg1: new[] {603, 604, 605, 610}, arg2: true);
                context.ShowGuideSummary(entityId: 20003001, textId: 20003001);
                context.PlaySystemSoundInBox(arg2: "System_ShowGuideSummary_01");
                context.SetMesh(arg1: new[] {3011, 3012, 3013, 3014, 3015, 3016}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
        ...
        private class State해제 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new[] {3011, 3012, 3013, 3014, 3015, 3016}, arg2: false, arg3: 0, arg4: 0, arg5: 5f);

    ...
    public static class _trap_06 {
        ...
        private class State시작 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10000514}, arg2: 1);
                ...
                context.SetMesh(arg1: new int[] {3061, 3062, 3063, 3064, 3065, 3066}, arg2: false, arg3: 0, arg4: 0,
                    arg5: 0f);
                context.SetMesh(
                    arg1: new int[]
            ...
            public override void Execute() {
                ...
                if (context.UserDetected(arg1: "10602")) {
                    context.State = new State경보(context);
                    return;
                }

                if (context.UserDetected(arg1: "10603")) {
                    context.State = new State경보(context);
                    return;
                }

                if (context.UserDetected(arg1: "10604")) {
                    context.State = new State경보(context);
                    return;
                }

                if (context.UserDetected(arg1: "10605")) {
                    context.State = new State경보(context);
                    return;
                }

                if (context.ObjectInteracted(arg1: new int[] {10000514}, arg2: 0)) {
        ...
        private class State경보 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10000514}, arg2: 0);
                ...
                context.SetMesh(arg1: new int[] {3061, 3062, 3063, 3064, 3065, 3066}, arg2: true, arg3: 0, arg4: 0,
                    arg5: 0f);
                context.SetMesh(
                    arg1: new int[]
                        {4601, 4602, 4603, 4604, 4605, 4606, 4607, 4608, 4609, 4610, 4611, 4612, 4613, 4614},

    ...
    public static class _trap_05 {
        ...
        private class State시작 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10000513}, arg2: 1);
                ...
                context.SetMesh(arg1: new int[] {3051, 3052, 3053, 3054, 3055, 3056}, arg2: false, arg3: 0, arg4: 0,
                    arg5: 0f);
                context.SetMesh(
                    arg1: new int[] {
            ...
            public override void Execute() {
                ...
                if (context.UserDetected(arg1: new int[] {10504})) {
                    context.State = new State경보(context);
                    return;
                }

                if (context.UserDetected(arg1: new int[] {10505})) {
                    context.State = new State경보(context);
                    return;
                }

                if (context.ObjectInteracted(arg1: new int[] {10000513}, arg2: 0)) {
        ...
        private class State경보 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10000513}, arg2: 0);
                ...
                context.SetMesh(arg1: new int[] {3051, 3052, 3053, 3054, 3055, 3056}, arg2: true, arg3: 0, arg4: 0,
                    arg5: 0f);
                context.SetMesh(
                    arg1: new int[] {
                        4501, 4502, 4503, 4504, 4505, 4506, 4507, 4508, 4509, 4510, 4511, 4512, 4513, 4514, 4515, 4516,

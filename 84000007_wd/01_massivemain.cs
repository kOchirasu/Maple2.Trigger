    ...
    public static class _01_massivemain {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(triggerIds: new []{8000, 8002}, visible: false);
                ...
                context.SetInteractObject(interactIds: new []{10001437}, state: 0);
                context.SetInteractObject(interactIds: new []{10001438, 10001439, 10001440}, state: 2);
        ...
        private class StateMusicChange : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveUser(mapId: 84000007, portalId: 1, boxId: 9000);
                context.AddBuff(boxIds: new []{9000}, skillId: 99940042, level: 1, arg4: false, arg5: false);
        ...
        private class StateR01DanceTime : TriggerState {
            ...
            public override void OnExit() {
                context.SetInteractObject(interactIds: new []{10001437}, state: 2);
            }
        }
        ...
        private class StateR01DancePattern01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10001438}, state: 1);
        ...
        private class StateR01DancePattern02 : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(boxIds: new []{9001}, sound: "DDStop_Stage_Ready_01");
                context.SetInteractObject(interactIds: new []{10001439}, state: 1);
        ...
        private class StateR01DancePattern03 : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(boxIds: new []{9001}, sound: "DDStop_Stage_Ready_01");
                context.SetInteractObject(interactIds: new []{10001440}, state: 1);
        ...
        private class StateR01DancePattern0401 : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(boxIds: new []{9001}, sound: "DDStop_Stage_Ready_01");
                context.SetInteractObject(interactIds: new []{10001437}, state: 1);
        ...
        private class StateR01DancePattern0403 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10001437}, state: 2);
                context.SetInteractObject(interactIds: new []{10001438}, state: 0);
            }
        ...
        private class StateR01DancePattern0503 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10001438}, state: 2);
                context.SetInteractObject(interactIds: new []{10001437}, state: 0);
            }
        ...
        private class StateR01DancePattern0602 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetSound(triggerId: 30000, arg2: true);
                context.SetEffect(triggerIds: new []{8000}, visible: true);
                context.SetInteractObject(interactIds: new []{10001439}, state: 0);
            }
        ...
        private class StateR01DancePattern0603 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10001439}, state: 2);
                context.SetInteractObject(interactIds: new []{10001437}, state: 0);
            }
        ...
        private class StateR01_GameStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10001437, 10001438, 10001439, 10001440}, state: 2);
        ...
        private class StateR01_GameTimerStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "11111", seconds: 30, clearAtZero: true, display: true, arg5: -40);
        ...
        private class StateR01End : TriggerState {
            ...
            public override TriggerState? Execute() {
                ...
                if (!context.UserDetected(boxIds: new []{9001})) {
                    return new StateFireworks_Lose(context);
                }
        ...
        private class StateR02Ready : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.EndMiniGameRound(winnerBoxId: 9001, expRate: 0.02f);
        ...
        private class StateR03_GameTimerStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "11111", seconds: 15, clearAtZero: true, display: true, arg5: -40);
        ...
        private class StateR04_GambleOrJackpot : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.RandomCondition(rate: 75f)) {
        ...
        private class StateR04_GameTimerStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "11111", seconds: 10, clearAtZero: true, display: true, arg5: -40);
        ...
        private class StateFireworks_Lose : TriggerState {
            internal StateFireworks_Lose(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new []{902, 903}, returnView: true);
        ...
        private class StateGameWrapUp : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    return new StateFireworks_Win(context);
                }
        ...
        private class StateFireworks_Win : TriggerState {
        ...
        private class StateGameOver : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveUser(mapId: 84000007, portalId: 3, boxId: 9002);
        ...
        private class StateLeaveAll : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveUser(mapId: 84000007, portalId: 3, boxId: 9001);
                context.AddBuff(boxIds: new []{9000}, skillId: 99940042, level: 1, arg4: false, arg5: false);
                context.SetLocalCamera(cameraId: 910, enable: false);
                context.SetSound(triggerId: 40000, arg2: false);
                context.SetUserValue(triggerId: 5, key: "BannerNumber", value: 0);
                context.SetEventUI(arg1: 1, script: "$84000007_WD__01_MASSIVEMAIN__0$", duration: 10000);
                context.PlaySystemSoundInBox(boxIds: new []{9000}, sound: "DJDD_Ending_03");
                context.SetSound(triggerId: 10000, arg2: false);
                context.SetTimer(timerId: "8888", seconds: 150, clearAtZero: false, display: true);
                context.SetPhotoStudio(isEnable: true);
            }

            public override TriggerState? Execute() {
                if (context.TimeExpired(timerId: "8888")) {

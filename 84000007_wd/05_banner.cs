    ...
    public static class _05_banner {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{711, 712, 713, 714, 715, 716, 717, 701, 702, 703, 704, 705, 706, 707, 708, 709}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateSetBanner : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetUserValue(key: "BannerNumber") == 70) {
                    context.SetMesh(triggerIds: new []{717}, visible: true, arg3: 0, arg4: 0, arg5: 2f);
                    context.SetMesh(triggerIds: new []{700}, visible: true, arg3: 0, arg4: 0, arg5: 2f);
                    return new StateNextWait(context);
                }

                if (context.GetUserValue(key: "BannerNumber") == 69) {
                    context.SetMesh(triggerIds: new []{716}, visible: true, arg3: 0, arg4: 0, arg5: 2f);

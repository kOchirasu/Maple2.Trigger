    ...
    public static class _barrier_8410 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000950, 10000966}, state: 2);
            }
        ...
        private class StateSensor7412 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{8411, 8412, 8413, 8414}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(triggerIds: new []{8410}, visible: false);
                context.SetInteractObject(interactIds: new []{10000950, 10000966}, state: 0);
            }
        ...
        private class StateEnable7412 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000950}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000950}, arg2: 0)) {
        ...
        private class StateActivate7412 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000950}, state: 2);
            }
        ...
        private class StateDelay7412 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000966}, state: 1);
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (context.ObjectInteracted(interactIds: new []{10000966}, arg2: 0)) {

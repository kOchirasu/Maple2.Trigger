    ...
    public static class _barrier_8330 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000948, 10000964}, state: 2);
            }
        ...
        private class StateSensor7332 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{8331, 8332, 8333, 8334, 8335, 8336, 8337, 8338}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(triggerIds: new []{8330}, visible: false);
                context.SetInteractObject(interactIds: new []{10000948, 10000964}, state: 0);
            }
        ...
        private class StateEnable7332 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000948}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000948}, arg2: 0)) {
        ...
        private class StateActivate7332 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000948}, state: 2);
            }
        ...
        private class StateDelay7332 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000964}, state: 1);
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (context.ObjectInteracted(interactIds: new []{10000964}, arg2: 0)) {

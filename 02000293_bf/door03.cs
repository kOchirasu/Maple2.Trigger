    ...
    public static class _door03 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(triggerId: 1007, visible: false, initialSequence: "Closed");
            }
        ...
        private class StateSetup : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000529, 10000520}, arg2: 0)) {
        ...
        private class StateTrigger02시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(triggerId: 1007, visible: true, initialSequence: "Opened");
                context.CreateMonster(spawnIds: new []{2034}, arg2: true);

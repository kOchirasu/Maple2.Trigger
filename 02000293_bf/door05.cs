namespace Maple2.Trigger._02000293_bf {
    public static class _door05 {
        public class StateWait : TriggerState {
            internal StateWait(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetActor(triggerId: 1009, visible: false, initialSequence: "Closed");
            }

            public override TriggerState? Execute() {
                if (context.UserDetected(boxIds: new []{999996})) {
        ...
        private class StateSetup : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000531, 10000522}, arg2: 0)) {
        ...
        private class StateTrigger02시작 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{2036}, arg2: true);

    ...
    public static class _main {
        ...
        private class Stateidle : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new int[] {221}, arg2: false);
        ...
        private class Stateready : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State연출시작_깨어난PC(context);
                    return;
                }
            }
        ...
        private class State연출시작_깨어난PC : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State연출시작_PC대사01(context);
                    return;
                }
            }
        ...
        private class State연출시작_PC대사01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 6000)) {
                    context.State = new State연출시작_조디대사01(context);
                    return;
                }
            }
        ...
        private class State연출시작_조디대사01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 9000)) {
                    context.State = new State첫번째연출_PC대사02(context);
                    return;
                }
            }
        ...
        private class State첫번째연출_PC대사02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 6000)) {
                    context.State = new State첫번째연출_조디대사02(context);
                    return;
                }
            }
        ...
        private class State첫번째연출_조디대사02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003344, illustID: "Peach_normal", msg: "$52010026_QD__MAIN__9$",
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 12000)) {
                    context.State = new State첫번째연출_PC대사03(context);
                    return;
                }
            }
        ...
        private class State첫번째연출_PC대사03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State첫번째연출_조디대사03(context);
                    return;
                }
            }
        ...
        private class State첫번째연출_조디대사03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 6000)) {
                    context.State = new State첫번째연출_PC대사04(context);
                    return;
                }
            }
        ...
        private class State첫번째연출_PC대사04 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State조디_카메라01(context);
                    return;
                }
            }
        ...
        private class State조디_카메라01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 500)) {
                    context.State = new State첫번째연출_조디대사04(context);
                    return;
                }
            }
        ...
        private class State첫번째연출_조디대사04 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State첫번째연출_조디대사05(context);
                    return;
                }
            }
        ...
        private class State첫번째연출_조디대사05 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 6000)) {
                    context.State = new State첫번째연출_PC대사05(context);
                    return;
                }
            }
        ...
        private class State첫번째연출_PC대사05 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State조디_카메라02(context);
                    return;
                }
            }
        ...
        private class State조디_카메라02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 500)) {
                    context.State = new State첫번째연출_조디대사06(context);
                    return;
                }
            }
        ...
        private class State첫번째연출_조디대사06 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$52010026_QD__MAIN__21$", arg3: new int[] {8000}, arg4: "0");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 6000)) {
                    context.State = new State두번째연출_ready(context);
                    return;
                }
            }
        ...
        private class State두번째연출_ready : TriggerState {
            ...
            public override void Execute() {
                if (context.UserDetected(arg1: new int[] {2101})) {
                    context.State = new State두번째연출_black(context);
                    return;
                }
            }
        ...
        private class State두번째연출_black : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State두번째연출_피치발견01(context);
                    return;
                }
            }
        ...
        private class State두번째연출_피치발견01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State두번째연출_피치발견02(context);
                    return;
                }
            }
        ...
        private class State두번째연출_피치발견02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State두번째연출_피치전투01(context);
                    return;
                }
            }
        ...
        private class State두번째연출_피치전투01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetOnetimeEffect(id: 2, enable: false, path: @"BG/Common/ScreenMask/Eff_fadein_1sec.xml");
                context.AddBalloonTalk(spawnPointID: 1000, msg: "$52010026_QD__MAIN__24$", duration: 1000,
                    delayTick: 0);
                context.PlaySystemSoundInBox(arg2: "System_ShowGuideSummary_01");
                context.SetEventUI(arg1: 1, arg2: "$52010026_QD__MAIN__25$", arg3: new int[] {2000}, arg4: "0");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State두번째연출_피치전투02(context);
                    return;
                }
            }
        ...
        private class State두번째연출_피치전투02 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {101, 102})) {
                    context.State = new State두번째연출_딜레이01(context);
                    return;
                }
            }
        ...
        private class State두번째연출_딜레이01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {5001}, arg2: false);
                context.SetEffect(arg1: new int[] {5002}, arg2: false);
                context.AddBalloonTalk(spawnPointID: 1000, msg: "$52010026_QD__MAIN__26$", duration: 2000,
                    delayTick: 1000);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State두번째연출_피치전투03(context);
                    return;
                }
            }
        ...
        private class State두번째연출_피치전투03 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnPointID: 1000, msg: "$52010026_QD__MAIN__27$", duration: 2000,
                    delayTick: 0);
                ...
                context.CreateMonster(arg1: new int[] {105}, arg2: false, arg3: 0);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {103, 104, 105})) {
                    context.State = new State두번째연출_딜레이02(context);
                    return;
                }
            }
        ...
        private class State두번째연출_딜레이02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State두번째연출_PC대사01(context);
                    return;
                }
            }
        ...
        private class State두번째연출_PC대사01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State두번째연출_잠시쉬기(context);
                    return;
                }
            }
        ...
        private class StateSkip : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {111}, arg2: false, arg3: 6000);
                context.CreateMonster(arg1: new int[] {112}, arg2: false, arg3: 6000);
                context.CreateMonster(arg1: new int[] {113}, arg2: false, arg3: 6000);
                context.CreateMonster(arg1: new int[] {114}, arg2: false, arg3: 6000);
                context.CreateMonster(arg1: new int[] {115}, arg2: false, arg3: 6000);
                context.CreateMonster(arg1: new int[] {121}, arg2: false, arg3: 5000);
                context.CreateMonster(arg1: new int[] {122}, arg2: false, arg3: 5000);
                context.CreateMonster(arg1: new int[] {123}, arg2: false, arg3: 5000);
                context.CreateMonster(arg1: new int[] {124}, arg2: false, arg3: 5000);
                context.CreateMonster(arg1: new int[] {125}, arg2: false, arg3: 5000);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State세번째연출_대사01(context);
                    return;
                }
            }
        ...
        private class State두번째연출_잠시쉬기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003343, illustID: "Peach_normal", align: "Left",
                    msg: "$52010026_QD__MAIN__29$", duration: 2000);
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 7000)) {
                    context.State = new State세번째연출_포털개방(context);
                    return;
                }
            }
        ...
        private class State세번째연출_포털개방 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State세번째연출_포털개방02(context);
                    return;
                }
            }
        ...
        private class State세번째연출_대사01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddBalloonTalk(spawnPointID: 1000, msg: "$52010026_QD__MAIN__33$", duration: 2000,
                    delayTick: 2000);
                context.PlaySystemSoundInBox(arg2: "System_ShowGuideSummary_01");
                context.SetEventUI(arg1: 1, arg2: "$52010026_QD__MAIN__34$", arg3: new int[] {2000}, arg4: "4000");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 6000)) {
                    context.State = new State피치탈출(context);
                    return;
                }
            }
        ...
        private class State피치탈출 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddBalloonTalk(spawnPointID: 1000, msg: "$52010026_QD__MAIN__42$", duration: 2000,
                    delayTick: 0);
                context.AddBuff(arg1: new int[] {2101}, arg2: 70000123, arg3: 1, arg4: false, arg5: false);
                context.SetEffect(arg1: new int[] {5101}, arg2: true);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {111, 112, 113, 114, 115, 121, 122, 123, 124, 125})) {
                    context.State = new State세번째연출_대사02(context);
                    return;
                }
            }
        ...
        private class State세번째연출_대사02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State세번째연출_대사02_1(context);
                    return;
                }
            }
        ...
        private class State세번째연출_대사02_1 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State다섯번째연출_ready(context);
                    return;
                }
            }
        ...
        private class State다섯번째연출_ready : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State다섯번째연출_엘리트몬스터(context);
                    return;
                }
            }
        ...
        private class Stateskip_a : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State다섯번째연출_엘리트몬스터대사(context);
                    return;
                }
            }
        ...
        private class State다섯번째연출_엘리트몬스터대사 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetOnetimeEffect(id: 7, enable: false, path: @"BG/Common/ScreenMask/Eff_fadein_1sec.xml");
                context.PlaySystemSoundInBox(arg2: "System_ShowGuideSummary_01");
                context.SetEventUI(arg1: 1, arg2: "$52010026_QD__MAIN__38$", arg3: new int[] {2000}, arg4: "0");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State다섯번째연출_전투(context);
                    return;
                }
            }
        ...
        private class State다섯번째연출_전투 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {131})) {
                    context.State = new State다섯번째연출_마지막(context);
                    return;
                }
            }
        ...
        private class State다섯번째연출_마지막 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State다섯번째연출_대화02(context);
                    return;
                }
            }
        ...
        private class State다섯번째연출_대화02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 8000)) {
                    context.State = new State다섯번째연출_암전(context);
                    return;
                }
            }
        ...
        private class State다섯번째연출_암전 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State다섯번째연출_의문의목소리암전(context);
                    return;
                }
            }

    ...
    public static class _brick_23 {
        public class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {34023}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetSkill(arg1: new[] {7023}, arg2: false);
            }

            public override void Execute() {
                if (context.UserDetected(arg1: new[] {1123})) {
        ...
        private class State발판 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 200)) {
                    context.SetMesh(arg1: new[] {34023}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);

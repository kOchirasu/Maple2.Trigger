    ...
    public static class _brick_24 {
        public class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {34024}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetSkill(arg1: new[] {7024}, arg2: false);
            }

            public override TriggerState Execute() {
                if (context.UserDetected(arg1: new[] {1124})) {
        ...
        private class State발판 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 200)) {
                    context.SetMesh(arg1: new[] {34024}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);

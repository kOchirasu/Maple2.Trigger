    ...
    public static class _brick_32 {
        public class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {34032}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetSkill(arg1: new[] {7032}, arg2: false);
            }

            public override TriggerState Execute() {
                if (context.UserDetected(arg1: new[] {1132})) {
        ...
        private class State발판 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 200)) {
                    context.SetMesh(arg1: new[] {34032}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);

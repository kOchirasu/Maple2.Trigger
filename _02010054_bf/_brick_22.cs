    ...
    public static class _brick_22 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {34022}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetSkill(arg1: new int[] {7022}, arg2: false);
            }

            public override void Execute() {
                if (context.UserDetected(arg1: new int[] {1122})) {
        ...
        private class State발판 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 200)) {
                    context.SetMesh(arg1: new int[] {34022}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);

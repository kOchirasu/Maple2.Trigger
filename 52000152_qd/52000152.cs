    ...
    public static class _52000152 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.MoveUser(mapId: 52000152, portalId: 1010);
        ...
        private class State묘지전경씬02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new []{4002, 4003, 4004, 4005}, returnView: false);
        ...
        private class StateQuit02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddBalloonTalk(spawnId: 0, msg: "$52000152_QD__52000152__2$", duration: 6000, delayTick: 1000);
            ...
            public override TriggerState? Execute() {
                if (context.QuestUserDetected(boxIds: new []{9001}, questIds: new []{20002328}, questStates: new byte[]{3})) {
        ...
        private class State제니아Spawn01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.MoveNpc(spawnId: 2001, patrolName: "MS2PatrolData_xeniaMove");
            }

            public override TriggerState? Execute() {
                if (context.QuestUserDetected(boxIds: new []{9001}, questIds: new []{20002332}, questStates: new byte[]{3})) {
        ...
        private class State수련장이동02 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveUser(mapId: 52000153, portalId: 1);
            }

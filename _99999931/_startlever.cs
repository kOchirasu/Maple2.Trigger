...
namespace Maple2.Trigger._99999931 {
    public static class _startlever {
        public static readonly Func<ITriggerContext, TriggerState> Start = context => new State시작레버(context);

        private class State시작레버 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10000215}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000215}, arg2: 0)) {
        ...
        private class State게임준비 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$99999931__STARTLEVER__0$", arg3: new int[] {4000});
            }

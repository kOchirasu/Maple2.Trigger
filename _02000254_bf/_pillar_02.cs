    ...
    public static class _pillar_02 {
        ...
        private class State시작대기중 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000441}, arg2: 0);
                context.SetSkill(arg1: new int[] {702}, arg2: false);
                context.SetEffect(arg1: new int[] {444}, arg2: false);
                context.SetEffect(arg1: new int[] {445}, arg2: false);
                context.SetEffect(arg1: new int[] {461}, arg2: false);
            }

            public override void Execute() {
                if (context.NpcDetected(arg1: 906, arg2: new int[] {104})) {
        ...
        private class State반응대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000441}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000441}, arg2: 0)) {
        ...
        private class State스턴 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {444}, arg2: true);
                context.SetEffect(arg1: new int[] {445}, arg2: true);
                context.SetEffect(arg1: new int[] {461}, arg2: true);

    ...
    public static class _fruit03 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000140}, state: 1);
                context.SetEffect(triggerIds: new []{203}, visible: false);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000140}, arg2: 0)) {

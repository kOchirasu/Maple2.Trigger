    ...
    public static class _fruit04 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000141}, state: 1);
                context.SetEffect(triggerIds: new []{204}, visible: false);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000141}, arg2: 0)) {

namespace Maple2.Trigger._52000007_qd {
    public static class _congratulation {
        ...
        private class State축하2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 100, script: "$52000007_QD__CONGRATULATION__0$");
                context.SetConversation(type: 1, spawnId: 101, script: "$52000007_QD__CONGRATULATION__1$");

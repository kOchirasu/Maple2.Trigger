    ...
    public static class _52000109 {
        public class StateWait01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new[] {200, 2001}, arg2: false);
            }
        ...
        private class StateWait03 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowCaption(type: "VerticalCaption", title: "$52000109_QD__52000109__0$", desc: "$52000109_QD__52000109__1$", align: "bottomLeft", offsetRateX: 0f, offsetRateY: 0f, duration: 6000, scale: 2.5f);
        ...
        private class State에델슈타인전경씬01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetOnetimeEffect(id: 40, enable: true, path: @"BG/Common/Eff_Com_Vibrate_Short.xml");
                context.AddBalloonTalk(spawnPointId: 0, msg: "$52000109_QD__52000109__2$", duration: 5000, delayTick: 1000);
                context.AddBalloonTalk(spawnPointId: 200, msg: "$52000109_QD__52000109__3$", duration: 6000, delayTick: 4000);
        ...
        private class State에델슈타인전경씬02 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11003292, illustId: "Ayesha_normal", msg: "$52000109_QD__52000109__4$", duration: 4000, align: "right");
                context.SetOnetimeEffect(id: 3000982, enable: true, path: @"BG/Common/Sound/Eff_Ayesha_IntroMovie_03000982.xml");
        ...
        private class State에델슈타인전경씬03 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 0, illustId: "0", msg: "$52000109_QD__52000109__5$", duration: 4000, align: "right");
        ...
        private class State에델슈타인전경씬04 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11003292, illustId: "Ayesha_normal", msg: "$52000109_QD__52000109__6$", duration: 4000, align: "right");
                context.SetOnetimeEffect(id: 3000983, enable: true, path: @"BG/Common/Sound/Eff_Ayesha_IntroMovie_03000983.xml");
            }
        ...
        private class State에델슈타인전경씬05 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 0, illustId: "0", msg: "$52000109_QD__52000109__7$", duration: 4000, align: "right");
            }
        ...
        private class State에델슈타인전경씬06 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 0, illustId: "0", msg: "$52000109_QD__52000109__8$", duration: 4000, align: "right");
            }
        ...
        private class State에델슈타인전경씬07 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11003292, illustId: "Ayesha_normal", msg: "$52000109_QD__52000109__9$", duration: 4000, align: "right");
                context.SetOnetimeEffect(id: 3000984, enable: true, path: @"BG/Common/Sound/Eff_Ayesha_IntroMovie_03000984.xml");
            }
        ...
        private class State에델슈타인전경씬08 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 0, illustId: "0", msg: "$52000109_QD__52000109__10$", duration: 4000, align: "right");
            }
        ...
        private class State에델슈타인전경씬11 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 0, illustId: "0", msg: "$52000109_QD__52000109__11$", duration: 4000, align: "right");
            }
        ...
        private class State에델슈타인전경씬12 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 0, illustId: "0", msg: "$52000109_QD__52000109__12$", duration: 4000, align: "right");
            }
        ...
        private class State에델슈타인전경씬13 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddBalloonTalk(spawnPointId: 0, msg: "$52000109_QD__52000109__13$", duration: 5000, delayTick: 1000);
                context.AddBalloonTalk(spawnPointId: 200, msg: "$52000109_QD__52000109__14$", duration: 6000, delayTick: 4000);
            }
        ...
        private class State에델슈타인전경씬14 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    return new State20002302Quest대기01(context);
                }
        ...
        private class State20002302Quest대기01 : TriggerState {
            internal State20002302Quest대기01(ITriggerContext context) : base(context) { }
            ...
            public override TriggerState Execute() {
                if (context.QuestUserDetected(arg1: new[] {10010}, arg2: new[] {20002304}, arg3: new byte[] {2})) {
                    return new State라딘대화씬03(context);
                }

                if (context.QuestUserDetected(arg1: new[] {10010}, arg2: new[] {20002303}, arg3: new byte[] {3})) {
                    return new State라딘대화씬01(context);
                }

                if (context.QuestUserDetected(arg1: new[] {10010}, arg2: new[] {20002302}, arg3: new byte[] {3})) {
                    return new State라딘Appear씬01(context);
                }

                if (context.QuestUserDetected(arg1: new[] {10010}, arg2: new[] {20002302}, arg3: new byte[] {2})) {
                    return new State라딘Appear씬01(context);
                }
        ...
        private class State라딘Appear씬01 : TriggerState {
            internal State라딘Appear씬01(ITriggerContext context) : base(context) { }
            ...
            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    return new State라딘Appear씬02(context);
                }
        ...
        private class State라딘Appear씬02 : TriggerState {
            internal State라딘Appear씬02(ITriggerContext context) : base(context) { }
            ...
            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    return new State라딘Appear씬03(context);
                }
        ...
        private class State라딘Appear씬03 : TriggerState {
            internal State라딘Appear씬03(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetProductionUI(arg1: 1);
                context.SetProductionUI(arg1: 3);
                context.AddCinematicTalk(npcId: 11003295, illustId: "Radin_normal", msg: "$52000109_QD__52000109__15$", duration: 4000, align: "right");
            }

            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    return new State라딘Appear씬04(context);
                }
        ...
        private class State라딘Appear씬04 : TriggerState {
            internal State라딘Appear씬04(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.FaceEmotion(spawnPointId: 200, emotionName: "hello_Cait");
                context.ShowCaption(type: "NameCaption", title: "$52000109_QD__52000109__16$", desc: "$52000109_QD__52000109__17$", align: "center", offsetRateX: -0.15f, offsetRateY: 0.15f, duration: 10000, scale: 2.0f);
            }

            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 7000)) {
                    return new State라딘Appear씬04_1(context);
                }
        ...
        private class State라딘Appear씬04_1 : TriggerState {
            internal State라딘Appear씬04_1(ITriggerContext context) : base(context) { }
            ...
            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    return new State라딘Appear씬05(context);
                }
        ...
        private class State라딘Appear씬05 : TriggerState {
            internal State라딘Appear씬05(ITriggerContext context) : base(context) { }
            ...
            public override TriggerState Execute() {
                if (context.QuestUserDetected(arg1: new[] {10010}, arg2: new[] {20002303}, arg3: new byte[] {2})) {
                    return new State라딘대화씬01(context);
                }
        ...
        private class State라딘대화씬04 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowCaption(type: "VerticalCaption", title: "$52000109_QD__52000109__18$", desc: "$52000109_QD__52000109__19$", align: "bottomLeft", offsetRateX: 0f, offsetRateY: 0f, duration: 10000, scale: 2.5f);
            }

    ...
    public static class _03_ladder {
        ...
        private class StateSetting : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10002026}, arg2: 0, arg4: false);
                context.SetUserValue(key: "EnableLadder", value: 0);
            }

            public override void Execute() {
                if (context.UserValue(key: "EnableLadder", value: 1)) {
        ...
        private class StateLeverOn : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10002026}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10002026}, arg2: 0)) {

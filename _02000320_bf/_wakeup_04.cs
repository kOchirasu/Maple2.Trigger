...
namespace Maple2.Trigger._02000320_bf {
    public static class _wakeup_04 {
        ...
        private class State도둑듬 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000329}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000329}, arg2: 0)) {
        ...
        private class State깨어남1 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {40004}, arg2: true);
                context.SetConversation(arg1: 1, arg2: 40004, arg3: "$02000320_BF__WAKEUP_04__0$", arg4: 2, arg5: 0);
                context.CreateMonster(arg1: new int[] {40005}, arg2: true);
                context.SetConversation(arg1: 1, arg2: 40005, arg3: "$02000320_BF__WAKEUP_04__1$", arg4: 2, arg5: 1);
                context.CreateMonster(arg1: new int[] {40006}, arg2: true);
                context.SetConversation(arg1: 1, arg2: 40006, arg3: "$02000320_BF__WAKEUP_04__2$", arg4: 2, arg5: 2);
                context.CreateMonster(arg1: new int[] {40001});
                context.CreateMonster(arg1: new int[] {40002});
                context.CreateMonster(arg1: new int[] {40003});
        ...
        private class State깨어남4 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {40004, 40005, 40006})) {
                    context.State = new State다시잠듬(context);
                    return;
                }

                if (!context.MonsterInCombat(arg1: new int[] {40004, 40005, 40006})) {
        ...
        private class State다시잠듬 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {40001, 40002, 40003, 40004, 40005, 40006});

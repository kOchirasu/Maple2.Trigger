    ...
    public static class _actor06 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetActor(arg1: 206, arg2: true, arg3: "Damg_B");
            }

            public override void Execute() {
                if (context.UserDetected(arg1: new int[] {1601})) {
        ...
        private class State더미해제 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(arg1: 206, arg2: false, arg3: "Damg_B");
            }
        ...
        private class State리젠준비 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(arg1: 206, arg2: true, arg3: "Regen_A");
            }

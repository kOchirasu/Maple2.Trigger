namespace Maple2.Trigger._02000431_bf {
    public static class _main {
        ...
        private class State부선장Script01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 2, spawnId: 24003011, script: "$02000431_BF__MAIN__0$", arg4: 3, arg5: 0);
            }
        ...
        private class State세이렌연주02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 1098, script: "$02000431_BF__MAIN__6$", arg4: 3, arg5: 0);
                context.PlaySystemSoundInBox(sound: "Dungeon_Siren_Harp01");
                context.SetNpcEmotionSequence(spawnId: 1098, sequenceName: "Attack_01_D");
            }

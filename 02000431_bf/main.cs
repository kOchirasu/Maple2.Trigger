namespace Maple2.Trigger._02000431_bf {
    public static class _main {
        ...
        private class State부선장Script01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 2, arg2: 24003011, script: "$02000431_BF__MAIN__0$", arg4: 3, arg5: 0);
            }
        ...
        private class State해적이동01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 2099, script: "$02000431_BF__MAIN__1$", arg4: 3, arg5: 0);
        ...
        private class State부선장Script03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 2, arg2: 24003011, script: "$02000431_BF__MAIN__2$", arg4: 3, arg5: 0);
            }
        ...
        private class State세이렌Script01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 2, arg2: 24003010, script: "$02000431_BF__MAIN__3$", arg4: 3, arg5: 0);
            }
        ...
        private class StateCamera310 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 1099, script: "$02000431_BF__MAIN__4$", arg4: 3, arg5: 0);
        ...
        private class StateCamera304 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 2099, script: "$02000431_BF__MAIN__5$", arg4: 3, arg5: 0);
        ...
        private class State세이렌연주02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 1098, script: "$02000431_BF__MAIN__6$", arg4: 3, arg5: 0);
                context.PlaySystemSoundInBox(arg2: "Dungeon_Siren_Harp01");
                context.SetNpcEmotionSequence(arg1: 1098, arg2: "Attack_01_D");
            }
        ...
        private class State세이렌이동 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 1098, script: "$02000431_BF__MAIN__7$", arg4: 3, arg5: 0);
        ...
        private class StateCamera307 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 2, arg2: 24003011, script: "$02000431_BF__MAIN__8$", arg4: 3, arg5: 0);
            }
        ...
        private class StateCamera308 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 2100, script: "$02000431_BF__MAIN__9$", arg4: 3, arg5: 0);
            }

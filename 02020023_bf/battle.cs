    ...
    public static class _battle {
        ...
        private class State전투_시작 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetNpcDuelHpBar(isOpen: true, spawnId: 101, durationTick: 300000, npcHpStep: 100);
            }

            public override TriggerState? Execute() {
                if (context.GetDungeonPlayTime() <= 180 && context.MonsterDead(spawnIds: new []{101})) {
                    context.DungeonMissionComplete(missionId: 24091005);
                    return new State전투_종료(context);
                }

                if (context.GetDungeonPlayTime() <= 70 && context.MonsterDead(spawnIds: new []{101})) {
                    context.DungeonMissionComplete(missionId: 24091006);
                    return new State전투_종료(context);
                }

                if (context.GetDungeonPlayTime() <= 270 && context.MonsterDead(spawnIds: new []{101})) {
        ...
        private class State전투_종료 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(spawnIds: new []{-1});
                context.SetNpcDuelHpBar(isOpen: false, spawnId: 101, durationTick: 300000);

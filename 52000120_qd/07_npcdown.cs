    ...
    public static class _07_npcdown {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001171}, state: 2);
                context.DestroyMonster(spawnIds: new []{233});
        ...
        private class StateNpcDown : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10001171}, state: 1);
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (context.ObjectInteracted(interactIds: new []{10001171}, arg2: 0)) {
        ...
        private class StateNpcWakeUp : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001171}, state: 2);
                context.CreateMonster(spawnIds: new []{233}, arg2: false);
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (context.NpcDetected(boxId: 9900, spawnIds: new []{223})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{222, 223});
                context.SetInteractObject(interactIds: new []{10001171}, state: 0);
            }

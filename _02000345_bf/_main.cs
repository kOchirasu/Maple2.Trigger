...
namespace Maple2.Trigger._02000345_bf {
    public static class _main {
        ...
        private class Statestart_game_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$02000345_BF__MAIN__11$", arg3: new int[] {3000});
                context.CreateMonster(arg1: new int[] {189}, arg2: true, arg3: 0);
            }
        ...
        private class Statestart_game_05 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$02000345_BF__MAIN__18$", arg3: new int[] {3000});
                context.CreateMonster(arg1: new int[] {201, 202, 203, 204, 205, 206, 207, 208, 209, 210}, arg2: true,
                    arg3: 0);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {201, 202, 203, 204, 205, 206, 207, 208, 209, 210})) {
        ...
        private class Statestart_game_06 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {301, 302, 303, 304, 305, 306, 307}, arg2: true, arg3: 0);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {301, 302, 303, 304, 305, 306, 307})) {
        ...
        private class Statestart_game_07 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {401, 402, 403, 404, 405, 406}, arg2: true, arg3: 0);
            }
        ...
        private class State대기_01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10000791}, arg2: 0);
                context.SetMesh(arg1: new int[] {6001, 6010}, arg2: true);
                context.SetMesh(arg1: new int[] {6001, 6002, 6003, 6004, 6005, 6006, 6007, 6008, 6009}, arg2: false);
        ...
        private class State오브젝티브_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$02000345_BF__MAIN1__2$", arg3: new int[] {10000});
        ...
        private class State클리어 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 7, arg2: "$02000345_BF__MAIN1__1$", arg3: new int[] {3000});
                ...
                context.SetInteractObject(arg1: new int[] {10000791}, arg2: 1);

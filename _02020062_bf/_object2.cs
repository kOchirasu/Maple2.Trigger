    ...
    public static class _object2 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {12000108}, arg2: 2);
            }
        ...
        private class State레버2_가이드메시지 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.UserDetected(arg1: new int[] {9012})) {
                    context.SetEventUI(arg1: 1, arg2: "$02020062_BF__OBJECT2__0$", arg3: new int[] {5000},
                        arg4: "9012");
        ...
        private class State레버2_발동 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {12000108}, arg2: 1);
                context.SetEventUI(arg1: 1, arg2: "$02020062_BF__OBJECT2__1$", arg3: new int[] {5000}, arg4: "9012");
            }
            ...
            public override void Execute() {
                ...
                if (context.ObjectInteracted(arg1: new int[] {12000108}, arg2: 0)) {

    ...
    public static class _movepanel3 {
        ...
        private class State발판초기화 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetBreakable(arg1: new int[] {2200, 2201, 2202, 2203, 2204, 2205, 2206, 2207, 2208},
                    arg2: false);
                context.SetVisibleBreakableObject(
                    arg1: new int[] {2200, 2201, 2202, 2203, 2204, 2205, 2206, 2207, 2208}, arg2: false);
                context.SetUserValue(triggerID: 99990026, key: "MovePanel03", value: 0);
                context.SetInteractObject(arg1: new int[] {12000117}, arg2: 2);
            }

            public override void Execute() {
                if (context.UserValue(key: "MovePanel03", value: 1)) {
        ...
        private class State레버생성 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {12000117}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {12000117}, arg2: 0)) {
        ...
        private class State발판이동 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetVisibleBreakableObject(
                    arg1: new int[] {2200, 2201, 2202, 2203, 2204, 2205, 2206, 2207, 2208}, arg2: true);
                context.SetInteractObject(arg1: new int[] {12000117}, arg2: 2);
            }

            public override void Execute() {
                if (context.UserDetected(arg1: new int[] {9202})) {
                    context.SetBreakable(arg1: new int[] {2200, 2201, 2202, 2203, 2204, 2205, 2206, 2207, 2208},
                        arg2: true);

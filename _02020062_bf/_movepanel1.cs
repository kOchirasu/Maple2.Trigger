    ...
    public static class _movepanel1 {
        ...
        private class State발판초기화 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetBreakable(arg1: new int[] {2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008},
                    arg2: false);
                context.SetVisibleBreakableObject(
                    arg1: new int[] {2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008}, arg2: false);
                context.SetUserValue(triggerID: 99990024, key: "MovePanel01", value: 0);
                context.SetInteractObject(arg1: new int[] {12000115}, arg2: 2);
            }

            public override void Execute() {
                if (context.UserValue(key: "MovePanel01", value: 1)) {
        ...
        private class State레버생성 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {12000115}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {12000115}, arg2: 0)) {
        ...
        private class State발판이동 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetVisibleBreakableObject(
                    arg1: new int[] {2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008}, arg2: true);
                context.SetInteractObject(arg1: new int[] {12000115}, arg2: 2);
            }

    ...
    public static class _main {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(
                    arg1: new int[] {
                        40000, 40001, 40002, 40003, 40004, 40005, 40006, 40007, 40008, 40009, 40010, 40011, 40012,
                        40013, 40014, 40015, 40016, 40017, 40018, 40019, 40020, 40021
                    }, arg2: false);
            }

            public override void Execute() {
                if (context.UserDetected(arg1: "9001") || context.UserDetected(arg1: "9003")) {
        ...
        private class State딜레이 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$02020062_BF__MAIN__0$", arg3: new int[] {5000});
        ...
        private class State방폭 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$02020062_BF__MAIN__1$", arg3: new int[] {10000});
            }
        ...
        private class State시작 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$02020062_BF__MAIN__2$", arg3: new int[] {5000});
        ...
        private class State오브젝트페이즈 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$02020062_BF__MAIN__3$", arg3: new int[] {5000});
                context.ShadowExpedition(type: "CloseBossGauge");
        ...
        private class State보스페이즈 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$02020062_BF__MAIN__4$", arg3: new int[] {5000});
                context.ResetTimer(arg1: "2");

    ...
    public static class _63000076_interact_1393 {
        public class StateSetup : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{109, 110, 111, 112, 113, 114}, arg2: true);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001393}, arg2: 0)) {
        ...
        private class State1393화난요정_01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{209, 210, 211, 212, 213, 214}, arg2: true);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{209, 210, 211, 212, 213, 214})) {
        ...
        private class State1393화난요정_03 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{109, 110, 111, 112, 113, 114}, arg2: false);
            }

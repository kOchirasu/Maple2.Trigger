    ...
    public static class _63000076_chat_708 {
        public class StateSetup : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.UserDetected(boxIds: new []{708})) {
        ...
        private class State708잡담_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnId: 108, msg: "$63000076_CS__63000076_CHAT_708__0$", duration: 2500, delayTick: 0);
            }
        ...
        private class State708잡담_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnId: 115, msg: "$63000076_CS__63000076_CHAT_708__1$", duration: 2500, delayTick: 0);
            }
        ...
        private class State708잡담_03 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnId: 108, msg: "$63000076_CS__63000076_CHAT_708__2$", duration: 2500, delayTick: 0);
            }

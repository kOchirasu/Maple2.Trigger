    ...
    public static class _portal03 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000888}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000888}, arg2: 0)) {
        ...
        private class StateCreation : TriggerState {
            ...
            public override void OnEnter() {
                context.SetPortal(portalId: 70, visible: false, enabled: true, minimapVisible: false);

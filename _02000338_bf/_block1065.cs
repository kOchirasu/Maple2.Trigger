    ...
    public static class _block1065 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {1065}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
            }

            public override void Execute() {
                if (context.UserDetected(arg1: new int[] {10065})) {
        ...
        private class State진행1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {1065}, arg2: false, arg3: 0, arg4: 0, arg5: 2f);
            }

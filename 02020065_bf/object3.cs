    ...
    public static class _object3 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{713}, arg2: false);
            }

            public override TriggerState? Execute() {
                if (context.GetUserValue(key: "TurretSpawn_3") == 1) {
        ...
        private class StateTurretEnabled : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{713}, arg2: false);
            }

            public override TriggerState? Execute() {
                if (context.GetUserValue(key: "TurretSpawn_3") == 0) {

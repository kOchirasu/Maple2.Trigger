    ...
    public static class _message {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "$02020065_BF__MESSAGE__0$", arg3: 5000);
            }
        ...
        private class State체력공지_1 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.GetNpcHpRate(spawnPointId: 801) <= 0.50f) {
                    context.SetEventUI(arg1: 1, script: "$02020065_BF__MESSAGE__1$", arg3: 5000);
        ...
        private class State체력공지_2 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.GetNpcHpRate(spawnPointId: 801) <= 0.30f) {
                    context.SetEventUI(arg1: 1, script: "$02020065_BF__MESSAGE__2$", arg3: 5000);
        ...
        private class State체력공지_3 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.GetNpcHpRate(spawnPointId: 801) <= 0.10f) {
                    context.SetEventUI(arg1: 1, script: "$02020065_BF__MESSAGE__3$", arg3: 5000);

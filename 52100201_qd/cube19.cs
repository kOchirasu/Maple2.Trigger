namespace Maple2.Trigger._52100201_qd {
    public static class _cube19 {
        ...
        private class State큐브19 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4035, 4036, 4037, 5035, 5036, 5037}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State큐브Remove : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4035, 4036, 4037, 5035, 5036, 5037}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }

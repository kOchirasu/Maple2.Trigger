namespace Maple2.Trigger._52100201_qd {
    public static class _cube14 {
        ...
        private class State큐브14 : TriggerState {
            internal State큐브14(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4025, 4026}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State큐브Remove : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4025, 4026}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }

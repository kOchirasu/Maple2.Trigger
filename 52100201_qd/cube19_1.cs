namespace Maple2.Trigger._52100201_qd {
    public static class _cube19_1 {
        ...
        private class StateOff_1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{5035, 5036, 5037}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateOn_1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{5035, 5036, 5037}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateOff_7 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 200)) {
                    context.SetUserValue(triggerId: 920019, key: "CubeOff", value: 0);
                    context.SetUserValue(triggerId: 910019, key: "Cube", value: 2);

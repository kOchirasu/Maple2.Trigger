namespace Maple2.Trigger._52100201_qd {
    public static class _cube16 {
        ...
        private class State큐브16 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4028, 5028}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State큐브Remove : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4028, 5028}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }

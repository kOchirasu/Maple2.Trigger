namespace Maple2.Trigger._52100201_qd {
    public static class _cube5 {
        ...
        private class State큐브5 : TriggerState {
            internal State큐브5(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4008}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State큐브Remove : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{4008}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (context.UserDetected(boxIds: new []{9004})) {
                    context.SetUserValue(triggerId: 910005, key: "Cube", value: 0);

    ...
    public static class _06_toroom_false {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10002086}, arg2: 0);
        ...
        private class StateToRoomFalse : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10002086}, arg2: 1);
            }

            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {10002086}, arg2: 0)) {

    ...
    public static class _10_ironplatetrap {
        public class StateSetting : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10002080}, state: 0, arg4: false);
        ...
        private class StateLeverOn : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10002080}, state: 1);
                context.SetEffect(triggerIds: new []{5100, 5101, 5102, 5103}, visible: true);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10002080}, arg2: 0)) {

    ...
    public static class _torchlight_04 {
        ...
        private class StateEvent_04 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new int[] {7541}, arg2: true);
                context.SetMesh(
                    arg1: new int[] {
                        6051, 6052, 6053, 6054, 6055, 6056, 6057, 6058, 6059, 6060, 6061, 6062, 6063, 6064, 6065, 6066
        ...
        private class Stateburn_state : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {7504}, arg2: true);
                context.SetMesh(
                    arg1: new int[] {
                        6051, 6052, 6053, 6054, 6055, 6056, 6057, 6058, 6059, 6060, 6061, 6062, 6063, 6064, 6065, 6066
                    }, arg2: false, arg3: 800, arg4: 100, arg5: 8f);
                context.SetEventUI(arg1: 1, arg2: "$02010052_BF__TORCHLIGHT_04__0$", arg3: new int[] {3000});
        ...
        private class Staterun_01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {501, 502, 503, 504, 505, 506}, arg2: true);
            }

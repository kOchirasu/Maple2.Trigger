    ...
    public static class _torchlight_05 {
        ...
        private class Stateidle : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {7542}, arg2: false);
                context.SetMesh(arg1: new int[] {6083, 6084, 6085, 6086, 6087, 6088, 6089, 6090}, arg2: false, arg3: 0,
                    arg4: 0, arg5: 0f);
                context.SetMesh(
                    arg1: new int[] {6071, 6072, 6073, 6074, 6075, 6076, 6077, 6078, 6079, 6080, 6081, 6082},
        ...
        private class Statefreeze : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {7542}, arg2: true);
        ...
        private class Stateburn_state : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {7505}, arg2: true);
                context.SetMesh(
                    arg1: new int[] {6071, 6072, 6073, 6074, 6075, 6076, 6077, 6078, 6079, 6080, 6081, 6082},
                    arg2: false, arg3: 800, arg4: 100, arg5: 8f);
                context.SetMesh(arg1: new int[] {600001}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEventUI(arg1: 1, arg2: "$02010052_BF__TORCHLIGHT_05__1$", arg3: new int[] {3000});
        ...
        private class Statespawn_state : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {510, 511, 512, 513, 514, 515}, arg2: true);
                context.SetTimer(arg1: "1", arg2: 1, arg4: false);
            }
        ...
        private class Stateblock_spawn : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {6083, 6084, 6085, 6086, 6087, 6088, 6089, 6090}, arg2: true, arg3: 80,
                    arg4: 500, arg5: 8f);
            }

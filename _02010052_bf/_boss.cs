...
namespace Maple2.Trigger._02010052_bf {
    public static class _boss {
        ...
        private class StateBoss_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.TimeExpired(arg1: "1")) {
                    context.State = new StateBoss_01b(context);
                    return;
                }
            }
        ...
        private class StateBoss_01b : TriggerState {
            ...
            public override void Execute() {
                if (context.TimeExpired(arg1: "1")) {
                    context.State = new StateBoss_01c(context);
                    return;
                }
            }
        ...
        private class Stateburn_state_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.TimeExpired(arg1: "1")) {
                    context.State = new StateBoss_02_idle(context);
                    return;
                }
            }
        ...
        private class StateBoss_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.TimeExpired(arg1: "1")) {
                    context.State = new StateBoss_02b(context);
                    return;
                }
            }
        ...
        private class StateBoss_02b : TriggerState {
            ...
            public override void Execute() {
                if (context.TimeExpired(arg1: "1")) {
                    context.State = new StateBoss_02c(context);
                    return;
                }
            }
        ...
        private class Stateburn_state_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.TimeExpired(arg1: "1")) {
                    context.State = new StateBoss_03_idle(context);
                    return;
                }
            }
        ...
        private class StateBoss_03 : TriggerState {
            ...
            public override void Execute() {
                if (context.TimeExpired(arg1: "1")) {
                    context.State = new StateBoss_03b(context);
                    return;
                }
            }
        ...
        private class StateBoss_03b : TriggerState {
            ...
            public override void Execute() {
                if (context.TimeExpired(arg1: "1")) {
                    context.State = new StateBoss_03c(context);
                    return;
                }
            }
        ...
        private class Stateburn_state_04 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(
                    arg1: new int[] {
                        ...
                        6345, 6346, 6347, 6348, 6349, 6350, 6351, 6352, 6353, 6354, 6355, 6356, 6357, 6358, 6359, 6360,
            ...
            public override void Execute() {
                if (context.TimeExpired(arg1: "6")) {
                    context.State = new StateBoss_battle_01(context);
                    return;
                }
            }

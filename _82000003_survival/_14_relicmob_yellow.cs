    ...
    public static class _14_relicmob_yellow {
        ...
        private class StateSetting : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {1400, 1401, 1402, 1403, 1404, 1405, 1406, 1407, 1408, 1409});
        ...
        private class StateMobSpawn01 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {1400})) {
        ...
        private class StateMobSpawn02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {1401}, arg2: false);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {1401})) {
                    context.State = new StateNotice(context);
                    return;
                }
        ...
        private class StateMobSpawn03 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {1402}, arg2: false);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {1402})) {
                    context.State = new StateNotice(context);
                    return;
                }
        ...
        private class StateMobSpawn04 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {1403}, arg2: false);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {1403})) {
                    context.State = new StateNotice(context);
                    return;
                }
        ...
        private class StateMobSpawn05 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {1404}, arg2: false);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {1404})) {
                    context.State = new StateNotice(context);
                    return;
                }
        ...
        private class StateMobSpawn06 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {1405}, arg2: false);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {1405})) {
                    context.State = new StateNotice(context);
                    return;
                }
        ...
        private class StateMobSpawn07 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {1406}, arg2: false);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {1406})) {
                    context.State = new StateNotice(context);
                    return;
                }
        ...
        private class StateMobSpawn08 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {1407}, arg2: false);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {1407})) {
                    context.State = new StateNotice(context);
                    return;
                }
        ...
        private class StateMobSpawn09 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {1408}, arg2: false);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {1408})) {
                    context.State = new StateNotice(context);
                    return;
                }
        ...
        private class StateMobSpawn10 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {1409}, arg2: false);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {1409})) {
                    context.State = new StateNotice(context);
                    return;
                }

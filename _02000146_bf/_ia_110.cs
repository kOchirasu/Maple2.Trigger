    ...
    public static class _ia_110 {
        ...
        private class State시작대기중 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000185}, arg2: 1);
        ...
        private class State오브젝트반응 : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000185}, arg2: 0)) {
            ...
            public override void OnExit() {
                ...
                context.CreateMonster(arg1: new int[] {410});
            }
        }
        ...
        private class StateNPC등장 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 410, arg3: "$02000146_BF__IA_110__0$", arg4: 3);
                context.SetTimer(arg1: "1", arg2: 15);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {410})) {

    ...
    public static class _ia_101 {
        ...
        private class State시작대기중 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000176}, arg2: 1);
                context.SetActor(arg1: 201, arg2: true, arg3: "Attack_Idle_A");
            }
        ...
        private class State오브젝트반응 : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000176}, arg2: 0)) {
            ...
            public override void OnExit() {
                context.SetActor(arg1: 201, arg2: false, arg3: "Attack_Idle_A");
        ...
        private class StateNPC등장 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 401, arg3: "$02000146_BF__IA_101__0$", arg4: 3);

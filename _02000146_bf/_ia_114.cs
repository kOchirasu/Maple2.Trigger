    ...
    public static class _ia_114 {
        ...
        private class State시작대기중 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000189}, arg2: 1);
        ...
        private class State오브젝트반응 : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000189}, arg2: 0)) {
            ...
            public override void OnExit() {
                ...
                context.CreateMonster(arg1: new int[] {414});
            }
        }
        ...
        private class StateNPC등장 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {414})) {

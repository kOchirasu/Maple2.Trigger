namespace Maple2.Trigger._02000355_bf {
    public static class _actor06 {
        public class StateWait : TriggerState {
            internal StateWait(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{606}, visible: false);
                context.SetActor(triggerId: 206, visible: true, initialSequence: "Damg_B");
            }

            public override TriggerState? Execute() {
                if (context.UserDetected(boxIds: new []{1601})) {
        ...
        private class State더미해제 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(triggerId: 206, visible: false, initialSequence: "Damg_B");
            }
        ...
        private class State리젠Prepare : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(triggerId: 206, visible: true, initialSequence: "Regen_A");
            }

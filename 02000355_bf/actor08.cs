    ...
    public static class _actor08 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetActor(triggerId: 208, visible: true, initialSequence: "Damg_B");
            }

            public override TriggerState? Execute() {
                if (context.UserDetected(boxIds: new []{1801})) {
        ...
        private class State더미해제 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(triggerId: 208, visible: false, initialSequence: "Damg_B");
            }
        ...
        private class State리젠Prepare : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(triggerId: 208, visible: true, initialSequence: "Regen_A");
            }

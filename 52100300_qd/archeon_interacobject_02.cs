namespace Maple2.Trigger._52100300_qd {
    public static class _archeon_interacobject_02 {
        ...
        private class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10002287}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10002287}, arg2: 0)) {
                    context.SetInteractObject(interactIds: new []{10002287}, state: 2);

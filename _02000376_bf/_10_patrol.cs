...
namespace Maple2.Trigger._02000376_bf {
    public static class _10_patrol {
        ...
        private class StateNpcChange01 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9301, arg2: new int[] {101})) {
        ...
        private class StatePatrol01 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9302, arg2: new int[] {101})) {
        ...
        private class StatePatrol02 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9303, arg2: new int[] {101})) {
        ...
        private class StatePatrol03 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9304, arg2: new int[] {101})) {
        ...
        private class StatePatrol04 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9305, arg2: new int[] {101})) {

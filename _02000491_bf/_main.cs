    ...
    public static class _main {
        public class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new[] {3101, 3102, 3103, 3104, 3105, 3106}, arg2: true, arg3: 0, arg4: 0,
                    arg5: 0f);
                context.SetMesh(arg1: new[] {3113, 3114}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                ...
                context.SetInteractObject(arg1: new[] {10000983}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10000984}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10000985}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10000986}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10000987}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10000988}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10000995}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10000996}, arg2: 2);
            }
        ...
        private class State전투02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {10000983}, arg2: 1);
                context.SetInteractObject(arg1: new[] {10000984}, arg2: 1);
                context.CreateMonster(arg1: new[] {12101, 12102, 12201, 12202, 12203, 12204, 12205, 12206},
                    arg2: false);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new[] {12101, 12102, 12201, 12202, 12203, 12204, 12205, 12206})) {
        ...
        private class State전투03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {10000986}, arg2: 1);
                context.CreateMonster(
                    arg1: new[]
                        {13101, 13102, 13103, 13104, 13105, 13106, 13107, 13108, 13201, 13202, 13203, 13204},
                    arg2: false);
            }
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new[]
                    ...
                    context.SetInteractObject(arg1: new[] {10000987}, arg2: 1);
                    context.SetInteractObject(arg1: new[] {10000988}, arg2: 1);
        ...
        private class State포털개방 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(
                    arg1: new[] {41101, 41102, 41103, 41104, 41105, 41106, 41201, 41202, 41203, 41204},
                    arg2: false);
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new[]
                    ...
                    context.SetInteractObject(arg1: new[] {10000995}, arg2: 1);
                    context.SetInteractObject(arg1: new[] {10000996}, arg2: 1);

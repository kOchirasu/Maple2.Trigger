    ...
    public static class _main2 {
        public class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {3107, 3108, 3109, 3110, 3111, 3112}, arg2: true, arg3: 0, arg4: 0,
                    arg5: 0f);
                context.SetMesh(arg1: new[] {3115, 3116}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetInteractObject(arg1: new[] {10000989}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10000990}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10000991}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10000992}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10000993}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10000994}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10000997}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10000998}, arg2: 2);
            }
        ...
        private class State전투02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {10000990}, arg2: 1);
                context.CreateMonster(
                    arg1: new[]
                        {22101, 22102, 22103, 22104, 22105, 22106, 22107, 22201, 22202, 22203, 22204, 22205},
                    arg2: false);
            }
        ...
        private class State전투03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(
                    arg1: new[]
                        {23102, 23103, 23104, 23105, 23106, 23107, 23108, 23201, 23202, 23203, 23204, 23205},
                    arg2: false);
            }
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new[]
                    ...
                    context.SetInteractObject(arg1: new[] {10000993}, arg2: 1);
        ...
        private class State전투04 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new[] {
                    ...
                    context.SetInteractObject(arg1: new[] {10000998}, arg2: 1);

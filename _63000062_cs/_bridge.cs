        ...
        private class State대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.DayOfWeek(dayOfWeeks: new byte[] {1}, desc: "1(일)-7(토)")) {
                    context.SetMesh(arg1: new int[] {4022, 4023, 4024}, arg2: false);
                    context.SetMesh(arg1: new int[] {4021, 4025, 4026, 4027}, arg2: true);
                    context.SetMesh(arg1: new int[] {4030}, arg2: true);
                    context.State = new State일요일(context);
                    return;
                }

                if (context.DayOfWeek(dayOfWeeks: new byte[] {2}, desc: "1(일)-7(토)")) {
                    context.SetMesh(arg1: new int[] {4023, 4024}, arg2: false);
                    context.SetMesh(arg1: new int[] {4021, 4022, 4025, 4026, 4027}, arg2: true);
                    context.SetMesh(arg1: new int[] {4030}, arg2: true);
                ...
                if (context.DayOfWeek(dayOfWeeks: new byte[] {3}, desc: "1(일)-7(토)")) {
                    context.SetMesh(arg1: new int[] {4024}, arg2: false);
                    context.SetMesh(arg1: new int[] {4021, 4022, 4023, 4025, 4026, 4027}, arg2: true);
                    context.SetMesh(arg1: new int[] {4030}, arg2: true);
                    context.State = new State화요일(context);
                    return;
                }

                if (context.DayOfWeek(dayOfWeeks: new byte[] {4}, desc: "수요일")) {
                    context.SetMesh(arg1: new int[] {4021, 4022, 4023, 4024, 4025, 4026, 4027}, arg2: true);
                    context.SetMesh(arg1: new int[] {4030}, arg2: false, desc: "바운딩 메쉬를 끈다");
                    context.State = new State수요일(context);
                    return;
                }

                if (context.DayOfWeek(dayOfWeeks: new byte[] {5}, desc: "1(일)-7(토)")) {
                    context.SetMesh(arg1: new int[] {4021, 4022, 4023, 4024, 4026, 4027}, arg2: false);
                    context.SetMesh(arg1: new int[] {4025}, arg2: true);
                    context.SetMesh(arg1: new int[] {4030}, arg2: true);
                ...
                if (context.DayOfWeek(dayOfWeeks: new byte[] {6}, desc: "1(일)-7(토)")) {
                    context.SetMesh(arg1: new int[] {4021, 4022, 4023, 4024, 4027}, arg2: false);
                    context.SetMesh(arg1: new int[] {4025, 4026}, arg2: true);
                    context.SetMesh(arg1: new int[] {4030}, arg2: true);
                ...
                if (context.DayOfWeek(dayOfWeeks: new byte[] {7}, desc: "1(일)-7(토)")) {
                    context.SetMesh(arg1: new int[] {4021, 4022, 4023, 4024, 4025, 4026}, arg2: false);
                    context.SetMesh(arg1: new int[] {4025, 4026, 4027}, arg2: true);
                    context.SetMesh(arg1: new int[] {4030}, arg2: true);

    ...
    public static class _barricade {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(triggerIds: new []{70001, 70002, 70003, 70004, 70005}, visible: false);
        ...
        private class StateCount : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "$02000481_BF__BARRICADE__0$", duration: 3000);
            }
        ...
        private class StateBlock : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{80000}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(triggerIds: new []{70001, 70002, 70003, 70004, 70005}, visible: true);
            }

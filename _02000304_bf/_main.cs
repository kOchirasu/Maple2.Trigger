    ...
    public static class _main {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10000646}, arg2: 2);
            }
        ...
        private class State전투시작 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {2001})) {
                    ...
                    context.SetInteractObject(arg1: new int[] {10000646}, arg2: 1);
        ...
        private class State반응대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000646}, arg2: 0)) {

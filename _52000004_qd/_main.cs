    ...
    public static class _main {
        public class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new[] {3001, 3002, 3003, 3004, 3005, 3006, 3007, 3008, 3009}, arg2: false,
        ...
        private class State엘리트스폰 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new[] {3001, 3002, 3003, 3004, 3005, 3006, 3007, 3008, 3009}, arg2: true,
        ...
        private class State미션성공 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new[] {199}, arg2: new[] {10001852},
                    arg3: new byte[] {2})) {
                ...
                if (context.QuestUserDetected(arg1: new[] {199}, arg2: new[] {10001851},
                    arg3: new byte[] {2})) {

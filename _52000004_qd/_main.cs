    ...
    public static class _main {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {3001, 3002, 3003, 3004, 3005, 3006, 3007, 3008, 3009}, arg2: false,
        ...
        private class State엘리트스폰 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {3001, 3002, 3003, 3004, 3005, 3006, 3007, 3008, 3009}, arg2: true,
                    arg3: 0, arg4: 0, arg5: 2f);
        ...
        private class State미션성공 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {199}, arg2: new int[] {10001852},
                    arg3: new byte[] {2})) {
                    context.SetEventUI(arg1: 7, arg2: "$52000004_QD__MAIN__5$", arg3: new int[] {3000}, arg4: "0");
                    context.State = new State포털생성(context);
                    return;
                }

                if (context.QuestUserDetected(arg1: new int[] {199}, arg2: new int[] {10001851},
                    arg3: new byte[] {2})) {
                    context.SetEventUI(arg1: 7, arg2: "$52000004_QD__MAIN__6$", arg3: new int[] {3000}, arg4: "0");
                    context.State = new State포털생성(context);
                    return;
                }

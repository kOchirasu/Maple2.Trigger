    ...
    public static class _52010037 {
        ...
        private class StateWait : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {9001}, arg2: new int[] {91000003},
                    arg3: new byte[] {2})) {
                    context.State = new State지하기지전경씬01(context);
                    return;
                }
                ...
                if (context.QuestUserDetected(arg1: new int[] {9001}, arg2: new int[] {91000004},
                    arg3: new byte[] {2})) {
                    context.CreateMonster(arg1: new int[] {200}, arg2: false);
                    context.State = new State블리체와대장들이동(context);
                    return;
                }

                if (context.QuestUserDetected(arg1: new int[] {9001}, arg2: new int[] {91000010},
                    arg3: new byte[] {3})) {
                    context.State = new State긴급상황발동01(context);
                    return;
                }
                ...
                if (context.QuestUserDetected(arg1: new int[] {9001}, arg2: new int[] {91000003},
                    arg3: new byte[] {3})) {
                    context.State = new State블리체함장등장(context);
                    return;
                }
            }
        ...
        private class State지하기지전경씬01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State지하기지전경씬02(context);
                    return;
                }
            }
        ...
        private class State지하기지전경씬02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State지하기지전경씬02_b(context);
                    return;
                }
            }
        ...
        private class State지하기지전경씬02_b : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State지하기지전경씬02_c(context);
                    return;
                }
            }
        ...
        private class State지하기지전경씬02_c : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State지하기지전경씬03(context);
                    return;
                }
            }
        ...
        private class State지하기지전경씬03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 6000)) {
                    context.State = new State지하기지전경씬04(context);
                    return;
                }
            }
        ...
        private class State긴급상황발동01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1500)) {
                    context.State = new State긴급상황발동02(context);
                    return;
                }
            }

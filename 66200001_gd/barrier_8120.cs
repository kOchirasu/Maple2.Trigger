    ...
    public static class _barrier_8120 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {10001186, 10001202}, arg2: 2);
            }
        ...
        private class StateSensor7122 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new[] {8121, 8122, 8123, 8124, 8125, 8126}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(arg1: new[] {8120}, arg2: false);
                context.SetInteractObject(arg1: new[] {10001186, 10001202}, arg2: 0);
            }
        ...
        private class StateCheckSameUserTag7122 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.CheckSameUserTag(triggerBoxId: 9120) && context.GetUserCount(boxId: 9120) == 2) {
        ...
        private class StateCheckSameUserTag7123 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.CheckSameUserTag(triggerBoxId: 9120) && context.GetUserCount(boxId: 9120) == 3) {
        ...
        private class StateCheckSameUserTag7124 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.CheckSameUserTag(triggerBoxId: 9120) && context.GetUserCount(boxId: 9120) == 4) {
        ...
        private class StateCheckSameUserTag7125 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.CheckSameUserTag(triggerBoxId: 9120) && context.GetUserCount(boxId: 9120) == 5) {

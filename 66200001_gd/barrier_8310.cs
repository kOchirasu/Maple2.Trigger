    ...
    public static class _barrier_8310 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {10001193, 10001209}, arg2: 2);
            }
        ...
        private class StateSensor7312 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new[] {8311, 8312, 8313, 8314, 8315, 8316}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(arg1: new[] {8310}, arg2: false);
                context.SetInteractObject(arg1: new[] {10001193, 10001209}, arg2: 0);
            }
        ...
        private class StateCheckSameUserTag7312 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.CheckSameUserTag(triggerBoxId: 9310) && context.GetUserCount(boxId: 9310) == 2) {
        ...
        private class StateEnable7312 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {10001193}, arg2: 1);
            }

            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {10001193}, arg2: 0)) {
        ...
        private class StateActivate7312 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {10001193}, arg2: 2);
            }
        ...
        private class StateDelay7312 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10001209}, arg2: 1);
            }
            ...
            public override TriggerState Execute() {
                ...
                if (context.ObjectInteracted(arg1: new[] {10001209}, arg2: 0)) {
        ...
        private class StateCheckSameUserTag7313 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.CheckSameUserTag(triggerBoxId: 9310) && context.GetUserCount(boxId: 9310) == 3) {
        ...
        private class StateCheckSameUserTag7314 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.CheckSameUserTag(triggerBoxId: 9310) && context.GetUserCount(boxId: 9310) == 4) {
        ...
        private class StateCheckSameUserTag7315 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.CheckSameUserTag(triggerBoxId: 9310) && context.GetUserCount(boxId: 9310) == 5) {

    ...
    public static class _barrier_8310 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{8311, 8312, 8313, 8314, 8315, 8316}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(triggerIds: new []{8310}, visible: false);
                context.SetInteractObject(interactIds: new []{10001193, 10001209}, state: 2);
            }
        ...
        private class StateSensor7312 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{8311, 8312, 8313, 8314, 8315, 8316}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(triggerIds: new []{8310}, visible: false);
                context.SetInteractObject(interactIds: new []{10001193, 10001209}, state: 0);
            }
        ...
        private class StateSafeGreen7312 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetUserCount(boxId: 9310) == 2) {
                    return new StateCheckSameUserTag7312(context);
                }
        ...
        private class StateCheckSameUserTag7312 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9310) && context.GetUserCount(boxId: 9310) == 2) {
                ...
                if (!context.CheckSameUserTag(boxId: 9310)) {
                    return new StateSafeGreen7312(context);
                }
        ...
        private class StateEnable7312 : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(boxIds: new []{9310}, sound: "DDStop_Stage_Shiled_01");
                context.SetInteractObject(interactIds: new []{10001193}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001193}, arg2: 0)) {
        ...
        private class StateActivate7312 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{8310}, visible: true);
                context.SetMesh(triggerIds: new []{8311, 8312, 8313, 8314, 8315, 8316}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetInteractObject(interactIds: new []{10001193}, state: 2);
            }
        ...
        private class StateDelay7312 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001209}, state: 1);
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (context.ObjectInteracted(interactIds: new []{10001209}, arg2: 0)) {
        ...
        private class StateSafeGreen7313 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetUserCount(boxId: 9310) == 3) {
                    return new StateCheckSameUserTag7313(context);
                }
        ...
        private class StateCheckSameUserTag7313 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9310) && context.GetUserCount(boxId: 9310) == 3) {
        ...
        private class StateSafeGreen7314 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetUserCount(boxId: 9310) == 4) {
                    return new StateCheckSameUserTag7314(context);
                }
        ...
        private class StateCheckSameUserTag7314 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9310) && context.GetUserCount(boxId: 9310) == 4) {
        ...
        private class StateSafeGreen7315 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetUserCount(boxId: 9310) == 5) {
                    return new StateCheckSameUserTag7315(context);
                }
        ...
        private class StateCheckSameUserTag7315 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9310) && context.GetUserCount(boxId: 9310) == 5) {

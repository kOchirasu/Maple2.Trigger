    ...
    public static class _barrier_8240 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{8241, 8242, 8243, 8244, 8245, 8246}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(triggerIds: new []{8240}, visible: false);
                context.SetInteractObject(interactIds: new []{10001192, 10001208}, state: 2);
            }
        ...
        private class StateSensor7242 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{8241, 8242, 8243, 8244, 8245, 8246}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(triggerIds: new []{8240}, visible: false);
                context.SetInteractObject(interactIds: new []{10001192, 10001208}, state: 0);
            }
        ...
        private class StateCheckSameUserTag7242 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9240) && context.GetUserCount(boxId: 9240) == 2) {
                ...
                if (!context.CheckSameUserTag(boxId: 9240)) {
                    return new StateSafeGreen7242(context);
                }
        ...
        private class StateEnable7242 : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(boxIds: new []{9240}, sound: "DDStop_Stage_Shiled_01");
                context.SetInteractObject(interactIds: new []{10001192}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001192}, arg2: 0)) {
        ...
        private class StateActivate7242 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{8240}, visible: true);
                context.SetMesh(triggerIds: new []{8241, 8242, 8243, 8244, 8245, 8246}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetInteractObject(interactIds: new []{10001192}, state: 2);
            }
        ...
        private class StateDelay7242 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001208}, state: 1);
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (context.ObjectInteracted(interactIds: new []{10001208}, arg2: 0)) {
        ...
        private class StateCheckSameUserTag7243 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9240) && context.GetUserCount(boxId: 9240) == 3) {
        ...
        private class StateCheckSameUserTag7244 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9240) && context.GetUserCount(boxId: 9240) == 4) {
        ...
        private class StateCheckSameUserTag7245 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9240) && context.GetUserCount(boxId: 9240) == 5) {

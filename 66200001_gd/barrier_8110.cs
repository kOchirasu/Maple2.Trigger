    ...
    public static class _barrier_8110 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{8111, 8112, 8113, 8114}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(triggerIds: new []{8110}, visible: false);
                context.SetInteractObject(interactIds: new []{10001185, 10001201}, state: 2);
            }
        ...
        private class StateSensor7112 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{8111, 8112, 8113, 8114}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(triggerIds: new []{8110}, visible: false);
                context.SetInteractObject(interactIds: new []{10001185, 10001201}, state: 0);
            }
        ...
        private class StateSafeGreen7112 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetUserCount(boxId: 9110) == 2) {
                    return new StateCheckSameUserTag7112(context);
                }
        ...
        private class StateCheckSameUserTag7112 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9110) && context.GetUserCount(boxId: 9110) == 2) {
                ...
                if (!context.CheckSameUserTag(boxId: 9110)) {
                    return new StateSafeGreen7112(context);
                }
        ...
        private class StateEnable7112 : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(boxIds: new []{9110}, sound: "DDStop_Stage_Shiled_01");
                context.SetInteractObject(interactIds: new []{10001185}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001185}, arg2: 0)) {
        ...
        private class StateActivate7112 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{8110}, visible: true);
                context.SetMesh(triggerIds: new []{8111, 8112, 8113, 8114}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetInteractObject(interactIds: new []{10001185}, state: 2);
            }
        ...
        private class StateDelay7112 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001201}, state: 1);
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (context.ObjectInteracted(interactIds: new []{10001201}, arg2: 0)) {
        ...
        private class StateSafeGreen7113 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetUserCount(boxId: 9110) == 3) {
                    return new StateCheckSameUserTag7113(context);
                }
        ...
        private class StateCheckSameUserTag7113 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9110) && context.GetUserCount(boxId: 9110) == 3) {
        ...
        private class StateSafeGreen7114 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetUserCount(boxId: 9110) == 4) {
                    return new StateCheckSameUserTag7114(context);
                }
        ...
        private class StateCheckSameUserTag7114 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9110) && context.GetUserCount(boxId: 9110) == 4) {
        ...
        private class StateSafeGreen7115 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetUserCount(boxId: 9110) == 5) {
                    return new StateCheckSameUserTag7115(context);
                }
        ...
        private class StateCheckSameUserTag7115 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9110) && context.GetUserCount(boxId: 9110) == 5) {

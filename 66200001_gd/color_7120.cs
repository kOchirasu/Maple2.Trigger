    ...
    public static class _color_7120 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{812}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(triggerIds: new []{912, 1012}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateYellowBefore : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{812}, visible: true, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(triggerIds: new []{912, 1012}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateRedBefore : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{1012}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(triggerIds: new []{912, 812}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateGreenAfter : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{912}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateYellowAfter : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{812}, visible: true, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(triggerIds: new []{912}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(triggerIds: new []{1012}, visible: false, arg3: 100, arg4: 0, arg5: 0f);
            }
        ...
        private class StateRedAfter : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{1012}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(triggerIds: new []{912}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(triggerIds: new []{812}, visible: false, arg3: 100, arg4: 0, arg5: 0f);
            }
        ...
        private class StateClear : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{912}, visible: false, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(triggerIds: new []{812}, visible: false, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(triggerIds: new []{1012}, visible: false, arg3: 0, arg4: 0, arg5: 2f);
            }
        ...
        private class StateRegen : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{812}, visible: true, arg3: 400, arg4: 0, arg5: 0f);
                context.SetMesh(triggerIds: new []{912, 1012}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }

    ...
    public static class _barrier_8210 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10001189, 10001205}, state: 2);
            }
        ...
        private class StateSensor7212 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{8211, 8212, 8213, 8214, 8215, 8216}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(triggerIds: new []{8210}, visible: false);
                context.SetInteractObject(interactIds: new []{10001189, 10001205}, state: 0);
            }
        ...
        private class StateCheckSameUserTag7212 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9210) && context.GetUserCount(boxId: 9210) == 2) {
                ...
                if (!context.CheckSameUserTag(boxId: 9210)) {
                    return new StateSafeGreen7212(context);
                }
        ...
        private class StateEnable7212 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10001189}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001189}, arg2: 0)) {
        ...
        private class StateActivate7212 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10001189}, state: 2);
            }
        ...
        private class StateDelay7212 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001205}, state: 1);
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (context.ObjectInteracted(interactIds: new []{10001205}, arg2: 0)) {
        ...
        private class StateCheckSameUserTag7213 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9210) && context.GetUserCount(boxId: 9210) == 3) {
        ...
        private class StateCheckSameUserTag7214 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9210) && context.GetUserCount(boxId: 9210) == 4) {
        ...
        private class StateCheckSameUserTag7215 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9210) && context.GetUserCount(boxId: 9210) == 5) {

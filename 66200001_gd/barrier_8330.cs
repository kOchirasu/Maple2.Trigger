    ...
    public static class _barrier_8330 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{8331, 8332, 8333, 8334, 8335, 8336, 8337, 8338}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(triggerIds: new []{8330}, visible: false);
                context.SetInteractObject(interactIds: new []{10001195, 10001211}, state: 2);
            }
        ...
        private class StateSensor7332 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{8331, 8332, 8333, 8334, 8335, 8336, 8337, 8338}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(triggerIds: new []{8330}, visible: false);
                context.SetInteractObject(interactIds: new []{10001195, 10001211}, state: 0);
            }
        ...
        private class StateCheckSameUserTag7332 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9330) && context.GetUserCount(boxId: 9330) == 2) {
                ...
                if (!context.CheckSameUserTag(boxId: 9330)) {
                    return new StateSafeGreen7332(context);
                }
        ...
        private class StateEnable7332 : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(boxIds: new []{9330}, sound: "DDStop_Stage_Shiled_01");
                context.SetInteractObject(interactIds: new []{10001195}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001195}, arg2: 0)) {
        ...
        private class StateActivate7332 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{8330}, visible: true);
                context.SetMesh(triggerIds: new []{8331, 8332, 8333, 8334, 8335, 8336, 8337, 8338}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetInteractObject(interactIds: new []{10001195}, state: 2);
            }
        ...
        private class StateDelay7332 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001211}, state: 1);
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (context.ObjectInteracted(interactIds: new []{10001211}, arg2: 0)) {
        ...
        private class StateCheckSameUserTag7333 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9330) && context.GetUserCount(boxId: 9330) == 3) {
        ...
        private class StateCheckSameUserTag7334 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9330) && context.GetUserCount(boxId: 9330) == 4) {
        ...
        private class StateCheckSameUserTag7335 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9330) && context.GetUserCount(boxId: 9330) == 5) {

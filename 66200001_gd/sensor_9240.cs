    ...
    public static class _sensor_9240 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{524, 5240}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StatePass : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(boxIds: new []{9240}, sound: "DDStop_Stage_Pass_01");
                context.SetMesh(triggerIds: new []{524}, visible: false, arg3: 0, arg4: 0, arg5: 2f);
        ...
        private class StateFail : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(boxIds: new []{9240}, sound: "DDStop_Stage_Fail_01");
                context.SetMesh(triggerIds: new []{524}, visible: false, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(triggerIds: new []{5240}, visible: false, arg3: 0, arg4: 0, arg5: 0f);

    ...
    public static class _barrier_8230 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10001191, 10001207}, state: 2);
            }
        ...
        private class StateSensor7232 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{8231, 8232, 8233, 8234, 8235, 8236, 8237, 8238}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(triggerIds: new []{8230}, visible: false);
                context.SetInteractObject(interactIds: new []{10001191, 10001207}, state: 0);
            }
        ...
        private class StateCheckSameUserTag7232 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9230) && context.GetUserCount(boxId: 9230) == 2) {
                ...
                if (!context.CheckSameUserTag(boxId: 9230)) {
                    return new StateSafeGreen7232(context);
                }
        ...
        private class StateEnable7232 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10001191}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001191}, arg2: 0)) {
        ...
        private class StateActivate7232 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10001191}, state: 2);
            }
        ...
        private class StateDelay7232 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001207}, state: 1);
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (context.ObjectInteracted(interactIds: new []{10001207}, arg2: 0)) {
        ...
        private class StateCheckSameUserTag7233 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9230) && context.GetUserCount(boxId: 9230) == 3) {
        ...
        private class StateCheckSameUserTag7234 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9230) && context.GetUserCount(boxId: 9230) == 4) {
        ...
        private class StateCheckSameUserTag7235 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9230) && context.GetUserCount(boxId: 9230) == 5) {

    ...
    public static class _barrier_8440 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{8441, 8442, 8443, 8444}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(triggerIds: new []{8440}, visible: false);
                context.SetInteractObject(interactIds: new []{10001200, 10001216}, state: 2);
            }
        ...
        private class StateSensor7442 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{8441, 8442, 8443, 8444}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(triggerIds: new []{8440}, visible: false);
                context.SetInteractObject(interactIds: new []{10001200, 10001216}, state: 0);
            }
        ...
        private class StateSafeGreen7442 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetUserCount(boxId: 9440) == 2) {
                    return new StateCheckSameUserTag7442(context);
                }
        ...
        private class StateCheckSameUserTag7442 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9440) && context.GetUserCount(boxId: 9440) == 2) {
                ...
                if (!context.CheckSameUserTag(boxId: 9440)) {
                    return new StateSafeGreen7442(context);
                }
        ...
        private class StateEnable7442 : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(boxIds: new []{9440}, sound: "DDStop_Stage_Shiled_01");
                context.SetInteractObject(interactIds: new []{10001200}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001200}, arg2: 0)) {
        ...
        private class StateActivate7442 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{8440}, visible: true);
                context.SetMesh(triggerIds: new []{8441, 8442, 8443, 8444}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetInteractObject(interactIds: new []{10001200}, state: 2);
            }
        ...
        private class StateDelay7442 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001216}, state: 1);
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (context.ObjectInteracted(interactIds: new []{10001216}, arg2: 0)) {
        ...
        private class StateSafeGreen7443 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetUserCount(boxId: 9440) == 3) {
                    return new StateCheckSameUserTag7443(context);
                }
        ...
        private class StateCheckSameUserTag7443 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9440) && context.GetUserCount(boxId: 9440) == 3) {
        ...
        private class StateSafeGreen7444 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetUserCount(boxId: 9440) == 4) {
                    return new StateCheckSameUserTag7444(context);
                }
        ...
        private class StateCheckSameUserTag7444 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9440) && context.GetUserCount(boxId: 9440) == 4) {
        ...
        private class StateSafeGreen7445 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetUserCount(boxId: 9440) == 5) {
                    return new StateCheckSameUserTag7445(context);
                }
        ...
        private class StateCheckSameUserTag7445 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.CheckSameUserTag(boxId: 9440) && context.GetUserCount(boxId: 9440) == 5) {

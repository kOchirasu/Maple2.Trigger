    ...
    public static class _sensor_9210 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{521, 5210}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StatePass : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(boxIds: new []{9210}, sound: "DDStop_Stage_Pass_01");
                context.SetMesh(triggerIds: new []{521}, visible: false, arg3: 0, arg4: 0, arg5: 2f);
        ...
        private class StateFail : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(boxIds: new []{9210}, sound: "DDStop_Stage_Fail_01");
                context.SetMesh(triggerIds: new []{521}, visible: false, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(triggerIds: new []{5210}, visible: false, arg3: 0, arg4: 0, arg5: 0f);

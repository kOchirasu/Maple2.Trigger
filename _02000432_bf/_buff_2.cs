...
namespace Maple2.Trigger._02000432_bf {
    public static class _buff_2 {
        ...
        private class State버프 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBuff(arg1: new int[] {2002}, arg2: 40501003, arg3: 1, arg4: true, arg5: false);
            }
        ...
        private class State사망_버프제거 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBuff(arg1: new int[] {2001}, arg2: 40501005, arg3: 1, arg4: true, arg5: false);
            }

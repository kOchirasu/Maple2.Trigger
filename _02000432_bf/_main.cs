...
namespace Maple2.Trigger._02000432_bf {
    public static class _main {
        ...
        private class State던전시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {1001, 1002, 2001, 2002}, arg2: false);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State던전시작_2(context);
                    return;
                }
            }
        ...
        private class State던전시작_2 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterInCombat(arg1: new int[] {2001, 2002})) {
        ...
        private class State종료연출대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(arg1: new int[] {1001, 1002, 2001, 2002, 2102});

    ...
    public static class _trigger_03_01 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {621, 622, 623, 624, 625, 626, 627, 628, 629});
            }
        ...
        private class State몹생성 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {621, 622, 623, 624, 625, 626, 627, 628, 629}, arg2: false);
                context.SetTimer(arg1: "1", arg2: 120);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {621, 622, 623, 624, 625, 626, 627, 628, 629})) {

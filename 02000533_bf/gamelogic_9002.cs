...
namespace Maple2.Trigger._02000533_bf {
    public static class _gamelogic_9002 {
        ...
        private class State라운드1시작전UI : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "$02000533_BF__GAMELOGIC_9002__0$", arg3: 3000);
            }

            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.LockMyPc(isLock: true);
                    context.SetEventUI(arg1: 1, script: "$02000533_BF__GAMELOGIC_9002__1$", arg3: 6000);
        ...
        private class State라운드1진행 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WidgetCondition(type: WidgetType.TypingGame, arg2: "Result", arg3: "1")) {
                    ...
                    context.SetEventUI(arg1: 1, script: "$02000533_BF__GAMELOGIC_9002__2$", arg3: 3000);
                ...
                if (context.WidgetCondition(type: WidgetType.TypingGame, arg2: "Result", arg3: "0")) {
                    ...
                    context.SetEventUI(arg1: 1, script: "$02000533_BF__GAMELOGIC_9002__3$", arg3: 3000);
                    return new State라운드종료(context);
                }
        ...
        private class State라운드2시작전UI : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "$02000533_BF__GAMELOGIC_9002__4$", arg3: 3000);
            }

            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.LockMyPc(isLock: true);
                    context.SetEventUI(arg1: 1, script: "$02000533_BF__GAMELOGIC_9002__5$", arg3: 4000);
        ...
        private class State라운드2진행 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WidgetCondition(type: WidgetType.TypingGame, arg2: "Result", arg3: "1")) {
                    context.SetEventUI(arg1: 1, script: "$02000533_BF__GAMELOGIC_9002__6$", arg3: 3000);
                    context.WidgetAction(type: WidgetType.Round, name: "RoundResult", args: "1");
                    return new State라운드종료(context);
                }

                if (context.WidgetCondition(type: WidgetType.TypingGame, arg2: "Result", arg3: "0")) {
                    context.SetEventUI(arg1: 1, script: "$02000533_BF__GAMELOGIC_9002__7$", arg3: 3000);
                    context.WidgetAction(type: WidgetType.Round, name: "RoundResult", args: "0");
                    return new State라운드종료(context);
                }
        ...
        private class State라운드3시작전UI : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "$02000533_BF__GAMELOGIC_9002__8$", arg3: 3000);
            }

            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.LockMyPc(isLock: true);
                    context.SetEventUI(arg1: 1, script: "$02000533_BF__GAMELOGIC_9002__9$", arg3: 3000);
        ...
        private class State라운드3진행 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WidgetCondition(type: WidgetType.TypingGame, arg2: "Result", arg3: "1")) {
                    context.LockMyPc(isLock: true);
                    context.SetEventUI(arg1: 1, script: "$02000533_BF__GAMELOGIC_9002__10$", arg3: 3000);
                    context.WidgetAction(type: WidgetType.Round, name: "RoundResult", args: "1");
                    return new State라운드종료(context);
                }

                if (context.WidgetCondition(type: WidgetType.TypingGame, arg2: "Result", arg3: "0")) {
                    context.SetEventUI(arg1: 1, script: "$02000533_BF__GAMELOGIC_9002__11$", arg3: 3000);
                    context.WidgetAction(type: WidgetType.Round, name: "RoundResult", args: "0");
                    return new State라운드종료(context);
                }

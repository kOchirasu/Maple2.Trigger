    ...
    public static class _battlezone_04 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {6609, 6610}, arg2: false);
                context.SetMesh(arg1: new int[] {1531, 1532, 1533, 1534, 1535, 1536, 1537, 1538, 1539, 1540},
                    arg2: true, arg3: 0, arg4: 1000, arg5: 0f);
                context.SetMesh(arg1: new int[] {19994}, arg2: true);
            }
            ...
            public override void Execute() {
                ...
                if (context.MonsterDead(arg1: new int[] {1109, 1110})) {
        ...
        private class State애플몽키소환 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new int[] {6609, 6610}, arg2: true);
            }
        ...
        private class State섹터개방 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {19994}, arg2: false);
                context.SetMesh(arg1: new int[] {1531, 1532, 1533, 1534, 1535, 1536, 1537, 1538, 1539, 1540},

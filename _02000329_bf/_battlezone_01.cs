    ...
    public static class _battlezone_01 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {6602, 6601}, arg2: false);
                context.SetMesh(arg1: new int[] {1501, 1502, 1503, 1504, 1505, 1506, 1507, 1508, 1509, 1510},
            ...
            public override void Execute() {
                ...
                if (context.MonsterDead(arg1: new int[] {1101, 1102})) {
        ...
        private class State애플몽키소환 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new int[] {6602, 6601}, arg2: true);
            }
        ...
        private class State섹터개방 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {19991}, arg2: false);
                context.SetMesh(arg1: new int[] {1501, 1502, 1503, 1504, 1505, 1506, 1507, 1508, 1509, 1510},

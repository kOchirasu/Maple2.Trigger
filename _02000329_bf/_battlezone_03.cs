    ...
    public static class _battlezone_03 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {6605, 6606, 6607, 6608}, arg2: false);
                context.SetMesh(arg1: new int[] {1521, 1522, 1523, 1524, 1525, 1526, 1527, 1528, 1529, 1530},
                    arg2: true, arg3: 0, arg4: 1000, arg5: 0f);
                context.SetMesh(arg1: new int[] {19993}, arg2: true);
            }
        ...
        private class State애플몽키소환 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new int[] {6605, 6606, 6607, 6608}, arg2: true);
            }
        ...
        private class State섹터개방 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {19993}, arg2: false);
                context.SetMesh(arg1: new int[] {1521, 1522, 1523, 1524, 1525, 1526, 1527, 1528, 1529, 1530},

namespace Maple2.Trigger._99999841 {
    public static class _boss_hpcheck {
        ...
        private class State메시지1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "A팀의Boss 체력이 70% 이하입니다.", duration: 5000);
            }
        ...
        private class State메시지2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "A팀의Boss 체력이 50% 이하입니다.", duration: 5000);
            }
        ...
        private class State메시지3 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "A팀의Boss 체력이 30% 이하입니다.", duration: 5000);
            }
        ...
        private class State메시지4 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "A팀의Boss 체력이 10% 이하입니다.", duration: 5000);
            }

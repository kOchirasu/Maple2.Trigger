    ...
    public static class _invasion_portal {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10002184}, state: 2, arg3: false);
            }
        ...
        private class StatePortal열림 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10002184}, state: 1, arg3: false);
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (context.ObjectInteracted(interactIds: new []{10002184}, arg2: 2)) {

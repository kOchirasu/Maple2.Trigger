    ...
    public static class _main_02 {
        ...
        private class Stateidle : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {2002}, arg2: new int[] {60100095},
                    arg3: new byte[] {1})) {
        ...
        private class Stateready : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {404, 405, 406, 407, 408, 409, 410, 411}, arg2: true);
        ...
        private class Statebattle_ready : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(arg1: new int[] {404, 405});
                context.SetSkip();
            }
        ...
        private class Statebattle : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {604, 605}, arg2: true);
            }
        ...
        private class StatebattleMsg : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$52000020_QD__MAIN_02__13$", arg3: new int[] {3000}, arg4: "0");
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {604, 605})) {
        ...
        private class Stateround_2 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {406, 407, 408, 409});
                context.CreateMonster(arg1: new int[] {606, 607, 608, 609}, arg2: true);
            }
        ...
        private class Stateround_3 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {410, 411, 302});
                context.CreateMonster(arg1: new int[] {610, 611, 502}, arg2: true);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {610, 611, 502})) {

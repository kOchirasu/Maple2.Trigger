    ...
    public static class _object3 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {12000086}, arg2: 2);
            }
        ...
        private class State레버3_체크 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.UserDetected(arg1: "9013")) {
                    context.State = new State레버3_안내멘트(context);
                    return;
                }
            }
        ...
        private class State레버3_안내멘트 : TriggerState {
            internal State레버3_안내멘트(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$02020061_BF__OBJECT3__0$", arg3: new int[] {5000}, arg4: "9013");
            }
        ...
        private class State레버3_발동 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {12000086}, arg2: 1);
                context.SetEventUI(arg1: 1, arg2: "$02020061_BF__OBJECT3__1$", arg3: new int[] {5000}, arg4: "9013");
            }
            ...
            public override void Execute() {
                ...
                if (context.ObjectInteracted(arg1: new int[] {12000086}, arg2: 0)) {

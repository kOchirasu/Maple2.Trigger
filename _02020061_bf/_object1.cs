...
namespace Maple2.Trigger._02020061_bf {
    public static class _object1 {
        ...
        private class State레버1_안내멘트 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$02020061_BF__OBJECT1__0$", arg3: new int[] {5000}, arg4: "9011");
            }
        ...
        private class State레버1_발동 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$02020061_BF__OBJECT1__1$", arg3: new int[] {5000}, arg4: "9011");
            }
            ...
            public override void Execute() {
                ...
                if (context.ObjectInteracted(arg1: new int[] {12000084}, arg2: 0)) {

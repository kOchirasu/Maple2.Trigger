...
namespace Maple2.Trigger._02020061_bf {
    public static class _interactmachine_6 {
        ...
        private class State시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10002138}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10002138}, arg2: 0)) {
        ...
        private class State재활성대기 : TriggerState {
            ...
            public override void Execute() {
                if (!context.CheckAnyUserAdditionalEffect(triggerBoxID: 9106, additionalEffectID: 99910370, level: true)
                ) {
                    context.State = new State시작(context);
                    return;
                }

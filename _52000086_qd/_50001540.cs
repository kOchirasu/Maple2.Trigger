...
namespace Maple2.Trigger._52000086_qd {
    public static class _50001540 {
        public static readonly Func<ITriggerContext, TriggerState> Start = context => new State퀘스트체크50100300_1(context);

        private class State퀘스트체크50100300_1 : TriggerState {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {3005, 3006, 3007, 3008, 3009, 3010, 3011, 3012}, arg2: true, arg3: 0,
                    arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {3102, 3103, 3104, 3105}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
        ...
        private class State에르다대사01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003069, illustID: "SnowQueen_normal",
                    msg: "$52000086_QD__50001540__0$", align: "Right", duration: 3000);
            }
        ...
        private class State에르다대사02 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11003069, illustID: "SnowQueen_normal",
                    msg: "$52000086_QD__50001540__1$", align: "Right", duration: 4000);
            }
        ...
        private class State설눈이대사01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003068, illustID: "Seolnunyi_normal",
                    msg: "$52000086_QD__50001540__2$", align: "right", duration: 4000);
            }
        ...
        private class State비에른대사01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003075, illustID: "SnowKing_normal",
                    msg: "$52000086_QD__50001540__3$", align: "left", duration: 4000);
            }
        ...
        private class State설눈이대사02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003068, illustID: "Seolnunyi_normal",
                    msg: "$52000086_QD__50001540__4$", align: "right", duration: 4000);
            }
        ...
        private class State비에른방향전환 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11003068, illustID: "Seolnunyi_normal",
                    msg: "$52000086_QD__50001540__5$", align: "right", duration: 2000);
        ...
        private class State비에른공격 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003068, illustID: "Seolnunyi_normal",
                    msg: "$52000086_QD__50001540__6$", align: "right", duration: 1000);
            }
        ...
        private class State에르다대사03 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelect(arg1: 302, arg2: true);
                context.AddCinematicTalk(npcID: 11003069, illustID: "SnowQueen_normal",
                    msg: "$52000086_QD__50001540__7$", align: "right", duration: 2500);
            }
        ...
        private class State비에른대사02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003075, illustID: "SnowKing_normal",
                    msg: "$52000086_QD__50001540__8$", align: "left", duration: 4000);
                context.AddCinematicTalk(npcID: 11003068, illustID: "Seolnunyi_normal",
                    msg: "$52000086_QD__50001540__9$", align: "right", duration: 3000);
            }
        ...
        private class State비에른대사03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003075, illustID: "SnowKing_normal",
                    msg: "$52000086_QD__50001540__10$", align: "left", duration: 3000);
            }
        ...
        private class State에르다대사04 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003069, illustID: "SnowQueen_normal",
                    msg: "$52000086_QD__50001540__11$", align: "Right", duration: 3000);
            }
        ...
        private class State에르다대사05 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003069, illustID: "SnowQueen_normal",
                    msg: "$52000086_QD__50001540__12$", align: "Right", duration: 4000);
            }
        ...
        private class State연출종료 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkip();
                context.DestroyMonster(arg1: new int[] {1001, 1002, 1003});
                context.CreateMonster(arg1: new int[] {1004, 1005}, arg2: false);
        ...
        private class State비에른대사04 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11003075, illustID: "SnowKing_normal",
                    msg: "$52000086_QD__50001540__13$", align: "left", duration: 4000);
            }
        ...
        private class State비에른대사05 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003075, illustID: "SnowKing_normal",
                    msg: "$52000086_QD__50001540__14$", align: "left", duration: 5000);
            }

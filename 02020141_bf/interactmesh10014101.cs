    ...
    public static class _interactmesh10014101 {
        public class State최초시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10003149}, state: 2);
            }
        ...
        private class State탈것_SpawnCinematic : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{914101}, arg2: false);
            }
        ...
        private class State탈것_Spawn : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10003149}, state: 1);
                context.DestroyMonster(spawnIds: new []{914101});
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10003149}, arg2: 0)) {

    ...
    public static class _mobspawn05 {
        ...
        private class StateTrigger영역체크시작 : TriggerState {
            ...
            public override TriggerState? Execute() {
                ...
                if (context.UserDetected(boxIds: new []{10500})) {
        ...
        private class State졸MonsterSpawn하기 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{10501, 10502, 10503, 10504}, arg2: false);
            }
        ...
        private class State졸MonsterRemove작업 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{10501, 10502, 10503, 10504});
            }

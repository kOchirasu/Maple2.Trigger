    ...
    public static class _interactmesh10014109 {
        public class State최초시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10003152}, state: 2);
            }
        ...
        private class State탈것_SpawnCinematic : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{914109}, arg2: false);
            }
        ...
        private class State탈것_Spawn : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10003152}, state: 1);
                context.DestroyMonster(spawnIds: new []{914109});
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10003152}, arg2: 0)) {

namespace Maple2.Trigger._02020141_bf {
    public static class _mobspawn01 {
        ...
        private class StateTrigger영역체크시작 : TriggerState {
            ...
            public override TriggerState? Execute() {
                ...
                if (context.UserDetected(boxIds: new []{10100})) {
        ...
        private class State졸MonsterSpawn하기 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{10101, 10102, 10103, 10104}, arg2: false);
            }
        ...
        private class State졸MonsterRemove작업 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{10101, 10102, 10103, 10104});
            }

    ...
    public static class _interactmesh10014112 {
        public class State최초시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10003148}, arg2: 2);
            }
        ...
        private class State탈것_SpawnCinematic : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new[] {914112}, arg2: false);
            }
        ...
        private class State탈것_Appear : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10003148}, arg2: 1);
                context.DestroyMonster(arg1: new[] {914112});
            }

            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {10003148}, arg2: 0)) {

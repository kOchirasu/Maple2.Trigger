namespace Maple2.Trigger._02020141_bf {
    public static class _interactmesh10014112 {
        public class State최초시작 : TriggerState {
            internal State최초시작(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10003148}, state: 2);
            }
        ...
        private class State탈것_SpawnCinematic : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{914112}, arg2: false);
            }
        ...
        private class State탈것_Spawn : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10003148}, state: 1);
                context.DestroyMonster(spawnIds: new []{914112});
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10003148}, arg2: 0)) {

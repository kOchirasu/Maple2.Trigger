    ...
    public static class _mobspawn06 {
        ...
        private class StateTrigger영역체크시작 : TriggerState {
            ...
            public override TriggerState Execute() {
                ...
                if (context.UserDetected(arg1: new[] {10600})) {
        ...
        private class State졸MonsterAppear하기 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new[] {10601, 10602, 10603, 10604}, arg2: false);
            }
        ...
        private class State졸MonsterRemove작업 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new[] {10601, 10602, 10603, 10604});
            }

    ...
    public static class _interactmesh10014106 {
        public class State최초시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10003151}, state: 2);
            }
        ...
        private class State탈것_SpawnCinematic : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{914106}, arg2: false);
            }
        ...
        private class State탈것_Spawn : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10003151}, state: 1);
                context.DestroyMonster(spawnIds: new []{914106});
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10003151}, arg2: 0)) {

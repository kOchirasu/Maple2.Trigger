    ...
    public static class _ia_105 {
        public class StateWaitStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10000180}, arg2: 1);
        ...
        private class StateInteractObject : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {10000180}, arg2: 0)) {
        ...
        private class StateNPCSpawn : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 405, script: "$02000146_BF__IA_105__0$", arg4: 3);

    ...
    public static class _ia_105 {
        public class StateWaitStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000180}, state: 1);
                context.SetActor(triggerId: 205, visible: true, initialSequence: "Attack_Idle_A");
            }
        ...
        private class StateInteractObject : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000180}, arg2: 0)) {
            ...
            public override void OnExit() {
                context.SetActor(triggerId: 205, visible: false, initialSequence: "Attack_Idle_A");
        ...
        private class StateNPCSpawn : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 405, script: "$02000146_BF__IA_105__0$", arg4: 3);

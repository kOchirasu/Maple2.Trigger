...
namespace Maple2.Trigger._61000011_me {
    public static class _main {
        ...
        private class StateWait : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WidgetCondition(type: WidgetType.OxQuizUGC, arg2: "IsStarted")) {
                    return new State게임시작(context);
                }

                if (context.WidgetCondition(type: WidgetType.OxQuizUGC, arg2: "IsCanceled")) {
        ...
        private class StateStart : TriggerState {
            ...
            public override TriggerState Execute() {
                ...
                if (context.WidgetCondition(type: WidgetType.OxQuizUGC, arg2: "IsFinished")) {
                    return new State게임끝(context);
                }

                if (context.WidgetCondition(type: WidgetType.OxQuizUGC, arg2: "IsQuizSubmit")) {
        ...
        private class State정답Wait : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WidgetCondition(type: WidgetType.OxQuizUGC, arg2: "IsRemoveWall")) {
                    return new State문제표시(context);
                }

                if (context.WidgetCondition(type: WidgetType.OxQuizUGC, arg2: "IsAnswerSubmit")) {
        ...
        private class State정답체크 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WidgetCondition(type: WidgetType.OxQuizUGC, arg2: "Correct")) {
                    return new State문제정답O(context);
                }

                if (context.WidgetCondition(type: WidgetType.OxQuizUGC, arg2: "Incorrect")) {
        ...
        private class State게임취소 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "$61000011_ME__GAME_END_BY_CANCEL$", arg3: 3000, arg4: "0");
        ...
        private class State우승자CameraCinematic : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 3, script: "$61000011_ME__WINNER_IS$", arg3: 5000, arg4: "105");
                context.SetEventUI(arg1: 3, script: "$61000011_ME__ENVY_IS$", arg3: 5000, arg4: "!105");
        ...
        private class StateEnd : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 5, script: "$61000011_ME__GAME_END_BY_ALL_RETIRED$", arg3: 3000, arg4: "0");
        ...
        private class StateSuccess알림 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 7, script: "$61000011_ME__MAIN__SUCCESS_IS$", arg3: 3000, arg4: "0");
                context.SetTimer(id: "40", arg2: 5);
            }
        ...
        private class State마무리 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, script: "$61000011_ME__MAIN__GOODBYE$", arg3: 3000, arg4: "0");

    ...
    public static class _eagle_01 {
        ...
        private class State시작대기중 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000293}, arg2: 1);
                context.SetActor(arg1: 201, arg2: true, arg3: "Dead_A");
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000293}, arg2: 0)) {
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 301, arg2: "MS2PatrolData_201");
                context.SetConversation(arg1: 1, arg2: 301, arg3: "$02000046_AD__EAGLE_01__0$", arg4: 2);

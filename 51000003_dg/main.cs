    ...
    public static class _main {
        public class StateIdle : TriggerState {
            ...
            public override void OnExit() {
                context.CreateMonster(spawnIds: new []{501, 502, 503, 504, 505, 506, 507, 508, 509}, arg2: true, arg3: 0);
            }
        }
        ...
        private class StateTutorial : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new []{8100, 8101, 8104, 8106, 8103, 8105, 8107, 8108}, returnView: false);
            }
        ...
        private class StateTutorial_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveUser(mapId: 51000003, portalId: 1, boxId: 701);
                context.SetEffect(triggerIds: new []{7998}, visible: false);
                context.CameraSelectPath(pathIds: new []{8005, 8001, 8002}, returnView: false);
                ...
                context.AddBuff(boxIds: new []{701}, skillId: 70000087, level: 1, arg5: false);
            }
            ...
            public override void OnExit() {
                context.DestroyMonster(spawnIds: new []{501, 502, 503, 504, 505, 506, 507, 508, 509});
            }
        }
        ...
        private class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(sound: "System_Monkey_01");
                context.SetAchievement(triggerId: 701, type: "trigger", code: "boomocean_start");
                context.SetAchievement(triggerId: 701, type: "trigger", code: "arcade_startcheck");
                context.SetMesh(triggerIds: new []{6101, 6102, 6103, 6104, 6105, 6106, 6107, 6108, 6109, 6110, 6111, 6112, 6113, 6114, 6115, 6116, 6117, 6118, 6119, 6120, 6121, 6122, 6123, 6124, 6125, 6126, 6127, 6128, 6129, 6130, 6131, 6132, 6133, 6134, 6135, 6136, 6137, 6138, 6139, 6140, 6141, 6142, 6143, 6144, 6145, 6146, 6147, 6148, 6149, 6150, 6151, 6152, 6153, 6154, 6155, 6156, 6157, 6158, 6159, 6160, 6161, 6162, 6163, 6164, 6165, 6166, 6167, 6168, 6169, 6170, 6171, 6172, 6173, 6174, 6175, 6176, 6177, 6178, 6179, 6180, 6181, 6182, 6183, 6184, 6185, 6186, 6187, 6188, 6189, 6190, 6191, 6192, 6193, 6194, 6195, 6196, 6197, 6198, 6199, 6200}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.RemoveBuff(boxId: 49179004, skillId: 0);
                context.ArcadeBoomBoomOceanSetSkillScore(skillId: 49210001, score: -500);
                context.ArcadeBoomBoomOceanSetSkillScore(skillId: 49210011, score: -500);
                context.ArcadeBoomBoomOceanSetSkillScore(skillId: 49210021, score: -500);
                context.ArcadeBoomBoomOceanSetSkillScore(skillId: 49210031, score: -500);
                context.ArcadeBoomBoomOceanSetSkillScore(skillId: 49200021, score: -500);
                context.ArcadeBoomBoomOceanSetSkillScore(skillId: 49200001, score: -500);
                context.ArcadeBoomBoomOceanSetSkillScore(skillId: 49190012, score: -500);
                context.ArcadeBoomBoomOceanSetSkillScore(skillId: 49190022, score: -500);
                context.ArcadeBoomBoomOceanSetSkillScore(skillId: 70000080, score: 1000);
                context.ArcadeBoomBoomOceanSetSkillScore(skillId: 70000081, score: 1000);
                context.ArcadeBoomBoomOceanSetSkillScore(skillId: 70000082, score: 1000);
                context.ArcadeBoomBoomOceanSetSkillScore(skillId: 70000083, score: 1000);
                context.ArcadeBoomBoomOceanSetSkillScore(skillId: 70000085, score: 1000);
            }
        ...
        private class StateStep_01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.PlaySystemSoundInBox(sound: "System_Fruit_Throw_Loop_01");
            }
        ...
        private class StateStep_03 : TriggerState {
            ...
            public override void OnExit() {
                context.SetAchievement(triggerId: 701, type: "trigger", code: "boomocean_1min");
            }
        }
        ...
        private class StateStep_09 : TriggerState {
            ...
            public override void OnExit() {
                context.SetAchievement(triggerId: 701, type: "trigger", code: "boomocean_3min");
            }
        }
        ...
        private class StateStep_15 : TriggerState {
            ...
            public override void OnExit() {
                context.SetAchievement(triggerId: 701, type: "trigger", code: "boomocean_5min");
            }
        }
        ...
        private class StateStep_26 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetAchievement(triggerId: 701, type: "trigger", code: "boomocean_10min");
            }

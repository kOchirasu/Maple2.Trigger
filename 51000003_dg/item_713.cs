namespace Maple2.Trigger._51000003_dg {
    public static class _item_713 {
        public class StateSpawn_check : TriggerState {
            internal StateSpawn_check(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{7713}, visible: false);
            }

            public override TriggerState? Execute() {
                if (context.GetUserValue(key: "item_713_spawn") == 1) {
        ...
        private class StateSpawnItem : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{7713}, visible: true);
                context.SetEffect(triggerIds: new []{7723}, visible: false);
            }

            public override TriggerState? Execute() {
                if (context.UserDetected(boxIds: new []{723})) {
                    return new StateGetItem_Random(context);
                }

                if (context.GetUserValue(key: "item_713_spawn") == 0) {
        ...
        private class StateGetItem_Random : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(triggerIds: new []{7713}, visible: false);
                context.SetEffect(triggerIds: new []{7723}, visible: true);
            }

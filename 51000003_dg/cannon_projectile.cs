    ...
    public static class _cannon_projectile {
        public class StateRound_check : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{111, 112, 113, 114, 115, 116, 117, 118});
            }
        ...
        private class StateRound_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{113}, arg2: true, arg3: 600);
                context.CreateMonster(spawnIds: new []{118}, arg2: true, arg3: 1500);
            }
        ...
        private class StateRound_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{114}, arg2: true, arg3: 700);
                context.CreateMonster(spawnIds: new []{117}, arg2: true, arg3: 1100);
            }
        ...
        private class StateRound_03 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{112}, arg2: true, arg3: 800);
                context.CreateMonster(spawnIds: new []{116}, arg2: true, arg3: 1300);
            }
        ...
        private class StateRound_04 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{111}, arg2: true, arg3: 300);
                context.CreateMonster(spawnIds: new []{115}, arg2: true, arg3: 900);
            }
        ...
        private class StateRound_05 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{111, 112, 113, 114, 115, 116, 117, 118});
                context.CreateMonster(spawnIds: new []{101}, arg2: true, arg3: 1000);
                context.CreateMonster(spawnIds: new []{102}, arg2: true, arg3: 2000);
                context.CreateMonster(spawnIds: new []{103}, arg2: true, arg3: 3000);
                context.CreateMonster(spawnIds: new []{104}, arg2: true, arg3: 4000);
                context.CreateMonster(spawnIds: new []{105}, arg2: true, arg3: 5000);
                context.CreateMonster(spawnIds: new []{106}, arg2: true, arg3: 6000);
                context.CreateMonster(spawnIds: new []{107}, arg2: true, arg3: 7000);
        ...
        private class StateRound_06 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{121}, arg2: true, arg3: 1000);
                context.CreateMonster(spawnIds: new []{122}, arg2: true, arg3: 3000);
                context.CreateMonster(spawnIds: new []{123}, arg2: true, arg3: 5000);
            }
        ...
        private class StateEnd : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{101, 102, 103, 104, 105, 106, 107, 108, 111, 112, 113, 114, 115, 116, 117, 118});
            }

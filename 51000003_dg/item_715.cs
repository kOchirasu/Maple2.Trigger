    ...
    public static class _item_715 {
        public class StateSpawn_check : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{7715, 7725}, visible: false);
            }
        ...
        private class StateSpawnItem : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{7715}, visible: true);
            }

            public override TriggerState? Execute() {
                if (context.UserDetected(boxIds: new []{725})) {
        ...
        private class StateGetItem_Random : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(triggerIds: new []{7715}, visible: false);
                context.SetEffect(triggerIds: new []{7725}, visible: true);
            }

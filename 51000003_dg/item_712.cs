namespace Maple2.Trigger._51000003_dg {
    public static class _item_712 {
        public class StateSpawn_check : TriggerState {
            internal StateSpawn_check(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{7712, 7722}, visible: false);
            }

            public override TriggerState? Execute() {
                if (context.GetUserValue(key: "item_712_spawn") == 1) {
        ...
        private class StateSpawnItem : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{7712}, visible: true);
            }

            public override TriggerState? Execute() {
                if (context.UserDetected(boxIds: new []{722})) {
                    return new StateGetItem_Random(context);
                }

                if (context.GetUserValue(key: "item_712_spawn") == 0) {
        ...
        private class StateGetItem_Random : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(triggerIds: new []{7712}, visible: false);
                context.SetEffect(triggerIds: new []{7722}, visible: true);
            }

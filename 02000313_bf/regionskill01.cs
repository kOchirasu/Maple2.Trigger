    ...
    public static class _regionskill01 {
        public class StateWaitStart : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 11, spawnIds: new []{2099})) {
        ...
        private class StateSkill작동 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(triggerIds: new []{302, 303}, enabled: true);
            }
        ...
        private class StateTriggerReset : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(triggerIds: new []{302, 303}, enabled: false);

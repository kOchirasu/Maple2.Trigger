    ...
    public static class _im_688 {
        public class StateWaitStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000688}, state: 1);
            }
        ...
        private class StateInteractObject : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000688}, arg2: 0)) {
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 1103, script: "$02000040_BF__IM_688__0$", arg4: 2);
            }

            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 1103, spawnIds: new []{1103})) {
        ...
        private class StateNPCDestroy : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetTimer(timerId: "1103", seconds: 60);
            }

            public override TriggerState? Execute() {
                if (context.TimeExpired(timerId: "1103")) {

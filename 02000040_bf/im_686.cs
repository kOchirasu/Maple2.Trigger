    ...
    public static class _im_686 {
        public class StateWaitStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000686}, state: 1);
            }
        ...
        private class StateInteractObject : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000686}, arg2: 0)) {
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 1101, script: "$02000040_BF__IM_686__0$", arg4: 2);
            }

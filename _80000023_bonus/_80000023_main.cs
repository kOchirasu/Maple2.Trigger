...
namespace Maple2.Trigger._80000023_bonus {
    public static class _80000023_main {
        ...
        private class State안내 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityID: 1, textID: 26300739, durationTime: 10);
            }
        ...
        private class State몬스터체크 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityID: 1, textID: 26300739, durationTime: 10000);
            }
        ...
        private class State문열기00 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityID: 2, textID: 26300740, durationTime: 10000);

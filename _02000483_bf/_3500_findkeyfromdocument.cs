    ...
    public static class _3500_findkeyfromdocument {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {3500}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {3501}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetInteractObject(arg1: new int[] {10002042}, arg2: 0);
        ...
        private class StateTrue : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {3501}, arg2: false, arg3: 100, arg4: 0, arg5: 2f);
                context.SetInteractObject(arg1: new int[] {10002042}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10002042}, arg2: 0)) {
        ...
        private class StateKeyFound : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {3500}, arg2: true, arg3: 0, arg4: 0, arg5: 2f);

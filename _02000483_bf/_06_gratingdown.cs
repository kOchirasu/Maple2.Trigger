    ...
    public static class _06_gratingdown {
        ...
        private class StateSetting : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10002051}, arg2: 0);
                context.SetInteractObject(arg1: new int[] {10002052}, arg2: 0);
                context.SetMesh(
        ...
        private class StateBlockEnable : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10002051}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10002051}, arg2: 0)) {
        ...
        private class StateBlockDisable : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10002052}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10002052}, arg2: 0)) {

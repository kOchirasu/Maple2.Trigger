    ...
    public static class _spawncheck {
        ...
        private class State잡몹소멸 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(arg1: new int[] {1027});
                context.DestroyMonster(arg1: new int[] {1028});
                context.DestroyMonster(arg1: new int[] {1029});
                context.DestroyMonster(arg1: new int[] {1030});
            }

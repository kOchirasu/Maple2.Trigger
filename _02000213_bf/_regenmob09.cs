...
namespace Maple2.Trigger._02000213_bf {
    public static class _regenmob09 {
        ...
        private class State소환몹등장 : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000259}, arg2: 1)) {
        ...
        private class State소멸체크 : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000259}, arg2: 0)) {
                    context.State = new State소멸(context);
                    return;
                }

                if (context.ObjectInteracted(arg1: new int[] {10000259}, arg2: 2)) {
                    context.State = new State소멸(context);
                    return;
                }

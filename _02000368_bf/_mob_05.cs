    ...
    public static class _mob_05 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetSkill(arg1: new int[] {7501}, arg2: false);
            }
        ...
        private class State전투01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {501, 511}, arg2: false);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {501, 511})) {
        ...
        private class State전투02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetSkill(arg1: new int[] {7501}, arg2: true);

...
namespace Maple2.Trigger._02000368_bf {
    public static class _main {
        ...
        private class State전투감지 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {101, 111, 201, 211, 301, 311, 401, 411, 501, 511, 601, 611})) {
        ...
        private class State전투감지2 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {102, 202, 302, 402, 502, 602})) {
        ...
        private class State포털개방 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetPortal(arg1: 40, arg2: true, arg3: true, arg4: false);
                context.SetPortal(arg1: 50, arg2: true, arg3: true, arg4: false);
                context.SetPortal(arg1: 60, arg2: true, arg3: true, arg4: false);

...
namespace Maple2.Trigger._02020063_bf {
    public static class _battle_2 {
        ...
        private class State추가Script_1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11001813, illust: "Turka_normal", duration: 5000, script: "$02020063_BF__BATTLE_2__0$");
            }
        ...
        private class State추가Script_2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11003536, illust: "Neirin_surprise", duration: 5000, script: "$02020063_BF__BATTLE_2__1$");
            }
        ...
        private class State추가Script_3 : TriggerState {
            ...
            public override void OnEnter() {
                context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11003533, illust: "Bliche_normal", duration: 5000, script: "$02020063_BF__BATTLE_2__2$");
            }
        ...
        private class State추가Script_4 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "$02020063_BF__BATTLE_2__3$", duration: 5000);
            }
        ...
        private class State포탑소환_2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11003536, illust: "Neirin_surprise", duration: 5000, script: "$02020063_BF__BATTLE_2__4$");
        ...
        private class State포탑소환_3 : TriggerState {
            ...
            public override void OnEnter() {
                context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11003536, illust: "Neirin_surprise", duration: 5000, script: "$02020063_BF__BATTLE_2__5$");
        ...
        private class StateEndWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11003536, illust: "Neirin_smile", duration: 5000, script: "$02020063_BF__BATTLE_2__6$");
            }

    ...
    public static class _10_bomb9 {
        ...
        private class StateStart : TriggerState {
            ...
            public override TriggerState? Execute() {
                ...
                if (context.MonsterDead(spawnIds: new []{313})) {
        ...
        private class State폭탄_터짐 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{2009}, visible: false, arg3: 1500, arg5: 3f);
            }
        ...
        private class StateWaitTime : TriggerState {
            ...
            public override TriggerState? Execute() {
                ...
                if (context.WaitTick(waitTick: 40000)) {
                    context.SetMesh(triggerIds: new []{2009}, visible: true, arg5: 3f);
                    return new StateStart(context);
                }
        ...
        private class StateEnd : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{313});
                context.SetMesh(triggerIds: new []{2009}, visible: false, arg3: 1500, arg5: 3f);
            }

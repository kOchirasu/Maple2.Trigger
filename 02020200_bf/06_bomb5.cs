namespace Maple2.Trigger._02020200_bf {
    public static class _06_bomb5 {
        ...
        private class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{212}, arg2: false);
            }
        ...
        private class State폭탄_터짐 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{2005}, visible: false, arg3: 1500, arg5: 3f);
            }
        ...
        private class StateWaitTime : TriggerState {
            ...
            public override TriggerState? Execute() {
                ...
                if (context.WaitTick(waitTick: 40000)) {
                    context.SetMesh(triggerIds: new []{2005}, visible: true, arg5: 3f);
                    return new StateStart(context);
                }
        ...
        private class StateEnd : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{212});
                context.SetMesh(triggerIds: new []{2005}, visible: false, arg3: 1500, arg5: 3f);
            }

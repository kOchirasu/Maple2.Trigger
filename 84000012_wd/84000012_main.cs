    ...
    public static class _84000012_main {
        ...
        private class StateStartCinematic : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.WeddingMoveUser(type: WeddingEntryType.Guest, mapId: 84000012, portalIds: new []{22, 23}, boxId: 701);
                context.WeddingMoveUser(type: WeddingEntryType.Guest, mapId: 84000012, portalIds: new []{22, 23}, boxId: 703);
                context.WeddingMoveUser(type: WeddingEntryType.Groom, mapId: 84000012, portalIds: new []{11}, boxId: 702);
                context.WeddingMoveUser(type: WeddingEntryType.Bride, mapId: 84000012, portalIds: new []{12}, boxId: 702);
                context.SetPortal(portalId: 99, visible: true, enabled: true, minimapVisible: true);
            }
        ...
        private class State주례줌인02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcId: 11004723, script: "$84000012_WD__84000012_MAIN__0$", duration: 3500);
            }
        ...
        private class State주례사 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetCinematicUI(type: 3);
                context.AddCinematicTalk(npcId: 11004723, script: "$84000012_WD__84000012_MAIN__1$", duration: 4000);
            }
        ...
        private class State탈주로중단 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11004723, script: "$84000012_WD__84000012_MAIN__2$", duration: 3000);
            }
        ...
        private class State탈주로중단선언 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11004723, script: "$84000012_WD__84000012_MAIN__3$", duration: 3000);
            }
        ...
        private class State미입력으로중단01 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11004723, script: "$84000012_WD__84000012_MAIN__4$", duration: 3000);
            }
        ...
        private class State미입력으로중단선언 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11004723, script: "$84000012_WD__84000012_MAIN__5$", duration: 3000);
            }
        ...
        private class State성혼발표 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11004723, script: "$84000012_WD__84000012_MAIN__6$", duration: 2500);

    ...
    public static class _bush_11 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.RemoveBuff(boxId: 1001011, skillId: 70000075);
            }
        ...
        private class StateBuff발동 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBuff(boxIds: new []{1001011}, skillId: 70000075, level: 1, arg4: false, arg5: false);
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (!context.UserDetected(boxIds: new []{1001011})) {
                    return new StateWait(context);
                }

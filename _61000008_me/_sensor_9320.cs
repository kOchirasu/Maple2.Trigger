    ...
    public static class _sensor_9320 {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {532}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {5320}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
            }

            public override void Execute() {
                if (context.UserValue(key: "Box32Check", value: 0)) {
                    context.State = new StateSensor0(context);
                    return;
                }

                if (context.UserValue(key: "Box32Check", value: 1)) {
                    context.State = new StateSensor1(context);
                    return;
                }

                if (context.UserValue(key: "Box32Check", value: 2)) {
                    context.State = new StateSensor2(context);
                    return;
                }

                if (context.UserValue(key: "Box32Check", value: 3)) {
                    context.State = new StateSensor3(context);
                    return;
                }

                if (context.UserValue(key: "Box32Check", value: 4)) {
                    context.State = new StateSensor4(context);
                    return;
                }

                if (context.UserValue(key: "Box32Check", value: 5)) {
                    context.State = new StateSensor5(context);
                    return;
                }

                if (context.UserValue(key: "Box32Check", value: 7)) {
                    context.State = new StateSensor7(context);
                    return;
                }

                if (context.UserValue(key: "Box32Check", value: 8)) {
                    context.State = new StateSensor8(context);
                    return;
                }

                if (context.UserValue(key: "Box32Check", value: 9)) {
                    context.State = new StateSensor9(context);
                    return;
                }

                if (context.UserValue(key: "Box32Check", value: 6)) {
                    context.State = new StateSensor10(context);
                    return;
                }

                if (context.UserValue(key: "Box32Check", value: 15)) {
                    context.State = new StateSensor15(context);
                    return;
                }

                if (context.UserValue(key: "Box32Check", value: 20)) {
                    context.State = new StateSensor20(context);
                    return;
                }

                if (context.UserValue(key: "Box32Check", value: 25)) {
                    context.State = new StateSensor25(context);
                    return;
                }

                if (context.UserValue(key: "Box32Check", value: 30)) {
        ...
        private class StateSensor7 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9320, arg2: 7, arg3: "Equal")) {
        ...
        private class StateSensor8 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9320, arg2: 8, arg3: "Equal")) {
                    context.State = new StateGamblePass(context);
                    return;
                }
        ...
        private class StateSensor9 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9320, arg2: 9, arg3: "Equal")) {
                    context.State = new StateGamblePass(context);
                    return;
                }
        ...
        private class StateSensor10 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9320, arg2: 10, arg3: "Equal")) {
                    context.State = new StateGamblePass(context);
                    return;
                }
        ...
        private class StateSensor15 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9320, arg2: 15, arg3: "Equal")) {
        ...
        private class StateSensor20 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9320, arg2: 20, arg3: "Equal")) {
                    context.State = new StateJackpotPass(context);
                    return;
                }
        ...
        private class StateSensor25 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9320, arg2: 25, arg3: "Equal")) {
                    context.State = new StateJackpotPass(context);
                    return;
                }
        ...
        private class StateSensor30 : TriggerState {
            ...
            public override void Execute() {
                if (context.CountUsers(arg1: 9320, arg2: 30, arg3: "Equal")) {
                    context.State = new StateJackpotPass(context);
                    return;
                }
        ...
        private class StateNormalPass : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(arg1: new int[] {9320}, arg2: "DDStop_Stage_Pass_01");
                context.SetUserValue(triggerID: 7320, key: "Color32", value: 0);
                context.SetMesh(arg1: new int[] {532}, arg2: false, arg3: 0, arg4: 0, arg5: 2f);
            }
        ...
        private class StateGamblePass : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(arg1: new int[] {9320}, arg2: "DDStop_Stage_GamblePass_01");
                context.SetUserValue(triggerID: 7320, key: "Color32", value: 0);
        ...
        private class StateFail : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(arg1: new int[] {9320}, arg2: "DDStop_Stage_Fail_01");
                context.SetMesh(arg1: new int[] {532}, arg2: false, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(arg1: new int[] {5320}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);

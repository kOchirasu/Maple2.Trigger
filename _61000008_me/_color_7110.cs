    ...
    public static class _color_7110 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new[] {1011}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateYellowBefore : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.GetUserValue(key: "Color11") == 3) {
                    // context.State = new StateYellowtoRed(context);
                    return;
                }

                if (context.GetUserValue(key: "Color11") == 4) {
                    context.State = new StateClear(context);
                    return;
                }

                if (context.GetUserValue(key: "Color11") == 0) {
        ...
        private class StateRedBefore : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new[] {911}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new[] {811}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }

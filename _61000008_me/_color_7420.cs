    ...
    public static class _color_7420 {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {842}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {942}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {1042}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateYellowBefore : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {842}, arg2: true, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(arg1: new int[] {942}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {1042}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }

            public override void Execute() {
                if (context.UserValue(key: "Color42", value: 2)) {
                    context.State = new StateGreenAfter(context);
                    return;
                }

                if (context.UserValue(key: "Color42", value: 3)) {
                    // context.State = new StateYellowtoRed(context);
                    return;
                }

                if (context.UserValue(key: "Color42", value: 4)) {
                    context.State = new StateClear(context);
                    return;
                }

                if (context.UserValue(key: "Color42", value: 0)) {
                    context.State = new StateReset(context);
                    return;
                }

                if (context.UserValue(key: "Color42", value: 5)) {
        ...
        private class StateRedBefore : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {1042}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {942}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {842}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }

            public override void Execute() {
                if (context.UserValue(key: "Color42", value: 1)) {
        ...
        private class StateGreenAfter : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {942}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateYellowAfter : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {842}, arg2: true, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(arg1: new int[] {942}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {1042}, arg2: false, arg3: 100, arg4: 0, arg5: 0f);
            }
        ...
        private class StateRedAfter : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {1042}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {942}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {842}, arg2: false, arg3: 100, arg4: 0, arg5: 0f);
            }
        ...
        private class StateClear : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {942}, arg2: false, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(arg1: new int[] {842}, arg2: false, arg3: 0, arg4: 0, arg5: 2f);
                context.SetMesh(arg1: new int[] {1042}, arg2: false, arg3: 0, arg4: 0, arg5: 2f);
            }
        ...
        private class StateRegen : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {842}, arg2: true, arg3: 400, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {942}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {1042}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }

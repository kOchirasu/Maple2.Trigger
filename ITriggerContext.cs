...
namespace Maple2.Trigger {
    public interface ITriggerContext {
        ...
        public void ArcadeSpringFarmSpawnMonster(int[] spawnId = default, int score = 0);
        ...
        public void RandomAdditionalEffect(string target = "", int triggerBoxId = 0, int spawnPointId = 0, byte targetCount = 0, int tick = 0, int waitTick = 0, string targetEffect = "", int additionalEffectId = 0);

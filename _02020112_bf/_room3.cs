    ...
    public static class _room3 {
        public class State대기 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.GetUserValue(key: "Extinction") == 1
                    && context.GetUserValue(key: "Extinction_1_check") == 1
                    && context.GetUserValue(key: "Extinction_2_check") == 1) {
        ...
        private class State격리 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new[] {181}, arg2: false);
                context.CreateMonster(arg1: new[] {182}, arg2: false);
                context.CreateMonster(arg1: new[] {183}, arg2: false);
                context.SetEventUI(arg1: 1, arg2: "$02020112_BF__ROOM3__1$", arg3: 5000, arg4: "932");

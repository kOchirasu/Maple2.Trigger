...
namespace Maple2.Trigger._02020112_bf {
    public static class _seperateroom {
        ...
        private class State시작 : TriggerState {
            ...
            public override void Execute() {
                if (context.CheckNpcHp(compare: "lowerEqual", value: 70, spawnPointId: 191, isRelative: "true")) {
        ...
        private class State격리조치_1_준비 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "Start", value: 2)) {
                    context.State = new State종료(context);
                    return;
                }

                if (context.CheckNpcHp(compare: "lowerEqual", value: 45, spawnPointId: 191, isRelative: "true")) {
        ...
        private class State격리조치_2_준비 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.CheckNpcHp(compare: "lowerEqual", value: 20, spawnPointId: 191, isRelative: "true")) {
                    context.State = new State격리조치_2_준비(context);
                    return;
                }
            }

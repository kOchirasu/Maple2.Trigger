    ...
    public static class _steam_5600 {
        ...
        private class State발사01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{560}, arg2: false);
            }
        ...
        private class State발사02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{561}, arg2: false);
            }
        ...
        private class StateDelay02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(spawnIds: new []{560});
            }
        ...
        private class StateReset : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{561});
            }

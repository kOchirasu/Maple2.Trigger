    ...
    public static class _steam_5700 {
        ...
        private class State발사01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{570}, arg2: false);
            }
        ...
        private class State발사02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{571}, arg2: false);
            }
        ...
        private class StateDelay02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(spawnIds: new []{570});
            }
        ...
        private class StateReset : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{571});
            }

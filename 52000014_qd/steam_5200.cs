    ...
    public static class _steam_5200 {
        ...
        private class State발사01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{520}, arg2: false);
            }
        ...
        private class State발사02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{521}, arg2: false);
            }
        ...
        private class StateDelay02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(spawnIds: new []{520});
            }
        ...
        private class StateReset : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{521});
            }

namespace Maple2.Trigger._52000014_qd {
    public static class _steam_5300 {
        ...
        private class State발사01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{530}, arg2: false);
            }
        ...
        private class State발사02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{531}, arg2: false);
            }
        ...
        private class StateDelay02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(spawnIds: new []{530});
            }
        ...
        private class StateReset : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{531});
            }

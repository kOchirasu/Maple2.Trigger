    ...
    public static class _rockdrop_1000 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(triggerIds: new []{1000, 1002, 1004}, enabled: false);
        ...
        private class State낙하01완료 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(triggerIds: new []{1000}, enabled: true);
            }
        ...
        private class State낙하02완료 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetSkill(triggerIds: new []{1002}, enabled: true);
            }
        ...
        private class State낙하03완료 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetSkill(triggerIds: new []{1004}, enabled: true);
            }

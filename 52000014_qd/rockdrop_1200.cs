    ...
    public static class _rockdrop_1200 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(triggerIds: new []{1200}, enabled: false);
                context.SetEffect(triggerIds: new []{1201}, visible: false);
            }
        ...
        private class State낙하01시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{1201}, visible: true);
            }
        ...
        private class State낙하01완료 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetSkill(triggerIds: new []{1200}, enabled: true);
            }

    ...
    public static class _main {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{3002, 3003, 3004, 3005}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(triggerIds: new []{3006, 3007, 3008, 3009}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State미카Script01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 2, spawnId: 11001285, script: "$52010006_QD__MAIN__0$", arg4: 4);
        ...
        private class State미카Script02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 2, spawnId: 11001285, script: "$52010006_QD__MAIN__10$", arg4: 4);
        ...
        private class State미카이동 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 104, spawnIds: new []{1001})) {
        ...
        private class State미카교체 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.MoveNpc(spawnId: 1007, patrolName: "MS2PatrolData_1001_C");
            }

            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 102, spawnIds: new []{1007})) {
        ...
        private class State카보Script01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
                context.SetConversation(type: 2, spawnId: 11001319, script: "$52010006_QD__MAIN__1$", arg4: 5);
        ...
        private class State카보Script02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 2, spawnId: 11001319, script: "$52010006_QD__MAIN__2$", arg4: 5);
        ...
        private class State미카친구들소환 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSceneSkip();
                context.CreateMonster(spawnIds: new []{1003, 1004, 1005}, arg2: false);
            }
        ...
        private class State스타츠Script01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 2, spawnId: 11001292, script: "$52010006_QD__MAIN__3$", arg4: 2);
        ...
        private class State둔바Script01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 2, spawnId: 11001217, script: "$52010006_QD__MAIN__11$", arg4: 2);
        ...
        private class State타라Script01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 2, spawnId: 11001218, script: "$52010006_QD__MAIN__12$", arg4: 3);
        ...
        private class State카보Script03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 2, spawnId: 11001319, script: "$52010006_QD__MAIN__4$", arg4: 5);
        ...
        private class State카보Script04 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
                context.SetConversation(type: 2, spawnId: 11001319, script: "$52010006_QD__MAIN__5$", arg4: 5);
        ...
        private class State카보Script05 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 2, spawnId: 11001319, script: "$52010006_QD__MAIN__6$", arg4: 5);
                context.MoveNpc(spawnId: 1006, patrolName: "MS2PatrolData_1002_B");
        ...
        private class State사슬해제 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(triggerIds: new []{3001}, visible: false, arg3: 0, arg4: 0, arg5: 3f);
                context.SetMesh(triggerIds: new []{3002, 3003, 3004, 3005}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(triggerIds: new []{3006, 3007, 3008, 3009}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }

            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 300)) {
                    context.MoveNpc(spawnId: 1007, patrolName: "MS2PatrolData_1001_D");
        ...
        private class State스타츠Script02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
                context.SetConversation(type: 2, spawnId: 11001292, script: "$52010006_QD__MAIN__7$", arg4: 5);
        ...
        private class State스타츠Script03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 2, spawnId: 11001292, script: "$52010006_QD__MAIN__8$", arg4: 5);
        ...
        private class State스타츠Script04 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 2, spawnId: 11001292, script: "$52010006_QD__MAIN__9$", arg4: 5);
        ...
        private class StateAchievement : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSceneSkip();
                context.SetAchievement(triggerId: 103, type: "trigger", code: "RescueMika");
            }
        ...
        private class State강제이동 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveUser(mapId: 02010030, portalId: 4, boxId: 0);
            }

    ...
    public static class _1122330_move {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetVisibleBreakableObject(triggerIds: new []{4000, 4001, 4002, 4003, 4004, 4005, 4006, 4007, 4008, 4009, 4010, 4011, 4012, 4013, 4014, 4015, 4016, 4017, 4018, 4019, 4020, 4021}, arg2: false);
                context.SetInteractObject(interactIds: new []{10002013}, state: 2);
        ...
        private class StateBoardApp01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10002013}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10002013}, arg2: 0)) {
        ...
        private class StateBoardGoUp01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetVisibleBreakableObject(triggerIds: new []{4000, 4001, 4002, 4003, 4004, 4005, 4006, 4007, 4008, 4009, 4010, 4011, 4012, 4013, 4014, 4015, 4016, 4017, 4018, 4019, 4020, 4021}, arg2: true);

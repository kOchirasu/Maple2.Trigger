...
namespace Maple2.Trigger._02000177_bf {
    public static class _main {
        ...
        private class StateDungeonStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10001058}, arg2: 1);
                context.SetInteractObject(arg1: new[] {10001059}, arg2: 1);
                context.SetInteractObject(arg1: new[] {10001060}, arg2: 1);
                context.CreateMonster(arg1: new[] {101, 102, 103, 104}, arg2: false);
                context.CreateMonster(arg1: new[] {110, 111, 112, 113, 114, 115, 116, 117}, arg2: false);
                context.CreateMonster(arg1: new[] {120, 121, 122, 123, 124, 125, 126, 127, 128, 129, 130},
                    arg2: false);
                context.CreateMonster(arg1: new[] {141, 142, 143, 144, 145, 146}, arg2: false);
                context.CreateMonster(arg1: new[] {150, 151, 152, 153, 154, 155, 156, 157, 158, 159}, arg2: false);
                context.SetMesh(
                    arg1: new[] {
                ...
                context.SetMesh(arg1: new[] {741, 742, 743, 744, 745, 746, 747, 748, 749, 750}, arg2: true, arg3: 0,
                    arg4: 0, arg5: 0f);
            }
        ...
        private class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new[] {1100, 1101, 1102, 1103, 1104, 1105, 1106, 1107, 1108, 1109, 1110},
        ...
        private class StateStep_2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(
                    arg1: new[] {1000, 1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008, 1009, 1010, 1011, 1012},
        ...
        private class StateStep_3 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(
                    arg1: new[] {1020, 1021, 1022, 1023, 1024, 1025, 1026, 1027, 1028, 1029, 1030, 1031, 1032},
                    arg2: true, arg3: 0, arg4: 100, arg5: 10f);
            }

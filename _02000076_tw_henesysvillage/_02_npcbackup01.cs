    ...
    public static class _02_npcbackup01 {
        ...
        private class State지원군생성 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 201, arg3: "$02000076_TW_HenesysVillage__02_NPCBACKUP01__0$",
                    arg4: 1);
            }

            public override void Execute() {
                if (context.NpcDetected(arg1: 4001, arg2: new int[] {201})) {
        ...
        private class State지원군이동 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 2001, arg2: new int[] {201})) {

namespace Maple2.Trigger._02010026_bf {
    public static class _02_mesh04 {
        public class StateWait : TriggerState {
            internal StateWait(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{2002}, visible: false);
            }

            public override TriggerState? Execute() {
                if (context.UserDetected(boxIds: new []{20002})) {
        ...
        private class StateSetup01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{2002}, visible: true);
            }
        ...
        private class StateSetup01끝 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "1", seconds: 2, clearAtZero: false);
            }

namespace Maple2.Trigger._02010026_bf {
    public static class _02_mesh02 {
        public class StateWait : TriggerState {
            internal StateWait(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{2000}, visible: false);
            }

            public override TriggerState? Execute() {
                if (context.UserDetected(boxIds: new []{20000})) {
        ...
        private class StateSetup01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{2000}, visible: true);
            }

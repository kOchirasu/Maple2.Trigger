    ...
    public static class _meetrookie_job80_03 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {10003012}, arg3: new byte[] {1},
                    arg4: 80)) {
        ...
        private class State미션완료01 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {9900}, arg2: new int[] {10003012},
                    arg3: new byte[] {2})) {

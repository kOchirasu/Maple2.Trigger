    ...
    public static class _bridge {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {301, 302, 303}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetInteractObject(arg1: new int[] {10000319}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000319}, arg2: 0)) {
        ...
        private class State생성 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {301, 302, 303}, arg2: true, arg3: 0, arg4: 500, arg5: 2f);
                context.SetTimer(arg1: "3", arg2: 3, arg3: false, arg4: false);
            }

            public override void Execute() {
                if (context.TimeExpired(arg1: "3")) {
                    context.SetMesh(arg1: new int[] {303, 302, 301}, arg2: false, arg3: 0, arg4: 500, arg5: 2f);

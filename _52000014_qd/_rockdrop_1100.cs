    ...
    public static class _rockdrop_1100 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(arg1: new int[] {1100}, arg2: false);
                context.SetEffect(arg1: new int[] {1101}, arg2: false);
            }
        ...
        private class State낙하01시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {1101}, arg2: true);
            }
        ...
        private class State낙하01완료 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetSkill(arg1: new int[] {1100}, arg2: true);
            }

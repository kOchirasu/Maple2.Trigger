    ...
    public static class _rockdrop_1000 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(arg1: new int[] {1000}, arg2: false);
                context.SetSkill(arg1: new int[] {1002}, arg2: false);
                context.SetSkill(arg1: new int[] {1004}, arg2: false);
                context.SetEffect(arg1: new int[] {1001}, arg2: false);
                context.SetEffect(arg1: new int[] {1003}, arg2: false);
                context.SetEffect(arg1: new int[] {1005}, arg2: false);
            }
        ...
        private class State낙하01완료 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(arg1: new int[] {1000}, arg2: true);
            }
        ...
        private class State낙하02시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {1003}, arg2: true);
            }
        ...
        private class State낙하02완료 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetSkill(arg1: new int[] {1002}, arg2: true);
            }
        ...
        private class State낙하03시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {1005}, arg2: true);
            }
        ...
        private class State낙하03완료 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetSkill(arg1: new int[] {1004}, arg2: true);
            }

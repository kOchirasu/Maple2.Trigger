...
namespace Maple2.Trigger._52000014_qd {
    public static class _steam_5600 {
        ...
        private class State발사01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {560}, arg2: false);
            }
        ...
        private class State발사02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {561}, arg2: false);
            }
        ...
        private class State딜레이02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(arg1: new int[] {560});
            }
        ...
        private class State초기화 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {561});
            }

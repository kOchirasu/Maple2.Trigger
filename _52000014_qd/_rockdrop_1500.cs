    ...
    public static class _rockdrop_1500 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new int[] {1501}, arg2: false);
                context.SetEffect(arg1: new int[] {1503}, arg2: false);
                context.SetEffect(arg1: new int[] {1505}, arg2: false);
            }
        ...
        private class State낙하01시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {1501}, arg2: true);
            }
        ...
        private class State낙하02시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {1503}, arg2: true);
            }
        ...
        private class State낙하03시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {1505}, arg2: true);
            }

    ...
    public static class _cannon_effect20 {
        ...
        private class State시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {820}, arg2: false);
            }

            public override void Execute() {
                if (context.UserDetected(arg1: new int[] {130})) {
        ...
        private class State이펙트대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 130, arg2: new int[] {8020})) {
        ...
        private class State이펙트on : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {820}, arg2: true);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {8020})) {

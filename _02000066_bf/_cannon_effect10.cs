...
namespace Maple2.Trigger._02000066_bf {
    public static class _cannon_effect10 {
        ...
        private class State시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {810}, arg2: false);
            }
        ...
        private class State이펙트대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 120, arg2: new int[] {8010})) {
        ...
        private class State이펙트on : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {8010})) {

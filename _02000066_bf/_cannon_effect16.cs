    ...
    public static class _cannon_effect16 {
        ...
        private class State시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {816}, arg2: false);
            }

            public override void Execute() {
                if (context.UserDetected(arg1: new int[] {126})) {
        ...
        private class State이펙트대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 126, arg2: new int[] {8016})) {
        ...
        private class State이펙트on : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {816}, arg2: true);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {8016})) {

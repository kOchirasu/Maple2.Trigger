    ...
    public static class _cannon_effect17 {
        ...
        private class State시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {817}, arg2: false);
            }

            public override void Execute() {
                if (context.UserDetected(arg1: new int[] {127})) {
        ...
        private class State이펙트대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 127, arg2: new int[] {8017})) {
        ...
        private class State이펙트on : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {817}, arg2: true);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {8017})) {

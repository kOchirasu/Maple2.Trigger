    ...
    public static class _cannon_effect08 {
        public class State시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {808}, arg2: false);
            }
        ...
        private class State이펙트대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 118, arg2: new[] {8008})) {
        ...
        private class State이펙트on : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {808}, arg2: true);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new[] {8008})) {

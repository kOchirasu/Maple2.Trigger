    ...
    public static class _cannon_effect09 {
        ...
        private class State시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {809}, arg2: false);
            }
        ...
        private class State이펙트대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 119, arg2: new int[] {8009})) {
        ...
        private class State이펙트on : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {809}, arg2: true);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {8009})) {

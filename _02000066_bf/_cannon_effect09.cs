    ...
    public static class _cannon_effect09 {
        public class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {809}, arg2: false);
            }
        ...
        private class State이펙트대기 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.NpcDetected(arg1: 119, arg2: new[] {8009})) {
        ...
        private class State이펙트on : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {809}, arg2: true);
            }

            public override TriggerState Execute() {
                if (context.MonsterDead(arg1: new[] {8009})) {

    ...
    public static class _cannon_effect18 {
        public class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {818}, arg2: false);
            }

            public override TriggerState Execute() {
                if (context.UserDetected(arg1: new[] {128})) {
        ...
        private class State이펙트대기 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.NpcDetected(arg1: 128, arg2: new[] {8018})) {
        ...
        private class State이펙트on : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {818}, arg2: true);
            }

            public override TriggerState Execute() {
                if (context.MonsterDead(arg1: new[] {8018})) {

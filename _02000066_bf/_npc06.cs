    ...
    public static class _npc06 {
        ...
        private class State시작 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10000374}, arg2: 0);
            }
        ...
        private class State오브젝트반응 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10000374}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000374}, arg2: 0)) {
        ...
        private class StateNPC대사 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(arg1: 206, arg2: false, arg3: "Dead_A");
                context.SetConversation(arg1: 1, arg2: 2006, arg3: "$02000066_BF__NPC06__1$", arg4: 2);
            }

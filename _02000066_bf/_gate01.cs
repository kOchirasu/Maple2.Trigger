    ...
    public static class _gate01 {
        ...
        private class State생성 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10000304}, arg2: 0);
        ...
        private class State게이트열림 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10000304}, arg2: 1);
        ...
        private class State게이트닫힘 : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000304}, arg2: 0)) {
                    context.State = new State생성(context);
                    return;
                }
            }

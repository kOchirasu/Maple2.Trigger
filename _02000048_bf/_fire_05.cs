    ...
    public static class _fire_05 {
        ...
        private class State시작대기중 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000310}, arg2: 1);
                context.SetMesh(arg1: new int[] {205}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(arg1: new int[] {305}, arg2: false);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000310}, arg2: 0)) {
        ...
        private class State오브젝트반응 : TriggerState {
            ...
            public override void OnExit() {
                context.SetMesh(arg1: new int[] {205}, arg2: true, arg3: 0, arg4: 0, arg5: 1f);
                context.SetEffect(arg1: new int[] {305}, arg2: true);
        ...
        private class State몬스터와전투 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (!context.MonsterInCombat(arg1: new int[] {405})) {

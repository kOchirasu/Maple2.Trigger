...
namespace Maple2.Trigger._02000048_bf {
    public static class _fire_01 {
        ...
        private class State오브젝트반응 : TriggerState {
            ...
            public override void OnExit() {
                context.SetMesh(arg1: new int[] {201}, arg2: true, arg3: 0, arg4: 0, arg5: 1f);
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 401, arg3: "$02000048_BF__FIRE_01__0$", arg4: 2);
        ...
        private class State몬스터와전투 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {401})) {
                    context.State = new State딜레이(context);
                    return;
                }

                if (!context.MonsterInCombat(arg1: new int[] {401})) {

    ...
    public static class _fire_02 {
        ...
        private class State시작대기중 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000307}, arg2: 1);
                context.SetMesh(arg1: new int[] {202}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetEffect(arg1: new int[] {302}, arg2: false);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000307}, arg2: 0)) {
        ...
        private class State오브젝트반응 : TriggerState {
            ...
            public override void OnExit() {
                context.SetMesh(arg1: new int[] {202}, arg2: true, arg3: 0, arg4: 0, arg5: 1f);
                context.SetEffect(arg1: new int[] {302}, arg2: true);
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 402, arg3: "$02000048_BF__FIRE_02__0$", arg4: 2);
        ...
        private class State몬스터와전투 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (!context.MonsterInCombat(arg1: new int[] {402})) {

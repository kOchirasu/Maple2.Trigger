namespace Maple2.Trigger._99999875 {
    public static class _16000_minipuzzle_timetrial {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000071}, state: 2);
        ...
        private class StateSetting : TriggerState {
            ...
            public override TriggerState? Execute() {
                ...
                if (context.ObjectInteracted(interactIds: new []{12000079}, arg2: 0)) {
                    context.SetTimer(timerId: "10", seconds: 90, autoRemove: true, display: false, vOffset: 0);
        ...
        private class StateTimeTrial_Success : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000071}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{12000071}, arg2: 0)) {
                ...
                if (context.TimeExpired(timerId: "100")) {
                    context.SetInteractObject(interactIds: new []{12000071}, state: 0);

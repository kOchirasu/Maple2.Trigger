    ...
    public static class _52000129_main {
        ...
        private class State준비 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new int[] {5001, 5002, 5003, 5004, 5005, 5006, 5007, 5008, 5009, 5010, 5011},
                    arg2: false);
            }

            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {701}, arg2: new int[] {40002691},
                    arg3: new byte[] {1})) {
        ...
        private class State카메라이동_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowCaption(type: "VerticalCaption", title: "$52000129_QD__52000129_MAIN__0$",
                    desc: "$52000129_QD__52000129_MAIN__1$", align: "bottomLeft", offsetRateX: 0f, offsetRateY: 0f,
        ...
        private class State퀘스트받기_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {702}, arg2: new int[] {40002691},
                    arg3: new byte[] {1})) {
                    context.State = new State퀘스트진행_01(context);
                    return;
                }

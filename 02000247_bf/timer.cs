namespace Maple2.Trigger._02000247_bf {
    public static class _timer {
        ...
        private class State초재기2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(id: "99", arg2: 5);
                context.SetEventUI(arg1: 1, script: "$02000247_BF__TIMER__0$", arg3: 3000, arg4: "0");
        ...
        private class StateDelay : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(id: "99", arg2: 5);
                context.SetEventUI(arg1: 1, script: "$02000247_BF__TIMER__1$", arg3: 3000, arg4: "0");
        ...
        private class State초재기3 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "$02000247_BF__TIMER__2$", arg3: 5000, arg4: "0");
            }

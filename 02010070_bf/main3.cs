    ...
    public static class _main3 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetSkill(triggerIds: new []{9001, 9002, 9003, 9004}, arg2: false);
        ...
        private class StateStart4 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{9000}, visible: false);
                context.SetSkill(triggerIds: new []{9001}, arg2: true);
        ...
        private class StateStart5 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetSkill(triggerIds: new []{9002}, arg2: true);
        ...
        private class StateStart6 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetSkill(triggerIds: new []{9003}, arg2: true);
            }
        ...
        private class StateStart7 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetSkill(triggerIds: new []{9004}, arg2: true);
            }

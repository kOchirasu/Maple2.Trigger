...
namespace Maple2.Trigger._80000015_bonus {
    public static class _main {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(
                    arg1: new int[] {
                        ...
                        30040, 30041, 30042, 30043, 30044, 30045, 30046, 30047, 30048, 30049, 30050, 30051, 30052,
                        30053, 30054, 30055, 30056, 30057, 30058, 30059, 30060, 30061, 30062, 30063, 30064, 30065,
        ...
        private class State보스소환대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserDetected(arg1: "198") && context.UserDetected(arg1: "194")) {

...
namespace Maple2.Trigger._80000015_bonus {
    public static class _skill_09 {
        ...
        private class State대기시간 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(arg1: new int[] {720}, arg2: false);
                context.SetSkill(arg1: new int[] {721}, arg2: false);
                context.SetSkill(arg1: new int[] {722}, arg2: false);
                context.SetSkill(arg1: new int[] {723}, arg2: false);
                context.SetSkill(arg1: new int[] {724}, arg2: false);
                context.SetSkill(arg1: new int[] {725}, arg2: false);
            }
        ...
        private class State스킬01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(arg1: new int[] {720}, arg2: true);
            }
        ...
        private class State스킬02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(arg1: new int[] {721}, arg2: true);
            }
        ...
        private class State스킬03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(arg1: new int[] {722}, arg2: true);
            }
        ...
        private class State스킬04 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(arg1: new int[] {723}, arg2: true);
            }
        ...
        private class State스킬05 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(arg1: new int[] {724}, arg2: true);
            }
        ...
        private class State스킬06 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(arg1: new int[] {725}, arg2: true);
            }

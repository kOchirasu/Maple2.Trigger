...
namespace Maple2.Trigger._80000015_bonus {
    public static class _lever {
        ...
        private class State안내 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$80000015_bonus__lever__0$", arg3: new int[] {2000}, arg4: "101");
            }
        ...
        private class State문열림 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {3000, 3001, 3002, 3003, 3004, 3005}, arg2: false, arg3: 0, arg4: 0,
                    arg5: 0f);
            }
        ...
        private class State딜레이 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.SetSkill(arg1: new int[] {7101}, arg2: true);

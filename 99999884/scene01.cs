    ...
    public static class _scene01 {
        ...
        private class State벨라Script1 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 2, arg2: 11000057, script: "$99999884__SCENE01__0$", arg4: 2);
            }
        ...
        private class State벨라Script2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(id: "1", arg2: 2);
                context.SetConversation(arg1: 1, arg2: 202, script: "$99999884__SCENE01__1$", arg4: 2);
            }
        ...
        private class State프레이Script1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(id: "1", arg2: 2);
                context.SetConversation(arg1: 2, arg2: 11000119, script: "$99999884__SCENE01__2$", arg4: 2);
            }
        ...
        private class State벨라Script3 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 202, script: "$99999884__SCENE01__3$", arg4: 2);
            }
        ...
        private class State벨라Script4 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 202, script: "$99999884__SCENE01__4$", arg4: 2);
            }
        ...
        private class State프레이Script2 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 203, script: "$99999884__SCENE01__5$", arg4: 2);
            }
        ...
        private class State벨라Script5 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.MoveNpc(arg1: 202, arg2: "202_MS2PatrolData_Bella_TurnToFrey");
                context.SetConversation(arg1: 1, arg2: 202, script: "$99999884__SCENE01__6$", arg4: 2);
            }
        ...
        private class State오스칼Script1 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 2, arg2: 11000015, script: "$99999884__SCENE01__7$", arg4: 2);
            }
        ...
        private class State오스칼Script2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(id: "1", arg2: 1);
                context.SetConversation(arg1: 1, arg2: 204, script: "$99999884__SCENE01__8$", arg4: 2);
            }

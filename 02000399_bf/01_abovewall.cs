    ...
    public static class _01_abovewall {
        ...
        private class StateMobActorSpawn : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 901, script: "$02000399_BF__01_ABOVEWALL__0$", arg4: 2, arg5: 1);
                context.SetConversation(arg1: 1, arg2: 902, script: "$02000399_BF__01_ABOVEWALL__1$", arg4: 2, arg5: 1);
                context.SetConversation(arg1: 1, arg2: 903, script: "$02000399_BF__01_ABOVEWALL__2$", arg4: 2, arg5: 1);
            }
        ...
        private class StateBattle01Start : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {10001150}, arg2: 1);
            }

            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {10001150}, arg2: 0)) {
        ...
        private class StateBattle03Start : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {10001151}, arg2: 1);
            }

            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {10001151}, arg2: 0)) {
        ...
        private class StateBattle04Start : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {10001152}, arg2: 1);
            }

            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {10001152}, arg2: 0)) {

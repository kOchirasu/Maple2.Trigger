    ...
    public static class _06_gratingdown {
        public class StateSetting : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10002104, 10002105}, state: 0);
        ...
        private class StateBlockEnable : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10002104}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10002104}, arg2: 0)) {
        ...
        private class StateBlockDisable : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10002105}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10002105}, arg2: 0)) {

namespace Maple2.Trigger._02000281_bf {
    public static class _move04 {
        public class StateWait : TriggerState {
            internal StateWait(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetBreakable(triggerIds: new []{804}, enabled: false);
            }

            public override TriggerState? Execute() {
                if (context.UserDetected(boxIds: new []{184})) {
        ...
        private class StateSetup발동 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetBreakable(triggerIds: new []{804}, enabled: true);
            }

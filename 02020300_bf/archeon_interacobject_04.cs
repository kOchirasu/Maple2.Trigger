namespace Maple2.Trigger._02020300_bf {
    public static class _archeon_interacobject_04 {
        ...
        private class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10002189}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10002189}, arg2: 0)) {
                    context.SetInteractObject(interactIds: new []{10002189}, state: 2);

namespace Maple2.Trigger._02020300_bf {
    public static class _monsterspawn {
        ...
        private class State스폰1 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{111, 121, 131, 141}, arg2: false);
            }
        ...
        private class State스폰2 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{112, 122, 132, 142}, arg2: false);
            }
        ...
        private class State스폰3 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{113, 123, 133, 143}, arg2: false);
            }
        ...
        private class State스폰4 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{114, 124, 134, 144}, arg2: false);
            }
        ...
        private class State스폰5 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{115, 125, 135, 145}, arg2: false);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{111, 112, 113, 114, 115, 121, 122, 123, 124, 125, 131, 132, 133, 134, 135, 141, 142, 143, 144, 145})) {

namespace Maple2.Trigger._02020300_bf {
    public static class _archeon_interacobject_02 {
        ...
        private class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10002187}, arg2: 1);
            }

            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {10002187}, arg2: 0)) {
                    context.SetInteractObject(arg1: new[] {10002187}, arg2: 2);

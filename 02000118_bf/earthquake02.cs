    ...
    public static class _earthquake02 {
        public class StateLeverPull : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000291}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000291}, arg2: 0)) {
        ...
        private class StateSkill동작 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetSkill(triggerIds: new []{2005, 2006, 2007, 2008}, enabled: true);
            }
        ...
        private class StateEnd : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetSkill(triggerIds: new []{2005, 2006, 2007, 2008}, enabled: false);
            }

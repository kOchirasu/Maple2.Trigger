    ...
    public static class _01_climbthewall {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10001132, 10001133}, state: 1);
        ...
        private class StateTerraceMobAttack01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 901, script: "$02000398_BF__01_CLIMBTHEWALL__0$", arg4: 2, arg5: 1);
                context.SetConversation(type: 1, spawnId: 902, script: "$02000398_BF__01_CLIMBTHEWALL__1$", arg4: 2, arg5: 1);
                context.SetConversation(type: 1, spawnId: 903, script: "$02000398_BF__01_CLIMBTHEWALL__2$", arg4: 2, arg5: 1);
            }
        ...
        private class StateTowerUnderMobAttack01 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001132}, arg2: 0)) {
        ...
        private class StateGuidePullTheLever01 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001133}, arg2: 0)) {

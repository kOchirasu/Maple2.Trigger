    ...
    public static class _cage_09 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{6809}, visible: false);
                context.SetActor(triggerId: 209, visible: true, initialSequence: "Closed");
                context.CreateMonster(spawnIds: new []{1009, 1109}, arg2: false);
            }
        ...
        private class State닭Creation : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(triggerIds: new []{6809}, visible: true);
            }

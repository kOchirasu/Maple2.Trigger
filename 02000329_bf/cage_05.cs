    ...
    public static class _cage_05 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{6805}, visible: false);
                context.SetActor(triggerId: 205, visible: true, initialSequence: "Closed");
                context.CreateMonster(spawnIds: new []{1005, 1105}, arg2: false);
            }
        ...
        private class State닭Creation : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(triggerIds: new []{6805}, visible: true);
            }

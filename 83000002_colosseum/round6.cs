    ...
    public static class _round6 {
        ...
        private class StateMonsterSpawn : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddBuff(arg1: new[] {106}, arg2: 69000501, arg3: 1, arg4: true);
            }
        ...
        private class State스폰대사 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnPointId: 106, msg: "$83000002_COLOSSEUM__ROUND6__3$", duration: 3000);
                context.SetTimer(id: "LimitTimer", arg2: 120, arg3: true);
                context.SetNpcDuelHpBar(isOpen: true, spawnPointId: 106, durationTick: 120000, npcHpStep: 10);
            }

            public override TriggerState Execute() {
                if (context.MonsterDead(arg1: new[] {106})) {
                    context.AddBalloonTalk(spawnPointId: 106, msg: "$83000002_COLOSSEUM__ROUND6__4$", duration: 3000);
                    context.SetNpcDuelHpBar(isOpen: false, spawnPointId: 106);
        ...
        private class StateClearRoundDelay : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    ...
                    context.SetEventUI(arg1: 3, script: "$83000002_COLOSSEUM__ROUND6__8$", arg3: 3000);
        ...
        private class StateFailRoundDelay : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.SetEventUI(arg1: 5, script: "$83000002_COLOSSEUM__ROUND6__9$", arg3: 3000);
                    return new StateFailRound(context);
                }

    ...
    public static class _round4 {
        ...
        private class State라운드ConditionCheck : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetDungeonRoundsRequired() == 4) {
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_normal", script: "$83000002_COLOSSEUM__ROUND4__0$", duration: 5000);
                    return new State라운드Wait(context);
                }

                context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND4__1$", duration: 3000);
        ...
        private class State라운드Wait : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.SideNpcTalk(type: SideNpcTalkType.CutIn, illust: "Alon_normal", duration: 3000);
        ...
        private class StateMonsterSpawn : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddBuff(boxIds: new []{104}, skillId: 69000501, level: 1, arg4: true);
            }
        ...
        private class State스폰대사 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBalloonTalk(spawnId: 104, msg: "$83000002_COLOSSEUM__ROUND4__3$", duration: 3000);
                context.SetTimer(timerId: "LimitTimer", seconds: 120, clearAtZero: true);
                context.SetNpcDuelHpBar(isOpen: true, spawnId: 104, durationTick: 120000, npcHpStep: 10);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{104})) {
                    context.AddBalloonTalk(spawnId: 104, msg: "$83000002_COLOSSEUM__ROUND4__4$", duration: 3000);
                    context.SetNpcDuelHpBar(isOpen: false, spawnId: 104);
                    return new StateClearRoundDelay(context);
                }

                if (context.TimeExpired(timerId: "LimitTimer")) {
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND4__5$", duration: 3000);
                ...
                if (context.UserDetected(boxIds: new []{902})) {
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND4__6$", duration: 3000);
                    context.DestroyMonster(spawnIds: new []{104});
                    context.SetNpcDuelHpBar(isOpen: false, spawnId: 104);
                    return new StateFailRoundDelay(context);
                }
                ...
                if (!context.UserDetected(boxIds: new []{904})) {
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_switchon", script: "$83000002_COLOSSEUM__ROUND4__7$", duration: 3000);
                    context.DestroyMonster(spawnIds: new []{104});
                    context.SetNpcDuelHpBar(isOpen: false, spawnId: 104);
                    return new StateFailRoundDelay(context);
                }
        ...
        private class StateClearRoundDelay : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    ...
                    context.SetEventUI(arg1: 3, script: "$83000002_COLOSSEUM__ROUND4__8$", duration: 3000);
        ...
        private class StateFailRoundDelay : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.SetEventUI(arg1: 5, script: "$83000002_COLOSSEUM__ROUND4__9$", duration: 3000);
                    return new StateFailRound(context);
                }
        ...
        private class StateClearRound : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    ...
                    context.SideNpcTalk(type: SideNpcTalkType.Talk, npcId: 11004288, illust: "nagi_normal", script: "$83000002_COLOSSEUM__ROUND4__10$", duration: 3000);

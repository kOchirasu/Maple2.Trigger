...
namespace Maple2.Trigger._83000002_colosseum {
    public static class _round9 {
        ...
        private class State스폰대사 : TriggerState {
            ...
            public override TriggerState Execute() {
                ...
                if (!context.UserDetected(arg1: new[] {904})) {
                    context.SetEventUI(arg1: 1, script: "$83000002_COLOSSEUM__ROUND9__7$", arg3: 3000);
        ...
        private class StateClearRoundDelay : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    ...
                    context.SetEventUI(arg1: 3, script: "$83000002_COLOSSEUM__ROUND9__9$", arg3: 3000);
        ...
        private class StateFailRoundDelay : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.SetEventUI(arg1: 5, script: "$83000002_COLOSSEUM__ROUND9__10$", arg3: 3000);
                    return new StateFailRound(context);
                }

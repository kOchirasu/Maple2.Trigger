    ...
    public static class _rockdrop_14 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(triggerIds: new []{8008, 8009, 8010}, enabled: false);
                context.SetEffect(triggerIds: new []{7008, 7009, 7010}, visible: false);
            }
        ...
        private class StateRockDrop02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(triggerIds: new []{8010}, enabled: true);
            }
        ...
        private class StateRockDrop11 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{7009}, visible: true);
            }
        ...
        private class StateRockDrop12 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(triggerIds: new []{8009}, enabled: true);
            }
        ...
        private class StateRockDrop21 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{7008}, visible: true);
            }
        ...
        private class StateRockDrop22 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(triggerIds: new []{8008}, enabled: true);
            }

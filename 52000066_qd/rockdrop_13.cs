    ...
    public static class _rockdrop_13 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(triggerIds: new []{8006, 8007}, enabled: false);
        ...
        private class StateRockDrop02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(triggerIds: new []{8006}, enabled: true);
            }
        ...
        private class StateRockDrop11 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{7007}, visible: true);
            }
        ...
        private class StateRockDrop12 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(triggerIds: new []{8007}, enabled: true);
            }

    ...
    public static class _main30000330 {
        public class StateIdle : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.QuestUserDetected(boxIds: new []{2001}, questIds: new []{30000330}, questStates: new byte[]{2})) {
        ...
        private class StateStartCinematic1 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetNpcEmotionLoop(spawnId: 104, sequenceName: "Quest_Programming", duration: 15000000f);
            }
        ...
        private class StateStartCinematic2 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetNpcEmotionLoop(spawnId: 103, sequenceName: "Talk_A", duration: 9000f);
        ...
        private class State정보검색첫번째2_1 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new []{4013, 4010}, returnView: false);
        ...
        private class State정보검색첫번째3_1 : TriggerState {
            ...
            public override void OnEnter() {
                context.FaceEmotion(spawnId: 104, emotionName: "dance_S");
        ...
        private class State정보검색첫번째4 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetNpcEmotionSequence(spawnId: 104, sequenceName: "Emotion_Troubled_A");
        ...
        private class State정보검색첫번째5 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetPcEmotionLoop(sequenceName: "Talk_A", duration: 20000f);
        ...
        private class State정보검색첫번째9_1 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.FaceEmotion(spawnId: 103, emotionName: "Idle_A");
            }
        ...
        private class State정보검색첫번째10 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.FaceEmotion(spawnId: 103, emotionName: "Trigger_Bore_03");

    ...
    public static class _npc_06 {
        ...
        private class State시작대기중 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000463}, arg2: 1);
                context.CreateMonster(arg1: new int[] {906});
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000463}, arg2: 0)) {
        ...
        private class StateNPC소멸 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {906});
            }

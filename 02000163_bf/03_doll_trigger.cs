namespace Maple2.Trigger._02000163_bf {
    public static class _03_doll_trigger {
        public class StateWait : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000103}, arg2: 0)) {
        ...
        private class State로봇사라짐 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000103}, arg2: 1)) {

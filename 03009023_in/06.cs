    ...
    public static class _06 {
        public class StateWaitStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000238}, state: 1);
                context.CreateMonster(spawnIds: new []{106}, arg2: true);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000238}, arg2: 0)) {
        ...
        private class StateNPC이동 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{206}, arg2: true);
                context.MoveNpc(spawnId: 206, patrolName: "MS2PatrolData_206");
                context.SetConversation(type: 1, spawnId: 206, script: "$03009023_IN__06__0$", arg4: 4, arg5: 1);
            }

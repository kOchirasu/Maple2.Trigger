    ...
    public static class _lookinto_all {
        ...
        private class StateWait : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {60100070},
                    arg3: new byte[] {3})) {
                ...
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {60100065},
                    arg3: new byte[] {3})) {
        ...
        private class StateQuit02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$52000037_QD__LOOKINTO_PRIEST_06__0$", arg3: new int[] {3000},
                    arg4: "0");
            }

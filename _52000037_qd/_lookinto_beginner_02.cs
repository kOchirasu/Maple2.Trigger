namespace Maple2.Trigger._52000037_qd {
    public static class _lookinto_beginner_02 {
        public class StateWait : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new[] {9000}, arg2: new[] {60100070}, arg3: new byte[] {3}, arg4: 1)) {
                    context.State = new StateQuit(context);
                    return;
                }

                if (context.QuestUserDetected(arg1: new[] {9900}, arg2: new[] {60100070}, arg3: new byte[] {2}, arg4: 1)) {
                    context.State = new StateQuit(context);
                    return;
                }

                if (context.QuestUserDetected(arg1: new[] {9900}, arg2: new[] {60100070}, arg3: new byte[] {1}, arg4: 1)) {
                    context.State = new StateLoadingDelay02(context);
                    return;
                }

                if (context.QuestUserDetected(arg1: new[] {9000}, arg2: new[] {60100065}, arg3: new byte[] {3}, arg4: 1)) {
                    context.State = new StateDefaultSetting02(context);
                    return;
                }

                if (context.QuestUserDetected(arg1: new[] {9000}, arg2: new[] {60100065}, arg3: new byte[] {2}, arg4: 1)) {
        ...
        private class StateQuit02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$52000037_QD__LOOKINTO_BEGINNER_02__0$", arg3: 3000, arg4: "0");
            }

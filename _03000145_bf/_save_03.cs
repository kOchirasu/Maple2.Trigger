    ...
    public static class _save_03 {
        ...
        private class State트리거초기화 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {3001}, arg2: false, arg5: 1f);
            }
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000469}, arg2: 1);
                context.CreateMonster(arg1: new int[] {301}, arg2: false);
                context.CreateMonster(arg1: new int[] {302}, arg2: false);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000469}, arg2: 0)) {
        ...
        private class State문열림 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {3001}, arg2: true, arg5: 1f);
        ...
        private class State도망끝 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(arg1: new int[] {312});
            }

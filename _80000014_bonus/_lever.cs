    ...
    public static class _lever {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10001314}, arg2: 1);
                context.SetMesh(arg1: new int[] {3501, 3502, 3503, 3504, 3505, 3506}, arg2: true, arg3: 0, arg4: 0,
                    arg5: 0f);
            }
        ...
        private class State반응대기 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.ObjectInteracted(arg1: new int[] {10001314}, arg2: 0)) {
        ...
        private class State안내 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$80000014_bonus__lever__0$", arg3: new int[] {2000});
            }
        ...
        private class State문열림 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {3501, 3502, 3503, 3504, 3505, 3506}, arg2: false, arg3: 0, arg4: 0,
                    arg5: 0f);
            }

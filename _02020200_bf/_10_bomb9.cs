    ...
    public static class _10_bomb9 {
        ...
        private class State시작 : TriggerState {
            ...
            public override TriggerState Execute() {
                ...
                if (context.MonsterDead(arg1: new[] {313})) {
        ...
        private class State폭탄_터짐 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new[] {2009}, arg2: false, arg3: 1500, arg5: 3f);
            }
        ...
        private class State대기시간 : TriggerState {
            ...
            public override TriggerState Execute() {
                ...
                if (context.WaitTick(waitTick: 40000)) {
                    context.SetMesh(arg1: new[] {2009}, arg2: true, arg5: 3f);
                    return new State시작(context);
                }
        ...
        private class State종료 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new[] {313});
                context.SetMesh(arg1: new[] {2009}, arg2: false, arg3: 1500, arg5: 3f);
            }

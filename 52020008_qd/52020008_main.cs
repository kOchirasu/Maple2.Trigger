    ...
    public static class _52020008_main {
        public class State감지 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(triggerIds: new []{9991}, arg2: false);
                context.SetVisibleBreakableObject(triggerIds: new []{5001, 5002, 5003, 5004, 5005, 5006, 5007, 5008, 5009, 6001, 6002, 7001, 7002}, arg2: false);
        ...
        private class StateCinematicCamera1_벽부수기세팅 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelect(triggerId: 507, enable: true);
            }
        ...
        private class StateCinematicCamera1_레지스탕스Spawn : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(triggerIds: new []{9991}, arg2: true);
        ...
        private class StateCinematicCamera1_세리하Script3 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelect(triggerId: 504, enable: true);
                context.SetVisibleBreakableObject(triggerIds: new []{6001, 6002, 7001, 7002}, arg2: true);
        ...
        private class StateCinematicCamera1_체키Script2 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelect(triggerId: 502, enable: true);
                context.SetVisibleBreakableObject(triggerIds: new []{6001, 6002, 7001, 7002}, arg2: false);
                context.SetBreakable(triggerIds: new []{6001, 6002, 7001, 7002}, enabled: false);
        ...
        private class StateStopCinematic : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetVisibleBreakableObject(triggerIds: new []{5001, 5002, 5003, 5004, 5005, 5006, 5007, 5008, 5009}, arg2: false);

    ...
    public static class _lever_01 {
        ...
        private class State닫힘상태 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {6001, 6002}, arg2: true, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {6020, 6021, 6022, 6023, 6024, 6025, 6026}, arg2: false, arg4: 0,
                    arg5: 0f);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000818}, arg2: 1)) {
        ...
        private class State작동 : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000818}, arg2: 0)) {
        ...
        private class State열림상태 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {6010, 6011, 6012, 6013, 6014, 6015, 6016}, arg2: false, arg4: 200,
                    arg5: 15f);
                context.SetMesh(arg1: new int[] {6020, 6021, 6022, 6023, 6024, 6025, 6026}, arg2: true, arg4: 200,
                    arg5: 15f);
        ...
        private class State열림 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {6001, 6002}, arg2: false, arg4: 0, arg5: 10f);
                context.SetTimer(arg1: "2", arg2: 2);
            }

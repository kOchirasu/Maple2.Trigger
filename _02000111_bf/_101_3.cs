    ...
    public static class _101_3 {
        ...
        private class State시작대기중1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000166}, arg2: 1);
                context.SetMesh(arg1: new int[] {303}, arg2: false);
                context.SetEffect(arg1: new int[] {403}, arg2: false);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000166}, arg2: 0)) {
        ...
        private class State열기1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {303}, arg2: true);
                context.SetEffect(arg1: new int[] {403}, arg2: true);
                context.SetTimer(arg1: "1", arg2: 30);
            }

            public override void Execute() {
                if (context.NpcDetected(arg1: 203, arg2: new int[] {103})) {
                    context.State = new State아이템1(context);
                    return;
                }

                if (context.NpcDetected(arg1: 203, arg2: new int[] {104})) {
                    context.State = new State아이템2(context);
                    return;
                }

                if (context.NpcDetected(arg1: 203, arg2: new int[] {105})) {
        ...
        private class State아이템1 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateItem(arg1: new int[] {503}, arg2: 0, arg3: 10000166);
                context.SetMesh(arg1: new int[] {303}, arg2: false);
                context.SetInteractObject(arg1: new int[] {10000166}, arg2: 1);
                context.SetEffect(arg1: new int[] {403}, arg2: true);

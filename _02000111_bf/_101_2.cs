    ...
    public static class _101_2 {
        ...
        private class State시작대기중1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000165}, arg2: 1);
                context.SetMesh(arg1: new int[] {302}, arg2: false);
                context.SetEffect(arg1: new int[] {402}, arg2: false);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000165}, arg2: 0)) {
        ...
        private class State열기1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {302}, arg2: true);
                context.SetEffect(arg1: new int[] {402}, arg2: true);
                context.SetTimer(arg1: "1", arg2: 30);
            }

            public override void Execute() {
                if (context.NpcDetected(arg1: 202, arg2: new int[] {103})) {
                    context.State = new State아이템1(context);
                    return;
                }

                if (context.NpcDetected(arg1: 202, arg2: new int[] {104})) {
                    context.State = new State아이템2(context);
                    return;
                }

                if (context.NpcDetected(arg1: 202, arg2: new int[] {105})) {
        ...
        private class State아이템1 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateItem(arg1: new int[] {502}, arg2: 0, arg3: 10000165);
                context.SetMesh(arg1: new int[] {302}, arg2: false);
                context.SetInteractObject(arg1: new int[] {10000165}, arg2: 1);
                context.SetEffect(arg1: new int[] {402}, arg2: true);

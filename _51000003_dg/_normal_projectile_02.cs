...
namespace Maple2.Trigger._51000003_dg {
    public static class _normal_projectile_02 {
        ...
        private class StateRound_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {351, 352});
                context.CreateMonster(arg1: new int[] {302}, arg2: true, arg3: 1000);
                context.CreateMonster(arg1: new int[] {303}, arg2: true, arg3: 2000);
            }
        ...
        private class StateRound_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {353, 354});
                context.CreateMonster(arg1: new int[] {304}, arg2: true, arg3: 500);
                context.CreateMonster(arg1: new int[] {305}, arg2: true, arg3: 1500);
            }
        ...
        private class StateRound_03 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {355, 356});
                context.CreateMonster(arg1: new int[] {306}, arg2: true, arg3: 1000);
                context.CreateMonster(arg1: new int[] {301}, arg2: true, arg3: 2000);
            }
        ...
        private class StateRound_04 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {312}, arg2: true, arg3: 500);
                context.CreateMonster(arg1: new int[] {311}, arg2: true, arg3: 1500);
            }

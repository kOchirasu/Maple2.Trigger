    ...
    public static class _item_713 {
        public class StateSpawn_check : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {7713}, arg2: false);
            }
        ...
        private class StateSpawnItem : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {7713}, arg2: true);
                context.SetEffect(arg1: new[] {7723}, arg2: false);
            }

            public override void Execute() {
                if (context.UserDetected(arg1: new[] {723})) {
        ...
        private class StateGetItem_Random : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new[] {7713}, arg2: false);
                context.SetEffect(arg1: new[] {7723}, arg2: true);
            }

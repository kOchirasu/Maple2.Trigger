    ...
    public static class _item_712 {
        public class StateSpawn_check : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {7712, 7722}, arg2: false);
            }
        ...
        private class StateSpawnItem : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {7712}, arg2: true);
            }

            public override void Execute() {
                if (context.UserDetected(arg1: new[] {722})) {
        ...
        private class StateGetItem_Random : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new[] {7712}, arg2: false);
                context.SetEffect(arg1: new[] {7722}, arg2: true);
            }

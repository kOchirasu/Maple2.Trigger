    ...
    public static class _item_712 {
        ...
        private class StateSpawn_check : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {7712}, arg2: false);
                context.SetEffect(arg1: new int[] {7722}, arg2: false);
            }

            public override void Execute() {
                if (context.UserValue(key: "item_712_spawn", value: 1)) {
        ...
        private class StateSpawnItem : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {7712}, arg2: true);
            }
            ...
            public override void Execute() {
                ...
                if (context.UserValue(key: "item_712_spawn", value: 0)) {
        ...
        private class StateGetItem_Random : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new int[] {7712}, arg2: false);
                context.SetEffect(arg1: new int[] {7722}, arg2: true);
            }

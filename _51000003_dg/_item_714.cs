    ...
    public static class _item_714 {
        public class StateSpawn_check : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {7714, 7724}, arg2: false);
            }
        ...
        private class StateSpawnItem : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {7714}, arg2: true);
            }

            public override void Execute() {
                if (context.UserDetected(arg1: new[] {724})) {
        ...
        private class StateGetItem_Random : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new[] {7714}, arg2: false);
                context.SetEffect(arg1: new[] {7724}, arg2: true);
            }

    ...
    public static class _item_715 {
        ...
        private class StateSpawn_check : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {7715}, arg2: false);
                context.SetEffect(arg1: new int[] {7725}, arg2: false);
            }

            public override void Execute() {
                if (context.UserValue(key: "item_715_spawn", value: 1)) {
        ...
        private class StateSpawnItem : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {7715}, arg2: true);
            }

            public override void Execute() {
                if (context.UserDetected(arg1: new int[] {725})) {
                    context.State = new StateGetItem_Random(context);
                    return;
                }

                if (context.UserValue(key: "item_715_spawn", value: 0)) {
        ...
        private class StateGetItem_Random : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new int[] {7715}, arg2: false);
                context.SetEffect(arg1: new int[] {7725}, arg2: true);
            }

    ...
    public static class _04_randomportal {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001137, 10001138, 10001139}, state: 0);
        ...
        private class StateToWall01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001137}, state: 1);
                context.SetUserValue(triggerId: 6, key: "ToRoomFalse", value: 1);
                context.SetUserValue(triggerId: 7, key: "ToTowerFalse", value: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001137}, arg2: 0)) {
        ...
        private class StateToWallGuide01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 2, spawnId: 11000006, script: "$02000396_BF__04_RANDOMPORTAL__1$", arg4: 5);
        ...
        private class StateToRoom01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10001138}, state: 1);
                context.SetUserValue(triggerId: 5, key: "ToWallFalse", value: 1);
                context.SetUserValue(triggerId: 7, key: "ToTowerFalse", value: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001138}, arg2: 0)) {
        ...
        private class StateToRoom02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "$02000396_BF__04_RANDOMPORTAL__2$", duration: 2000, boxId: 0);
        ...
        private class StateToRoomGuide01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
                context.SetConversation(type: 2, spawnId: 11000006, script: "$02000396_BF__04_RANDOMPORTAL__3$", arg4: 5);
        ...
        private class StateToTower01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(triggerId: 5, key: "ToWallFalse", value: 1);
                context.SetUserValue(triggerId: 6, key: "ToRoomFalse", value: 1);
                context.SetInteractObject(interactIds: new []{10001139}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001139}, arg2: 0)) {
        ...
        private class StateToTower02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "$02000396_BF__04_RANDOMPORTAL__4$", duration: 2000, boxId: 0);
        ...
        private class StateToTowerGuide01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
                context.SetConversation(type: 2, spawnId: 11000006, script: "$02000396_BF__04_RANDOMPORTAL__5$", arg4: 5);

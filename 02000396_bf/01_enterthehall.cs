    ...
    public static class _01_enterthehall {
        ...
        private class StateBlackeyeApp02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 101, script: "$02000396_BF__01_ENTERTHEHALL__0$", arg4: 3, arg5: 1);
        ...
        private class StateBlackeyeApp03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 101, script: "$02000396_BF__01_ENTERTHEHALL__1$", arg4: 3, arg5: 0);
        ...
        private class StateEnemyApp02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 901, script: "$02000396_BF__01_ENTERTHEHALL__2$", arg4: 2, arg5: 1);
                context.SetConversation(type: 1, spawnId: 902, script: "$02000396_BF__01_ENTERTHEHALL__3$", arg4: 2, arg5: 1);
                context.SetConversation(type: 1, spawnId: 903, script: "$02000396_BF__01_ENTERTHEHALL__4$", arg4: 2, arg5: 1);
        ...
        private class StateBlackeyeAction01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
                context.SetConversation(type: 2, spawnId: 11000006, script: "$02000396_BF__01_ENTERTHEHALL__5$", arg4: 5);
        ...
        private class StateBlackeyeAction02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 102, script: "$02000396_BF__01_ENTERTHEHALL__6$", arg4: 3, arg5: 1);
        ...
        private class StateMoveToUpstairs02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
                context.SetConversation(type: 2, spawnId: 11000006, script: "$02000396_BF__01_ENTERTHEHALL__7$", arg4: 5);
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(sound: "System_ShowGuideSummary_01");
                context.SetEventUI(arg1: 1, script: "$02000396_BF__01_ENTERTHEHALL__8$", duration: 4000, boxId: 0);
        ...
        private class StateNpcMonologue01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 102, script: "$02000396_BF__01_ENTERTHEHALL__9$", arg4: 3, arg5: 0);
            }
        ...
        private class StateNpcMonologue02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 102, script: "$02000396_BF__01_ENTERTHEHALL__10$", arg4: 3, arg5: 0);
            }
        ...
        private class StateNpcMonologue03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 102, script: "$02000396_BF__01_ENTERTHEHALL__11$", arg4: 3, arg5: 0);
            }
        ...
        private class StateNpcMonologue04 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 102, script: "$02000396_BF__01_ENTERTHEHALL__12$", arg4: 3, arg5: 0);
            }

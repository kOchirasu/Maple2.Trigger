    ...
    public static class _52010069 {
        ...
        private class Statewait_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {2001}, arg2: new int[] {50100680},
                    arg3: new byte[] {3})) {
                ...
                if (context.QuestUserDetected(arg1: new int[] {2001}, arg2: new int[] {50100680},
                    arg3: new byte[] {2})) {
                    context.State = new State아이오브라펜타로(context);
                    return;
                }

                if (context.QuestUserDetected(arg1: new int[] {2001}, arg2: new int[] {50100680},
                    arg3: new byte[] {1})) {
                    context.State = new State전경씬_04(context);
                    return;
                }

                if (context.QuestUserDetected(arg1: new int[] {2001}, arg2: new int[] {50100670},
                    arg3: new byte[] {2})) {
                    context.State = new State전경씬(context);
                    return;
                }
            }
        ...
        private class State전경씬 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State전경씬_02(context);
                    return;
                }
            }
        ...
        private class State전경씬_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State전경씬_03(context);
                    return;
                }
            }
        ...
        private class State전경씬_03 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowCaption(type: "VerticalCaption", title: "$52010069_QD__52010069__0$", align: "bottomLeft",
                    offsetRateX: 0f, offsetRateY: 0f, duration: 5000, scale: 2.5f);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State전경씬_03_01(context);
                    return;
                }
            }
        ...
        private class State전경씬_03_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State전경씬_03_02(context);
                    return;
                }
            }
        ...
        private class State전경씬_04 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State전경씬_04_01(context);
                    return;
                }
            }
        ...
        private class StateQuit02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State조사중_01(context);
                    return;
                }
            }
        ...
        private class State조사중_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State조사중_02(context);
                    return;
                }
            }
        ...
        private class State조사중_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 11000)) {
                    context.State = new State조사중_03(context);
                    return;
                }
            }
        ...
        private class State조사중_03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State재회_01(context);
                    return;
                }
            }
        ...
        private class State재회_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State재회_02(context);
                    return;
                }
            }
        ...
        private class State재회_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 8000)) {
                    context.State = new State재회_03(context);
                    return;
                }
            }
        ...
        private class State재회_03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State재회_04(context);
                    return;
                }
            }
        ...
        private class State재회_04 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11001229, align: "left", illustID: "Ishura_Dark_Idle",
                    msg: "$52010069_QD__52010069__8$", duration: 3000);
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 12000)) {
                    context.State = new State재회_05(context);
                    return;
                }
            }
        ...
        private class State재회_05 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 6000)) {
                    context.State = new State재회정리(context);
                    return;
                }
            }
        ...
        private class State재회정리 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State재회정리_02(context);
                    return;
                }
            }
        ...
        private class State재회정리_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State재회정리_03(context);
                    return;
                }
            }
        ...
        private class State아이오브라펜타로 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State아이오브라펜타로_01(context);
                    return;
                }
            }
        ...
        private class State아이오브라펜타로_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State아이오브라펜타로_02(context);
                    return;
                }
            }

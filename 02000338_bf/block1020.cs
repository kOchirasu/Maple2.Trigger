namespace Maple2.Trigger._02000338_bf {
    public static class _block1020 {
        public class StateWait : TriggerState {
            internal StateWait(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{1020}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }

            public override TriggerState? Execute() {
                if (context.UserDetected(boxIds: new []{10020})) {
        ...
        private class State진행1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{1020}, visible: false, arg3: 0, arg4: 0, arg5: 2f);
            }

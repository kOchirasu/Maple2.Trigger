namespace Maple2.Trigger._02000338_bf {
    public static class _block1000 {
        public class StateWait : TriggerState {
            internal StateWait(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{1000}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State진행1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(timerId: "2", seconds: 30);
                context.SetMesh(triggerIds: new []{1000}, visible: false, arg3: 0, arg4: 0, arg5: 2f);
            }

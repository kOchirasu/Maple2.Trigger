    ...
    public static class _16000_minipuzzle_timetrial {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {12000071}, arg2: 2);
        ...
        private class StateSetting : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.ObjectInteracted(arg1: new int[] {12000079}, arg2: 0)) {
                    context.SetTimer(arg1: "10", arg2: 90, arg3: true, arg4: false, arg5: 0);
        ...
        private class StateTimeTrial_Success : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {12000071}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {12000071}, arg2: 0)) {
                ...
                if (context.TimeExpired(arg1: "100")) {
                    context.SetInteractObject(arg1: new int[] {12000071}, arg2: 0);

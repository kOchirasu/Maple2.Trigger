    ...
    public static class _round_05_skill {
        public class StateWaitStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{3501, 3502, 3503}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State지역Random : TriggerState {
            ...
            public override TriggerState? Execute() {
                ...
                if (context.RandomCondition(rate: 33f)) {
                    context.SetMesh(triggerIds: new []{3502}, visible: true, arg3: 0, arg4: 0, arg5: 0f);
                    return new StateB지역(context);
                }

                if (context.RandomCondition(rate: 34f)) {
                    context.SetMesh(triggerIds: new []{3503}, visible: true, arg3: 0, arg4: 0, arg5: 0f);

namespace Maple2.Trigger._51000001_dg {
    public static class _round_01_skill {
        public class StateWaitStart : TriggerState {
            internal StateWaitStart(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{3101, 3102, 3103}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateA지역 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.UserDetected(boxIds: new []{10101})) {

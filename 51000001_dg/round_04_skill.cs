    ...
    public static class _round_04_skill {
        public class StateWaitStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{3401, 3402, 3403, 3404}, visible: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateC지역 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.UserDetected(boxIds: new []{10403})) {
                    return new StateSkillRandom(context);
                }
        ...
        private class StateD지역 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.UserDetected(boxIds: new []{10404})) {
                    return new StateSkillRandom(context);
                }

...
namespace Maple2.Trigger._66000004_gd {
    public static class _buffskill_04 {
        ...
        private class StateA스킬작동 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(arg1: new int[] {7401}, arg2: true);
                context.SetTimer(arg1: "60", arg2: 60);
            }

            public override void Execute() {
                if (context.TimeExpired(arg1: "60")) {
                    context.SetSkill(arg1: new int[] {7401}, arg2: false);
        ...
        private class StateB스킬작동 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(arg1: new int[] {7402}, arg2: true);
                context.SetTimer(arg1: "60", arg2: 60);
            }

            public override void Execute() {
                if (context.TimeExpired(arg1: "60")) {
                    context.SetSkill(arg1: new int[] {7402}, arg2: false);
                    context.State = new State시작대기중(context);
                    return;
                }
            }
        ...
        private class StateC스킬작동 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(arg1: new int[] {7403}, arg2: true);
                context.SetTimer(arg1: "60", arg2: 60);
            }

            public override void Execute() {
                if (context.TimeExpired(arg1: "60")) {
                    context.SetSkill(arg1: new int[] {7403}, arg2: false);
                    context.State = new State시작대기중(context);
                    return;
                }
            }

    ...
    public static class _portal04 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000905}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000905}, arg2: 0)) {
        ...
        private class StateCreation : TriggerState {
            ...
            public override void OnEnter() {
                context.SetPortal(portalId: 61, visible: true, enabled: true, minimapVisible: false);

    ...
    public static class _round_03_skill {
        ...
        private class State시작대기중 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {3301}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {3302}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {3303}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateA지역 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserDetected(arg1: "10301")) {
        ...
        private class StateB지역 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserDetected(arg1: "10302")) {
                    context.State = new State스킬랜덤(context);
                    return;
                }
            }
        ...
        private class StateC지역 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserDetected(arg1: "10303")) {
                    context.State = new State스킬랜덤(context);
                    return;
                }
            }

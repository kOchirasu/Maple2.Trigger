    ...
    public static class _round_08_skill {
        ...
        private class State시작대기중 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {3801}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {3802}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {3803}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {3804}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {3805}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class State지역랜덤 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.RandomCondition(arg1: 20f)) {
                    context.SetMesh(arg1: new int[] {3801}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                    context.State = new StateA지역(context);
                    return;
                }

                if (context.RandomCondition(arg1: 20f)) {
                    context.SetMesh(arg1: new int[] {3802}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                    context.State = new StateB지역(context);
                    return;
                }

                if (context.RandomCondition(arg1: 20f)) {
                    context.SetMesh(arg1: new int[] {3803}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                    context.State = new StateC지역(context);
                    return;
                }

                if (context.RandomCondition(arg1: 20f)) {
                    context.SetMesh(arg1: new int[] {3804}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                    context.State = new StateD지역(context);
                    return;
                }

                if (context.RandomCondition(arg1: 20f)) {
                    context.SetMesh(arg1: new int[] {3805}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);

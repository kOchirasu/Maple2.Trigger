    ...
    public static class _round_04_skill {
        ...
        private class State시작대기중 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {3402}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {3403}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {3404}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
            }
        ...
        private class StateA지역 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserDetected(arg1: new int[] {10401})) {
        ...
        private class StateB지역 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserDetected(arg1: new int[] {10402})) {
                    context.State = new State스킬랜덤(context);
                    return;
                }
            }
        ...
        private class StateC지역 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserDetected(arg1: new int[] {10403})) {
                    context.State = new State스킬랜덤(context);
                    return;
                }
            }
        ...
        private class StateD지역 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserDetected(arg1: new int[] {10404})) {
                    context.State = new State스킬랜덤(context);
                    return;
                }
            }

    ...
    public static class _12000_minipuzzle_tracingfoothold {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {12000082, 12000083, 12000221, 12000075}, arg2: 2);
        ...
        private class StateTracingFootHold_Success : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {12000221}, arg2: 1);
                context.SetTimer(id: "2", arg2: 60, arg3: true, arg4: false, arg5: 0);
            }

            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {12000221}, arg2: 0)) {
                    return new StateTracingFootHold_SuccessDelay(context);
                }

                if (context.TimeExpired(arg1: "2")) {
                    context.SetInteractObject(arg1: new[] {12000221}, arg2: 2);

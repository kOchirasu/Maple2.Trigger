    ...
    public static class _12000_minipuzzle_tracingfoothold {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000082, 12000083, 12000221, 12000075}, state: 2);
        ...
        private class StateTracingFootHold_Success : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000221}, state: 1);
                context.SetTimer(timerId: "2", seconds: 60, clearAtZero: true, display: false, arg5: 0);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{12000221}, arg2: 0)) {
                    return new StateTracingFootHold_SuccessDelay(context);
                }

                if (context.TimeExpired(timerId: "2")) {
                    context.SetInteractObject(interactIds: new []{12000221}, state: 2);

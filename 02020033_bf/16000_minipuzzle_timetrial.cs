namespace Maple2.Trigger._02020033_bf {
    public static class _16000_minipuzzle_timetrial {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000262, 12000079, 12000098}, state: 0);
        ...
        private class StateTimeTrial_Success : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000262}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{12000262}, arg2: 0)) {
                    context.SetInteractObject(interactIds: new []{12000262}, state: 2);
                ...
                if (context.TimeExpired(timerId: "100")) {
                    context.SetInteractObject(interactIds: new []{12000262}, state: 0);
                    context.ResetTimer(timerId: "100");

    ...
    public static class _ia_106 {
        ...
        private class State시작대기중 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(arg1: 106, arg2: false, arg3: "Idle_A");
            }
        ...
        private class State오브젝트반응 : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000095}, arg2: 0)) {
        ...
        private class State개구리보이기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(arg1: 106, arg2: true, arg3: "Idle_A");
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000095}, arg2: 1)) {

...
namespace Maple2.Trigger._02000022_bf {
    public static class _ia_104 {
        ...
        private class State오브젝트반응 : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000093}, arg2: 0)) {
        ...
        private class State개구리보이기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(arg1: 104, arg2: true, arg3: "Idle_A");
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000093}, arg2: 1)) {

namespace Maple2.Trigger._52020016_qd {
    public static class _monster_spawn_4_3 {
        ...
        private class State전투Phase : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new[] {4000404}, arg2: false);
                context.SetConversation(arg1: 1, arg2: 4000404, script: "당신 떄문에!!당신 떄문에!!", arg4: 3, arg5: 0);
            }

            public override TriggerState Execute() {
                if (context.GetNpcHpRate(spawnPointId: 4000404) <= 0.20f) {
        ...
        private class StateMonsterDestroy : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new[] {4000404}, arg2: false);
            }

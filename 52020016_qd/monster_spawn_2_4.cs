namespace Maple2.Trigger._52020016_qd {
    public static class _monster_spawn_2_4 {
        ...
        private class State전투Phase : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{4000104}, arg2: false);
                context.SetConversation(type: 1, spawnId: 4000104, script: "하하하하 어디 한번 발버둥 쳐봐라!!", arg4: 3, arg5: 0);
            }

            public override TriggerState? Execute() {
                if (context.GetNpcHpRate(spawnId: 4000104) <= 0.20f) {
        ...
        private class StateMonsterDestroy : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{4000104}, arg2: false);
            }

namespace Maple2.Trigger._52020016_qd {
    public static class _monster_spawn_1_1 {
        ...
        private class State전투Phase : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{4000001}, arg2: false);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{4000001})) {
        ...
        private class StateMonster리젠 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{4000003}, arg2: false);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{4000003})) {
                    return new State전투Phase(context);
                }
        ...
        private class State끝 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{4000001}, arg2: false);
                context.DestroyMonster(spawnIds: new []{4000003}, arg2: false);
            }

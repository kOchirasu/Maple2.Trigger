namespace Maple2.Trigger._52020016_qd {
    public static class _monster_spawn_4_1 {
        ...
        private class State전투Phase : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new[] {4000402}, arg2: false);
                context.SetConversation(arg1: 1, arg2: 4000402, script: "저를 살려내란 말이에요!!", arg4: 3, arg5: 0);
            }

            public override TriggerState Execute() {
                if (context.GetNpcHpRate(spawnPointId: 4000402) <= 0.20f) {
        ...
        private class StateMonsterDestroy : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new[] {4000402}, arg2: false);
            }

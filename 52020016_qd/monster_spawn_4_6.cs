namespace Maple2.Trigger._52020016_qd {
    public static class _monster_spawn_4_6 {
        ...
        private class State전투Phase : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{4000407}, arg2: false);
                context.SetConversation(type: 1, spawnId: 4000407, script: "같이 놀아요!!", arg4: 3, arg5: 0);
            }

            public override TriggerState? Execute() {
                if (context.GetNpcHpRate(spawnId: 4000407) <= 0.20f) {
        ...
        private class StateMonsterDestroy : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{4000407}, arg2: false);
            }

namespace Maple2.Trigger._52020016_qd {
    public static class _monster_spawn_4_8 {
        ...
        private class State전투Phase : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(spawnIds: new []{4000409}, arg2: false);
                context.SetConversation(type: 1, spawnId: 4000409, script: "죽기 싫탄 말이야에요!!", arg4: 3, arg5: 0);
            }

            public override TriggerState? Execute() {
                if (context.GetNpcHpRate(spawnId: 4000409) <= 0.20f) {
        ...
        private class StateMonsterDestroy : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{4000409}, arg2: false);
            }

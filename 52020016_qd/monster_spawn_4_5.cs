namespace Maple2.Trigger._52020016_qd {
    public static class _monster_spawn_4_5 {
        ...
        private class State전투Phase : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new[] {4000406}, arg2: false);
                context.SetConversation(arg1: 1, arg2: 4000406, script: "헤햇..제가 무서운가요?!", arg4: 3, arg5: 0);
            }

            public override TriggerState Execute() {
                if (context.GetNpcHpRate(spawnPointId: 4000406) <= 0.20f) {
        ...
        private class StateMonsterDestroy : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new[] {4000406}, arg2: false);
            }

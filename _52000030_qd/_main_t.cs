namespace Maple2.Trigger._52000030_qd {
    public static class _main_t {
        ...
        private class State연출시작 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WidgetCondition(arg1: "SceneMovie", arg2: "IsStop", arg3: "1")) {
                    return new State이슈라대사01(context);
                }
        ...
        private class State이슈라대사01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 2, arg2: 11001244, arg3: "$52000030_QD__MAIN_T__0$", arg4: 2, arg5: 0);
                context.SetConversation(arg1: 2, arg2: 11001586, arg3: "$52000030_QD__MAIN_T__1$", arg4: 3, arg5: 0);
        ...
        private class State2차전투 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.MonsterDead(arg1: new[] {2003})) {
                    return new State이슈라대사02(context);
                }
        ...
        private class State이슈라대사02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetProductionUI(arg1: 1);
                context.SetProductionUI(arg1: 3);
                context.SetConversation(arg1: 2, arg2: 11001586, arg3: "$52000030_QD__MAIN_T__2$", arg4: 2, arg5: 0);
            }
        ...
        private class State3차전투 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.MonsterDead(arg1: new[] {2005})) {
                    return new State이슈라대사03(context);
                }
        ...
        private class State이슈라대사03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetProductionUI(arg1: 1);
                context.SetProductionUI(arg1: 3);
                context.SetConversation(arg1: 2, arg2: 11001244, arg3: "$52000030_QD__MAIN_T__3$", arg4: 2, arg5: 0);
                context.SetConversation(arg1: 2, arg2: 11001586, arg3: "$52000030_QD__MAIN_T__4$", arg4: 2, arg5: 0);
            }

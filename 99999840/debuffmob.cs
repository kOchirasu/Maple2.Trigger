    ...
    public static class _debuffmob {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetDungeonVariable(id: 801, value: false);
                context.SetDungeonVariable(id: 802, value: false);
                context.SetDungeonVariable(id: 803, value: false);
            }
        ...
        private class StateA지역 : TriggerState {
            ...
            public override TriggerState? Execute() {
                ...
                if (context.MonsterDead(spawnIds: new []{801})) {
                    ...
                    context.SetDungeonVariable(id: 801, value: true);
        ...
        private class StateB지역 : TriggerState {
            ...
            public override TriggerState? Execute() {
                ...
                if (context.MonsterDead(spawnIds: new []{802})) {
                    ...
                    context.SetDungeonVariable(id: 802, value: true);
                    return new StateDelay(context);
                }
        ...
        private class StateC지역 : TriggerState {
            ...
            public override TriggerState? Execute() {
                ...
                if (context.MonsterDead(spawnIds: new []{803})) {
                    ...
                    context.SetDungeonVariable(id: 803, value: true);
                    return new StateDelay(context);
                }

    ...
    public static class _trigger_01 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000208}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000208}, arg2: 0)) {
        ...
        private class State소환 : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 401, arg2: new int[] {101})) {
        ...
        private class State아이템 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateItem(arg1: new int[] {504});
            }

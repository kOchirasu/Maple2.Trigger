    ...
    public static class _main {
        public class StateIdle : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000030, 12000031, 12000032, 12000033, 12000034, 12000035, 12000036}, state: 1);
        ...
        private class StateBoss : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetCinematicUI(type: 2);
                context.CameraReset(interpolationTime: 0.0f);
                context.SetEventUI(arg1: 1, script: "$02000403_BF__MAIN__0$", duration: 3000);
                context.SetOnetimeEffect(id: 1, enable: false, path: @"BG/Common/ScreenMask/Eff_fadein_1sec.xml");
            }

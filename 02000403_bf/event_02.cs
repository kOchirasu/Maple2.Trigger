    ...
    public static class _event_02 {
        public class StateIdle : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{12000030}, arg2: 0)) {
        ...
        private class StateScene_02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 2, spawnId: 11001956, script: "$02000403_BF__EVENT_02__0$", arg4: 5);
        ...
        private class StateScene_03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkip(state: new StateScene_06_ready(context));
                context.SetConversation(type: 2, spawnId: 11001956, script: "$02000403_BF__EVENT_02__1$", arg4: 5);
            }
        ...
        private class StateScene_04 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 2, spawnId: 11001956, script: "$02000403_BF__EVENT_02__2$", arg4: 5);
            }
        ...
        private class StateScene_05 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 2, spawnId: 11001956, script: "$02000403_BF__EVENT_02__3$", arg4: 5);
            }
        ...
        private class StateScene_06_ready : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{12000031, 12000032, 12000033, 12000034, 12000035, 12000036}, state: 1);
                context.DestroyMonster(spawnIds: new []{199});
                context.SetSkip();
        ...
        private class StateScene_09 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 181, script: "$02000403_BF__EVENT_02__5$", arg4: 3, arg5: 2);
                context.SetConversation(type: 1, spawnId: 182, script: "$02000403_BF__EVENT_02__6$", arg4: 3, arg5: 4);
                context.SetConversation(type: 1, spawnId: 183, script: "$02000403_BF__EVENT_02__7$", arg4: 3, arg5: 8);
                context.SetConversation(type: 1, spawnId: 184, script: "$02000403_BF__EVENT_02__8$", arg4: 3, arg5: 0);
            }

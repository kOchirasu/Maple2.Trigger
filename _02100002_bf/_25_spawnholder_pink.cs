    ...
    public static class _25_spawnholder_pink {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {10001256}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10001257}, arg2: 0);
            }
        ...
        private class StateSpawnStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10001257}, arg2: 1);
                context.SetInteractObject(arg1: new[] {10001256}, arg2: 2);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new[] {10001257}, arg2: 0)) {
        ...
        private class StateSpawnStop : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10001257}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10001256}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new[] {10001256}, arg2: 0)) {

    ...
    public static class _23_spawnholder_orange {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10001252}, arg2: 2);
                context.SetInteractObject(arg1: new int[] {10001253}, arg2: 0);
            }
        ...
        private class StateSpawnStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10001253}, arg2: 1);
                context.SetInteractObject(arg1: new int[] {10001252}, arg2: 2);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10001253}, arg2: 0)) {
        ...
        private class StateSpawnStop : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10001253}, arg2: 2);
                context.SetInteractObject(arg1: new int[] {10001252}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10001252}, arg2: 0)) {

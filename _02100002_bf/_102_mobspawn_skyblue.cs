    ...
    public static class _102_mobspawn_skyblue {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(arg1: new[] {20100, 20075, 20050, 20025, 20001, 21001, 21002, 21003});
                context.SetEffect(arg1: new[] {5102, 5202}, arg2: false);
            }
        ...
        private class StateGauge100_Normal : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new[] {20100}, arg2: false);
            }
        ...
        private class StateGauge75_Normal : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {5102}, arg2: true);
                context.CreateMonster(arg1: new[] {20075}, arg2: false);
            }
        ...
        private class StateGauge50_Normal : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {5102}, arg2: true);
                context.CreateMonster(arg1: new[] {20050}, arg2: false);
            }
        ...
        private class StateGauge25_Normal : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {5102}, arg2: true);
                context.CreateMonster(arg1: new[] {20025}, arg2: false);
            }
        ...
        private class StateSpawn_Eater : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new[] {21001}, arg2: false);
            }
        ...
        private class StateSpawn_Runner : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {5202}, arg2: true);
                context.CreateMonster(arg1: new[] {21002}, arg2: false);
            }

    ...
    public static class _main {
        public class StateIdle : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10002018, 10002019, 10002020, 10002021, 10002022, 10002023, 10002024}, state: 1);
        ...
        private class StateBoss_scene : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetSound(triggerId: 9900, enabled: true);
                context.DestroyMonster(spawnIds: new []{201, 202, 203, 204, 205, 206});
                context.SetEffect(triggerIds: new []{7999}, visible: false);
                context.CreateMonster(spawnIds: new []{311, 312, 313, 314, 315, 316, 2000}, arg2: false);
        ...
        private class StateBoss : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(spawnIds: new []{311, 312, 313, 314, 315, 316, 2000});
                context.CreateMonster(spawnIds: new []{1999, 301, 302, 303, 304, 305, 306}, arg2: false);
                ...
                context.SetInteractObject(interactIds: new []{10002018, 10002019, 10002020, 10002021, 10002022, 10002023, 10002024}, state: 2);
                context.SetCinematicUI(type: 0);
                context.SetCinematicUI(type: 2);
                context.CameraReset(interpolationTime: 0.0f);
                context.SetEventUI(arg1: 1, script: "$02000471_BF__MAIN__0$", duration: 3000);
                context.SetOnetimeEffect(id: 1, enabled: false, path: @"BG/Common/ScreenMask/Eff_fadein_1sec.xml");
            }
        ...
        private class StateDungeonClear_ready : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSound(triggerId: 9900, enabled: false);

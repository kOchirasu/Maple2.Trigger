    ...
    public static class _elite_02 {
        public class StateIdle : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetUserValue(key: "10002020clear") != 1 && context.GetUserValue(key: "SpawnCheck") == 1) {
        ...
        private class StateBuff : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBuff(boxIds: new []{1999}, skillId: 70002011, level: 1, arg4: true, arg5: false);
                context.AddBuff(boxIds: new []{302}, skillId: 70002011, level: 1, arg4: true, arg5: false);
            }

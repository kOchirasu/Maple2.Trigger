    ...
    public static class _processlevel02 {
        public class StateLeverPull : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10000218}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000218}, arg2: 0)) {
        ...
        private class State게임시작 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetBreakable(triggerIds: new []{103, 104, 108, 111, 113, 115, 116, 118, 119, 121, 122, 124, 126, 129, 133, 134}, enabled: true);
            }
        ...
        private class State게임진행1 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetBreakable(triggerIds: new []{103, 104, 108, 111, 113, 115, 116, 118, 119, 121, 122, 124, 126, 129, 133, 134}, enabled: false);
                context.SetSkill(triggerIds: new []{803, 804, 808, 811, 813, 815, 816, 818, 819, 821, 822, 824, 826, 829, 833, 834}, enabled: true);
            }
        ...
        private class State게임진행2 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetSkill(triggerIds: new []{803, 804, 808, 811, 813, 815, 816, 818, 819, 821, 822, 824, 826, 829, 833, 834}, enabled: false);
            }

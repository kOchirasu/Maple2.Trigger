    ...
    public static class _bridge02 {
        ...
        private class StateNPC감지대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10000919}, arg2: 2);
            }

            public override void Execute() {
                if (context.NpcDetected(arg1: 103, arg2: new int[] {2099})) {
        ...
        private class State오브젝트반응대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10000919}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000919}, arg2: 0)) {

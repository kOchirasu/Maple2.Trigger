    ...
    public static class _skill_07 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(triggerIds: new []{712, 726}, enabled: false);
                context.SetVisibleBreakableObject(triggerIds: new []{7701, 7702, 7703, 7704}, visible: false);
        ...
        private class StateWaitTime : TriggerState {
            ...
            public override void OnEnter() {
                context.SetVisibleBreakableObject(triggerIds: new []{7701, 7702, 7703, 7704}, visible: true);
            }
        ...
        private class StateActivateSkill : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(triggerIds: new []{712, 726}, enabled: true);
                context.SetBreakable(triggerIds: new []{7701, 7702, 7703, 7704}, enabled: false);
            }

    ...
    public static class _skill_03 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetVisibleBreakableObject(triggerIds: new []{7301, 7302, 7303}, visible: false);
                context.SetBreakable(triggerIds: new []{7301, 7302, 7303}, enabled: false);
            }
        ...
        private class StateWaitTime : TriggerState {
            ...
            public override void OnEnter() {
                context.SetVisibleBreakableObject(triggerIds: new []{7301, 7302, 7303}, visible: true);
            }
        ...
        private class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetBreakable(triggerIds: new []{7301, 7302, 7303}, enabled: true);
            }

...
namespace Maple2.Trigger._52000083_qd {
    public static class _main {
        public static readonly Func<ITriggerContext, TriggerState> Start = context => new State50001536연출출력체크(context);

        private class State50001536연출출력체크 : TriggerState {
            internal State50001536연출출력체크(ITriggerContext context) : base(context) { }

            public override void OnEnter() { }

            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50001536},
                    arg3: new byte[] {1})) {
                    context.State = new State연출시작(context);
                    return;
                }

                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50100260},
                    arg3: new byte[] {1})) {
                    context.State = new State연출시작(context);
                    return;
                }
        ...
        private class State조건체크03 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50001537},
                    arg3: new byte[] {1})) {
                    context.State = new State연출이후(context);
                    return;
                }
                ...
                if (context.QuestUserDetected(arg1: new int[] {9000}, arg2: new int[] {50100270},
                    arg3: new byte[] {1})) {
                    context.State = new State연출이후(context);
                    return;
                }
        ...
        private class State몬스터처치 : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {1021, 1022, 1023, 1024})) {
        ...
        private class State검사시네마틱대사 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004022, illustID: "11004022", msg: "$52000083_QD__MAIN__1$",
        ...
        private class State검사대화02 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004022, illustID: "11004022", msg: "$52000083_QD__MAIN__7$",
                    align: "left", duration: 3000);
                context.SetNpcEmotionLoop(arg1: 1012, arg2: "Talk_A", arg3: 3000f);
            }
        ...
        private class State검사대화03 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004022, illustID: "11004022", msg: "$52000083_QD__MAIN__9$",
                    align: "left", duration: 3000);
                context.SetNpcEmotionLoop(arg1: 1012, arg2: "Talk_A", arg3: 3000f);
            }
        ...
        private class State검사대화04 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004022, illustID: "11004022", msg: "$52000083_QD__MAIN__14$",
                    align: "left", duration: 3000);
                context.SetNpcEmotionLoop(arg1: 1012, arg2: "Talk_A", arg3: 3000f);
            }
        ...
        private class State검사대화06 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004022, illustID: "11004022", msg: "$52000083_QD__MAIN__16$",
                    align: "left", duration: 3000);
            }
        ...
        private class State검사시네마틱대사02 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004022, illustID: "11004022", msg: "$52000083_QD__MAIN__19$",
                    align: "left", duration: 3000);
            }
        ...
        private class State검사말풍선03 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004022, illustID: "11004022", msg: "$52000083_QD__MAIN__20$",
                    align: "left", duration: 3000);
            }

    ...
    public static class _3000051_phase_4_interect_01 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {200021, 200022}, arg2: false);
                context.SetInteractObject(arg1: new int[] {10003111}, arg2: 2);
            }

            public override void Execute() {
                if (context.UserValue(key: "Phase_4_Interect_01", value: 1)) {
        ...
        private class State시작 : TriggerState {
            ...
            public override void Execute() {
                ...
                if (context.UserValue(key: "Phase_4_Interect_01", value: 0)) {
        ...
        private class State인터렉트_설정 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {200021, 200022}, arg2: true);
                context.SetInteractObject(arg1: new int[] {10003111}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10003111}, arg2: 0)) {

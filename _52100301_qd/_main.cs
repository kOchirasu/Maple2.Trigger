    ...
    public static class _main {
        public class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new[] {5641, 5642, 5643, 5644}, arg2: true);
                ...
                context.SetInteractObject(arg1: new[] {10003101}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10003102}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10003103}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10003104}, arg2: 2);
                context.SetAgent(
                    arg1:
        ...
        private class State시작 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SideNpcTalk(type: "talk", npcId: 29500101, illust: "ArcheonBlack_Normal",
                    script: "$52100301_QD__MAIN__0$", duration: 5684);
        ...
        private class State보스전_성공 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SideNpcTalk(type: "talk", npcId: 29500101, illust: "ArcheonBlack_Die",
                    script: "$52100301_QD__MAIN__1$", duration: 3176);
        ...
        private class State추가대화 : TriggerState {
            ...
            public override void OnEnter() {
                context.SideNpcTalk(type: "talk", npcId: 11004205, illust: "ArcaneBlader_normal",
                    script: "$52100301_QD__MAIN__2$", duration: 3176);
            }

    ...
    public static class _trigger_01 {
        ...
        private class State어나운스0 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, script: "$61000004_ME__TRIGGER_01__0$", duration: 4000, boxId: 0);
            }
        ...
        private class State경기종료 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 4, script: "$61000004_ME__TRIGGER_01__3$", duration: 5000, notBoxId: 102);

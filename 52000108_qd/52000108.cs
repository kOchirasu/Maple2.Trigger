    ...
    public static class _52000108 {
        ...
        private class State불끄기Quest01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {2000}, arg2: false);
        ...
        private class State불끄기Quest06 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {2002}, arg2: false);
        ...
        private class State불끄기Quest08 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {2003}, arg2: false);
            }
        ...
        private class State불끄기Quest09 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {2004}, arg2: false);
        ...
        private class State불끄기Quest11 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new[] {2008}, arg2: false);
        ...
        private class State저항군로봇Quest01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {2013, 2014}, arg2: false);
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
        ...
        private class State저항군로봇Quest03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {2015}, arg2: false);
        ...
        private class State저항군로봇Quest05 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {2016}, arg2: false);
            }
        ...
        private class State저항군로봇Quest06 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {2017, 2018}, arg2: false);
            }
        ...
        private class State저항군로봇Quest08 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new[] {2028}, arg2: false);
        ...
        private class State저항군로봇Quest09 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {2010, 2019}, arg2: false);
        ...
        private class State저항군로봇Quest10 : TriggerState {
            ...
            public override void OnEnter() {
                context.FaceEmotion(spawnPointId: 0, emotionName: "PC_OutOfMind_01");
                context.CameraSelectPath(pathIds: new[] {2031}, arg2: false);
        ...
        private class State저항군로봇Quest11 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {2011, 2012}, arg2: false);
            }
        ...
        private class State저항군로봇Quest12a : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new[] {2029, 2030}, arg2: false);
            }
        ...
        private class State저항군로봇Quest12_b : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new[] {2020, 2021}, arg2: false);
            }
        ...
        private class State체키등판Quest03 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new[] {2034, 2035}, arg2: false);
        ...
        private class State체키등판Quest04 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new[] {2036}, arg2: false);
        ...
        private class State체키등판Quest05 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new[] {2037, 2038}, arg2: false);
        ...
        private class State체키등판Quest06 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new[] {2039, 2040}, arg2: false);
        ...
        private class State프로토콜해피01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {2041, 2042}, arg2: false);
                context.MoveUser(arg1: 52000108, arg2: 11);
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
        ...
        private class State프로토콜해피03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {2043}, arg2: false);
        ...
        private class State프로토콜해피04 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {2044}, arg2: false);
        ...
        private class State프로토콜해피05 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {2045, 2046}, arg2: false);
        ...
        private class State프로토콜해피06 : TriggerState {
            ...
            public override void OnEnter() {
                context.FaceEmotion(spawnPointId: 0);
                context.CameraSelectPath(pathIds: new[] {2047}, arg2: false);
        ...
        private class State프로토콜해피07 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {2048}, arg2: false);
        ...
        private class State프로토콜해피08 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new[] {2049, 2050}, arg2: false);
        ...
        private class State프로토콜해피09 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(pathIds: new[] {2051, 2053}, arg2: false);
        ...
        private class State프로토콜해피10 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(pathIds: new[] {2052}, arg2: false);

...
namespace Maple2.Trigger._52100001_qd {
    public static class _main {
        public class State퀘스트체크 : TriggerState {
        ...
        private class StateDungeonStart : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State부선장대사01(context);
                    return;
                }
            }
        ...
        private class State부선장대사01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State해적이동01(context);
                    return;
                }
            }
        ...
        private class State카메라302 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State부선장대사03(context);
                    return;
                }
            }
        ...
        private class State부선장대사03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 2, arg2: 24003011, arg3: "$02000391_BF__MAIN__2$", arg4: 4, align: "left");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4858)) {
                    context.State = new State세이렌대사01(context);
                    return;
                }
            }
        ...
        private class State세이렌대사01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcId: 11003888, illustId: "Celine_normal", msg: "$02000391_BF__MAIN__3$", align: "left", duration: 4000);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4179)) {
                    context.State = new State카메라310(context);
                    return;
                }
            }
        ...
        private class State카메라310 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcId: 11003888, illustId: "Celine_normal", msg: "$02000391_BF__MAIN__4$", align: "left", duration: 3000);
        ...
        private class State딜레이01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State카메라305(context);
                    return;
                }
            }
        ...
        private class State카메라305 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1500)) {
                    context.State = new State세이렌연주02(context);
                    return;
                }
            }
        ...
        private class State세이렌연주02 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11003888, illustId: "Celine_normal", msg: "$02000391_BF__MAIN__6$", align: "left", duration: 5000);
                context.PlaySystemSoundInBox(arg2: "Dungeon_Siren_Harp01");
                context.SetNpcEmotionSequence(arg1: 1098, arg2: "Attack_01_D");
            }
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2500)) {
                    context.State = new State물큐브제거(context);
                    return;
                }
            }
        ...
        private class State물큐브제거 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2500)) {
                    context.State = new State세이렌이동(context);
                    return;
                }
            }
        ...
        private class State세이렌이동 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcId: 11003888, illustId: "Celine_normal", msg: "$02000391_BF__MAIN__7$", align: "left", duration: 3500);
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3500)) {
                    context.State = new State카메라307(context);
                    return;
                }
            }
        ...
        private class State카메라307 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State카메라308(context);
                    return;
                }
            }
        ...
        private class State사망딜레이 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    ...
                    context.State = new State오브젝트카메라(context);
                    return;
                }
            }
        ...
        private class State오브젝트카메라 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State하프반응대기(context);
                    return;
                }
            }
        ...
        private class State연주딜레이 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3500)) {
                    context.State = new State물큐브제거2(context);
                    return;
                }
            }
        ...
        private class State퀘스트완료가능이거나완료1 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State퀘스트완료가능이거나완료2(context);
                    return;
                }
            }
        ...
        private class State퀘스트완료가능이거나완료2 : TriggerState {
            internal State퀘스트완료가능이거나완료2(ITriggerContext context) : base(context) { }

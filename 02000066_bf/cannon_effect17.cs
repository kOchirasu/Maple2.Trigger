    ...
    public static class _cannon_effect17 {
        public class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {817}, arg2: false);
            }

            public override TriggerState Execute() {
                if (context.UserDetected(arg1: new[] {127})) {
        ...
        private class State이펙트Wait : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.NpcDetected(arg1: 127, arg2: new[] {8017})) {
        ...
        private class State이펙트on : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {817}, arg2: true);
            }

            public override TriggerState Execute() {
                if (context.MonsterDead(arg1: new[] {8017})) {

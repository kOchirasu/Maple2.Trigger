    ...
    public static class _npc03 {
        public class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {10000343}, arg2: 0);
            }
        ...
        private class StateInteractObject : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {10000343}, arg2: 1);
            }

            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {10000343}, arg2: 0)) {
        ...
        private class StateNPCScript : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(arg1: 203, arg2: false, arg3: "Dead_A");
                context.SetConversation(arg1: 1, arg2: 2003, script: "$02000066_BF__NPC03__1$", arg4: 2);
            }

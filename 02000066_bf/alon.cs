namespace Maple2.Trigger._02000066_bf {
    public static class _alon {
        ...
        private class StateNPCScript01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 5001, script: "$02000066_BF__ALON__0$", arg4: 3);
            }
        ...
        private class StateNPCScript02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 5001, script: "$02000066_BF__ALON__1$", arg4: 3);
            }
        ...
        private class StateNPCScript03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 5001, script: "$02000066_BF__ALON__2$", arg4: 3);
            }
        ...
        private class StateNPCScript04 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 5001, script: "$02000066_BF__ALON__3$", arg4: 3);
            }

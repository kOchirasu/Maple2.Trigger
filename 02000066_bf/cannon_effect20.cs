    ...
    public static class _cannon_effect20 {
        public class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{820}, visible: false);
            }

            public override TriggerState? Execute() {
                if (context.UserDetected(boxIds: new []{130})) {
        ...
        private class State이펙트Wait : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 130, spawnIds: new []{8020})) {
        ...
        private class State이펙트on : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{820}, visible: true);
            }

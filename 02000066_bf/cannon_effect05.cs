    ...
    public static class _cannon_effect05 {
        public class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{805}, visible: false);
            }
        ...
        private class State이펙트Wait : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 115, spawnIds: new []{8005})) {
        ...
        private class State이펙트on : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{805}, visible: true);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{8005})) {

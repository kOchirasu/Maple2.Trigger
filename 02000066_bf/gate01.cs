    ...
    public static class _gate01 {
        ...
        private class StateCreation : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000304}, state: 0);
        ...
        private class State게이트열림 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000304}, state: 1);
        ...
        private class State게이트닫힘 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000304}, arg2: 0)) {
                    return new StateCreation(context);
                }

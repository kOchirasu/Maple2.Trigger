namespace Maple2.Trigger._02000066_bf {
    public static class _oscal {
        public class StateStart : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.GetUserValue(key: "randomTalk") == 1) {
                    context.CreateMonster(spawnIds: new []{5003}, arg2: false);
        ...
        private class StateWaitCombat : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.MonsterInCombat(spawnIds: new []{5003})) {
        ...
        private class StateNPCScript01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 5003, script: "$02000066_BF__OSCAL__0$", arg4: 3);
            }
        ...
        private class StateNPCScript02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 5003, script: "$02000066_BF__OSCAL__1$", arg4: 3);
            }
        ...
        private class StateNPCScript03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 5003, script: "$02000066_BF__OSCAL__2$", arg4: 2);
            }
        ...
        private class StateNPCScript04 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 5003, script: "$02000066_BF__OSCAL__3$", arg4: 3);
            }

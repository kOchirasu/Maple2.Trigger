    ...
    public static class _npc05 {
        public class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000373}, state: 0);
            }
        ...
        private class StateInteractObject : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000373}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000373}, arg2: 0)) {
        ...
        private class StateNPCScript : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(triggerId: 205, visible: false, initialSequence: "Dead_A");
                context.SetConversation(type: 1, spawnId: 2005, script: "$02000066_BF__NPC05__1$", arg4: 2);
            }

    ...
    public static class _cannon_effect11 {
        public class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {811}, arg2: false);
            }
        ...
        private class State이펙트Wait : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.NpcDetected(arg1: 121, arg2: new[] {8011})) {
        ...
        private class State이펙트on : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new[] {811}, arg2: true);
            }

            public override TriggerState Execute() {
                if (context.MonsterDead(arg1: new[] {8011})) {

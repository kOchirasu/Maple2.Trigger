    ...
    public static class _cannon_effect13 {
        public class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{813}, visible: false);
            }
        ...
        private class State이펙트Wait : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 123, spawnIds: new []{8013})) {
        ...
        private class State이펙트on : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{813}, visible: true);
            }

            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{8013})) {

    ...
    public static class _gate04 {
        ...
        private class StateCreation : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000336}, state: 0);
                context.CreateMonster(spawnIds: new []{3004}, arg2: false);
            }
        ...
        private class State게이트열림 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000336}, state: 1);
        ...
        private class State게이트닫힘 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000336}, arg2: 0)) {
                    return new StateCreation(context);
                }

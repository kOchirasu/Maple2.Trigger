    ...
    public static class _gate06 {
        ...
        private class StateCreation : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {10000338}, arg2: 0);
        ...
        private class State게이트열림 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {10000338}, arg2: 1);
        ...
        private class State게이트닫힘 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {10000338}, arg2: 0)) {
                    return new StateCreation(context);
                }

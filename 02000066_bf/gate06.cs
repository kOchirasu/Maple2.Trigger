namespace Maple2.Trigger._02000066_bf {
    public static class _gate06 {
        public class StateStart : TriggerState {
            internal StateStart(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{3006});
            }
        ...
        private class StateCreation : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000338}, state: 0);
                context.CreateMonster(spawnIds: new []{3006}, arg2: false);
            }
        ...
        private class State게이트열림 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000338}, state: 1);
        ...
        private class State게이트닫힘 : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000338}, arg2: 0)) {
                    return new StateCreation(context);
                }

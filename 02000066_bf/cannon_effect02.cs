namespace Maple2.Trigger._02000066_bf {
    public static class _cannon_effect02 {
        public class StateStart : TriggerState {
            internal StateStart(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{802}, visible: false);
            }
        ...
        private class State이펙트Wait : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 112, spawnIds: new []{8002})) {
        ...
        private class State이펙트on : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{8002})) {

    ...
    public static class _npc06 {
        public class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000374}, state: 0);
            }
        ...
        private class StateInteractObject : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10000374}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10000374}, arg2: 0)) {
        ...
        private class StateNPCScript : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(triggerId: 206, visible: false, initialSequence: "Dead_A");
                context.SetConversation(type: 1, spawnId: 2006, script: "$02000066_BF__NPC06__1$", arg4: 2);
            }

    ...
    public static class _main2 {
        ...
        private class State전투02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new[] {22101, 22102, 22103, 22104, 22105, 22106, 22107, 22201, 22202, 22203, 22204, 22205, 22206}, arg2: false);
            }

            public override TriggerState Execute() {
                if (context.MonsterDead(arg1: new[] {22101, 22102, 22103, 22104, 22105, 22106, 22107, 22201, 22202, 22203, 22204, 22205, 22206})) {
        ...
        private class State전투03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new[] {23101, 23102, 23103, 23104, 23105, 23106, 23107, 23108, 23201, 23202, 23203, 23204, 23205}, arg2: false);
            }

            public override TriggerState Execute() {
                if (context.MonsterDead(arg1: new[] {23101, 23102, 23103, 23104, 23105, 23106, 23107, 23108, 23201, 23202, 23203, 23204, 23205})) {

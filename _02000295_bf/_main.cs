    ...
    public static class _main {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(arg1: new int[] {910, 911, 912, 913, 914, 915, 916, 917});
                context.CreateMonster(arg1: new int[] {4100}, arg2: false);
                context.DestroyMonster(arg1: new int[] {4101});
                context.CreateMonster(arg1: new int[] {900, 901, 902}, arg2: true);
                context.CreateMonster(arg1: new int[] {800, 801, 802, 803, 804}, arg2: true);
                ...
                context.SetMesh(arg1: new int[] {95001, 95002, 95003, 95004, 95005, 95006}, arg2: true, arg3: 0,
                    arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {2000}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {2001, 2002}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(
                    arg1: new int[] {
        ...
        private class StateBattleReady01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State트리거01웨이브(context);
                    return;
                }
            }
        ...
        private class State트리거01웨이브 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new int[] {5001}, arg2: false);
                context.SetEffect(arg1: new int[] {5002}, arg2: false);
                context.SetMesh(arg1: new int[] {95001, 95002, 95003, 95004, 95005, 95006}, arg2: false, arg3: 0,
                    arg4: 0, arg5: 2f);
                context.CreateMonster(arg1: new int[] {910, 911}, arg2: true);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State트리거02웨이브(context);
                    return;
                }
            }
        ...
        private class State트리거02웨이브 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {912, 913}, arg2: true);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 6000)) {
                    context.State = new State트리거03웨이브(context);
                    return;
                }
            }
        ...
        private class State트리거03웨이브 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {914, 915}, arg2: true);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 8000)) {
                    context.State = new State트리거04웨이브(context);
                    return;
                }
            }
        ...
        private class State트리거04웨이브 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {916, 917}, arg2: true);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {910, 911, 912, 913, 914, 915, 916, 917})) {
                    context.State = new StateBossAct01(context);
                    return;
                }
            }
        ...
        private class StateBossAct01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new StateBossAct02(context);
                    return;
                }
            }
        ...
        private class StateBossAct02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new StateBossAct03(context);
                    return;
                }
            }
        ...
        private class StateBossBattle01 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {4100});
                context.CreateMonster(arg1: new int[] {4101}, arg2: true);
            }

            public override void Execute() {
                if (context.UserValue(key: "LuminaArmyJoin", value: 1)) {
                    context.State = new StateBossBattle02(context);
                    return;
                }

                if (context.MonsterDead(arg1: new int[] {4101})) {
                    context.State = new StateBossBattle02(context);
                    return;
                }
            }
        ...
        private class StateBattleEnd03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 500)) {
                    context.State = new StateReleaseSlaves01(context);
                    return;
                }
            }
        ...
        private class StateReleaseSlaves01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new StateReleaseSlaves02(context);
                    return;
                }
            }
        ...
        private class StateReleaseSlaves02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new StateReleaseSlaves03(context);
                    return;
                }
            }
        ...
        private class StateReleaseSlaves03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2500)) {
                    context.State = new StateReleaseSlaves04(context);
                    return;
                }
            }
        ...
        private class StateReleaseSlaves04 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 9000)) {
                    context.State = new StateReleaseSlaves05(context);
                    return;
                }
            }
        ...
        private class StateReleaseSlaves05 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1500)) {
                    context.State = new StateToBeContinued01(context);
                    return;
                }
            }

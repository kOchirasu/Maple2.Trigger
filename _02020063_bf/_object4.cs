    ...
    public static class _object4 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {714}, arg2: false);
            }

            public override void Execute() {
                if (context.UserValue(key: "TurretSpawn_4", value: 1)) {
        ...
        private class State터렛_활성화 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {714}, arg2: false);
            }

            public override void Execute() {
                if (context.UserValue(key: "TurretSpawn_4", value: 0)) {

    ...
    public static class _object5 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {715}, arg2: false);
            }

            public override void Execute() {
                if (context.UserValue(key: "TurretSpawn_5", value: 1)) {
        ...
        private class State터렛_활성화 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {715}, arg2: false);
            }

            public override void Execute() {
                if (context.UserValue(key: "TurretSpawn_5", value: 0)) {
                    context.State = new State대기(context);
                    return;
                }

                if (context.MonsterDead(arg1: new int[] {715})) {

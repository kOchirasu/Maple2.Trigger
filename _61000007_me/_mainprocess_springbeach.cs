namespace Maple2.Trigger._61000007_me {
    public static class _mainprocess_springbeach {
        ...
        private class State준비멘트1 : TriggerState {
            internal State준비멘트1(ITriggerContext context) : base(context) { }
        ...
        private class State준비멘트2 : TriggerState {
            internal State준비멘트2(ITriggerContext context) : base(context) { }
        ...
        private class State경기장입장 : TriggerState {
            ...
            public override void Execute() {
                if (true) {
                    context.MoveUser(arg1: 61000007, arg2: 902, arg3: 302);
        ...
        private class State시작멘트1 : TriggerState {
            internal State시작멘트1(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.StartMiniGame(boxId: 301, round: 5, gameName: "springbeach");
                context.SetMiniGameAreaForHack(boxId: 301);
                context.SetTimer(arg1: "13", arg2: 5);
                ...
                context.SetAchievement(arg1: 301, arg2: "trigger", arg3: "springbeach_start");
        ...
        private class State시작멘트2 : TriggerState {
            internal State시작멘트2(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetTimer(arg1: "14", arg2: 5);
                context.SetEventUI(arg1: 1, arg2: "$61000007_ME__MAINPROCESS_SPRINGBEACH__3$", arg3: 5500);
        ...
        private class State시작멘트3 : TriggerState {
            internal State시작멘트3(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.PlaySystemSoundInBox(arg2: "ME_Mainprocess_Springbeach_04");
                context.SetTimer(arg1: "15", arg2: 7);
                context.SetEventUI(arg1: 1, arg2: "$61000007_ME__MAINPROCESS_SPRINGBEACH__4$", arg3: 7000);
            }
        ...
        private class State라운드1 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetTimer(arg1: "16", arg2: 4);
        ...
        private class State게임시작1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(arg1: "17", arg2: 6);
        ...
        private class State공격중지01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(arg1: "19", arg2: 3);
        ...
        private class State게임시작2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(arg1: "22", arg2: 6);
        ...
        private class State게임시작3 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(arg1: "26", arg2: 6);
        ...
        private class State공격중지03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(arg1: "27", arg2: 3);
                context.SetSkill(arg1: new[] {201, 202, 203, 204, 205, 206, 207, 208, 209, 210, 211, 212, 213, 214, 215, 216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 228, 229, 230, 231, 232, 233, 234, 235, 236, 237, 238, 239, 240, 241, 242, 243, 244, 245, 246, 247, 248, 249, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264}, arg2: false);
            }
        ...
        private class State라운드4 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetTimer(arg1: "29", arg2: 4);
        ...
        private class State게임시작4 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(arg1: "30", arg2: 6);
        ...
        private class State라운드5 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetTimer(arg1: "33", arg2: 4);
        ...
        private class State게임시작5 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(arg1: "34", arg2: 6);
        ...
        private class State우승자카메라연출 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 3, arg2: "$61000007_ME__MAINPROCESS_SPRINGBEACH__15$", arg3: 5000,
                    arg4: "301");
                context.SetEventUI(arg1: 6, arg2: "$61000007_ME__MAINPROCESS_SPRINGBEACH__16$", arg3: 5000,
        ...
        private class State보상단계 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 3, arg2: "$61000007_ME__MAINPROCESS_SPRINGBEACH__17$", arg3: 5000,
                    arg4: "301");
                context.SetEventUI(arg1: 6, arg2: "$61000007_ME__MAINPROCESS_SPRINGBEACH__18$", arg3: 5000,
                    arg4: "303,304,305,306");
                context.AddBuff(arg1: new[] {301}, arg2: 70000019, arg3: 1);
                context.SetAchievement(arg1: 301, arg2: "trigger", arg3: "springbeach_win");
                context.MiniGameGiveReward(winnerBoxId: 301, contentType: "miniGame");
                context.EndMiniGame(winnerBoxId: 301, gameName: "springbeach");
            }
        ...
        private class State탈락멘트 : TriggerState {
            internal State탈락멘트(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetTimer(arg1: "40", arg2: 6);
        ...
        private class State다리등장 : TriggerState {
            internal State다리등장(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.UnSetMiniGameAreaForHack();
                context.SetTimer(arg1: "41", arg2: 10);
                context.SetMesh(
        ...
        private class State1스프링공격01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(arg1: "99", arg2: 2);
                context.SetBreakable(
        ...
        private class State2_04게임진행1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetTimer(arg1: "98", arg2: 2);
                context.SetBreakable(
                    arg1: new[] {101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122, 123, 124, 125, 126, 127, 128, 129, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 140, 141, 142, 143, 144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 161, 162, 163, 164, 601, 602, 603, 604, 605, 606, 607, 608, 609, 610, 611, 612, 613, 614, 615, 616}, arg2: false);
            }

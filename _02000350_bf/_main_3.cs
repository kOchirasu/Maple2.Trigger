    ...
    public static class _main_3 {
        ...
        private class State시작대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$02000350_BF__MAIN_3__0$", arg3: new int[] {2000}, arg4: "0");
        ...
        private class State11라운드 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$02000350_BF__MAIN_3__1$", arg3: new int[] {4000}, arg4: "0");
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {111001}, score: 295000);
            }
        ...
        private class State12라운드 : TriggerState {
            ...
            public override void OnEnter() {
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {112001}, score: 78750);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {112001})) {
        ...
        private class State13라운드 : TriggerState {
            ...
            public override void OnEnter() {
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {113001}, score: 43750);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {113001})) {
        ...
        private class State14라운드 : TriggerState {
            ...
            public override void OnEnter() {
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {114001}, score: 48750);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {114001})) {
        ...
        private class State15라운드 : TriggerState {
            ...
            public override void OnEnter() {
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {115001}, score: 415000);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {115001})) {

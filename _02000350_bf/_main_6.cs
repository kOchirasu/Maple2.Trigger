    ...
    public static class _main_6 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {3601}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
        ...
        private class State시작대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {6601}, arg2: true);
        ...
        private class State26라운드 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$02000350_BF__MAIN_6__0$", arg3: new int[] {4000}, arg4: "0");
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {126001}, score: 2200000);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {126001})) {
        ...
        private class State27라운드 : TriggerState {
            ...
            public override void OnEnter() {
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {127001}, score: 2500000);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {127001})) {
        ...
        private class State28라운드 : TriggerState {
            ...
            public override void OnEnter() {
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {128001}, score: 3000000);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {128001})) {
        ...
        private class State29라운드 : TriggerState {
            ...
            public override void OnEnter() {
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {129001}, score: 5000000);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {129001})) {
        ...
        private class State30라운드대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {6602}, arg2: true);
        ...
        private class State30라운드 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {130001}, arg2: true);
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {130002}, score: 8000000);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {130002})) {
                    context.SetMesh(arg1: new int[] {3601}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                    context.DestroyMonster(arg1: new int[] {130001});
        ...
        private class State성공 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 7, arg2: "$02000350_BF__MAIN_6__1$", arg3: new int[] {3000}, arg4: "0");
        ...
        private class State포털생성 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$02000350_BF__MAIN_6__2$", arg3: new int[] {2500}, arg4: "0");

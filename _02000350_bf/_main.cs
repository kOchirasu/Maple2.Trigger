    ...
    public static class _main {
        ...
        private class State시작대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$02000350_BF__MAIN__0$", arg3: new int[] {3000}, arg4: "0");
        ...
        private class State안내02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$02000350_BF__MAIN__1$", arg3: new int[] {3000}, arg4: "0");
                context.SetTimer(arg1: "3", arg2: 3);
            }
        ...
        private class State안내03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$02000350_BF__MAIN__2$", arg3: new int[] {4000}, arg4: "0");
        ...
        private class State1라운드대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {6110}, arg2: true);
                context.SetEffect(arg1: new int[] {6111}, arg2: true);
                context.SetEffect(arg1: new int[] {6112}, arg2: true);
                context.SetEffect(arg1: new int[] {6113}, arg2: true);
                context.SetTimer(arg1: "3", arg2: 3);
        ...
        private class State1라운드 : TriggerState {
            ...
            public override void OnEnter() {
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {101001}, score: 6000);
            }
        ...
        private class State2라운드 : TriggerState {
            ...
            public override void OnEnter() {
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {102001}, score: 6000);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {102001})) {
        ...
        private class State3라운드 : TriggerState {
            ...
            public override void OnEnter() {
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {103001}, score: 16000);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {103001})) {
        ...
        private class State4라운드대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$02000350_BF__MAIN__3$", arg3: new int[] {2000}, arg4: "0");
            }
        ...
        private class State4라운드 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {104099}, arg2: false);
            }

            public override void Execute() {
                if (context.TimeExpired(arg1: "30")) {
                    context.DestroyMonster(arg1: new int[] {104099});
        ...
        private class State5라운드 : TriggerState {
            ...
            public override void OnEnter() {
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {105001}, score: 135000);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {105001})) {

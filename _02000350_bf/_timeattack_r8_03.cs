...
namespace Maple2.Trigger._02000350_bf {
    public static class _timeattack_r8_03 {
        ...
        private class State몹스폰 : TriggerState {
            ...
            public override void OnEnter() {
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {108003}, score: 8000);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {108099})) {
                    context.DestroyMonster(arg1: new int[] {108003});
                    context.State = new State종료(context);
                    return;
                }

                if (context.MonsterDead(arg1: new int[] {108003})) {
                    context.State = new State몹스폰(context);
                    return;
                }
            }

...
namespace Maple2.Trigger._02000498_bf {
    public static class _timeattack_r4_01 {
        ...
        private class State몹스폰 : TriggerState {
            ...
            public override void OnEnter() {
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {104001}, score: 4100);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {104099})) {
                    context.DestroyMonster(arg1: new int[] {104001});
                    context.State = new State종료(context);
                    return;
                }

                if (context.MonsterDead(arg1: new int[] {104001})) {
                    context.State = new State몹스폰(context);
                    return;
                }
            }

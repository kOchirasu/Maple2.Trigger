...
namespace Maple2.Trigger._02000498_bf {
    public static class _main_2 {
        ...
        private class State6라운드 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$02000350_BF__MAIN_2__0$", arg3: new int[] {4000}, arg4: "0");
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {106001, 106002, 106003, 106004, 106005},
                    score: 18000);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {106001, 106002, 106003, 106004, 106005})) {
        ...
        private class State7라운드 : TriggerState {
            ...
            public override void OnEnter() {
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {107001, 107002, 107003, 107004, 107005},
                    score: 22000);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {107001, 107002, 107003, 107004, 107005})) {
        ...
        private class State8라운드대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$02000350_BF__MAIN_2__1$", arg3: new int[] {2000}, arg4: "0");
            }
        ...
        private class State8라운드 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {108099}, arg2: false);
            }

            public override void Execute() {
                if (context.TimeExpired(arg1: "30")) {
                    context.DestroyMonster(arg1: new int[] {108099});
        ...
        private class State9라운드 : TriggerState {
            ...
            public override void OnEnter() {
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {109001, 109002, 109003, 109004},
                    score: 65000);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {109001, 109002, 109003, 109004})) {
        ...
        private class State10라운드 : TriggerState {
            ...
            public override void OnEnter() {
                context.DarkStream(type: "SpawnMonster", spawnID: new int[] {110001}, score: 270000);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {110001})) {

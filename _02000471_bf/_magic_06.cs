    ...
    public static class _magic_06 {
        ...
        private class Stateidle : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(triggerID: 2040315, key: "10002024clear", value: 0);
                context.SetUserValue(triggerID: 2040321, key: "10002024clear", value: 0);
                context.SetUserValue(triggerID: 2040322, key: "10002024clear", value: 0);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10002024}, arg2: 0)) {
        ...
        private class StateReady : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {1106}, arg2: false, arg3: 0, arg4: 200, arg5: 15f);
                context.SetMesh(arg1: new int[] {1206}, arg2: true, arg3: 0, arg4: 200, arg5: 15f);
                context.CreateMonster(arg1: new int[] {206}, arg2: false);
                context.AddBuff(arg1: new int[] {206}, arg2: 70002051, arg3: 1, arg4: true, arg5: false);
            }

            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {206})) {
        ...
        private class StateEvent_06 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetUserValue(triggerID: 2040315, key: "10002024clear", value: 1);
                context.SetUserValue(triggerID: 2040321, key: "10002024clear", value: 1);
                context.SetUserValue(triggerID: 2040322, key: "10002024clear", value: 1);
        ...
        private class StateEvent_06_b : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 1103, arg3: "$02000471_BF__MAGIC_06__0$", arg4: 3, arg5: 1);
                context.SetNpcEmotionSequence(arg1: 1103, arg2: "Talk_A");
                context.SetConversation(arg1: 1, arg2: 1104, arg3: "$02000471_BF__MAGIC_06__1$", arg4: 3, arg5: 4);
                context.SetConversation(arg1: 1, arg2: 1103, arg3: "$02000471_BF__MAGIC_06__2$", arg4: 3, arg5: 7);
                context.SetConversation(arg1: 1, arg2: 1104, arg3: "$02000471_BF__MAGIC_06__3$", arg4: 3, arg5: 10);
            }
        ...
        private class StateEvent_06_d : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {1103, 1104, 1105, 1101, 1102});
            }
        ...
        private class StateEvent_06_f : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {1107, 1108}, arg2: false);
            }
        ...
        private class StateEvent_06_h : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 1107, arg3: "$02000471_BF__MAGIC_06__4$", arg4: 5, arg5: 0);
                context.SetConversation(arg1: 1, arg2: 1108, arg3: "$02000471_BF__MAGIC_06__5$", arg4: 3, arg5: 3);
            }
        ...
        private class StateEvent_06_i : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 1107, arg3: "$02000471_BF__MAGIC_06__6$", arg4: 5, arg5: 0);
                context.SetConversation(arg1: 1, arg2: 1108, arg3: "$02000471_BF__MAGIC_06__7$", arg4: 3, arg5: 3);
                context.SetConversation(arg1: 1, arg2: 1107, arg3: "$02000471_BF__MAGIC_06__8$", arg4: 3, arg5: 5);
            }
        ...
        private class StateEvent_06_k : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {1107, 1108});
            }

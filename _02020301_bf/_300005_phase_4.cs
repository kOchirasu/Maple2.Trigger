    ...
    public static class _300005_phase_4 {
        ...
        private class State패이즈_4_시작 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new[] {200011, 200012, 200013, 200014, 200015, 200016, 200017, 200018},
                    arg2: false);
                context.DestroyMonster(arg1: new[] {512});
                context.DestroyMonster(arg1: new[] {511});
                context.SetInteractObject(arg1: new[] {10003122}, arg2: 2);
                context.SetInteractObject(arg1: new[] {10003121}, arg2: 2);
                ...
                context.SideNpcTalk(type: "talk", npcId: 11004205, illust: "ArcaneBlader_unfair",
                    script: "$02020301_BF__300005_PHASE_4__0$", duration: 3176);
            }
        ...
        private class State추가대화 : TriggerState {
            ...
            public override void OnEnter() {
                context.SideNpcTalk(type: "talk", npcId: 29500101, illust: "ArcheonBlack_Angry",
                    script: "$02020301_BF__300005_PHASE_4__1$", duration: 3176);
            }
        ...
        private class State추가대화_2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SideNpcTalk(type: "talk", npcId: 11004205, illust: "ArcaneBlader_unfair",
                    script: "$02020301_BF__300005_PHASE_4__2$", duration: 3176);
            }
        ...
        private class State엘리베이터_대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SideNpcTalk(type: "talk", npcId: 11004205, illust: "ArcaneBlader_unfair",
                    script: "$02020301_BF__300005_PHASE_4__3$", duration: 3176);
                ...
                context.SetVisibleBreakableObject(
                    ...
                    arg2: false);
                context.SetVisibleBreakableObject(
                    arg1: new[] {5101, 5102, 5103, 5104, 5105, 5106, 5107, 5108, 5109, 5110}, arg2: true);
                context.SetVisibleBreakableObject(
                    arg1: new[] {5111, 5112, 5113, 5114, 5115, 5116, 5117, 5118, 5119, 5120}, arg2: true);
                context.SetVisibleBreakableObject(
                    arg1: new[] {5121, 5122, 5123, 5124, 5125, 5126, 5127, 5128, 5129, 5130}, arg2: true);
                context.SetVisibleBreakableObject(
                    arg1: new[] {5131, 5132, 5133, 5134, 5135, 5136, 5137, 5138, 5139, 5140}, arg2: true);
                context.SetBreakable(arg1: new[] {5101, 5102, 5103, 5104, 5105, 5106, 5107, 5108, 5109, 5110},
                    arg2: true);
                context.SetBreakable(arg1: new[] {5111, 5112, 5113, 5114, 5115, 5116, 5117, 5118, 5119, 5120},
                    arg2: true);
                context.SetBreakable(arg1: new[] {5121, 5122, 5123, 5124, 5125, 5126, 5127, 5128, 5129, 5130},
                    arg2: true);
                context.SetBreakable(arg1: new[] {5131, 5132, 5133, 5134, 5135, 5136, 5137, 5138, 5139, 5140},
                    arg2: true);
            }
        ...
        private class State엘리베이터_도착 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetVisibleBreakableObject(
                    arg1: new[] {5101, 5102, 5103, 5104, 5105, 5106, 5107, 5108, 5109, 5110}, arg2: false);
                context.SetVisibleBreakableObject(
                    arg1: new[] {5111, 5112, 5113, 5114, 5115, 5116, 5117, 5118, 5119, 5120}, arg2: false);
                context.SetVisibleBreakableObject(
                    arg1: new[] {5121, 5122, 5123, 5124, 5125, 5126, 5127, 5128, 5129, 5130}, arg2: false);
                context.SetVisibleBreakableObject(
                    arg1: new[] {5131, 5132, 5133, 5134, 5135, 5136, 5137, 5138, 5139, 5140}, arg2: false);
                context.SetBreakable(arg1: new[] {5101, 5102, 5103, 5104, 5105, 5106, 5107, 5108, 5109, 5110},
                    arg2: false);
                context.SetBreakable(arg1: new[] {5111, 5112, 5113, 5114, 5115, 5116, 5117, 5118, 5119, 5120},
                    arg2: false);

    ...
    public static class _3000064_phase_5_interect_04 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {200037, 200038}, arg2: false);
            }

            public override void Execute() {
                if (context.UserValue(key: "Phase_5_Interect_04", value: 1)) {
        ...
        private class State인터렉트_설정 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {200037, 200038}, arg2: true);
                context.SetInteractObject(arg1: new int[] {10003104}, arg2: 1);
                context.SetVisibleBreakableObject(arg1: new int[] {5540}, arg2: false);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10003104}, arg2: 0)) {
                    context.State = new State인터렉트_동작(context);
                    return;
                }

                if (context.UserValue(key: "Phase_5_Interect_04", value: 0)) {

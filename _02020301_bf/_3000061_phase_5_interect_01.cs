...
namespace Maple2.Trigger._02020301_bf {
    public static class _3000061_phase_5_interect_01 {
        ...
        private class State인터렉트_설정 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(arg1: new int[] {200031, 200032}, arg2: true);
                context.SetInteractObject(arg1: new int[] {10003101}, arg2: 1);
                context.SetVisibleBreakableObject(arg1: new int[] {5510}, arg2: false);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10003101}, arg2: 0)) {

namespace Maple2.Trigger._02020120_bf {
    public static class _bgmchangeskillbreakreset {
        ...
        private class State던전시간작동대기 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.GetUserCount(boxId: 399) == 1) {
                    return new StateSkill브레이크신호대기_BGM교체(context);
                }
        ...
        private class StateSkill브레이크신호대기_BGM교체 : TriggerState {
            internal StateSkill브레이크신호대기_BGM교체(ITriggerContext context) : base(context) { }
        ...
        private class StateSkill브레이크실패Reset처리 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 6000)) {
                    return new StateSkill브레이크실패연출출력(context);
                }
        ...
        private class StateSkill브레이크실패연출출력 : TriggerState {
            internal StateSkill브레이크실패연출출력(ITriggerContext context) : base(context) { }
        ...
        private class StateBoss한테보내는PortalCreation : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 500)) {
                    // return new StateSkill브레이크신호대기_시간다시Setting(context);
                    return null;
                }
        ...
        private class StateBoss한테보내는PortalCreation_시간Reset안함02 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 500)) {
                    // return new StateSkill브레이크신호대기_시간Setting안함(context);
                    return null;
                }

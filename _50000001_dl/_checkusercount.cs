    ...
    public static class _checkusercount {
        ...
        private class StateDungeonStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.ShowGuideSummary(entityID: 25100203, textID: 25100203, durationTime: 3000);
            }
        ...
        private class StateWaitDungeon01 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityID: 25100201, textID: 25100201, durationTime: 3000);
            }
        ...
        private class StateWaitDungeon03 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityID: 25100202, textID: 25100202, durationTime: 3000);
            }

...
namespace Maple2.Trigger._02000387_bf {
    public static class _1101_customer {
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9113, arg2: new int[] {1101})) {
        ...
        private class StatePickItem_30000634 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 1101, nifPath: @"Map/Kerningcity/Indoor/ke_in_prop_tv_A01.nif",
        ...
        private class StatePickItem_30000690 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 1101, nifPath: @"Map/Tria/Indoor/tr_in_prop_sofa_D01.nif",
                    isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StatePickItem_30000693 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 1101, nifPath: @"Map/Kerningcity/Indoor/ke_in_prop_massage_A01.nif",
                    isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StatePickItem_30000712 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 1101, nifPath: @"Map/Orient/Indoor/or_in_prop_incense_A01.nif",
                    isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9301, arg2: new int[] {1101})) {

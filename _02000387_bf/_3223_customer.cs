...
namespace Maple2.Trigger._02000387_bf {
    public static class _3223_customer {
        ...
        private class StateCustomerEnter : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {3223}, arg2: false);
            }
        ...
        private class StatePatrol01 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 3223, arg2: "MS2PatrolData_301");
            }
        ...
        private class StatePatrol02 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 3223, arg2: "MS2PatrolData_302");
            }
        ...
        private class StatePatrol03 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 3223, arg2: "MS2PatrolData_303");
            }
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9133, arg2: new int[] {3223})) {
        ...
        private class StatePickItem_30000658 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 3223, nifPath: @"Map/Tria/Indoor/tr_in_prop_ringer_A01.nif",
        ...
        private class StateRightItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnPointID: 3223);
                context.SetConversation(arg1: 1, arg2: 3223, arg3: "$02000387_BF__3223_CUSTOMER__0$", arg4: 3, arg5: 0);
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 3223, arg2: "MS2PatrolData_333");
            }

            public override void Execute() {
                if (context.NpcDetected(arg1: 9303, arg2: new int[] {3223})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {3223});
            }
        ...
        private class StateWrongItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnPointID: 3223);
                context.SetConversation(arg1: 1, arg2: 3223, arg3: "$02000387_BF__3223_CUSTOMER__1$", arg4: 3, arg5: 0);
            }

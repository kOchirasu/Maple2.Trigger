...
namespace Maple2.Trigger._02000387_bf {
    public static class _1217_customer {
        ...
        private class StateCustomerEnter : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {1217}, arg2: false);
            }
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9113, arg2: new int[] {1217})) {
        ...
        private class StatePickItem_30000678 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 1217, nifPath: @"Map/Royalcity/Field/ry_fi_prop_hammock_A01.nif",
        ...
        private class StateRightItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 1217, arg3: "$02000387_BF__1217_CUSTOMER__0$", arg4: 3, arg5: 0);
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9301, arg2: new int[] {1217})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {1217});
            }
        ...
        private class StateWrongItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnPointID: 1217);
                context.SetConversation(arg1: 1, arg2: 1217, arg3: "$02000387_BF__1217_CUSTOMER__1$", arg4: 3, arg5: 0);
            }

...
namespace Maple2.Trigger._02000387_bf {
    public static class _2222_customer {
        ...
        private class StateCustomerEnter : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {2222}, arg2: false);
            }
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9123, arg2: new int[] {2222})) {
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9302, arg2: new int[] {2222})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {2222});
            }

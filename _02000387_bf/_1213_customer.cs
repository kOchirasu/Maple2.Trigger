...
namespace Maple2.Trigger._02000387_bf {
    public static class _1213_customer {
        ...
        private class StateCustomerEnter : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {1213}, arg2: false);
            }
        ...
        private class StatePatrol01 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 1213, arg2: "MS2PatrolData_101");
            }
        ...
        private class StatePatrol02 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 1213, arg2: "MS2PatrolData_102");
            }
        ...
        private class StatePatrol03 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 1213, arg2: "MS2PatrolData_103");
            }
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9113, arg2: new int[] {1213})) {
        ...
        private class StatePickItem_30000691 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 1213, nifPath: @"Map/Tria/Indoor/tr_in_prop_paintbag_A01.nif",
        ...
        private class StateRightItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnPointID: 1213);
                context.SetConversation(arg1: 1, arg2: 1213, arg3: "$02000387_BF__1213_CUSTOMER__0$", arg4: 3, arg5: 0);
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 1213, arg2: "MS2PatrolData_111");
            }

            public override void Execute() {
                if (context.NpcDetected(arg1: 9301, arg2: new int[] {1213})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {1213});
            }
        ...
        private class StateWrongItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnPointID: 1213);
                context.SetConversation(arg1: 1, arg2: 1213, arg3: "$02000387_BF__1213_CUSTOMER__1$", arg4: 3, arg5: 0);
            }

...
namespace Maple2.Trigger._02000387_bf {
    public static class _4108_customer {
        ...
        private class StateCustomerEnter : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {4108}, arg2: false);
            }
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9143, arg2: new int[] {4108})) {
        ...
        private class StatePickItem_30000641 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 4108, nifPath: @"Map/Henesys/Indoor/he_in_prop_kettle_A01.nif",
        ...
        private class StatePickItem_30000647 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 4108, nifPath: @"Map/UGC/Indoor/ugc_in_funct_alchemy_B01.nif",
                    isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StatePickItem_30000648 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 4108, nifPath: @"Map/UGC/Indoor/ugc_in_funct_alchemy_A01.nif",
                    isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StatePickItem_30000711 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 4108, nifPath: @"Map/UGC/Indoor/ugc_in_funct_workstone_G01.nif",
                    isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9304, arg2: new int[] {4108})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {4108});
            }

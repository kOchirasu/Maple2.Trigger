...
namespace Maple2.Trigger._02000387_bf {
    public static class _1109_customer {
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9113, arg2: new int[] {1109})) {
        ...
        private class StatePickItem_30000641 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 1109, nifPath: @"Map/Henesys/Indoor/he_in_prop_kettle_A01.nif",
        ...
        private class StatePickItem_30000647 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 1109, nifPath: @"Map/UGC/Indoor/ugc_in_funct_alchemy_B01.nif",
                    isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StatePickItem_30000648 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 1109, nifPath: @"Map/UGC/Indoor/ugc_in_funct_alchemy_A01.nif",
                    isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StatePickItem_30000711 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 1109, nifPath: @"Map/UGC/Indoor/ugc_in_funct_workstone_G01.nif",
                    isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9301, arg2: new int[] {1109})) {

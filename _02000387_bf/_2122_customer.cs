...
namespace Maple2.Trigger._02000387_bf {
    public static class _2122_customer {
        ...
        private class StateCustomerEnter : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {2122}, arg2: false);
            }
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9123, arg2: new int[] {2122})) {
        ...
        private class StatePickItem_30000652 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 2122, nifPath: @"Map/Common/Indoor/co_in_prop_brazier_A01.nif",
        ...
        private class StatePickItem_30000680 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 2122, nifPath: @"Map/Royalcity/Indoor/ry_in_prop_grill_A01.nif",
                    isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9302, arg2: new int[] {2122})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {2122});
            }

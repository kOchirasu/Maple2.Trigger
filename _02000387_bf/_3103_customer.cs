...
namespace Maple2.Trigger._02000387_bf {
    public static class _3103_customer {
        ...
        private class StateCustomerEnter : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {3103}, arg2: false);
            }
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9133, arg2: new int[] {3103})) {
        ...
        private class StatePickItem_30000677 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 3103, nifPath: @"Map/Royalcity/Field/ry_fi_prop_plane_A01.nif",
        ...
        private class StatePickItem_30000679 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 3103, nifPath: @"Map/Royalcity/Field/ry_fi_prop_yacht_A02.nif",
                    isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StatePickItem_30000684 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 3103, nifPath: @"Map/Ludibrium/Field/lu_fi_prop_rocket_A01.nif",
                    isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StatePickItem_30000697 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 3103, nifPath: @"Npc/Etc/UGC_Poclain/UGC_Poclain_01.nif",
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9303, arg2: new int[] {3103})) {

...
namespace Maple2.Trigger._02000387_bf {
    public static class _1201_customer {
        ...
        private class StatePatrol01 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 1201, arg2: "MS2PatrolData_101");
            }
        ...
        private class StatePatrol02 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 1201, arg2: "MS2PatrolData_102");
            }
        ...
        private class StatePatrol03 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 1201, arg2: "MS2PatrolData_103");
            }
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9113, arg2: new int[] {1201})) {
        ...
        private class StatePickItem_30000707 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 1201, nifPath: @"Map/Henesys/Indoor/he_in_prop_cushiona_A01.nif",
        ...
        private class StateRightItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnPointID: 1201);
                context.SetConversation(arg1: 1, arg2: 1201, arg3: "$02000387_BF__1201_CUSTOMER__0$", arg4: 3, arg5: 0);
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(arg1: 1201, arg2: "MS2PatrolData_111");
            }

            public override void Execute() {
                if (context.NpcDetected(arg1: 9301, arg2: new int[] {1201})) {
        ...
        private class StateWrongItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnPointID: 1201);
                context.SetConversation(arg1: 1, arg2: 1201, arg3: "$02000387_BF__1201_CUSTOMER__1$", arg4: 3, arg5: 0);
            }

...
namespace Maple2.Trigger._02000387_bf {
    public static class _3115_customer {
        ...
        private class StateCustomerEnter : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {3115}, arg2: false);
            }
        ...
        private class StatePatrolEnd : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9133, arg2: new int[] {3115})) {
        ...
        private class StatePickItem_30000617 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 3115, nifPath: @"Map/Common/Field/co_fi_prop_game_A01.nif",
        ...
        private class StatePickItem_30000618 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 3115, nifPath: @"Map/Common/Field/co_fi_prop_game_A02.nif",
                    isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StatePickItem_30000668 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 3115, nifPath: @"Map/Royalcity/Indoor/ry_in_prop_cranegame_A01.nif",
                    isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StatePickItem_30000671 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 3115,
        ...
        private class StatePickItem_30000672 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 3115, nifPath: @"Map/Royalcity/Indoor/ry_in_prop_pingpong_A01.nif",
                    isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StatePickItem_30000673 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 3115, nifPath: @"Map/Royalcity/Indoor/ry_in_prop_pooltable_A01.nif",
                    isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StatePickItem_30000674 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddEffectNif(spawnPointID: 3115, nifPath: @"Map/Royalcity/Indoor/ry_in_prop_pump_A01.nif",
                    isOutline: true, scale: 1.2f, rotateZ: 225);
            }
        ...
        private class StateRightItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 1, arg2: 3115, arg3: "$02000387_BF__3115_CUSTOMER__0$", arg4: 3, arg5: 0);
        ...
        private class StateCustomerLeave : TriggerState {
            ...
            public override void Execute() {
                if (context.NpcDetected(arg1: 9303, arg2: new int[] {3115})) {
        ...
        private class StateQuit : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[] {3115});
            }
        ...
        private class StateWrongItem : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.RemoveEffectNif(spawnPointID: 3115);
                context.SetConversation(arg1: 1, arg2: 3115, arg3: "$02000387_BF__3115_CUSTOMER__1$", arg4: 3, arg5: 0);
            }

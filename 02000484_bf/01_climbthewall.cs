    ...
    public static class _01_climbthewall {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10002030, 10002031}, state: 0);
        ...
        private class StateTerraceMobAttack01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 901, script: "$02000484_BF__01_CLIMBTHEWALL__0$", arg4: 2, arg5: 1);
                context.SetConversation(type: 1, spawnId: 902, script: "$02000484_BF__01_CLIMBTHEWALL__1$", arg4: 2, arg5: 1);
                context.SetConversation(type: 1, spawnId: 903, script: "$02000484_BF__01_CLIMBTHEWALL__2$", arg4: 2, arg5: 1);
            }
        ...
        private class StateTowerUnderMobAttack01End : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{920, 921, 922, 923})) {
        ...
        private class StateSwichOn : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10002030}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10002030}, arg2: 0)) {
        ...
        private class StateGuideMoveToBridge01End : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.MonsterDead(spawnIds: new []{930, 931, 932, 933, 934})) {
        ...
        private class StateGuidePullTheLever01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10002031}, state: 1);
                context.PlaySystemSoundInBox(sound: "System_ShowGuideSummary_01");
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10002031}, arg2: 0)) {

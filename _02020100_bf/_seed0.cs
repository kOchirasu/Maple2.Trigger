    ...
    public static class _seed0 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "Seed0start", value: 1)) {
        ...
        private class State시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {1301}, arg2: true, arg3: 0, arg4: 0, arg5: 2f);
                context.SetInteractObject(arg1: new int[] {10002115}, arg2: 1, arg3: true);
            }

            public override void Execute() {
                if (context.UserValue(key: "Seed0start", value: 2)) {
                    context.State = new State종료(context);
                    return;
                }

                if (context.ObjectInteracted(arg1: new int[] {10002115}, arg2: 0)) {
        ...
        private class State씨앗0_대기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10002115}, arg2: 0, arg3: true);

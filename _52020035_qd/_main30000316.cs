    ...
    public static class _main30000316 {
        ...
        private class Stateidle : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {701}, arg2: new int[] {30000315, 30000316},
                    arg3: new byte[] {2})) {
        ...
        private class State연출시작_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State라딘이야기01(context);
                    return;
                }
            }
        ...
        private class State라딘이야기01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State라딘이야기01_01(context);
                    return;
                }
            }
        ...
        private class State라딘이야기01_01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003750, msg: "…이런 일이 있었다고 합니다.", duration: 3000);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State라딘이야기01_02(context);
                    return;
                }
            }
        ...
        private class State라딘이야기01_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State라딘이야기01_03(context);
                    return;
                }
            }
        ...
        private class State라딘이야기01_03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003753, msg: "그렇다는 것은 확실히 이곳에 중요한 무언가가 있다는 얘기겠지.", duration: 4000);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State라딘이야기01_04(context);
                    return;
                }
            }
        ...
        private class State라딘이야기01_04 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(arg1: new int[] {4001}, arg2: false);
                context.AddCinematicTalk(npcID: 11003753, msg: "수고했네. 덕분에 중요한 정보를 얻게 되었군.", duration: 4000);
                context.AddCinematicTalk(npcID: 11003750, msg: "이런 상황을 예측하신 라딘님께서 미리 지시해주신 덕분입니다.", duration: 3000);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 7000)) {
                    context.State = new State라딘이야기02(context);
                    return;
                }
            }
        ...
        private class State라딘이야기02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State라딘이야기02_01(context);
                    return;
                }
            }
        ...
        private class State라딘이야기02_01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003750, msg: "그 자들이라면… 설마 흑성회 녀석들과 다시 거래하실 생각이신겁니까?", duration: 4000);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State라딘이야기02_02(context);
                    return;
                }
            }
        ...
        private class State라딘이야기02_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State라딘이야기02_03(context);
                    return;
                }
            }
        ...
        private class State라딘이야기02_03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003753, msg: "짓밟아버리는 것은 그 이후에 해도 늦지 않아.", duration: 3000);
                context.SetNpcEmotionSequence(arg1: 102, arg2: "Bore_A");
                context.AddCinematicTalk(npcID: 11003750, msg: "넵, 분부대로 하겠습니다.", duration: 4000);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 6000)) {
                    context.State = new State화면암전(context);
                    return;
                }
            }
        ...
        private class State화면암전 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 500)) {
                    context.State = new State흑성회입장전(context);
                    return;
                }
            }
        ...
        private class State흑성회입장전 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State흑성회등장직전(context);
                    return;
                }
            }
        ...
        private class State흑성회등장직전 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State흑성회입장(context);
                    return;
                }
            }
        ...
        private class State흑성회입장 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetProductionUI(arg1: 1);
                context.SetProductionUI(arg1: 3);
                context.CreateMonster(arg1: new int[] {116}, arg2: false, arg3: 0);
                context.CreateMonster(arg1: new int[] {109}, arg2: false, arg3: 0);
                context.CreateMonster(arg1: new int[] {104}, arg2: false, arg3: 0);
                context.CreateMonster(arg1: new int[] {103}, arg2: false, arg3: 0);
                context.CreateMonster(arg1: new int[] {122}, arg2: false, arg3: 0);
                context.CreateMonster(arg1: new int[] {123}, arg2: false, arg3: 0);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State흑성회입장_02(context);
                    return;
                }
            }
        ...
        private class State흑성회입장_02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(arg1: new int[] {4032}, arg2: false);
                context.AddCinematicTalk(npcID: 11003754, msg: "이런곳까지 불러내다니... 다시봤구만, 나으리.", duration: 5000);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 6000)) {
                    context.State = new State손님맞이(context);
                    return;
                }
            }
        ...
        private class State손님맞이 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 100)) {
                    context.State = new State손님맞이_01(context);
                    return;
                }
            }
        ...
        private class State손님맞이_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State손님맞이_01_01(context);
                    return;
                }
            }
        ...
        private class State손님맞이_01_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 100)) {
                    context.State = new State손님맞이_02(context);
                    return;
                }
            }
        ...
        private class State손님맞이_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(arg1: new int[] {4033}, arg2: false);
                context.AddCinematicTalk(npcID: 11003757, msg: @"우린 여기 놀러온게 아니야.\n흑성회의 간부답게 행동해라.", duration: 3000);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State손님맞이_03(context);
                    return;
                }
            }
        ...
        private class State손님맞이_03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 500)) {
                    context.State = new State손님맞이_03_01(context);
                    return;
                }
            }
        ...
        private class State손님맞이_03_01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003758, msg: @"형… 알았어요.\n대신 일이 끝나면 꼭 같이…", duration: 3000);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State흑성회와이야기시작01_1(context);
                    return;
                }
            }
        ...
        private class State흑성회와이야기시작01_1 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(arg1: new int[] {4020}, arg2: false);
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State흑성회와이야기시작02(context);
                    return;
                }
            }
        ...
        private class State흑성회와이야기시작02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State흑성회와이야기시작02_01(context);
                    return;
                }
            }
        ...
        private class State흑성회와이야기시작02_01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003757, msg: "민, 상대의 도발에 일일이 반응하지마라.", duration: 3000);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State흑성회와이야기시작02_02(context);
                    return;
                }
            }
        ...
        private class State흑성회와이야기시작02_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State흑성회와이야기시작03(context);
                    return;
                }
            }
        ...
        private class State흑성회와이야기시작03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 14000)) {
                    context.State = new State흑성회와이야기시작03_01(context);
                    return;
                }
            }
        ...
        private class State흑성회와이야기시작03_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(arg1: new int[] {4023}, arg2: false);
                context.AddCinematicTalk(npcID: 11003754, msg: "도대체 무슨 꿍꿍이 속인거지?", duration: 3000);
                context.DestroyMonster(arg1: new int[] {109});
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State흑성회와이야기시작04(context);
                    return;
                }
            }
        ...
        private class State흑성회와이야기시작04 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 11000)) {
                    context.State = new State흑성회와이야기시작04_라딘과웨이홍(context);
                    return;
                }
            }
        ...
        private class State흑성회와이야기시작04_라딘과웨이홍 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State흑성회와이야기시작04_라딘과웨이홍_02(context);
                    return;
                }
            }
        ...
        private class State흑성회와이야기시작04_라딘과웨이홍_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 17000)) {
                    context.State = new State흑성회와이야기시작04_라딘과웨이홍_03(context);
                    return;
                }
            }
        ...
        private class State흑성회와이야기시작04_라딘과웨이홍_03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 9000)) {
                    context.State = new State흑성회와이야기시작04_라딘과웨이홍_04(context);
                    return;
                }
            }
        ...
        private class State흑성회와이야기시작04_라딘과웨이홍_04 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 13000)) {
                    context.State = new State흑성회와이야기시작04_라딘과웨이홍_05(context);
                    return;
                }
            }
        ...
        private class State흑성회와이야기시작04_라딘과웨이홍_05 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 6000)) {
                    context.State = new State흑성회와이야기시작04_라딘과웨이홍_06(context);
                    return;
                }
            }
        ...
        private class State흑성회와이야기시작04_라딘과웨이홍_06 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 12000)) {
                    context.State = new State흑성회와이야기시작04_라딘과웨이홍_07(context);
                    return;
                }
            }
        ...
        private class State흑성회와이야기시작04_라딘과웨이홍_07 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 7000)) {
                    context.State = new State흑성회와이야기시작04_라딘과웨이홍_08(context);
                    return;
                }
            }
        ...
        private class State흑성회와이야기시작04_라딘과웨이홍_08 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003753, msg: "훗, 이제서야 말이 통하는군.", duration: 2000);
                context.SetNpcEmotionSequence(arg1: 103, arg2: "Bore_A");
                context.AddCinematicTalk(npcID: 11003753, msg: "그럼, 계획에 대해서 이야기해 보도록 하지…", duration: 3000);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State흑성회와이야기시작04_1(context);
                    return;
                }
            }
        ...
        private class State흑성회와이야기시작04_1 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State장면전환(context);
                    return;
                }
            }
        ...
        private class State장면전환 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State장면전환_02(context);
                    return;
                }
            }
        ...
        private class State장면전환_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State마을로이동(context);
                    return;
                }
            }

...
namespace Maple2.Trigger._52020035_qd {
    public static class _main30000318 {
        public static readonly Func<ITriggerContext, TriggerState> Start = context => new Stateidle3(context);

        private class Stateidle3 : TriggerState {
            internal Stateidle3(ITriggerContext context) : base(context) { }

            public override void OnEnter() { }

            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {703}, arg2: new int[] {30000318},
                    arg3: new byte[] {2})) {
        ...
        private class State연출시작3 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State연출시작3_1(context);
                    return;
                }
            }
        ...
        private class State연출시작3_1 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(arg1: new int[] {118});
                context.DestroyMonster(arg1: new int[] {119});
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State뒷이야기(context);
                    return;
                }
            }
        ...
        private class State뒷이야기 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3500)) {
                    context.State = new State뒷이야기01(context);
                    return;
                }
            }
        ...
        private class State뒷이야기01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 7000)) {
                    context.State = new State뒷이야기02(context);
                    return;
                }
            }
        ...
        private class State뒷이야기02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State뒷이야기02_1(context);
                    return;
                }
            }

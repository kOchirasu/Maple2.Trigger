...
namespace Maple2.Trigger._52020035_qd {
    public static class _main30000317 {
        public static readonly Func<ITriggerContext, TriggerState> Start = context => new Stateidle2(context);

        private class Stateidle2 : TriggerState {
            internal Stateidle2(ITriggerContext context) : base(context) { }

            public override void OnEnter() { }

            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {702}, arg2: new int[] {30000317},
                    arg3: new byte[] {1})) {
        ...
        private class State연출시작3 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {110}, arg2: false, arg3: 0);
        ...
        private class State라딘과대화시작 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003753,
                    msg: @"지원군을 소집하는데도 시간이 걸리겠지만\n우리가 포털 수리 및 방어 시스템을 무력화시키지 않는다면\n결국 또 다른 많은 희생을 치루게 되겠지.",
                    duration: 4500);
            }
        ...
        private class State라딘과대화시작_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(arg1: new int[] {4027}, arg2: false);
        ...
        private class State라딘과대화시작_03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003753,
                    msg: @"그렇지. 게다가 자네가 얘기해준 티어스 코어라는 물건에 대해서도 빨리 정보를 찾아\n왜 어둠의 세력이 그것을 노리고 있는지도 알아내야 하고 말이야.",
                    duration: 4500);
            }
        ...
        private class State카메라이동 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {111}, arg2: false, arg3: 0);
                context.CreateMonster(arg1: new int[] {115}, arg2: false, arg3: 0);
                context.CreateMonster(arg1: new int[] {112}, arg2: false, arg3: 0);
                context.CreateMonster(arg1: new int[] {113}, arg2: false, arg3: 0);
                context.CreateMonster(arg1: new int[] {114}, arg2: false, arg3: 0);
            }
        ...
        private class State하렌 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.ShowCaption(type: "VerticalCaption", title: "하렌", desc: "흑성회 제 3 간부", align: "centerLeft",
        ...
        private class State카일 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(arg1: new int[] {4024}, arg2: false);
                context.SetNpcEmotionSequence(arg1: 114, arg2: "Bore_B");
                context.ShowCaption(type: "VerticalCaption", title: "카일", desc: "흑성회 제 4 간부", align: "centerRight",
                    offsetRateX: 0f, offsetRateY: 0f, duration: 3000, scale: 2f);
            }
        ...
        private class State브리드민 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.ShowCaption(type: "VerticalCaption", title: "브리드 민", desc: "흑성회 제 5 간부", align: "centerLeft",
                    offsetRateX: 0f, offsetRateY: 0f, duration: 3000, scale: 2f);
            }
        ...
        private class State바사라첸 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.ShowCaption(type: "VerticalCaption", title: "바사라첸", desc: "흑성회 제 2 간부", align: "centerRight",
                    offsetRateX: 0f, offsetRateY: 0f, duration: 3000, scale: 2f);
            }
        ...
        private class State웨이홍 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003754,
                    msg: @"여어~ $MyPCName$, 용케도 살아있었군.\n정말 그 끈질긴 생명력은 칭찬하지 않을 수 없군 그래.", duration: 4000);
                context.ShowCaption(type: "VerticalCaption", title: "웨이홍", desc: "흑성회 보스", align: "centerLeft",
                    offsetRateX: 0f, offsetRateY: 0f, duration: 3000, scale: 2f);
            }
        ...
        private class State흑성회와의동맹에대하여 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(arg1: new int[] {4029}, arg2: false);
        ...
        private class State흑성회와의동맹에대하여2 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(arg1: new int[] {4026}, arg2: false);
                context.AddCinematicTalk(npcID: 11003754,
                    msg: @"제법 똑똑한 녀석인줄 알았는데 이제보니 영 머리가 안굴러 가는 녀석이군.\n세상물정 모르는 꼬맹이같으니라고.", duration: 4000);
            }
        ...
        private class State정보전달하기 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003754, msg: @"뭐, 징징거리는 어린아이는 다 달랜 것 같으니…\n본격적으로 거래를 시작해보자구.",
                    duration: 4000);
                context.AddCinematicTalk(npcID: 11003754,
                    msg: @"선불을 하는 취미는 없지만 호의를 베풀어 먼저 알려주도록 하지.\n의심많은 녀석의 입도 다물게 할겸. 후후.", duration: 4000);
                context.AddCinematicTalk(npcID: 11003754,
                    msg: @"일단 우리 쪽에서 입수한 정보에 따르면 크리티아스의 방어 시스템은\n티아만 에너지 포트라는 곳에서 제어되고 있다고 한다.", duration: 4000);
            }
        ...
        private class State정보전달하기3 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11003753, msg: "혹시 티어스 코어에 대한 정보는 그게 다인가? 어디에 있다던지 하는건…",
                    duration: 3000);
            }
        ...
        private class State정보전달하기4 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {117}, arg2: false, arg3: 0);
                context.CreateMonster(arg1: new int[] {118}, arg2: false, arg3: 0);

    ...
    public static class _madricansiege {
        ...
        private class StateDungeonStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 2, spawnId: 11000015, script: "$52100031_QD__MADRICANSIEGE__0$", arg4: 4, arg5: 0);
            }
        ...
        private class StateDungeonInit : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 1, spawnId: 1001, script: "$52100031_QD__MADRICANSIEGE__1$", arg4: 3, arg5: 0);
            }
        ...
        private class State1차지원 : TriggerState {
            ...
            public override void OnEnter() {
                context.SpawnNpcRange(spawnIds: new []{2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025, 2026, 2027, 2028, 2029, 2030}, isAutoTargeting: false);
        ...
        private class State암전 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetCinematicUI(type: 1);
                context.SetCinematicUI(type: 3);
                context.MoveUser(mapId: 52100031, portalId: 3);
                ...
                context.SpawnNpcRange(spawnIds: new []{1901, 1902, 1903, 1904, 1905, 1906, 1907, 1908, 1909, 1910, 1911, 1912, 1913, 1914, 1915, 1916, 1917, 1918, 1919, 1920, 1921, 1922}, isAutoTargeting: false);
        ...
        private class State던전종료StartCinematic : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetNpcEmotionLoop(spawnId: 1922, sequenceName: "Talk_A", duration: 3000f);
                context.AddCinematicTalk(npcId: 11001567, illustId: "11001567", script: "$52100031_QD__MADRICANSIEGE__2$", duration: 3000, align: Align.Right);
        ...
        private class State던전EndingCinematic01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetNpcEmotionLoop(spawnId: 1921, sequenceName: "Talk_A", duration: 3000f);
                context.AddCinematicTalk(npcId: 11001566, illustId: "11001566", script: "$52100031_QD__MADRICANSIEGE__3$", duration: 3000, align: Align.Left);
            }
        ...
        private class State던전EndingCinematic02 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetNpcRotation(spawnId: 1920, rotation: 180);
                context.SetNpcEmotionLoop(spawnId: 1920, sequenceName: "Talk_A", duration: 3000f);
                context.AddCinematicTalk(npcId: 11001568, illustId: "11001568", script: "$52100031_QD__MADRICANSIEGE__4$", duration: 3000, align: Align.Left);
            }
        ...
        private class State룬블레이더이동 : TriggerState {
            ...
            public override void OnEnter() {
                context.MoveNpc(spawnId: 1920, patrolName: "MS2PatrolData_1920");
                context.MoveNpc(spawnId: 1921, patrolName: "MS2PatrolData_1921");
                context.MoveNpc(spawnId: 1922, patrolName: "MS2PatrolData_1922");
            }
        ...
        private class State던전종료StopCinematic : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(spawnIds: new []{1920, 1921, 1922}, arg2: false);
                context.SetSkip();
                context.SetCinematicUI(type: 0);
                context.SetCinematicUI(type: 2);
                context.CameraReset(interpolationTime: 0.0f);

    ...
    public static class _01_climbthewall {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10002083}, arg2: 1);
                context.SetInteractObject(arg1: new int[] {10002084}, arg2: 1);
        ...
        private class State1stArrowGuide01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.ShowGuideSummary(entityID: 20039801, textID: 20039801, durationTime: 4000);
        ...
        private class StateLiftUpBombGuide01 : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(arg2: "System_ShowGuideSummary_01");
                context.ShowGuideSummary(entityID: 20039802, textID: 20039802, durationTime: 4000);
        ...
        private class StateTowerUnderMobAttack01 : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(arg2: "System_ShowGuideSummary_01");
                context.ShowGuideSummary(entityID: 20039803, textID: 20039803, durationTime: 3000);
                context.CreateMonster(arg1: new int[] {920, 921, 922, 923}, arg2: false);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10002083}, arg2: 0)) {
        ...
        private class StateLadderOnToTowerUp01 : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(arg2: "System_ShowGuideSummary_01");
                context.ShowGuideSummary(entityID: 20039804, textID: 20039804, durationTime: 3000);
        ...
        private class StateGuidePullTheLever01 : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10002084}, arg2: 0)) {

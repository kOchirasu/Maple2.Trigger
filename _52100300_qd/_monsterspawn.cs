    ...
    public static class _monsterspawn {
        ...
        private class State대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.UserValue(key: "Spawn", value: 1)) {
        ...
        private class State스폰1 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {111, 121, 131, 141}, arg2: false);
            }
        ...
        private class State스폰2 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {112, 122, 132, 142}, arg2: false);
            }
        ...
        private class State스폰3 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {113, 123, 133, 143}, arg2: false);
            }
        ...
        private class State스폰4 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {114, 124, 134, 144}, arg2: false);
            }
        ...
        private class State스폰5 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {115, 125, 135, 145}, arg2: false);
            }

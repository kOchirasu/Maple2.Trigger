...
namespace Maple2.Trigger._52100300_qd {
    public static class _archeon_interacobject_03 {
        ...
        private class State시작 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10002288}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10002288}, arg2: 0)) {
                    context.SetInteractObject(arg1: new int[] {10002288}, arg2: 2);

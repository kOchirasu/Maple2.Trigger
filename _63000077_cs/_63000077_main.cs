    ...
    public static class _63000077_main {
        ...
        private class State준비 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {701}, arg2: new int[] {30000379},
                    arg3: new byte[] {3})) {
                    context.State = new State일반사냥(context);
                    return;
                }

                if (context.QuestUserDetected(arg1: new int[] {701}, arg2: new int[] {30000378},
                    arg3: new byte[] {2})) {
                    context.State = new State일반사냥(context);
                    return;
                }
                ...
                if (context.QuestUserDetected(arg1: new int[] {701}, arg2: new int[] {30000378},
                    arg3: new byte[] {1})) {
                    context.State = new State30000378수락_01(context);
                    return;
                }

                if (context.QuestUserDetected(arg1: new int[] {701}, arg2: new int[] {30000377},
                    arg3: new byte[] {3})) {
                    context.State = new State30000377완료_01(context);
                    return;
                }

                if (context.QuestUserDetected(arg1: new int[] {701}, arg2: new int[] {30000377},
                    arg3: new byte[] {2})) {
                    context.State = new State화난보보스_01(context);
                    return;
                }
        ...
        private class State30000378수락_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 500)) {
                    context.State = new State30000378수락_02(context);
                    return;
                }
            }
        ...
        private class State30000378수락_02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {106, 108}, arg2: false);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State에블린일기_01(context);
                    return;
                }
            }
        ...
        private class State30000377완료_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 500)) {
                    context.State = new State30000377완료_02(context);
                    return;
                }
            }
        ...
        private class State30000377완료_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State클라우스대화_05(context);
                    return;
                }
            }
        ...
        private class State잠시대기_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 500)) {
                    context.State = new State보보스의오해_01(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State보보스의오해_02(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2500)) {
                    context.State = new State보보스의오해_03(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_03 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004373, msg: "$63000077_CS__63000077_MAIN__0$", duration: 3500,
                    align: "right");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State보보스의오해_04(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_04 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State보보스의오해_05(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_05 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State보보스의오해_06(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_06 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 500)) {
                    context.State = new State보보스의오해_07(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_07 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 0, msg: "$63000077_CS__63000077_MAIN__2$", duration: 2800,
                    align: "right");
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State보보스의오해_08(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_08 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State보보스의오해_09(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_09 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004373, msg: "$63000077_CS__63000077_MAIN__3$", duration: 3500,
                    align: "right");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State보보스의오해_10(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_10 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State보보스의오해_11(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_11 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 0, msg: "$63000077_CS__63000077_MAIN__4$", duration: 4000,
                    align: "right");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4500)) {
                    context.State = new State보보스의오해_12(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_12 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State보보스의오해_13(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_13 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004373, msg: "$63000077_CS__63000077_MAIN__5$", duration: 2500,
                    align: "right");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State보보스의오해_14(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_14 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004373, msg: "$63000077_CS__63000077_MAIN__6$", duration: 3500,
                    align: "right");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State보보스의오해_15(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_15 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State보보스의오해_16(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_16 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 0, msg: "$63000077_CS__63000077_MAIN__7$", duration: 2500,
                    align: "right");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State보보스의오해_17(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_17 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 0, msg: "$63000077_CS__63000077_MAIN__8$", duration: 2500,
                    align: "right");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State보보스의오해_18(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_18 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State보보스의오해_19(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_19 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004373, msg: "$63000077_CS__63000077_MAIN__9$", duration: 2500,
                    align: "right");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State보보스의오해_20(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_20 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004373, msg: "$63000077_CS__63000077_MAIN__10$", duration: 3000,
                    align: "right");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 3500)) {
                    context.State = new State보보스의오해_21(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_21 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State보보스의오해_22(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_22 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004373, msg: "$63000077_CS__63000077_MAIN__11$", duration: 2000,
                    align: "right");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 2500)) {
                    context.State = new State보보스의오해_23(context);
                    return;
                }
            }
        ...
        private class State보보스의오해_23 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004373, msg: "$63000077_CS__63000077_MAIN__12$", duration: 2000,
                    align: "right");
            }
        ...
        private class State화난보보스_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 500)) {
                    context.State = new State화난보보스_02(context);
                    return;
                }
            }
        ...
        private class State화난보보스_02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {220}, arg2: false);
                context.CreateMonster(
                    arg1: new int[] {201, 202, 203, 204, 205, 206, 207, 208, 209, 210, 211, 212, 213, 214, 215, 216},
                    arg2: false);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State화난보보스_03(context);
                    return;
                }
            }
        ...
        private class State화난보보스_03 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {701}, arg2: new int[] {30000377},
                    arg3: new byte[] {2})) {
                    context.State = new State패배한보보스_01(context);
                    return;
                }
            }
        ...
        private class State패배한보보스_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 500)) {
                    context.State = new State패배한보보스_02(context);
                    return;
                }
            }
        ...
        private class State패배한보보스_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new int[]
                    {201, 202, 203, 204, 205, 206, 207, 208, 209, 210, 211, 212, 213, 214, 215, 216, 220});
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State패배한보보스_03(context);
                    return;
                }
            }
        ...
        private class State패배한보보스_03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State클라우스대화_01(context);
                    return;
                }
            }
        ...
        private class State클라우스대화_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004368, msg: "$63000077_CS__63000077_MAIN__13$", duration: 2500,
                    align: "left");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State클라우스대화_02(context);
                    return;
                }
            }
        ...
        private class State클라우스대화_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004368, msg: "$63000077_CS__63000077_MAIN__14$", duration: 2500,
                    align: "left");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State클라우스대화_03(context);
                    return;
                }
            }
        ...
        private class State클라우스대화_03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 500)) {
                    context.State = new State클라우스대화_04(context);
                    return;
                }
            }
        ...
        private class State에블린일기_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State에블린일기_02(context);
                    return;
                }
            }
        ...
        private class State에블린일기_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 8000)) {
                    context.State = new State에블린일기_03(context);
                    return;
                }
            }
        ...
        private class State에블린일기_03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State다시만난가족_01(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004368, msg: "$63000077_CS__63000077_MAIN__16$", duration: 3500,
                    illustID: "June_normal", align: "left");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State다시만난가족_02(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_02 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004368, msg: "$63000077_CS__63000077_MAIN__17$", duration: 3000,
                    illustID: "June_normal", align: "left");
                context.CreateMonster(arg1: new int[] {103, 104, 105}, arg2: false);
                context.MoveNpc(arg1: 103, arg2: "MS2PatrolData_2003");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 3500)) {
                    context.State = new State다시만난가족_03(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_03 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004356, msg: "$63000077_CS__63000077_MAIN__18$", duration: 2000,
                    align: "left");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 500)) {
                    context.State = new State다시만난가족_04(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_04 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State다시만난가족_05(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_05 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004356, msg: "$63000077_CS__63000077_MAIN__19$", duration: 3500,
                    align: "right");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State다시만난가족_06(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_06 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11004373, msg: "$63000077_CS__63000077_MAIN__20$", duration: 2000,
                    align: "left");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 2500)) {
                    context.State = new State다시만난가족_07(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_07 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1500)) {
                    context.State = new State다시만난가족_08(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_08 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004373, msg: "$63000077_CS__63000077_MAIN__21$", duration: 3500,
                    align: "left");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 2500)) {
                    context.State = new State다시만난가족_09(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_09 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1500)) {
                    context.State = new State다시만난가족_10(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_10 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004356, msg: "$63000077_CS__63000077_MAIN__22$", duration: 3500,
                    illustID: "Evelyn_glad", align: "right");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State다시만난가족_11(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_11 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State다시만난가족_12(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_12 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004373, msg: "$63000077_CS__63000077_MAIN__23$", duration: 4000,
                    align: "left");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4500)) {
                    context.State = new State다시만난가족_13(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_13 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004373, msg: "$63000077_CS__63000077_MAIN__24$", duration: 3000,
                    align: "left");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 3500)) {
                    context.State = new State다시만난가족_14(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_14 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelect(arg1: 8011, arg2: true);
                context.AddCinematicTalk(npcID: 11004361, msg: "$63000077_CS__63000077_MAIN__25$", duration: 4000,
                    illustID: "Aiden_smile", align: "right");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4500)) {
                    context.State = new State다시만난가족_15(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_15 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004365, msg: "$63000077_CS__63000077_MAIN__26$", duration: 3500,
                    illustID: "Mia_happy", align: "right");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State다시만난가족_16(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_16 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004356, msg: "$63000077_CS__63000077_MAIN__27$", duration: 2000,
                    illustID: "Evelyn_normal", align: "right");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State다시만난가족_17(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_17 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004356, msg: "$63000077_CS__63000077_MAIN__28$", duration: 3500,
                    illustID: "Evelyn_sad", align: "right");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State다시만난가족_18(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_18 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004368, msg: "$63000077_CS__63000077_MAIN__29$", duration: 3000,
                    illustID: "June_smile", align: "right");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 3500)) {
                    context.State = new State다시만난가족_19(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_19 : TriggerState {
            ...
            public override void OnEnter() {
                context.AddCinematicTalk(npcID: 11004356, msg: "$63000077_CS__63000077_MAIN__30$", duration: 3500,
                    illustID: "Evelyn_glad", align: "right");
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State다시만난가족_20(context);
                    return;
                }
            }
        ...
        private class State다시만난가족_20 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State업적_01(context);
                    return;
                }
            }
        ...
        private class State업적_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 500)) {
                    context.State = new State업적_02(context);
                    return;
                }
            }

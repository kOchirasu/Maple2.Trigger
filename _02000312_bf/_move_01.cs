    ...
    public static class _move_01 {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {3100, 3101, 3102, 3103}, arg2: true, arg3: 0, arg4: 0, arg5: 0f);
                context.SetMesh(arg1: new int[] {3200, 3201, 3202, 3203}, arg2: false, arg3: 0, arg4: 0, arg5: 0f);
                ...
                context.SetInteractObject(arg1: new int[] {10001034}, arg2: 2);
                context.SetUserValue(key: "BoardApp", value: 0);
            }

            public override void Execute() {
                if (context.UserValue(key: "BoardApp", value: 1)) {
        ...
        private class StateBoardApp02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10001034}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10001034}, arg2: 0)) {
        ...
        private class StateBoardGoUp01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {3100, 3101, 3102, 3103}, arg2: false, arg3: 100, arg4: 0, arg5: 2f);
                context.SetInteractObject(arg1: new int[] {10001034}, arg2: 2);
        ...
        private class StateBoardDisApp01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {3200, 3201, 3202, 3203}, arg2: true, arg3: 100, arg4: 0, arg5: 2f);
            }
        ...
        private class StateBoardReset03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {3200, 3201, 3202, 3203}, arg2: false, arg3: 100, arg4: 0, arg5: 2f);
            }

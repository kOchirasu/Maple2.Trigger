    ...
    public static class _52000104 {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEffect(arg1: new int[] {5408}, arg2: false);
                context.SetEffect(arg1: new int[] {5409}, arg2: false);
                context.SetEffect(arg1: new int[] {5410}, arg2: false);
                context.SetEffect(arg1: new int[] {5411}, arg2: false);
                context.SetEffect(arg1: new int[] {5412}, arg2: false);
                context.SetEffect(arg1: new int[] {5413}, arg2: false);
                context.SetEffect(arg1: new int[] {5414}, arg2: false);
                context.SetEffect(arg1: new int[] {5415}, arg2: false);
                context.SetEffect(arg1: new int[] {5416}, arg2: false);
            }
        ...
        private class StateQuit02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddBalloonTalk(spawnPointID: 0, msg: "$52000104_QD__52000104__2$", duration: 6000,
                    delayTick: 1000);
                context.ShowGuideSummary(entityID: 25201041, textID: 25201041, durationTime: 10000);
            }
        ...
        private class State리린과대화05 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {10011}, arg2: new int[] {20002316},
                    arg3: new byte[] {1})) {
                    context.State = new State꽃가꾸기퀘스트01(context);
                    return;
                }

                if (context.QuestUserDetected(arg1: new int[] {10011}, arg2: new int[] {20002317},
                    arg3: new byte[] {1})) {
                ...
                if (context.QuestUserDetected(arg1: new int[] {10011}, arg2: new int[] {20002319},
                    arg3: new byte[] {1})) {
                    context.State = new State할아버지등장씬01(context);
                    return;
                }
        ...
        private class State꽃가꾸기퀘스트01 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShowGuideSummary(entityID: 25201042, textID: 25201042, durationTime: 10000);
        ...
        private class State꽃섬멸퀘스트03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetProductionUI(arg1: 2);
                context.CameraReset(interpolationTime: 0.0f);
                context.CreateMonster(arg1: new int[] {200, 201, 202, 203, 204}, arg2: false);
                context.SetSound(arg1: 9000, arg2: true);
                context.AddBalloonTalk(spawnPointID: 0, msg: "$52000104_QD__52000104__5$", duration: 6000,
                    delayTick: 1000);
                context.ShowGuideSummary(entityID: 25201043, textID: 25201043, durationTime: 10000);
            }
        ...
        private class State대검바라보기01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.ShowGuideSummary(entityID: 25201044, textID: 25201044, durationTime: 10000);
                ...
                context.SetEffect(arg1: new int[] {5408}, arg2: true);
                context.SetEffect(arg1: new int[] {5409}, arg2: true);
                context.SetEffect(arg1: new int[] {5410}, arg2: true);
                context.SetEffect(arg1: new int[] {5411}, arg2: true);
                context.SetEffect(arg1: new int[] {5412}, arg2: true);
                context.SetEffect(arg1: new int[] {5413}, arg2: true);
                context.SetEffect(arg1: new int[] {5414}, arg2: true);
                context.SetEffect(arg1: new int[] {5415}, arg2: true);
                context.SetEffect(arg1: new int[] {5416}, arg2: true);
            }
        ...
        private class State수련장으로이동01 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddBalloonTalk(spawnPointID: 101, msg: "$52000104_QD__52000104__10$", duration: 6000,
                    delayTick: 2500);
                context.ShowGuideSummary(entityID: 25201045, textID: 25201045, durationTime: 10000);
            }

            public override void Execute() {
                if (context.NpcDetected(arg1: 10013, arg2: new int[] {102})) {

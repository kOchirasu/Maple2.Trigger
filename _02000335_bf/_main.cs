    ...
    public static class _main {
        ...
        private class Stateidle : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(arg1: new int[] {6901, 6902, 6903, 6904, 6905, 6906, 6907, 6908}, arg2: false, arg4: 0,
                    arg5: 10f);
                ...
                context.CreateMonster(
                    ...
                    arg2: false);
                context.SetEffect(arg1: new int[] {6901}, arg2: false);
                context.SetEffect(arg1: new int[] {6902}, arg2: false);
                context.SetEffect(arg1: new int[] {6903}, arg2: false);
                context.SetEffect(arg1: new int[] {6904}, arg2: false);
                context.SetEffect(arg1: new int[] {6905}, arg2: false);
                context.SetEffect(arg1: new int[] {6906}, arg2: false);
        ...
        private class State시작_03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$02000335_BF__MAIN__1$", arg3: new int[] {3000}, arg4: "0");
            ...
            public override void OnExit() {
                context.SetMesh(arg1: new int[] {6401, 6402, 6403, 6404}, arg2: false, arg4: 0, arg5: 10f);
            }
        }
        ...
        private class State관문_01_개방 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new int[] {6101, 6102, 6103, 6104, 6105, 6106, 6107, 6108}, arg2: false, arg4: 0,
                    arg5: 10f);
                context.SetTimer(arg1: "3", arg2: 3, arg4: false);
            }
        ...
        private class State관문_02_개방 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.PlaySystemSoundInBox(arg2: "System_ShowGuideSummary_01");
                context.ShowGuideSummary(entityID: 106, textID: 20003362);
                context.SetMesh(arg1: new int[] {6111, 6112, 6113, 6114, 6115, 6116, 6117, 6118}, arg2: false, arg4: 0,
                    arg5: 10f);
                context.SetTimer(arg1: "3", arg2: 3, arg4: false);
            }

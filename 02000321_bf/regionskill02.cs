    ...
    public static class _regionskill02 {
        public class StateWaitStart : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.NpcDetected(boxId: 202, spawnIds: new []{900})) {
        ...
        private class StateSkill작동 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(triggerIds: new []{301, 303}, enabled: true);
            }
        ...
        private class StateTriggerReset : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkill(triggerIds: new []{301, 303}, enabled: false);

namespace Maple2.Trigger._02020130_bf {
    public static class _phasepatterntrigger {
        ...
        private class StateBoss3마리_Phase전환실행_4페이즈 : TriggerState {
            internal StateBoss3마리_Phase전환실행_4페이즈(ITriggerContext context) : base(context) { }
        ...
        private class StateBoss3마리_Phase전환실행_5페이즈 : TriggerState {
            internal StateBoss3마리_Phase전환실행_5페이즈(ITriggerContext context) : base(context) { }

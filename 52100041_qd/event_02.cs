    ...
    public static class _event_02 {
        public class StateIdle : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10002071}, arg2: 0)) {
        ...
        private class StateScene_02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 2, spawnId: 11001956, script: "$52100041_QD__EVENT_02__0$", arg4: 5);
        ...
        private class StateScene_03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkip(state: new StateScene_06_ready(context));
                context.SetConversation(type: 2, spawnId: 11001956, script: "$52100041_QD__EVENT_02__1$", arg4: 5);
            }
        ...
        private class StateScene_04 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 2, spawnId: 11001956, script: "$52100041_QD__EVENT_02__2$", arg4: 5);
            }
        ...
        private class StateScene_05 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(type: 2, spawnId: 11001956, script: "$52100041_QD__EVENT_02__3$", arg4: 5);
            }
        ...
        private class StateScene_06_ready : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10002072, 10002073, 10002074, 10002075, 10002076, 10002077}, state: 1);
                context.DestroyMonster(spawnIds: new []{199});
                context.SetSkip();
        ...
        private class StateScene_07 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, script: "$02000403_BF__EVENT_02__4$", duration: 3000);
        ...
        private class StateScene_09 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 181, script: "$52100041_QD__EVENT_02__5$", arg4: 3, arg5: 2);
                context.SetConversation(type: 1, spawnId: 182, script: "$52100041_QD__EVENT_02__6$", arg4: 3, arg5: 4);
                context.SetConversation(type: 1, spawnId: 183, script: "$52100041_QD__EVENT_02__7$", arg4: 3, arg5: 8);
                context.SetConversation(type: 1, spawnId: 184, script: "$52100041_QD__EVENT_02__8$", arg4: 3, arg5: 0);
            }

    ...
    public static class _52000159 {
        public class Statewait_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new[] {2001}, arg2: new[] {40002735},
                    arg3: new byte[] {2})) {
                    context.State = new State정리_01(context);
                    return;
                }

                if (context.QuestUserDetected(arg1: new[] {2001}, arg2: new[] {40002736},
                    arg3: new byte[] {2})) {
                    context.State = new State정리_01(context);
                    return;
                }

                if (context.QuestUserDetected(arg1: new[] {2001}, arg2: new[] {40002737},
                    arg3: new byte[] {2})) {
                    context.State = new State정리_01(context);
                    return;
                }
        ...
        private class Statewait_01_1 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State어쌔신과거_01(context);
                    return;
                }
            }
        ...
        private class State어쌔신과거_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State어쌔신과거_02(context);
                    return;
                }
            }
        ...
        private class State어쌔신과거_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 8000)) {
                    context.State = new State어쌔신과거_03(context);
                    return;
                }
            }
        ...
        private class State어쌔신과거_03 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.ShowCaption(type: "VerticalCaption", title: "$52000159_QD__52000159__0$", align: "bottomLeft",
                    offsetRateX: 0f, offsetRateY: 0f, duration: 5000, scale: 2.5f);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State어쌔신과거_04(context);
                    return;
                }
            }
        ...
        private class State어쌔신과거_04 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State어쌔신과거_05(context);
                    return;
                }
            }
        ...
        private class State어쌔신과거_05 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 12000)) {
                    context.State = new State어쌔신과거_06(context);
                    return;
                }
            }
        ...
        private class State어쌔신과거_06 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 9000)) {
                    context.State = new State어쌔신과거_07(context);
                    return;
                }
            }
        ...
        private class State암전 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State쉐도클로_01(context);
                    return;
                }
            }
        ...
        private class State쉐도클로_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State쉐도클로_02(context);
                    return;
                }
            }
        ...
        private class State밝아짐 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new[] {2001}, arg2: new[] {40002735},
                    arg3: new byte[] {2})) {
                    context.State = new State남자의죽음_01(context);
                    return;
                }
        ...
        private class State남자의죽음_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State남자의죽음_01_02(context);
                    return;
                }
            }
        ...
        private class State남자의죽음_01_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State남자의죽음_02(context);
                    return;
                }
            }
        ...
        private class State남자의죽음_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State남자의죽음_03(context);
                    return;
                }
            }
        ...
        private class State남자의죽음_03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State남자의죽음_03_01(context);
                    return;
                }
            }
        ...
        private class State남자의죽음_03_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State남자의죽음_04(context);
                    return;
                }
            }
        ...
        private class State남자의죽음_04 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State남자의죽음_05(context);
                    return;
                }
            }
        ...
        private class State남자의죽음_05 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new[] {2001}, arg2: new[] {40002737},
                    arg3: new byte[] {2})) {
                    context.State = new State쉐도클로표창_01(context);
                    return;
                }
            }
        ...
        private class State쉐도클로표창_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State쉐도클로표창_01_01(context);
                    return;
                }
            }
        ...
        private class State쉐도클로표창_01_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State쉐도클로표창_02(context);
                    return;
                }
            }
        ...
        private class State쉐도클로표창_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State쉐도클로표창_03(context);
                    return;
                }
            }
        ...
        private class State쉐도클로표창_03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State쉐도클로표창_03_01(context);
                    return;
                }
            }
        ...
        private class State쉐도클로표창_03_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State쉐도클로표창_04(context);
                    return;
                }
            }
        ...
        private class State쉐도클로표창_04 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State쉐도클로표창_05(context);
                    return;
                }
            }

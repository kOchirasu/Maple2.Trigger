namespace Maple2.Trigger._52100041_qd {
    public static class _move {
        ...
        private class State랜덤블록1 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetRandomMesh(arg1: new[] {3047, 3048, 3049, 3050, 3051, 3052, 3053, 3054}, arg2: true,
        ...
        private class State랜덤블록2 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetRandomMesh(arg1: new[] {3055, 3056, 3057, 3058, 3059, 3060, 3061, 3062, 3063},
        ...
        private class State랜덤블록3 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetRandomMesh(arg1: new[] {3064, 3065, 3066, 3067, 3068, 3069, 3070, 3071, 3072},
                    arg2: true, arg3: 4, arg4: 0, arg5: 1);
            }
        ...
        private class State랜덤블록4 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetRandomMesh(arg1: new[] {3073, 3074, 3075, 3076, 3077, 3078, 3079, 3080}, arg2: true,
                    arg3: 4, arg4: 0, arg5: 1);
            }
        ...
        private class State랜덤블록5 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetRandomMesh(arg1: new[] {3080, 3081, 3082, 3083, 3084, 3085}, arg2: true, arg3: 4,
                    arg4: 0, arg5: 1);
            }

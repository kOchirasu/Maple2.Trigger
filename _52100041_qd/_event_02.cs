    ...
    public static class _event_02 {
        public class Stateidle : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new[] {10002071}, arg2: 0)) {
        ...
        private class Statescene_02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 2, arg2: 11001956, arg3: "$52100041_QD__EVENT_02__0$", arg4: 5);
        ...
        private class Statescene_03 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetSkip(arg1: "scene_06_ready");
                context.SetConversation(arg1: 2, arg2: 11001956, arg3: "$52100041_QD__EVENT_02__1$", arg4: 5);
            }
        ...
        private class Statescene_04 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetMesh(arg1: new[] {1002}, arg2: true, arg3: 0, arg4: 200, arg5: 35f);
                context.SetMesh(
                    arg1: new[] {
                ...
                context.SetConversation(arg1: 2, arg2: 11001956, arg3: "$52100041_QD__EVENT_02__2$", arg4: 5);
            }
        ...
        private class Statescene_05 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetConversation(arg1: 2, arg2: 11001956, arg3: "$52100041_QD__EVENT_02__3$", arg4: 5);
            }
        ...
        private class Statescene_06_ready : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10002072}, arg2: 1);
                context.SetInteractObject(arg1: new[] {10002073}, arg2: 1);
                context.SetInteractObject(arg1: new[] {10002074}, arg2: 1);
                context.SetInteractObject(arg1: new[] {10002075}, arg2: 1);
                context.SetInteractObject(arg1: new[] {10002076}, arg2: 1);
                context.SetInteractObject(arg1: new[] {10002077}, arg2: 1);
                context.DestroyMonster(arg1: new[] {199});
                context.SetSkip();
        ...
        private class Statescene_07 : TriggerState {
            ...
            public override void OnEnter() {
                context.ShadowExpedition(type: "OpenBossGauge", title: "$52100041_QD__EVENT_02__4$",
                    maxGaugePoint: 1000);
                context.DestroyMonster(arg1: new[] {199});
                ...
                context.SetEventUI(arg1: 1, arg2: "$02000403_BF__EVENT_02__4$", arg3: 3000);
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new[] {106, 105, 116, 115})) {
        ...
        private class Statescene_08 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new[] {181, 182, 183, 184}, arg2: false);
            }
        ...
        private class Statescene_09 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(arg1: 1, arg2: 181, arg3: "$52100041_QD__EVENT_02__5$", arg4: 3, arg5: 2);
                context.SetConversation(arg1: 1, arg2: 182, arg3: "$52100041_QD__EVENT_02__6$", arg4: 3, arg5: 4);
                context.SetConversation(arg1: 1, arg2: 183, arg3: "$52100041_QD__EVENT_02__7$", arg4: 3, arg5: 8);
                context.SetConversation(arg1: 1, arg2: 184, arg3: "$52100041_QD__EVENT_02__8$", arg4: 3, arg5: 0);
            }
        ...
        private class Statescene_10 : TriggerState {
            ...
            public override void OnEnter() {
                context.DestroyMonster(arg1: new[] {181, 182, 183, 184});
            }

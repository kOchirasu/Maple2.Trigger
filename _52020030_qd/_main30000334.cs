    ...
    public static class _main30000334 {
        ...
        private class State연출시작 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(arg1: new int[] {4023, 4020}, arg2: false);
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State유저걸어감(context);
                    return;
                }
            }
        ...
        private class State유저걸어감 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 9000)) {
                    context.State = new State바라보는크란츠(context);
                    return;
                }
            }
        ...
        private class State바라보는크란츠 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State바라보는크란츠_01(context);
                    return;
                }
            }
        ...
        private class State바라보는크란츠_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(arg1: new int[] {4027, 4014}, arg2: false);
                context.AddCinematicTalk(npcID: 11003761, msg: "...", duration: 3000);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State바라보는크란츠_02(context);
                    return;
                }
            }
        ...
        private class State바라보는크란츠_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3500)) {
                    context.State = new State바라보는크란츠_03(context);
                    return;
                }
            }
        ...
        private class State바라보는크란츠_03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State잠시암전(context);
                    return;
                }
            }
        ...
        private class State잠시암전 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(arg1: new int[] {4016, 4015}, arg2: false);
            }

            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State크란츠습격전(context);
                    return;
                }
            }
        ...
        private class State크란츠습격전 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State크란츠습격(context);
                    return;
                }
            }
        ...
        private class State크란츠습격 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State크란츠습격01(context);
                    return;
                }
            }
        ...
        private class State크란츠습격01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1500)) {
                    context.State = new State크란츠습격02(context);
                    return;
                }
            }
        ...
        private class State크란츠습격02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State크란츠습격03(context);
                    return;
                }
            }
        ...
        private class State크란츠습격03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State크란츠습격03_01(context);
                    return;
                }
            }
        ...
        private class State크란츠습격03_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State크란츠습격03_01_01(context);
                    return;
                }
            }
        ...
        private class State크란츠습격03_01_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State크란츠습격03_02(context);
                    return;
                }
            }
        ...
        private class State크란츠습격03_02 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State크란츠습격03_03(context);
                    return;
                }
            }
        ...
        private class State크란츠습격03_03 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 4000)) {
                    context.State = new State크란츠습격04(context);
                    return;
                }
            }
        ...
        private class State크란츠습격04_01 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State크란츠습격05(context);
                    return;
                }
            }

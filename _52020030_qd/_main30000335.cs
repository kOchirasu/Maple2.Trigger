namespace Maple2.Trigger._52020030_qd {
    public static class _main30000335 {
        public class State입장1 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.QuestUserDetected(arg1: new[] {2003}, arg2: new[] {30000335}, arg3: new byte[] {1})) {
                    return new State투르카이오네연출시작(context);
                }
        ...
        private class State투르카이오네연출시작 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    return new State투르카이오네연출시작_02(context);
                }
        ...
        private class State투르카이오네연출시작_02 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    return new State투르카의등장(context);
                }
        ...
        private class State투르카의등장 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    return new State투르카의등장_01(context);
                }
        ...
        private class State투르카의등장_01 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    return new State투르카의등장02(context);
                }
        ...
        private class State투르카의등장02 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 6000)) {
                    return new State투르카의등장03(context);
                }
        ...
        private class State투르카의등장03 : TriggerState {
            ...
            public override TriggerState Execute() {
                if (context.WaitTick(waitTick: 6000)) {
                    return new State투르카의등장04(context);
                }
        ...
        private class State반대하는플레이어02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(arg1: new[] {4019, 4035}, arg2: false);
        ...
        private class State반대하는플레이어03 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(arg1: new[] {4036}, arg2: false);
        ...
        private class State크란츠이동_02 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CameraSelectPath(arg1: new[] {4037}, arg2: false);
        ...
        private class State공명완료02_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(arg1: new[] {4039}, arg2: false);
        ...
        private class State공명완료03_01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CameraSelectPath(arg1: new[] {4038}, arg2: false);

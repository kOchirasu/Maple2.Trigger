...
namespace Maple2.Trigger._52000052_qd {
    public static class _801_penalty_01round {
        ...
        private class State1stWaveStart01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90180, 90188}, arg2: false);
            }
        ...
        private class State1stWaveStart02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90185, 90189}, arg2: false);
            }
        ...
        private class State2ndWaveStart01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90190, 90192}, arg2: false);
            }
        ...
        private class State2ndWaveStart02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90195, 90197}, arg2: false);
            }

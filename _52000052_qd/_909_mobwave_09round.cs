...
namespace Maple2.Trigger._52000052_qd {
    public static class _909_mobwave_09round {
        ...
        private class State1stWaveDirection10 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90900, 90902, 90904, 90906, 90908}, arg2: false);
            }
        ...
        private class State1stWaveDirection11 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90901, 90903, 90905, 90907, 90909}, arg2: false);
            }
        ...
        private class State1stWaveDirection20 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90910, 90912, 90914, 90916, 90918}, arg2: false);
            }
        ...
        private class State1stWaveDirection21 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90911, 90913, 90915, 90917, 90919}, arg2: false);
            }
        ...
        private class State1stWaveDirection30 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90920, 90922, 90924, 90926, 90928}, arg2: false);
            }
        ...
        private class State1stWaveDirection31 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90921, 90923, 90925, 90927, 90929}, arg2: false);
            }
        ...
        private class State1stWaveDirection40 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90930, 90932, 90934, 90936, 90938}, arg2: false);
            }
        ...
        private class State1stWaveDirection41 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90931, 90933, 90935, 90937, 90939}, arg2: false);
            }
        ...
        private class State1stWaveDirection50 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90940, 90942, 90944, 90946, 90948}, arg2: false);
            }
        ...
        private class State1stWaveDirection51 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90941, 90943, 90945, 90947, 90949}, arg2: false);
            }
        ...
        private class StateNpcDownPenaltyStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$52000052_QD__901_MOBWAVE_01ROUND__1$", arg3: new int[] {4000},
                    arg4: "0");
                context.SetConversation(arg1: 1, arg2: 1109, arg3: "$52000052_QD__901_MOBWAVE_01ROUND__2$", arg4: 4,
                    arg5: 4);
            }

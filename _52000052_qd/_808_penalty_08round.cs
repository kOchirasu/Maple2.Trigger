...
namespace Maple2.Trigger._52000052_qd {
    public static class _808_penalty_08round {
        ...
        private class State1stWaveStart01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90886, 90888}, arg2: false);
            }
        ...
        private class State1stWaveStart02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90881, 90883}, arg2: false);
            }
        ...
        private class State2ndWaveStart01 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90890, 90892}, arg2: false);
            }
        ...
        private class State2ndWaveStart02 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90897, 90899}, arg2: false);
            }

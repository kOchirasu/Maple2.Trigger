    ...
    public static class _901_mobwave_01round {
        ...
        private class State1stWaveStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {90100, 90102}, arg2: false);
            }
        ...
        private class State1stWaveDelayRandom : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90105, 90107, 90109}, arg2: false);
            }
        ...
        private class State2ndWaveStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {90116, 90118}, arg2: false);
            }
        ...
        private class State2ndWaveDelayRandom : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90113, 90115, 90117}, arg2: false);
            }
        ...
        private class State3rdWaveStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {90124, 90126}, arg2: false);
            }
        ...
        private class State3rdWaveDelay : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90121, 90125, 90129}, arg2: false);
            }
        ...
        private class State5thWaveStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {90192, 90196}, arg2: false);
            }
        ...
        private class State5thWaveDelay : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90195, 90197, 90199}, arg2: false);
            }
        ...
        private class StateNpcDownPenaltyStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$52000052_QD__901_MOBWAVE_01ROUND__1$", arg3: new int[] {4000},
                    arg4: "0");
                context.SetConversation(arg1: 1, arg2: 1101, arg3: "$52000052_QD__901_MOBWAVE_01ROUND__2$", arg4: 4,
                    arg5: 4);
            }

...
namespace Maple2.Trigger._52000052_qd {
    public static class _906_mobwave_06round {
        ...
        private class State1stWaveDirection10 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90600, 90602, 90604, 90606, 90608}, arg2: false);
            }
        ...
        private class State1stWaveDirection11 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90601, 90603, 90605, 90607, 90609}, arg2: false);
            }
        ...
        private class State1stWaveDirection20 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90610, 90612, 90614, 90616, 90618}, arg2: false);
            }
        ...
        private class State1stWaveDirection21 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90611, 90613, 90615, 90617, 90619}, arg2: false);
            }
        ...
        private class State1stWaveDirection30 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90620, 90622, 90624, 90626, 90628}, arg2: false);
            }
        ...
        private class State1stWaveDirection31 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90621, 90623, 90625, 90627, 90629}, arg2: false);
            }
        ...
        private class State1stWaveDirection40 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90630, 90632, 90634, 90636, 90638}, arg2: false);
            }
        ...
        private class State1stWaveDirection41 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90631, 90633, 90635, 90637, 90639}, arg2: false);
            }
        ...
        private class State1stWaveDirection50 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90640, 90642, 90644, 90646, 90648}, arg2: false);
            }
        ...
        private class State1stWaveDirection51 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90641, 90643, 90645, 90647, 90649}, arg2: false);
            }
        ...
        private class State5thWaveStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {90690, 90692, 90694, 90696, 90698}, arg2: false);
            }
        ...
        private class State5thWaveDelay : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {90691, 90693, 90695, 90697, 90699}, arg2: false);
            }
        ...
        private class StateNpcDownPenaltyStart : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetEventUI(arg1: 1, arg2: "$52000052_QD__901_MOBWAVE_01ROUND__1$", arg3: new int[] {4000},
                    arg4: "0");
                context.SetConversation(arg1: 1, arg2: 1106, arg3: "$52000052_QD__901_MOBWAVE_01ROUND__2$", arg4: 4,
                    arg5: 4);
            }

    ...
    public static class _quest_01 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {101}, arg2: new int[] {40002600},
                    arg3: new byte[] {3})) {
        ...
        private class State제이시추가배치 : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {101}, arg2: new int[] {40002603},
                    arg3: new byte[] {2})) {
        ...
        private class State기본NPC배치 : TriggerState {
            ...
            public override void OnEnter() {
                context.CreateMonster(arg1: new int[] {2001, 2002}, arg2: false);
            }
        ...
        private class State연출01시작 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.DestroyMonster(arg1: new int[] {2001, 2002, 2003});

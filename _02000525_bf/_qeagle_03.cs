    ...
    public static class _qeagle_03 {
        ...
        private class State시작대기중 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10000571}, arg2: 1);
                context.SetActor(arg1: 905, arg2: false, arg3: "Attack_Idle_A");
                context.SetEffect(arg1: new int[] {906}, arg2: false);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000571}, arg2: 0)) {
        ...
        private class State오브젝트반응 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(arg1: 905, arg2: true, arg3: "Attack_Idle_A");

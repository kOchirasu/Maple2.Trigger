    ...
    public static class _3400_findkeyfromcandle {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10001143}, state: 0);
        ...
        private class StateTrue : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{3401}, visible: false, arg3: 100, arg4: 0, arg5: 2f);
                context.SetInteractObject(interactIds: new []{10001143}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10001143}, arg2: 0)) {
        ...
        private class StateKeyFound : TriggerState {
            ...
            public override void OnEnter() {
                context.SetMesh(triggerIds: new []{3400}, visible: true, arg3: 0, arg4: 0, arg5: 2f);

    ...
    public static class _04_hallwaybattle {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10002045}, state: 0);
        ...
        private class StateMobTrapOn01 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetConversation(type: 1, spawnId: 901, script: "$02000483_BF__04_HALLWAYBATTLE__0$", arg4: 2, arg5: 0);
                context.SetConversation(type: 1, spawnId: 902, script: "$02000483_BF__04_HALLWAYBATTLE__1$", arg4: 2, arg5: 0);
                context.SetConversation(type: 1, spawnId: 903, script: "$02000483_BF__04_HALLWAYBATTLE__2$", arg4: 2, arg5: 0);
            }
        ...
        private class StateGuideUseKey : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{10002045}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10002045}, arg2: 0)) {

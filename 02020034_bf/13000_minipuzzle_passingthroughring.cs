namespace Maple2.Trigger._02020034_bf {
    public static class _13000_minipuzzle_passingthroughring {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000233, 12000076}, state: 2);
        ...
        private class StatePassingThroughRing_Success : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000233}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{12000233}, arg2: 0)) {

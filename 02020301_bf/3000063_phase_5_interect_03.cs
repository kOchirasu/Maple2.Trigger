    ...
    public static class _3000063_phase_5_interect_03 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{200035, 200036}, visible: false);
            }
        ...
        private class State인터렉트_설정 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{200035, 200036}, visible: true);
                context.SetInteractObject(interactIds: new []{10003103}, state: 1);
                context.SetVisibleBreakableObject(triggerIds: new []{5530}, visible: false);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10003103}, arg2: 0)) {

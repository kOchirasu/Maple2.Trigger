    ...
    public static class _3000051_phase_4_interect_01 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{200021, 200022}, visible: false);
                context.SetInteractObject(interactIds: new []{10003111}, state: 2);
            }
        ...
        private class State인터렉트_설정 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{200021, 200022}, visible: true);
                context.SetInteractObject(interactIds: new []{10003111}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10003111}, arg2: 0)) {

    ...
    public static class _3000064_phase_5_interect_04 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{200037, 200038}, visible: false);
            }
        ...
        private class State인터렉트_설정 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEffect(triggerIds: new []{200037, 200038}, visible: true);
                context.SetInteractObject(interactIds: new []{10003104}, state: 1);
                context.SetVisibleBreakableObject(triggerIds: new []{5540}, visible: false);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10003104}, arg2: 0)) {

namespace Maple2.Trigger._02000432_bf {
    public static class _buff_2 {
        ...
        private class StateBuff : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBuff(boxIds: new []{2002}, skillId: 40501003, level: 1, arg4: true, arg5: false);
            }
        ...
        private class StateDead_BuffRemove : TriggerState {
            ...
            public override void OnEnter() {
                context.AddBuff(boxIds: new []{2001}, skillId: 40501005, level: 1, arg4: true, arg5: false);
            }

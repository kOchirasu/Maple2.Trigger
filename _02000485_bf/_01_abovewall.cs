    ...
    public static class _01_abovewall {
        ...
        private class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10002048}, arg2: 0);
                context.SetInteractObject(arg1: new int[] {10002049}, arg2: 0);
                context.SetInteractObject(arg1: new int[] {10002050}, arg2: 0);
        ...
        private class StateBattle01Start : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10002048}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10002048}, arg2: 0)) {
        ...
        private class StateBattle03Start : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new int[] {10002049}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10002049}, arg2: 0)) {
        ...
        private class StateBattle04Start : TriggerState {
            ...
            public override void Execute() {
                if (context.UserDetected(arg1: "9350")) {
        ...
        private class StateBattle04Start_2 : TriggerState {
            ...
            public override void OnEnter() {
                context.PlaySystemSoundInBox(arg2: "System_ShowGuideSummary_01");
                context.ShowGuideSummary(entityID: 20039907, textID: 20039907, durationTime: 3000);
        ...
        private class StateBattle04End : TriggerState {
            ...
            public override void Execute() {
                if (context.MonsterDead(arg1: new int[] {940, 941, 942})) {
        ...
        private class StateSwichOn : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new int[] {10002050}, arg2: 1);
            }

            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10002050}, arg2: 0)) {

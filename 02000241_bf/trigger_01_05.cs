    ...
    public static class _trigger_01_05 {
        ...
        private class State버튼눌림 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(spawnIds: new []{605, 606}, arg2: false);
                context.MoveNpc(spawnId: 605, patrolName: "MS2PatrolData_605");
                context.MoveNpc(spawnId: 606, patrolName: "MS2PatrolData_606");
            }

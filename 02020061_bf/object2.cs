    ...
    public static class _object2 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000085}, state: 2);
            }
        ...
        private class StateLever2_안내MassiveEvent : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "$02020061_BF__OBJECT2__0$", duration: 5000, boxId: 9012);
            }
        ...
        private class StateLever2_발동 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000085}, state: 1);
                context.SetEventUI(arg1: 1, script: "$02020061_BF__OBJECT2__1$", duration: 5000, boxId: 9012);
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (context.ObjectInteracted(interactIds: new []{12000085}, arg2: 0)) {

    ...
    public static class _object3 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {12000086}, arg2: 2);
            }
        ...
        private class StateLever3_체크 : TriggerState {
            ...
            public override TriggerState Execute() {
                ...
                if (context.UserDetected(arg1: new[] {9013})) {
                    return new StateLever3_안내MassiveEvent(context);
                }
        ...
        private class StateLever3_안내MassiveEvent : TriggerState {
            internal StateLever3_안내MassiveEvent(ITriggerContext context) : base(context) { }

            public override void OnEnter() {
                context.SetEventUI(arg1: 1, arg2: "$02020061_BF__OBJECT3__0$", arg3: 5000, arg4: "9013");
            }
        ...
        private class StateLever3_발동 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(arg1: new[] {12000086}, arg2: 1);
                context.SetEventUI(arg1: 1, arg2: "$02020061_BF__OBJECT3__1$", arg3: 5000, arg4: "9013");
            }
            ...
            public override TriggerState Execute() {
                ...
                if (context.ObjectInteracted(arg1: new[] {12000086}, arg2: 0)) {
                    return new StateLever3_MonsterAppear(context);
                }
        ...
        private class StateLever3_MonsterAppear : TriggerState {
            internal StateLever3_MonsterAppear(ITriggerContext context) : base(context) { }

    ...
    public static class _object3 {
        public class StateWait : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000086}, state: 2);
            }
        ...
        private class StateLever3_안내MassiveEvent : TriggerState {
            ...
            public override void OnEnter() {
                context.SetEventUI(arg1: 1, script: "$02020061_BF__OBJECT3__0$", duration: 5000, boxId: 9013);
            }
        ...
        private class StateLever3_발동 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.SetInteractObject(interactIds: new []{12000086}, state: 1);
                context.SetEventUI(arg1: 1, script: "$02020061_BF__OBJECT3__1$", duration: 5000, boxId: 9013);
            }
            ...
            public override TriggerState? Execute() {
                ...
                if (context.ObjectInteracted(interactIds: new []{12000086}, arg2: 0)) {

namespace Maple2.Trigger._02020061_bf {
    public static class _object3 {
        ...
        private class State레버3_체크 : TriggerState {
            ...
            public override TriggerState Execute() {
                ...
                if (context.UserDetected(arg1: new[] {9013})) {
                    return new State레버3_안내MassiveEvent(context);
                }
        ...
        private class State레버3_안내MassiveEvent : TriggerState {
            internal State레버3_안내MassiveEvent(ITriggerContext context) : base(context) { }
        ...
        private class State레버3_발동 : TriggerState {
            ...
            public override TriggerState Execute() {
                ...
                if (context.ObjectInteracted(arg1: new[] {12000086}, arg2: 0)) {
                    return new State레버3_MonsterAppear(context);
                }
        ...
        private class State레버3_MonsterAppear : TriggerState {
            internal State레버3_MonsterAppear(ITriggerContext context) : base(context) { }

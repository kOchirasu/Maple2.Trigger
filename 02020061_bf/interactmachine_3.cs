namespace Maple2.Trigger._02020061_bf {
    public static class _interactmachine_3 {
        ...
        private class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(arg1: new[] {10002135}, arg2: 1);
            }

            public override TriggerState Execute() {
                if (context.ObjectInteracted(arg1: new[] {10002135}, arg2: 0)) {
        ...
        private class State재활성Wait : TriggerState {
            ...
            public override TriggerState Execute() {
                if (!context.CheckAnyUserAdditionalEffect(triggerBoxId: 9103, additionalEffectId: 99910370, level: 1)) {
                    return new StateStart(context);
                }

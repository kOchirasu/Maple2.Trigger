namespace Maple2.Trigger._02020061_bf {
    public static class _interactmachine_8 {
        ...
        private class StateStart : TriggerState {
            ...
            public override void OnEnter() {
                context.SetInteractObject(interactIds: new []{10002140}, state: 1);
            }

            public override TriggerState? Execute() {
                if (context.ObjectInteracted(interactIds: new []{10002140}, arg2: 0)) {
        ...
        private class State재활성Wait : TriggerState {
            ...
            public override TriggerState? Execute() {
                if (!context.CheckAnyUserAdditionalEffect(boxId: 9108, additionalEffectId: 99910370, level: 1)) {
                    return new StateStart(context);
                }

    ...
    public static class _main {
        ...
        private class Stateidle : TriggerState {
            ...
            public override void Execute() {
                if (context.QuestUserDetected(arg1: new int[] {9900}, arg2: new int[] {60100115},
                    arg3: new byte[] {1})) {
        ...
        private class State레논등장 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State계단이동(context);
                    return;
                }
            }
        ...
        private class State계단이동 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 8000)) {
                    context.State = new State시체발견(context);
                    return;
                }
            }
        ...
        private class State시체발견 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State의문(context);
                    return;
                }
            }
        ...
        private class State의문 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State상황파악(context);
                    return;
                }
            }
        ...
        private class State상황파악 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State현장목격(context);
                    return;
                }
            }
        ...
        private class State현장목격 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State오해1(context);
                    return;
                }
            }
        ...
        private class State오해1 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State오해2(context);
                    return;
                }
            }
        ...
        private class State오해2 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State오해3(context);
                    return;
                }
            }
        ...
        private class State오해3 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State오해4(context);
                    return;
                }
            }
        ...
        private class State오해4 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State오해5(context);
                    return;
                }
            }
        ...
        private class State쓰러짐 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State탈출(context);
                    return;
                }
            }
        ...
        private class State탈출 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State레논탈출(context);
                    return;
                }
            }
        ...
        private class State레논탈출 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 1000)) {
                    context.State = new State카메라시점변경_ready(context);
                    return;
                }
            }
        ...
        private class State카메라시점변경_ready : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 2000)) {
                    context.State = new State카메라시점변경(context);
                    return;
                }
            }
        ...
        private class State카메라시점변경 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 3000)) {
                    context.State = new State카트반등장(context);
                    return;
                }
            }
        ...
        private class State카트반이동 : TriggerState {
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State의미심장(context);
                    return;
                }
            }
        ...
        private class State의미심장 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.AddCinematicTalk(npcID: 11001024, msg: "$52000073_QD__MAIN__14$", duration: 3000,
                    align: "center");
            ...
            public override void Execute() {
                if (context.WaitTick(waitTick: 5000)) {
                    context.State = new State다크윈드통로(context);
                    return;
                }
            }

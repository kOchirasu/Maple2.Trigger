    ...
    public static class _door05 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(arg1: 1009, arg2: false, arg3: "Closed");
            }

            public override void Execute() {
                if (context.UserDetected(arg1: new int[] {999996})) {
        ...
        private class State준비 : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000531, 10000522}, arg2: 0)) {
        ...
        private class State트리거02시작 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {2036}, arg2: true);

    ...
    public static class _door01 {
        ...
        private class State대기 : TriggerState {
            ...
            public override void OnEnter() {
                context.SetActor(arg1: 1001, arg2: false, arg3: "Closed");
            }
        ...
        private class State준비 : TriggerState {
            ...
            public override void Execute() {
                if (context.ObjectInteracted(arg1: new int[] {10000523, 10000504}, arg2: 0)) {
        ...
        private class State트리거02시작 : TriggerState {
            ...
            public override void OnEnter() {
                ...
                context.CreateMonster(arg1: new int[] {2028}, arg2: true);
